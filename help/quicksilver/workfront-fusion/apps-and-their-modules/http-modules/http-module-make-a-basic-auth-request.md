...
>
>* [HTTP >기본 권한 부여 요청 모듈 만들기](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/http-module-make-a-basic-auth-request.html)
>
>모든 책갈피를 업데이트하십시오.
>
