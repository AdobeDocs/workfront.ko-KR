...
title: 이메일 모듈
description: 다음 기간 [!DNL Adobe Workfront Fusion] 시나리오에서는 전자 메일 계정을 여러 타사 응용 프로그램 및 서비스에 연결할 수 있습니다.이렇게 하면 IMAP을 통해 전자 메일을 다운로드하고, SMTP를 통해 전자 메일을 보내고, 새 초안을 만들고, 한 폴더에서 다른 폴더로 전자 메일을 이동 및 복사하고, 전자 메일을 읽음 또는 읽지 않음으로 표시하고, 전자 메일을 삭제할 수 있습니다.
author: Becky
...
다음 기간 [!DNL Adobe Workfront Fusion] 시나리오에서는 전자 메일 계정을 여러 타사 응용 프로그램 및 서비스에 연결할 수 있습니다.이렇게 하면 IMAP을 통해 전자 메일을 다운로드하고, SMTP를 통해 전자 메일을 보내고, 새 초안을 만들고, 한 폴더에서 다른 폴더로 전자 메일을 이동 및 복사하고, 전자 메일을 읽음 또는 읽지 않음으로 표시하고, 전자 메일을 삭제할 수 있습니다.
...
에 연결해야 하는 이메일 모듈로 시나리오를 만들려면 이 옵션을 사용합니다. [!DNL Google] 계정입니다. 범위가 제한된 계정입니다.

에 대한 연결을 만들 수 있습니다. [!DNL Google] 이메일 모듈 내에서 직접 계정

1. 이메일 모듈에서 **[!UICONTROL 추가]** 다음 옆에 [!UICONTROL 연결] 필드.
1. 선택 **[!DNL Google]** 를 연결 유형으로 사용하십시오.
1. 연결의 이름을 입력합니다.
1. (선택 사항) [!UICONTROL [!DNL Google] 클라이언트 ID] 및 [!UICONTROL 클라이언트 암호].
...
1. 이메일 모듈에서 **[!UICONTROL 추가]** 다음 옆에 [!UICONTROL 연결] 필드.
1. 선택 **[!UICONTROL 기타(SMTP)]** 를 연결 유형으로 사용하십시오.
1. 입력 **[!UICONTROL 이름]** 연결용.
1. 다음 항목 선택 **[!UICONTROL 이메일 공급자]** 목록에서 삭제할 수 있습니다. 이메일 공급자가 목록에 없는 경우 기타를 선택합니다.
1. 다음을 입력하십시오. **[!UICONTROL 이메일 주소]**, **[!UICONTROL 전체 이름]**, 사용자 **[!UICONTROL 사용자 이름]**&#x200B;및 **[!UICONTROL 암호]**.
1. (조건부) 공급자가 목록에 없는 경우 **[!UICONTROL SMTP 서버]** 및 **[!UICONTROL 포트]**&#x200B;을 클릭하고 원하는 대로 지정합니다 **[!UICONTROL TLS(보안 연결) 사용]**. 이 정보를 찾으려면 다음을 확인하십시오. [!UICONTROL 도움말] 사서함의 섹션입니다. 이 정보를 사용할 수 없는 경우 이메일 서비스 공급자에게 문의하십시오.
1. 클릭 **[!UICONTROL 계속]** 를 클릭하여 연결을 만들고 모듈로 돌아갑니다.

## [!UICONTROL 이메일] 모듈 및 해당 필드

를 구성할 때 [!UICONTROL 이메일] 모듈, [!DNL Workfront Fusion] 아래 나열된 필드를 표시합니다. 이러한 필드와 함께 앱이나 서비스의 액세스 수준과 같은 요소에 따라 추가 필드가 표시될 수 있습니다. 모듈의 굵은 제목은 필수 필드를 나타냅니다.
...
>[!NOTE]
>
>고유 이메일 ID(&#39;)입니다.[!UICONTROL 이메일 ID(UID)]&quot;&quot;는 이메일의 식별자입니다. 이메일 ID는 각 이메일 폴더에 대해 고유합니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!UICONTROL Workfront Fusion]에 이메일 계정을 연결하는 방법은 을 참조하십시오. <a href="#connect-your-email-to-workfront-fusion" class="MCXref xref">[!UICONTROL Workfront Fusion]에 이메일 연결</a> 이 문서에서.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 최대 이메일 수 [!DNL Workfront Fusion] 한 시나리오 실행 주기 중에 를 반환해야 합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[!UICONTROL Connection] </td> 
   <td> <p>이메일 계정 연결에 대한 지침을 보려면 [!DNL Workfront Fusion], 참조 <a href="#connect-your-email-to-workfront-fusion" class="MCXref xref">[!UICONTROL Workfront Fusion]에 이메일 연결</a> 이 문서에서.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL 전송 후 메시지 저장]</td> 
   <td>전자 메일 메시지가 전송되면 사서함에 저장됩니다. 을 사용하여 보낸 이메일을 저장하려면 이 옵션을 활성화하십시오. [!DNL Workfront Fusion] (으)로 <i>[!UICONTROL Sent mail]</i> 폴더 또는 사서함의 다른 폴더입니다. 다음과 같은 일부 이메일 서비스 [!DNL Gmail], 보낸 메시지를 자동으로 저장합니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>이메일의 [!UICONTROL From] 필드에 표시되는 이메일 주소(및 필요한 경우 이름)를 입력하거나 매핑합니다. </p> <p>중요: 올바른 구문을 사용하십시오. <code>name@email.com</code> 또는 <code>"Name" name@email.com</code>.</p> <p>참고: 일반적으로 [!DNL Workfront Fusion] 은 연결을 만들 때 입력한 이메일 주소를 발신자 주소로 사용합니다. 다른 이메일 주소를 입력하면 계정에 내 주소가 아닌 다른 주소에서 이메일을 보낼 수 있는 권한이 없을 수 있으므로 메시지를 보낼 때 오류가 발생할 수 있습니다. 예: <code>test@mail.com</code> 또는 "<code>John Bush" test@email.com</code>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Sender]</p> </td> 
   <td> <p>이메일의 [!UICONTROL Sender] 필드에 표시되는 이메일 주소를 입력하거나 매핑합니다.</p> <p>팁: 이 필드를 사용할지 또는 부터 필드를 사용할지 확실하지 않은 경우 부터 필드를 선택하는 것이 좋습니다.</p> <p>중요: 올바른 구문을 사용하십시오. <code>name@email.com</code> 또는 <code>"Name" name@email.com</code></p> </td> 
  </tr> 
  <tr> 
...
선택한 폴더의 이메일 또는 초안을 읽은 상태로 표시합니다. [!UICONTROL 읽기] 플래그.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>이 옵션을 활성화하면 모듈이 현재 열려 있는 사서함에서 [!UICONTROL Deleted](으)로 플래그가 지정된 모든 메시지를 영구적으로 제거할 수 있습니다.</p> <p>참고: [!DNL Gmail], 이 동작은 [!UICONTROL Settings] &gt;[!UICONTROL Forwarding POP/IMAP in IMAP access] 섹션의 설정에 의해 제어됩니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 세부 정보를 검색할 이메일의 이메일 ID(UID)를 입력합니다.</p> <p>을 사용하여 이메일의 UID를 가져올 수 있습니다 [!DNL Workfront Fusion]s[!UICONTROL 감시 이메일] 모듈 또는 [!UICONTROL 검색 이메일] 모듈.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL 최대 결과 수]</td> 
   <td> <p> 최대 이메일 수 [!DNL Workfront Fusion] 한 시나리오 실행 주기 중에 를 반환해야 합니다.</p> </td> 
...
반복자에 대한 자세한 내용은 [의 반복자 모듈 [!DNL Adobe Workfront Fusion]](../../workfront-fusion/modules/iterator-module.md).
