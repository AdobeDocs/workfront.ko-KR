...
title: NetSuite 모듈
description: Adobe Workfront Fusion 시나리오에서는 [!DNL NetSuite]여러 타사 애플리케이션 및 서비스에 연결할 수 있습니다.
author: Becky
...
에서 [!DNL Adobe Workfront Fusion] 시나리오, [!DNL NetSuite]여러 타사 애플리케이션 및 서비스에 연결할 수 있습니다.
...
를 사용하려면 [!DNL NetSuite] 모듈이면 반드시 [!DNL NetSuite] 계정이 필요합니다.



## [!DNL NetSuite] 모듈 및 해당 필드

구성 시 [!DNL NetSuite] 모듈, [!DNL Workfront Fusion] 아래 나열된 필드를 표시합니다. 이와 함께 추가 [!DNL NetSuite] 앱이나 서비스에서 액세스 수준과 같은 요소에 따라 필드가 표시될 수 있습니다. 모듈에서 굵게 표시된 제목은 필수 필드를 나타냅니다.
...
이 작업 모듈을 사용하면 [!DNL NetSuite] API. 이렇게 하면 다른 방식으로 수행할 수 없는 데이터 흐름 자동화를 만들 수 있습니다 [!DNL NetSuite] 모듈.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>연결 방법에 대한 지침은 [!DNL NetSuite] Workfront Fusion 계정,<a href="#create-a-connection-to-netsuite-in-a-workfront-fusion-netsuite-module" class="MCXref xref">연결 만들기 [!DNL NetSuite] Workfront Fusion NetSuite 모듈에서</a> 참조하십시오.</p> </td> 
  </tr> 
  <tr> 
