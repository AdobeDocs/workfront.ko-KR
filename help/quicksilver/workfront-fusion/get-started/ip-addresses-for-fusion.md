...
허용 목록에 추가하다 방화벽 또는 메일 서버가 특정 공급업체에 대해서만 액세스를 허용하도록 구성된 경우 환경 및 간에 통신을 허용하려면 해당 공급업체에 특정 IP 주소를 추가해야 합니다. [!DNL Adobe Workfront Fusion].

활성화하려면 다음 IP 주소를 허용 목록에 추가하십시오. [!DNL Workfront Fusion] 을 클릭하여 시스템에 액세스합니다.
...
조직의 허용 목록에 추가하다 설정에 대한 자세한 내용은 을 참조하십시오. [허용 목록에 추가하다 방화벽 구성](../../administration-and-setup/get-started-wf-administration/configure-your-firewall.md).
