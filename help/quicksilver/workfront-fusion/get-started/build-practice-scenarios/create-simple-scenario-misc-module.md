...
title: 에서 간단한 시나리오 만들기 [!DNL Adobe Workfront Fusion]
...
1. 다음에서 [!UICONTROL 레코드 유형] 상자, 선택 **[!UICONTROL 문제]**. 이렇게 하면 모듈이 문제만 검색하도록 설정됩니다.

   다음을 찾을 수 있습니다. **[!UICONTROL 문제]** &quot; &quot;라는 단어를 입력하면[!UICONTROL 문제].&quot;

1. 다음에서 **[!UICONTROL 결과 집합]** 상자, 선택 **[!UICONTROL 첫 번째 일치 레코드]**.

   이 옵션은 기준을 충족하는 첫 번째 레코드만 반환하도록 모듈을 설정합니다.
1. 다음에서 **[!UICONTROL 검색 기준]** 영역에서 특정 문제를 반환하도록 기준을 구성합니다.
   ...
   1. 의 마지막 필드에서 [!UICONTROL 검색 기준]를 클릭하고, 검색 중인 문제의 이름에 있는 단어 또는 구를 입력합니다.
...
1. 모듈을 마우스 오른쪽 단추로 클릭하고 **[!UICONTROL 이름 바꾸기]**&#x200B;을 클릭하고, 모듈에서 수행할 작업을 설명하는 이름을 입력한 다음(&quot;문제 검색&quot; 등), **[!UICONTROL 확인]**.
...
1. 선택 [!DNL Adobe Workfront] 응용 프로그램 목록에서 모듈을 선택합니다 **[!UICONTROL 기타 동작]**.
...
1. **[!UICONTROL 레코드 유형]**필드, 선택 **[!UICONTROL 문제]**: 수행할 작업이 문제와 관련되어 있기 때문입니다.
1. 다음에서 **[!UICONTROL 작업]** 필드, 선택 **프로젝트 변환**. 선택한 문제를 프로젝트로 변환하는 작업입니다.
1. 다음을 클릭합니다. **[!UICONTROL ID]** 필드.
