...
>
>* [날짜 및 시간 형식에 대한 토큰](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/mapping-panel/functions/tokens-for-date-and-time-formatting.html)
>
>모든 책갈피를 업데이트하십시오.
>
