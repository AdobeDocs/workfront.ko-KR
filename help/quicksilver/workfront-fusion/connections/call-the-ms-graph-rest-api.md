...
>
>* [MS Graph REST API를 호출합니다](https://experienceleague.adobe.com/docs/workfront-fusion/using/create-scenarios/connect-to-applications/call-the-ms-graph-rest-api.html)
>
>모든 책갈피를 업데이트하십시오.
>
