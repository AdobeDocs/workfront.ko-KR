...
1. 시나리오를 만들려면 **[!UICONTROL 새 시나리오 만들기]** 페이지의 오른쪽 상단 모서리에서 을 참조하십시오.

   또는

   기존 시나리오를 편집하려면 해당 시나리오를 클릭합니다.
...
1. 시나리오 편집을 마쳤거나 편집하는 동안 언제든지 [!UICONTROL 저장] 아이콘. ![](assets/save-icon.gif)
...
<tbody>
  <tr>
     ...
     <td> <p>물음표 아이콘을 클릭합니다. <img src="assets/question-mark-full-size.png"></p> <p> 그런 다음 시작하려는 앱 또는 서비스를 찾아 클릭합니다. 2단계에서 앱을 선택한 경우 여기에 표시되어 쉽게 액세스할 수 있습니다( 및 <strong>[!UICONTROL 즐겨찾기]</strong> 섹션에 있는 마지막 항목이 될 필요가 없습니다.</p> </td>
  </tr>
  <tr>
  ...
  <tr>
     ...
     <td> <p>[!UICONTROL 렌치] 아이콘을 클릭합니다. <img src="assets/wrench-icon.gif"> 을 클릭하고 다음 옵션 중 하나를 사용합니다.</p>    
       <ul>
  ...
  <tr>  
   ...
   <tr> 
     ...
     <td> 
       <p>시나리오를 실행합니다. 시나리오 실행이 완료되면 [!UICONTROL 시나리오 편집기]의 오른쪽 아래 모서리에 로그가 표시됩니다. </p> <p> <img src="assets/log-350x189.png" style="width: 350;height: 189;"> </p> <p>시나리오에 따라 로그에는 각 단계의 어려움과 시나리오를 실행하는 동안 발생한 모든 오류에 대한 정보가 포함될 수 있습니다.</p> 
     </td>  
   </tr>  
   <tr>   
   ...
   <tr> 
     ...
     <td>[!UICONTROL More] 메뉴를 클릭합니다. <img src="assets/more-icon.png">그런 다음 [!UICONTROL 블루프린트 내보내기]를 클릭합니다.</td>  
   </tr>  
   <tr>   
     <td role="rowheader">컴퓨터에서 시나리오 블루프린트 가져오기</td>   
     <td>[!UICONTROL More] 메뉴를 클릭합니다. <img src="assets/more-icon.png">그런 다음 [!UICONTROL 블루프린트 가져오기]를 클릭합니다.</td>  
   </tr>  
   <tr>   
     <td role="rowheader">이전 버전의 시나리오 복원</td>   
     <td>문서 보기 <a href="../../workfront-fusion/scenarios/restore-a-scenario-version.md" class="MCXref xref">에서 시나리오 버전 복원 [!DNL Adobe Workfront Fusion]</a>.</td>  
   </tr>  
   <tr> 
   ...
   <tr> 
     ...
     <td>[!UICONTROL Tools] 아이콘을 클릭합니다. <img src="assets/tools-icon.gif"> 트리거, 작업, 집계 및 변환기를 만들 수 있습니다. 자세한 내용은 <a href="../../workfront-fusion/apps-and-their-modules/tools-modules.md" class="MCXref xref">도구</a>.</td>  
   </tr>  
   <tr> 
     <td role="rowheader">텍스트 구문 분석 도구 사용</td>   
     <td>[!UICONTROL Text parser] 아이콘을 클릭합니다. <img src="assets/text-parser-icon.gif"> HTML 코드에서 요소를 검색하고, 검색 패턴과 일치하는 문자열 요소를 찾아 추출하고, 텍스트를 검색하여 바꾸고, 웹 사이트에서 데이터를 "스크랩"할 수 있습니다. 자세한 내용은 <a href="../../workfront-fusion/apps-and-their-modules/tools-modules.md" class="MCXref xref">도구</a>.</td>  
   </tr>  
   <tr> 
     <td role="rowheader">가장 일반적으로 사용되는 앱 및 서비스에 액세스</td>   
     <td> 에서 아이콘을 클릭합니다. <strong>[!UICONTROL 즐겨찾기]</strong> 섹션 을 참조하십시오. 앱과 서비스를 시나리오에 추가할 때 아이콘이 이 섹션에 자동으로 표시됩니다. 추가 아이콘을 클릭할 수도 있습니다 <img src="assets/add-icon.gif"> 이 영역에 앱 및 서비스를 수동으로 추가합니다.</td>  
   </tr>  
   <tr> 
