...
# [!DNL Adobe Workfront Fusion]에서 시나리오의 실행 기록 보기
...
### [!UICONTROL 시나리오 세부 정보] 페이지에서 시나리오 실행 기록 보기
...
### [!UICONTROL 기록] 탭에서 시나리오 실행 기록 보기
...
1. (선택 사항) 처리된 번들을 포함하여 선택한 시나리오 실행에 대한 자세한 내용을 보려면 **[!UICONTROL 세부 정보]** 링크를 클릭하십시오.
...
1. 왼쪽 패널에서 **[!UICONTROL 시나리오]** 아이콘 ![](assets/scenarios-icon.png)을(를) 클릭한 다음 시나리오를 클릭합니다.

   또는

   시나리오 편집기에서 시나리오 작업을 수행하는 경우 창의 왼쪽 위 모서리 근처에 있는 왼쪽 화살표 ![](assets/exit-editing-arrow.png)을(를) 클릭합니다.

1. 화면의 왼쪽 상단 근처에 있는 **[!UICONTROL 기록]** 탭을 클릭합니다.
