...
통합 검토 및 승인은 Adobe 및 Frame.io를 포함하여 Adobe 엔터프라이즈 제품 전반에 걸쳐 에셋의 중앙 저장소 역할을 하는 클라우드 기반 스토리지 솔루션인 Workfront 엔터프라이즈 스토리지에 구축됩니다. <!--, and Creative Cloud.-->
...
통합 검토 및 승인은 Adobe 엔터프라이즈 스토리지를 사용하여 작성되므로 프로젝트 및 문서를 관리할 때 알아야 하는 일부 강제 구조 및 이름 지정 규칙이 있습니다.
