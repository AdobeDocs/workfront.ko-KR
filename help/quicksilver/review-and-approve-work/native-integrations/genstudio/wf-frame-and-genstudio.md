...
title: GenStudio for Performance Marketing 및 Frame.io 통합 시작
description: GenStudio for Performance Marketing 및 Frame.io 통합 시작
author: Courtney
...
* Workfront 통합 승인 템플릿을 사용하여 검토 및 승인 워크플로 정의
...
조직의 콘텐츠 검토 프로세스가 자주 반복되거나 동일한 사용자에 의해 검토되는 경우 통합 승인 템플릿을 사용하여 검토 및 승인 워크플로를 자동화할 수 있습니다.

### Workfront에서 통합 승인 템플릿 만들기

한 명 또는 두 명의 검토자만을 위한 간단한 단일 단계 템플릿을 만들거나 여러 단계 및 종속성이 있는 복잡한 검토를 위한 다중 단계 템플릿을 만들 수 있습니다.

Workfront에서 승인 워크플로 템플릿을 만드는 방법에 대한 자세한 내용은 [문서에 대한 승인 워크플로 템플릿 만들기](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-approval-template.md)를 참조하십시오.
...
GenStudio for Performance Marketing의 Frame.io 뷰어에서 초안 콘텐츠를 직접 검토하고 승인할 수 있습니다.

Frame.io 뷰어로 다음을 수행할 수 있습니다.
