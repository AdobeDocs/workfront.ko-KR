...
승인 대기 중인 항목 또는 직접 승인을 위해 제출한 항목을 보는 방법에 대한 자세한 내용은 [승인 보기](../../review-and-approve-work/manage-approvals/view-approvals.md).
...
1. (선택 사항) 문서의 &quot;날짜, 프로젝트 또는 우선 순위별 그룹화 및 정렬&quot; 섹션에 설명된 대로 승인이 표시되는 순서를 변경합니다 [홈 영역의 작업 목록에 항목 표시](../../workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md).
...
1. 오른쪽 패널에서 승인 결정을 내릴 때 사용할 수 있는 옵션 중 하나를 클릭합니다. 승인하는 항목의 유형에 따라 페이지의 오른쪽 상단에 다음 옵션이 표시됩니다.
   ...
   * **문서:** 클릭 **승인**, **거부**, 또는 **변경 사항**.\
      승인을 볼 때는 다음 사항을 고려하십시오.

      * 사용자가 문서의 &quot;증명 링크 공유&quot; 섹션에 설명된 대로 증명을 공유할 때 여기에 증명 승인이 표시됩니다 [Adobe Workfront 내에서 증명 공유](../../review-and-approve-work/proofing/managing-proofs-within-workfront/share-a-proof-in-workfront.md).
      ...
      * 증명에 대한 승인 결정을 내리려면 **증명으로 이동**, 클릭 **검토 완료**&#x200B;을 클릭한 다음 사용 가능한 옵션 중 하나를 클릭합니다. 증명을 승인할 때 사용할 수 있는 옵션은 다음과 같습니다. **승인됨**, **변경 사항과 함께 승인됨**, **변경 필요**, 및 **관련 없음**.

      * 증명에 대한 결정이 내려지면 증명을 클릭할 때까지 &quot;결정됨&quot; 텍스트가 있는 내 승인 탭에 증명이 유지됩니다. **새로 고침** 단추를 클릭하거나 브라우저 페이지를 새로 고칠 때까지 단추를 클릭합니다.
   ...
   * **액세스:** 에서 부여할 액세스 수준 선택 **액세스 변경** 드롭다운 메뉴를 클릭한 다음 **액세스 권한 부여**. 또는 **무시**.
...
1. 클릭 **승인** 또는 **거부**&#x200B;승인 프로세스를 승인 또는 거부할지 여부에 따라 달라집니다.\
   이제 승인 보류 중이던 승인 단계가 승인되고, 승인 진행이 다음 단계로 넘어간다. 모든 단계가 승인된 후 상태가 승인됩니다.

## 문서에서 직접 문서 승인 

1. 승인이 필요한 문서가 포함된 문서 영역으로 이동합니다.
1. 문서를 선택하고 **승인**, **변경 사항**, 또는 **거부**.\
   ![](assets/approval-approve-document-350x215.png)\
   ![](assets/document-approval-350x199.png)

1. (선택 사항) 문서에 대해 증명이 생성된 경우에 설명된 대로 증명 인터페이스 내에서 문서를 승인할 수 있습니다 [증명에서 문서 승인](#approve-a-document-from-a-proof).

## 승인 알림 이메일에서 문서 승인

알림 설정에 따라 다른 사용자가 승인 결정을 내려야 하는 문서에 대해 알리는 이메일을 받을 수 있습니다. 다음 내용이 포함된 이메일을 받는 경우: **승인 결정** 버튼은 이메일에서 직접 승인 프로세스를 시작할 수 있습니다.

1. 이메일에서 **승인 결정** 증명을 위한 문서 세부 정보 페이지를 열려면 다음을 수행하십시오.
1. 다음 중 하나를 수행하여 문서를 검토하십시오.

   * 문서에 대한 메타데이터를 봅니다.
   * 마크업과 주석이 있는 문서를 검토하기 위한 증명을 만든 경우 **증명 열기** ![](assets/open-proof-icon-qs.png) 오른쪽 상단 모서리 근처에서 증명을 검토합니다.
...
1. 클릭: **결정** 오른쪽 상단의 옵션을 사용하여 문서를 승인하거나, 변경 내용으로 승인하거나, 거부합니다.

## 증명에서 문서 승인 {#approve-a-document-from-a-proof}

증명 뷰어 내에서 문서를 승인할 수 있습니다. 자세한 내용은 [증명 뷰어에서 증명 결정](../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/make-a-decision-on-a-proof/make-decisions-on-proof.md) 이 문서에서 [증명 뷰어에서 증명 결정](../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/make-a-decision-on-a-proof/make-decisions-on-proof.md).
