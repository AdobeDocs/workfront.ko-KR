...
기존 문서 승인은 보다 일반적인 승인에 사용됩니다. 피드백은 업데이트 탭에 채팅 형식으로 캡처됩니다. 승인 버튼을 사용하여 변경 사항을 승인, 거부 또는 승인할 수 있습니다.

Workfront에 업로드한 후 문서에 승인자를 추가하려면 [레거시 문서 승인 요청](../../review-and-approve-work/manage-approvals/request-document-approvals.md)을 참조하십시오.

>[!NOTE]
>
>현재 Workfront에는 몇 가지 문서 승인 옵션이 있습니다. 자세한 내용은 [문서 승인에 사용할 수 있는 기능](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md)을 참조하세요.
