...
title: 문서 승인을 제출할 추가 승인자 추가
description: 홈 영역에서 직접 문서 승인에 승인자를 추가할 수 있습니다.
author: Courtney
...
# 문서 승인을 제출할 추가 승인자 추가

홈 영역에서 직접 문서 승인에 승인자를 추가할 수 있습니다.
...
1. 에서 **누군가 이 문서를 승인하도록 함** 상자에 승인자의 이름을 입력합니다.

   Adobe Workfront 관리자가 다음에 설명된 대로 Workfront을 사용하지 않는 사람과 공동 작업하는 기능을 활성화한 경우 [시스템 보안 환경 설정 구성](../../administration-and-setup/manage-workfront/security/configure-security-preferences.md)에는 포함할 이메일 주소를 입력할 수 있습니다.
