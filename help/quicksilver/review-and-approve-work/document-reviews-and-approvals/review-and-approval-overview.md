...
>[!IMPORTANT]
>
>이 기능은 곧 제공될 예정입니다. 현재 Frame.io 계정은 Workfront 팀에서 수동으로 추가합니다. Adobe 계정 담당자에게 문의하십시오.
...
* **검토자** 주석을 추가하고 에셋에 표시할 수 있습니다. 완료되면 검토를 완료된 것으로 표시할 수 있습니다. 에셋이 승인 프로세스에서 앞으로 이동하기 위해서는 검토를 완료로 표시할 필요가 없습니다.<!--example of when to add reviewers-->
...
* **승인 템플릿**: Workfront 설정 영역에서 프로젝트 코디네이터는 재생성 가능한 승인 템플릿을 만들 수 있습니다. 템플릿 내에서 검토자와 승인자를 추가하고 완료 기간을 지정할 수 있습니다. 승인 템플릿이 에셋에 적용되면 기한은 지정된 시간대에서 계산됩니다.
  ...
  자세한 내용은 [승인 템플릿 만들기 및 관리]
  <!--add link.-->

* Workfront에서 자산을 업로드하고 검토 및 승인을 위해 프레임으로 보냅니다. <!-- delayed? -Need more info on this workflow -->

### Frame.io에서 자산 승인

이해 당사자는 Frame.io 뷰어로 연결된 자산을 검토하고 승인할 수 있습니다.

Frame.io에서 에셋을 검토하는 방법에 대한 자세한 내용은 <!-- get link from frame team?-->
...
* 변경 사항과 함께 승인: 자산은 변경이 필요하며, 자산이 변경되면 사용할 수 있습니다. 추가 승인이 필요하지 않습니다.
...
검토자는 Frame.io 뷰어 내부에 검토 완료를 표시할 수 있지만 승인 프로세스에서 에셋이 앞으로 이동하는 데는 필요하지 않습니다. <!--check if this is accurate -->
...
### Adobe Experience Manager Assets에 승인된 에셋 보내기

<!-- deprioritized?-->
기본 통합을 사용하여 승인된 에셋을 Adobe Experience Manager Assets으로 전송합니다.
...
![](assets/example-workflow.png) - 다른 버전의 이 설명서나 비디오 연습이 필요할 수 있음
