...
* Workfront 고객은 V2 Workfront SKU를 사용해야 합니다. 조직이 V2 Workfront SKU를 아직 사용하고 있지 않은 경우 V2 Workfront SKU를 계약에 추가하려면 Adobe을 사용하는 계약 이벤트가 필요합니다. Adobe 계정 담당자에게 문의하십시오.
...
통합 검토 및 승인에 액세스하려면 조직이 V2 Workfront SKU를 사용해야 합니다. V2 Workfront SKU를 아직 사용하지 않는 조직은 Adobe과의 계약 이벤트를 통해 V2 Workfront SKU를 추가해야 합니다. 시작하려면 다음 단계를 따르십시오.

* 현재 Adobe 계약이 V2 Workfront SKU에 있는지 확인하려면 Workfront 계정 담당자에게 문의하십시오.

* 조직이 V2 Workfront SKU에 없는 경우 계정 담당자가 추가하는 데 필요한 계약 이벤트를 안내합니다.

* 계약에 V2 Workfront SKU가 포함되면 Adobe Professional Services에서 조직에 대한 통합을 구성합니다.
...
**Adobe 엔터프라이즈 스토리지란 무엇이며 이 통합과 어떤 관련이 있습니까?**

Adobe 엔터프라이즈 스토리지는 Workfront, Frame.io 및 Adobe Creative Cloud을 연결하는 공통 스토리지 계층입니다. Assets은 한 곳에서 라이브하며 수동 파일 전송 없이 도구 간에 액세스할 수 있습니다. 크리에이티브는 제자리에서 작동할 수 있으며 검토자는 항상 최신 버전을 확인합니다.
...
예. 통합에서 Adobe 엔터프라이즈 스토리지를 사용하므로 다음 규칙이 적용됩니다.
...
+++ 를 확장하여 계약, SKU 및 스토리지에 대한 FAQ를 봅니다.

**언제 통합 검토 및 승인을 사용할 수 있습니까?**

이제 통합 검토 및 승인을 사용할 수 있습니다. 액세스하려면 V2 Workfront SKU가 필요합니다. V2 Workfront SKU를 사용하기 전에 계약이 체결된 경우 V2 Workfront SKU를 추가하려면 Adobe과의 계약 이벤트가 필요합니다. 다음 두 가지 경로가 있습니다.

* 갱신 시: V2 Workfront SKU는 다음 계약 갱신 날짜에 추가됩니다.

* 조기 재계약: Adobe 계정 팀은 기존 계약 종료 날짜를 유지하면서 V2 Workfront SKU 권한을 추가하도록 조기에 재계약할 수 있습니다. 동등한 패키지로 이동할 경우 가격 상승은 없습니다.

조직에 가장 적합한 경로를 결정하려면 Adobe 계정 담당자에게 문의하십시오.
...
**V2 Workfront SKU로 업그레이드하면 더 많은 저장 공간이 제공됩니까?**

예. V2 Workfront SKU를 사용하면 각 라이센스 사용자는 이전 버전의 30GB에서 증가한 60GB의 스토리지를 받게 됩니다.

**Adobe 엔터프라이즈 스토리지와 레거시 Workfront 스토리지 중에서 선택하려면 어떻게 해야 합니까?**

엔터프라이즈 스토리지는 Frame.io 뷰어 환경을 제공하며 통합 검토 및 승인에 필요합니다. 레거시 스토리지는 Workfront Proof 뷰어(ProofHQ)를 기본값으로 계속 사용합니다.

조직에 간단한 워크플로와 더 복잡한 증명 워크플로가 혼재되어 있는 경우 먼저 마이그레이션할 워크플로의 우선 순위를 지정할 수 있습니다.

엔터프라이즈 스토리지는 가장 큰 이점을 얻을 수 있는 워크플로우부터 시작하여 새로운 경험을 점진적으로 롤아웃할 수 있는 유연성을 제공합니다.

**Frame.io 라이선스는 어떻게 관리됩니까?**

V2 Workfront SKU에 서명한 후 모든 Workfront 사용자는 검토 및 승인 워크플로를 위해 Frame.io 뷰어에 액세스할 수 있습니다. 이에 대해 별도의 Frame.io Enterprise 라이선스가 필요하지 않습니다.
