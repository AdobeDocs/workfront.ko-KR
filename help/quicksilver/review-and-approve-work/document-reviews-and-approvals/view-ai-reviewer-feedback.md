...
title: 콘텐츠 검토자 점수 및 피드백 보기
description: 승인 요청을 제출한 후 몇 초 후에 문서 요약 패널에서 콘텐츠 검토자의 점수와 피드백을 볼 수 있습니다.
author: Courtney
...
![콘텐츠 검토자 피드백](assets/ai-reviewer-output.png)

## 점수 계산 방법 이해

콘텐츠 검토자는 검토 유형에 따라 점수를 다르게 계산합니다.
...
객관적인 가이드라인은 복사 검토에 더 많은 비중을 가지므로 브랜드에서 구체적이고 측정 가능한 가이드라인을 작성하는 것이 좋습니다. 자세한 내용은 콘텐츠 검토자의 브랜드 만들기 및 관리 문서에서 [브랜드 지침 작성에 대한 모범 사례](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/create-a-brand.md#best-practices-for-writing-brand-guidelines) 섹션을 참조하십시오.
...
![콘텐츠 검토자 피드백에 주의가 필요합니다](assets/ai-reviewer-needs-attention.png)
