...
Frame.io 뷰어에서 문서를 검토하려면 Workfront 인스턴스를 Frame.io와 통합해야 합니다. 자세한 내용은 [통합 검토 및 승인 개요](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/document-approvals-overview.md)를 참조하십시오.