...
* 콘텐츠 검토자를 사용하여 브랜드 준수 검토를 자동화합니다. 자세한 내용은 [Workfront 콘텐츠 검토자 시작](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/wf-ai-reviewer.md)을 참조하세요.

* Frame.io 뷰어를 사용하여 문서를 검토하고 승인합니다. 자세한 내용은 [통합 검토 및 승인 시작](/help/quicksilver/review-and-approve-work/get-started-with-unified-approvals.md)을 참조하세요.
