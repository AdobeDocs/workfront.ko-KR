...
기존 문서 승인은 향후 날짜에 Workfront에서 제거됩니다. 통합 승인 시스템은 기존 문서 승인을 대체하도록 설계되었습니다.

레거시 문서 승인에 사용할 수 있는 주요 기능:
...
통합 승인 은 기존 승인 시스템을 재설계한 것입니다. 현재 제한된 릴리스에서 제공되는 이 제품은 포괄적인 이해 관계자 참여 및 버전별 문서 승인이 필요한 비즈니스를 위한 실용적이고 효과적인 솔루션으로 설계되었습니다.
...
* Frame.io 통합을 사용하여 문서를 검토하고 승인합니다. 자세한 내용은 [Frame.io 통합 시작하기](/help/quicksilver/review-and-approve-work/native-integrations/frame-io/get-started-with-frame-integration.md)를 참조하십시오.

* AI 검토자를 사용하여 브랜드 규정 준수 검토를 자동화합니다. 자세한 내용은 [Workfront AI 검토자 시작하기](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/wf-ai-reviewer.md)를 참조하세요.
