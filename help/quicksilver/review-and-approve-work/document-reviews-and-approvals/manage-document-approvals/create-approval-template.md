...
1. 경로 1의 단계 1에 대한 세부 정보 입력:
   ...
   <tr class="preview">
   <td><span class="preview"><strong>미리 보기에 사람 또는 팀 추가(선택 사항)</strong></span></td>
    <td><span class="preview">사용자 이름, 팀 또는 이메일 주소를 입력하세요. 템플릿에서 참가자는 선택 사항입니다. 문서에 템플릿을 적용할 때 해당 템플릿을 추가하도록 선택할 수 있습니다.<br>
...
>[!NOTE]
>
>새 템플릿은 사용자에게만 표시됩니다. 템플릿을 공유, 편집 또는 삭제하려면 [승인 템플릿 관리](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/manage-approval-templates.md)를 참조하세요.
