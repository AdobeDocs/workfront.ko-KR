...
## 프로덕션 환경의 문서 요약에서 승인자 또는 검토자 제거
...
1. 문서 요약 패널에서 **승인** 섹션까지 아래로 스크롤합니다. 제거하려는 승인자 또는 검토자의 이름을 마우스로 가리킨 다음, 이름 뒤에 나타나는 **삭제** 아이콘 ![삭제 아이콘](../assets/delete.png)을 클릭합니다.
...
## 기존 문서 영역의 미리보기 환경에 있는 승인 워크플로에서 승인자 또는 검토자 제거
