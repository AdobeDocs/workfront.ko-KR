...
캔버스 대시보드 영역에서 보고서 대시보드를 만들어 새 문서 승인 기능을 사용하여 검토 및 승인에 대한 고급 정보와 자세한 정보를 모두 표시할 수 있습니다.

>[!IMPORTANT]
>
>이 기능은 새 문서 승인 서비스를 사용하고 Canvas Dashboards Beta에 등록된 고객에게만 제공됩니다.
...
1. 위의 섹션에 설명된 대로 [대시보드를 만듭니다](#create-a-dashboard).
1. **KPI** 카드에서 **추가**&#x200B;를 클릭합니다.
1. **KPI 제목** 텍스트 상자에 _기한 초과_&#x200B;을(를) 입력하십시오.
1. **KPI 캡션** 텍스트 상자에 _과거 승인 단계 기한_&#x200B;을(를) 입력하십시오. 이 텍스트는 KPI에 표시되는 내용을 설명합니다.
1. 페이지 맨 위에서 **KPI 필드 선택**&#x200B;을 클릭합니다.
1. 아래로 스크롤하여 **문서 승인 폴더**&#x200B;를 찾습니다.
1. **상태**&#x200B;를 선택한 다음 드롭다운 메뉴에서 **개수**&#x200B;를 선택합니다.
1. **필터 편집** > **조건 추가**&#x200B;를 클릭합니다.
...
1. 위의 섹션에 설명된 대로 [대시보드를 만듭니다](#create-a-dashboard).
1. **KPI** 카드에서 **추가**&#x200B;를 클릭합니다.
1. **KPI 제목** 텍스트 상자에 _중단_&#x200B;을(를) 입력하십시오.
1. **KPI 캡션** 텍스트 상자에 _2주 이상 승인 기한_&#x200B;을 입력하십시오. 이 텍스트는 KPI에 표시되는 내용을 설명합니다.
1. 페이지 맨 위에서 **KPI 필드 선택**&#x200B;을 클릭합니다.
...
1. **이름** 텍스트 상자에 _결정별 승인_&#x200B;을 입력하십시오.
...
1. **아래쪽(X) 축**&#x200B;의 **필드 업데이트**&#x200B;를 클릭하고 첫 번째 **문서 승인** 폴더와 **상태**&#x200B;를 차례로 선택합니다.
...
1. **필터 편집** > **조건 추가**&#x200B;를 클릭합니다.
   ...
   1. 연산자를 **작거나 같음**(으)로 변경한 다음, 상대적 날짜 설정 을 전환하고 텍스트 상자에 _$$TODAYem_을(를) 입력하십시오.
...
1. 위의 섹션에 설명된 대로 [대시보드를 만듭니다](#create-a-dashboard).
1. **테이블** 카드에서 **추가**&#x200B;를 클릭합니다.
1. **이름** 텍스트 상자에 _승인 보류 중_&#x200B;을(를) 입력하십시오.
1. (선택 사항) **설명** 텍스트 상자에 설명을 입력합니다. 이 텍스트는 차트 이름 옆에 툴팁으로 표시됩니다.
1. **열 설정 열기**&#x200B;를 클릭합니다.
