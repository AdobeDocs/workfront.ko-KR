...
title: 증명의 자동화된 워크플로우에 단계 및 사용자 추가
description: 증명 소유자인 경우 기존 자동화된 워크플로우에 단계를 추가할 수 있습니다.
author: Courtney
...
# 증명의 자동화된 워크플로우에 단계 및 사용자 추가

증명 소유자인 경우 기존 자동화된 워크플로우에 단계를 추가할 수 있습니다.
...
## 자동화된 워크플로우에 단계 및 사용자 추가

1. 문서 목록에서 문서 위로 마우스를 가져간 다음 **교정 워크플로** 표시됩니다.
1. Adobe Workfront의 오른쪽 위 모서리 근처에 있는 **새로운 단계**.
1. 다음을 지정합니다.
