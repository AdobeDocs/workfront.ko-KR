...
>[!TIP]
>
>증명 뷰어 내에서 증명을 공유할 수도 있습니다. 자세한 내용은 [증명 뷰어에서 증명 공유](../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md).
...
1. 클릭 **공유** > **증명 링크**.
1. 다음에서 **증명 링크** 상자가 나타나면 다음 중 하나를 수행합니다.
   ...
   * Adobe Workfront에서 직접 링크를 이메일로 보내려면 다음을 수행합니다.
      ...
      1. 다음에서 **또는 이메일 링크 대상** 필드에서 입력을 시작하고 수신자의 이름을 선택합니다. 또는 공유할 외부 사용자의 이메일 주소를 지정합니다.
         ...
         <table style="table-layout:auto">
          ...
          <tbody>
           <tr>
            ...
            <td><p>이메일 알림에 사용자가 사용 중인 증명 뷰어 내의 증명으로 사용자를 안내하고 보기 액세스 권한을 부여하는 버튼을 포함합니다.</p><p>If <strong>공개 URL 또는 포함 코드를 통해 증명 구독</strong> 증명에 대해 이 꺼져 있으면 Workfront 로그인 자격 증명으로 로그인하여 증명에 주석을 추가할 수 있습니다. 이 기능이 켜지면 이메일 주소와 이름을 제공하는 모든 사람(암호 필요 없음)이 서명하고 증명에 주석을 추가할 수 있습니다.</p></td>
           </tr>
           <tr>
...
>* 자동화된 워크플로가 활성화되고 Workfront에서 증명이 활성화되지 않은 사용자를 증명에 추가하면 자동화된 워크플로 내에 새 단계가 생성됩니다. 추가하려는 사용자가 증명을 처음 볼 때 이 새 단계에 자동으로 추가됩니다. (자세한 내용은 [자동화된 워크플로우 개요](../../../review-and-approve-work/proofing/proofing-overview/automated-workflow.md).)
>

### 문서 탭에서 기존 증명에 사용자 추가

1. 사용자를 추가할 증명이 포함된 문서를 선택합니다.
1. 증명에 자동화된 워크플로(단계)가 없는 경우 **자세히** 아이콘을 1단계 섹션의 오른쪽 위 모서리에 있는 다음 을 클릭합니다 **공유** 을 클릭하여 제품에서 사용할 수 있습니다.

   또는

   증명에 자동화된 워크플로가 있는 경우 **자세히** 아이콘을 클릭하여 검토자를 추가할 스테이지의 오른쪽 위 모서리에 있는 다음 **공유** 을 클릭하여 제품에서 사용할 수 있습니다.

1. 다음에서 **이 버전 공유** 아래에 나타나는 상자 **공유**&#x200B;을(를) 통해 증명을 공유할 사용자의 이름 또는 이메일 주소를 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.

1. (선택 사항) 증명에 여러 사용자를 추가하려면 이 단계를 반복합니다.
1. (선택 사항) 검토자에 대한 기한을 설정합니다.
1. (선택 사항) 다음을 확인합니다 **사람들에게 이메일로 알림** 증명에 추가했음을 검토자에게 알리려면 이(가) 선택됩니다.
1. (선택 사항) **사용자 정의 메시지 추가** 이메일에 보낼 수 있습니다.
1. 모든 검토자를 추가한 경우 **공유**.
...
증명 승인 개체 보고서에 대한 자세한 내용은 [오브젝트에 대한 보고서](../../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md#reporting-on-objects) 의 섹션 [Adobe Workfront의 오브젝트 이해](../../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md)
