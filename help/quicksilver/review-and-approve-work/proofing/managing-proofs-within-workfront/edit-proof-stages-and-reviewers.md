...
1. **워크플로** 섹션에서 다음 중 하나를 변경합니다.
   ...
   >[!NOTE]
   >
   >제거한 검토자가 증명에 대해 이미 결정을 내린 경우 해당 사용자에 대한 승인자 결정 필드는 증명 승인 보고서에 하이픈(-)을 표시합니다. 자세한 내용은 증명 승인 보고서에서 [승인자 결정에 하이픈이 표시됨](../../../review-and-approve-work/proofing/tips-tricks-and-troubleshooting/approver-decision-shows-hyphen.md)을 참조하세요.
