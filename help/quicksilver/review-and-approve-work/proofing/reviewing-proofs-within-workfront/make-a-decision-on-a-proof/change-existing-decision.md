...
title: 증명에서 기존 결정 변경
description: 증명이 활성화(잠금 또는 보관 안 됨)되어 있으면 언제든지 결정을 변경할 수 있습니다.
author: Courtney
...
증명이 활성화(잠금 또는 보관 안 됨)되어 있으면 언제든지 결정을 변경할 수 있습니다. 
...
1. 증명 뷰어의 가운데 맨 위에서 결정한 사항을 클릭합니다.
1. 표시되는 **증명 결정** 상자에서 이전에 결정한 내용 아래의 **결정 제거**&#x200B;를 클릭합니다.
