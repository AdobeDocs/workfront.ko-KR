...
description: 비디오가 연속적으로 반복되도록 구성할 수 있습니다(비디오가 완료된 후 재생이 다시 시작됨).
author: Courtney
...
비디오가 연속적으로 반복되도록 구성할 수 있습니다(비디오가 완료된 후 재생이 다시 시작됨). 
