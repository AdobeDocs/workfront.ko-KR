...
title: 교정 뷰어에서 증명 공유
description: 증명 소유자 또는 작성자가 공유를 사용하도록 설정한 경우 교정 뷰어에서 증명을 공유할 수 있습니다.
author: Courtney
...
증명 소유자 또는 작성자가 공유를 사용하도록 설정한 경우 교정 뷰어에서 증명을 공유할 수 있습니다.
...
소유자가 공유 증명을 구성한 경우 URL을 통해 증명을 공유할 수 있습니다. 증명 소유자는 언제든지 공유 설정을 업데이트할 수 있습니다. 자세한 내용은 [증명 설정 편집](../../../../review-and-approve-work/proofing/managing-proofs-within-workfront/edit-proof-settings.md).

1. 왼쪽 아이콘 메뉴가 표시되지 않으면 **메뉴** 교정 뷰어 왼쪽 위 모서리에 있는 아이콘.

   ![](assets/menu-icon-in-proofing-viewer-350x188.png)

1. 언어 교정 뷰어의 왼쪽 아이콘 메뉴에서 **공유** 아이콘.

   ![Share_btn_in_viewer.png](assets/share-btn-in-viewer.png)

1. 에서 **증명 공유** 표시되는 옵션을 확인합니다. **공유 가능한 링크 가져오기** 이 선택되어 있습니다.
...
증명 소유자가 이를 위해 구성한 경우 포함 코드를 통해 증명을 공유할 수 있습니다.

포함 코드를 통해 증명을 공유하려면

1. 교정 뷰어 왼쪽의 도구 모음에서 **공유** 아이콘.

   ![Share_btn_in_viewer__1_.png](assets/share-btn-in-viewer--1-.png)

1. 에서 **증명 공유** 표시되는 옵션을 클릭합니다. **포함 코드 가져오기**&#x200B;를 클릭한 다음 **복사**.

## 사용자를 추가하여 증명 공유

다음 권한이 있는 경우 증명을 검토하는 동안 사용자를 증표에 추가할 수 있습니다.

* 감독자 또는 관리자 권한
* 관리자 권한 및 증명 생성자 또는 소유자입니다.
* 작성자 또는 중재자 증명 역할을 사용하는 관리자 권한

증명에 자동화된 워크플로우가 있는 경우 사용자를 개별 단계에 추가할 수 있습니다. 자세한 내용은 [자동화된 워크플로우 개요](../../../../review-and-approve-work/proofing/proofing-overview/automated-workflow.md).

기본적으로 증명에 추가하는 사용자는 다음과 같습니다.

* 증명 링크가 포함된 이메일 알림을 받습니다.
* 다음에 설명된 대로 홈 또는 내 작업 영역에서 증명에 대한 승인 결정을 내릴 수 있습니다. [작업 승인](../../../../review-and-approve-work/manage-approvals/approving-work.md).
* 증명을 검토하기 위해 교정을 사용할 필요가 없습니다.
...
1. 클릭 **수신자 추가** 왼쪽 목록에 있습니다.
1. 아래 **새 증명 수신자**&#x200B;를 클릭하고 증명을 공유할 사용자의 이름을 입력한 다음 드롭다운 목록에 표시될 이름을 클릭합니다.
1. (선택 사항) 검토자 옵션을 개인 이름 오른쪽에 있는 검토자 옵션을 변경합니다.

   * **증명 역할**: 자세한 내용은 [Workfront 증명의 증명 역할 관리](../../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md).

   * **단계**: 증명에 자동화된 워크플로우가 있는 경우에만 사용할 수 있습니다. 자세한 내용은  [자동화된 워크플로우 단계 개요](../../../../review-and-approve-work/proofing/proofing-overview/stages.md).

   * **이메일 경고**: 다음 옵션 중 하나를 선택하여 증명의 활동에 대한 알림을 받는 방법을 지정합니다.
...
1. (선택 사항) 앞의 두 단계를 반복하여 증표에 여러 사용자를 추가합니다. 
1. (선택 사항) **기한** 검토자의 경우(증명에 자동화된 워크플로우가 없는 경우에만 사용 가능).
1. (선택 사항) 선택 **새 수신자에게 전자 메일 알림 보내기** 증거에 추가했다는 것을 알려주기 위해
1. 증명에 사용자를 추가했으면 을 클릭합니다 **완료.**
