...
title: Outlook의 댓글에 회신
description: Outlook 받은 편지함에서  [!DNL Adobe Workfront] 전자 메일 알림을 받으면 Outlook에서 알림에 회신하기만 하면  [!DNL Workfront] 댓글을 빠르게 게시할 수 있습니다.
author: Becky
...
[!DNL Outlook] 받은 편지함에서 [!DNL Adobe Workfront] 전자 메일 알림을 받으면 Outlook에서 알림에 회신하는 것만으로 [!DNL Workfront]에 댓글을 빠르게 게시할 수 있습니다.
...
1. 회신할 댓글이 포함된 [!DNL Workfront] 전자 메일 알림을 선택하십시오.
