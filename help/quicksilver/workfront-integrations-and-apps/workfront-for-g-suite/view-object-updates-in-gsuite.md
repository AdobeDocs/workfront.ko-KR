...
description: G Suite를 종료하지 않으면에서 업데이트에 대한 업데이트 및 응답을 볼 수 있습니다 [!DNL Adobe Workfront] 개체.
author: Becky
...
# 보기 [!DNL Adobe Workfront] 개체 업데이트 [!DNL G Suite]
...
떠나지 않고 [!DNL G Suite], 업데이트에 대한 업데이트 및 응답을 볼 수 있습니다 [!DNL Adobe Workfront] 개체.
...
1. 을(를) 클릭합니다. **[!UICONTROL 업데이트]** 탭.
1. 표시되는 옵션을 사용하여 객체에 이미 추가된 업데이트에 의해 결정됩니다.

   * 업데이트에 주석이 있는 경우 **[!UICONTROL 댓글 표시]** 설명 스레드를 보려면
   * 업데이트에 첫 번째 응답을 추가하려면 **[!UICONTROL 회신]**&#x200B;을 입력한 다음 설명을 입력합니다.

1. 로 돌아가려면 **[!UICONTROL 업데이트]** 탭, **[!UICONTROL 모든 업데이트 보기]**.
