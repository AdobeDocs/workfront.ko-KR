...
description: ' [!DNL Adobe Workfront] 을(를)  [!DNL Slack] 과(와) 통합하여  [!DNL Workfront] Slack에서 액세스하거나 [!DNL Workfront] 슬래시 명령을 사용하여 특정 작업을 수행할 수 있습니다. 통합은  [!DNL Slack] 모바일 앱을 포함한  [!DNL Slack] 환경에서 사용할 수 있습니다.'
author: Becky
...
[!DNL Slack]의 [!DNL Workfront]을(를) 사용하려면 사용자 또는 [!DNL Slack] 관리자가 [!DNL Slack] 인스턴스에 [!DNL Workfront] 앱을 설치해야 합니다. 자세한 내용은 [Slack을 위한 Adobe Workfront 구성](../../workfront-integrations-and-apps/using-workfront-with-slack/configure-workfront-for-slack.md)을 참조하십시오.
...
[!DNL Slack] 채널에서 슬래시 명령을 입력하여 [!DNL Slack]에서 [!DNL Workfront] 인스턴스에 액세스할 수 있습니다.
...
* 명령은 항상 `/workfront` 또는 `/wf`(으)로 시작해야 하며 그 뒤에는 공백과 [!DNL Workfront]에서 수행할 작업의 이름이 와야 합니다.
  ...
  이는 명령이 [!DNL Workfront] 앱용임을 나타냅니다. [!DNL Workfront]에 대한 명령은 [!DNL Slack] 인스턴스로 [!DNL Workfront] 앱을 이미 구성한 경우에만 작동합니다.
...
1. 메시지에 따라 향상된 인증, OAuth 2.0 또는 SAML(Security Assertion Markup Language) URL을 사용하여 [!DNL Workfront]에 로그인합니다.
   ...
   [!DNL Slack]의 [!DNL Workfront] 알림에 대한 구성 페이지가 열립니다.

1. (선택 사항) [!DNL Slack]에서 수신하지 않을 [!DNL Workfront] 알림을 비활성화합니다.

   [!DNL Slack]에 대한 [!DNL Workfront] 설정 구성에 대한 자세한 내용은 이 문서의 [설정 구성](#configure-settings-configure-settings) 섹션을 참조하십시오

1. [!DNL Slack] 채널로 다시 이동합니다.

   [!DNL Slack] 인스턴스에서 [!DNL Workfront]에 로그인했습니다.
...
1. [!DNL Slack] 인스턴스에 로그인하고 [!DNL Slack]에서 [!DNL Workfront]에 로그인합니다.\
   [!DNL Slack]에서 [!DNL Workfront]에 로그인하는 방법에 대한 자세한 내용은 [다음에 로그인 [!DNL Workfront] 부터 [!DNL Slack]](#log-in-to-workfront-from-slack-log-in-to-workfront-from-slack)을 참조하세요.
...
1. 다음 명령 중에서 선택합니다.
   ...
   * `/wf home`
     ...
     [!DNL Slack]에서 [!DNL Workfront] 작업 항목을 관리하는 방법에 대한 자세한 내용은 [작업 및 승인 관리 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/manage-your-work-and-approvals-from-slack.md)를 참조하십시오.
   ...
   * `/wf add task <TaskName>`
     ...
     Slack에서 [!DNL Workfront]에 작업을 추가하는 방법에 대한 자세한 내용은 [작업 및 문제 만들기 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/create-tasks-and-issues-from-slack.md)의 &quot;[!DNL Slack]에서 작업 만들기&quot; 섹션을 참조하십시오.
   ...
   * `/wf add issue <Issue Name>`
     ...
     [!DNL Slack]에서 [!DNL Workfront]에 문제를 추가하는 방법에 대한 자세한 내용은 [작업 및 문제 만들기 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/create-tasks-and-issues-from-slack.md)의 &quot;[!DNL Slack]에서 문제 만들기&quot; 섹션을 참조하십시오.

   * `/wf favorites`

     [!DNL Workfront] 즐겨찾기 목록을 표시합니다.

     [!DNL Slack]에서 즐겨찾기에 액세스하는 방법에 대한 자세한 내용은 [즐겨찾기 및 최근 항목 액세스 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/access-favorites-and-recent-items-from-slack.md) 문서의 [다음 위치에서 [!UICONTROL 즐겨찾기] 목록 액세스 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/access-favorites-and-recent-items-from-slack.md#accessing-favorites) 섹션을 참조하십시오.
   ...
   * `wf tasks`
     ...
     [!DNL Slack]에서 작업 관리에 대한 자세한 내용은 [작업 및 승인 관리 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/manage-your-work-and-approvals-from-slack.md)의 &quot;[!DNL Slack]에서 작업 관리&quot; 섹션을 참조하십시오.

   * `/wf issues`

     문제 목록을 표시합니다.

     [!DNL Slack]에서 문제를 관리하는 방법에 대한 자세한 내용은 [작업 및 승인 관리 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/manage-your-work-and-approvals-from-slack.md)의 &quot;[!DNL Slack]에서 문제 관리&quot; 섹션을 참조하십시오.

   * `/wf approvals`에 [!DNL Workfront] 승인이 표시됩니다.\

     [!DNL Slack]의 승인 관리에 대한 자세한 내용은 [작업 및 승인 관리 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/manage-your-work-and-approvals-from-slack.md)의 &quot;[!DNL Slack]에서 승인 관리&quot; 섹션을 참조하십시오.
   ...
   * `/wf search <keyword>`
      ...
      * 참고 \
        ...
        [!DNL Slack]에서 검색하는 방법에 대한 자세한 내용은 [Slack에서  [!DNL Adobe Workfront] 항목 검색](../../workfront-integrations-and-apps/using-workfront-with-slack/search-for-wf-items-from-slack.md)을 참조하세요.
   * `/wf log in`
   ...
   * `/wf log out `
     ...
     [!DNL Slack]에서 [!DNL Workfront]에서 로그아웃합니다. 다른 응용 프로그램의 다른 브라우저 탭에서 별도의 [!DNL Workfront] 인스턴스가 열려 있는 경우 [!DNL Workfront]에 로그인한 상태로 유지됩니다.
   * `/wf settings`

     [!DNL Slack]에서 [!DNL Workfront] 설정을 구성할 수 있는 액세스 권한을 제공합니다.
...
1. (선택 사항) 명령의 메시지를 삭제하려면 해당 명령이 포함된 Slack 메시지의 오른쪽 상단 모서리로 마우스를 가져간 후 **[!UICONTROL 메시지 동작 표시]**&#x200B;를 클릭한 &#x200B; 다음 **[!UICONTROL 메시지 삭제]**&#x200B;를 클릭합니다.

1. (선택 사항 및 조건부) **[!UICONTROL 삭제]**&#x200B;를 클릭하여 이 메시지 삭제를 확인합니다.

### [!DNL Slack]의 공유 링크에서 [!DNL Workfront]에 액세스 {#access-workfront-from-a-shared-link-in-slack}

[!DNL Slack]에서 사용자와 공유된 개체에 연결된 링크에서 [!DNL Workfront]개의 개체에 액세스할 수 있습니다.
...
1. Workfront 설정을 비활성화하려면 다음 옵션 중에서 선택을 취소합니다.
   ...
   * **[!UICONTROL 일반 설정]** 영역에서 **[!UICONTROL URL을 [!DNL Slack] 채널에 붙여 넣을 때 [!UICONTROL Slack]의 개체에 URL을 공유할 때 [!DNL Slack]에서 [!DNL Workfront] 개체에 대한 추가 정보를 추가하지 않으려면 [!DNL Workfront]추가 설명, 기한 또는 요청자 이름]**&#x200B;설정을 사용하지 않도록 설정하십시오.

   * **[!UICONTROL 알림 설정]** 영역에서 Workfront에서 수신을 중지할 알림을 비활성화하십시오.\

     [!DNL Slack]에서 [!DNL Workfront]개의 알림을 받는 방법에 대한 자세한 내용은 [수신 [!DNL Adobe Workfront] 알림 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/receive-workfront-notifications-in-slack.md)을 참조하세요.

## [!DNL Slack]에서 [!DNL Workfront]에서 로그아웃
