...
승인이란 기존 문서 승인을 의미합니다. 통합 문서 승인은 현재 [!DNL Microsoft Teams]에서 지원되지 않습니다. Workfront의 다양한 승인 시스템에 대한 자세한 내용은 [문서 승인에 사용할 수 있는 기능](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md)을 참조하세요.
