...
&#42;보유 중인 플랜, 역할 또는 증명 권한 프로필을 알아보려면 [!DNL Workfront] 또는 [!DNL Workfront Proof] 관리자.

## 전제 조건

* 다음을 설치해야 합니다. [!DNL Adobe Workfront for design and video] 다음에서 증명을 업로드하기 전에 [!DNL Illustrator].
