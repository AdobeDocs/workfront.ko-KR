...
[!DNL Microsoft Teams]에서 [!UICONTROL Workfront]에 로그인하고 ]Microsoft Teams을 위한 [!UICONTROL Workfront을 설치하는 방법에 대한 자세한 내용은 [Microsoft Teams을 위한 Adobe Workfront 설치](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/install-workfront-ms-teams.md)를 참조하십시오.
