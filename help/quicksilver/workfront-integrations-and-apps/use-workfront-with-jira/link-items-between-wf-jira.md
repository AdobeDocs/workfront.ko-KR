...
* [!DNL Jira]에 대해 [!DNL Workfront]을(를) 설치합니다.
...
[!DNL Workfront] 관리자는 [!DNL Workfront]의 작업 또는 문제에 대해 특정 조건이 충족될 때마다 [!DNL Jira]에서 문제를 자동으로 만드는 트리거를 정의할 수 있습니다. Workfront 및 [!DNL Jira]개 항목이 연결됩니다.
...
1. **+ 새 작업**&#x200B;을(를) 클릭합니다.
   >[!NOTE]
   >
   >기존 Workfront 항목을 Jira 문제에 연결하려면 해당 항목의 **자세히** ![추가 아이콘](assets/more-icon.png) 메뉴에서 **편집**&#x200B;을(를) 선택하십시오.
...
1. **[!UICONTROL 링크]**&#x200B;를 클릭합니다. 두 항목이 연결되고 [!DNL Workfront] 오른쪽 패널이 [!DNL Workfront] 항목의 정보로 채워집니다.
   ...
   기본적으로 다음 [!DNL Workfront] 필드가 [!DNL Workfront] 오른쪽 패널의 [!DNL Jira]에 표시됩니다.
   ...
   * **[!UICONTROL 참조 번호]**&#x200B;입니다. 패널의 **참조 번호**&#x200B;을(를) 클릭하여 [!DNL Workfront] 항목에 액세스할 수 있습니다.

   오른쪽 패널에 표시할 추가 필드를 활성화하는 방법에 대한 자세한 내용은 [구성 [!DNL Adobe Workfront for Jira]](../../workfront-integrations-and-apps/use-workfront-with-jira/configure-workfront-for-jira.md)에서 [!DNL Jira]과(와) [!DNL Workfront]개 항목 간의 필드 동기화 구성 섹션을 참조하십시오. 통합과 연결된 [!DNL Workfront] 관리자의 댓글이 [!DNL Jira] 문제의 **[!DNL Workfront]** 탭에 게시되어 새 [!DNL Jira] 항목이 생성되었는지 확인합니다. 댓글에 [!DNL Jira] 문제에 대한 링크가 포함되어 있습니다.
