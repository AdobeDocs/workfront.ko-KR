...
[!DNL Jira]에 대해 [!DNL Workfront]을(를) 설정할 때 [!DNL Jira] 시스템 관리자는 한 응용 프로그램에서 특정 필드를 구성하여 다른 응용 프로그램에서 연결된 항목의 필드와 동기화할 수 있습니다.
...
주로 [!DNL Workfront]에서 작업하는 경우 [!DNL Workfront]에서 작업 항목을 업데이트할 수 있으며 [!DNL Jira]의 해당 항목도 업데이트할 수 있습니다. 이 업데이트는 [!DNL Jira] 라이선스가 필요 없는 [!DNL Jira]에 대한 [!DNL Workfront]의 통합을 통해 이루어집니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!UICONTROL 문제 이름]</p> <p>이름 변경에 대한 댓글이 [!DNL Jira] 문제의 <strong>[!DNL Workfront]</strong> 탭에 추가됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL 문제 또는 작업 설명]</td> 
   <td> <p> [!UICONTROL 문제 설명]</p> <p>업데이트된 설명에 대한 댓글이 [!DNL Jira] 문제의 <strong>[!DNL Workfront]</strong> 탭에 추가됩니다.<br></p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>[!UICONTROL 첨부 파일]</p> <p>업로드한 첨부 파일에 대한 댓글이 [!DNL Jira] 문제의 <strong>[!DNL Workfront]</strong> 탭에 추가됩니다.<br></p> </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL 계획된 완료 일자]</td> 
   <td> <p>[!UICONTROL 기한]</p> <p>변경된 [!UICONTROL 기한]에 대한 댓글이 [!DNL Jira] 문제의 [!DNL Workfront] 탭에 추가됩니다. </p> <p>참고: [!UICONTROL Jira]에서 업데이트된 이 필드를 보려면 [!DNL Jira] 문제에 대해 <strong>[!UICONTROL 기한]</strong>을(를) 활성화해야 합니다. </p> </td> 
  </tr> 
  <tr> 
   <td>사용자 지정 Forms 및 사용자 지정 필드</td> 
   <td> <p> [!DNL Jira] 문제의 [!DNL Workfront] 오른쪽 패널에 표시합니다. <br>실제 값이 있는 사용자 지정 필드만 패널에 표시됩니다.<br></p> <p>참고: 사용자 정의 양식 섹션은 [!DNL Workfront] 관리자의 액세스 수준으로 표시됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL 문제 또는 작업 우선 순위]</td> 
   <td>[!DNL Jira] 문제의 [!DNL Workfront] 오른쪽 패널에 표시됩니다. <br>문제 [!DNL Jira]의 <strong>[!UICONTROL 우선 순위]</strong> 필드를 업데이트하지 않습니다. </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL Log Time] </td> 
   <td> <p>기록된 시간에 대한 댓글이 [!DNL Jira] 문제의 <strong>[!DNL Workfront]</strong> 탭에 추가됩니다. 여기에는 시간을 기록한 사용자의 이름과 시간이 다른 경우 기록된 사용자가 포함됩니다. [!DNL Jira]의 <strong>[!UICONTROL 작업 로그]</strong> 탭에 기록된 시간이 없습니다.<br></p> </td> 
  </tr> 
  <tr> 
...
주로 [!DNL Jira]에서 작업하는 경우 [!DNL Jira]에서 작업 항목을 업데이트할 수 있으며 [!DNL Workfront]의 해당 항목도 업데이트할 수 있습니다. [!DNL Jira]에서 업데이트한 내용을 받기 위해 [!DNL Jira] 문제와 연결된 [!DNL Workfront] 항목에 대해 [!DNL Workfront] 라이선스를 가지고 있지 않아도 됩니다.

[!DNL Workfront] 관리자가 연결된 항목 간의 필드를 동기화하도록 [!DNL Jira]에 대해 [!DNL Workfront]을(를) 구성한 경우 [!DNL Jira]에서 업데이트하는 특정 필드도 연결된 [!DNL Workfront] 항목에 대해 업데이트됩니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Hours<br>연결된 [!DNL Workfront] 항목에 Jira에 기록된 시간을 추가하는 것 외에도 [!DNL Workfront] 항목의 [!UICONTROL Updates] 탭에 로깅 시간에 대한 댓글이 추가됩니다.</p> <p>[!DNL Workfront]에서 시간을 기록하는 [!DNL Jira] 사용자를 업데이트하는 등 연결된 [!DNL Jira] 문제에 대한 시간 로깅에 대한 자세한 내용은 <a href="#log-time-for-linked-jira-and-workfront-items" class="MCXref xref">연결된 [!DNL Jira] 및 [!DNL Workfront]개 항목에 대한 시간 기록</a>을 참조하십시오.</p> </td> 
  </tr> 
  <tr> 
   <td> 댓글 <br><br></td> 
   <td> <p>[!UICONTROL Setup] 탭의 [!UICONTROL SYNCHRONIZE FROM JIRA TO WORKFRONT] 섹션에서 <strong>[!UICONTROL Comments]</strong> 설정이 <strong>[!UICONTROL Always]</strong>인 경우 [!DNL Workfront] 문제 또는 작업의 [!UICONTROL Updates] 탭에 댓글이 추가됩니다.</p> <p>[!DNL Jira]에서 Workfront 설정을 구성하는 방법에 대한 자세한 내용은 <a href="../../workfront-integrations-and-apps/use-workfront-with-jira/configure-workfront-for-jira.md">구성 [!DNL Workfront for Jira]</a>을(를) 참조하십시오.</p> <p>연결된 [!DNL Jira] 문제의 항목에 대한 댓글에 대한 자세한 내용은 <a href="#comment-from-a-linked-jira-issue" class="MCXref xref">연결된 [!DNL Jira] 문제의 댓글</a>을 참조하세요.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
[!DNL Jira]에서 시간을 기록한 위치에 관계없이 [!DNL Jira]에서 [!DNL Jira] 항목에 대해 기록한 시간도 연결된 [!DNL Workfront] 항목으로 전송됩니다.\
[!DNL Workfront] 패널의 Jira에 시간을 기록할 때 시간은 [!DNL Workfront]에만 기록됩니다.\
[!DNL Workfront]에 기록한 시간은 [!DNL Jira]에 연결된 문제의 시간에 영향을 주지 않습니다.

>[!NOTE]
>
>시간이 [!DNL Workfront] 작업에 연결된 [!DNL Jira] 항목에 추가된 경우 [!DNL Workfront]의 [!UICONTROL 시간 유형]은(는) [!UICONTROL 작업 시간]입니다. 시간이 [!DNL Workfront] 문제와 연결된 [!DNL Jira] 항목에 추가된 경우 [!DNL Workfront]의 [!UICONTROL 시간 유형]은(는) [!UICONTROL 문제 시간]입니다.

시간 로깅을 기록하려면 [!DNL Jira]의 **[!DNL Workfront]** 탭과 [!DNL Workfront]의 항목의 **[!UICONTROL 업데이트]** 탭에 댓글이 추가됩니다.\
시간은 [!DNL Workfront] 항목의 **[!UICONTROL 시간]** 탭에도 표시됩니다.
...
1. **[!UICONTROL 작업 설명]**&#x200B;을 포함하여 시간 항목에 정보를 계속 추가한 다음 **[!UICONTROL 로그]**&#x200B;를 클릭합니다.\
   시간은 [!DNL Jira] 항목의 **[!UICONTROL 작업 로그]** 탭과 연결된 [!DNL Workfront] 항목에 추가됩니다.\
   시간 항목에 대한 작업 설명이 [!DNL Workfront]의 시간 항목에 메모로 기록됩니다.

### [!DNL Jira]에서 [!DNL Workfront] 항목에 시간을 기록합니다.

이 시간을 [!DNL Jira] 문제에 기록하지 않고 [!DNL Jira] 문제의 연결된 [!DNL Workfront] 항목에 시간을 기록할 수 있습니다.
...
1. **[!UICONTROL 로그 시간]**&#x200B;을 클릭합니다.
   ...
   이 시간은 [!DNL Jira] 문제의 [!UICONTROL 작업 로그] 탭에 추가되지 않습니다.
...
1. [!DNL Workfront] 패널 또는 **[!UICONTROL 설명]** 탭에서 **[!UICONTROL 설명]** 아이콘을 클릭합니다.

1. 댓글을 입력한 다음 **[!UICONTROL 보내기]**&#x200B;를 클릭합니다.

   주석이 다음에 추가됩니다.

   * [!DNL Jira] 문제의 **[!DNL Workfront]** 탭입니다.
   * [!DNL Jira] 문제의 **[!UICONTROL 댓글]** 탭입니다.
