...
title: ' [!DNL Salesforce] 개체에서  [!DNL Adobe Workfront] 프로젝트 만들기'
description: Salesforce용  [!DNL Adobe Workfront] 을(를) 설치한 후  [!DNL Salesforce] 기회 및 계정에서 특정 기준을 충족할 때  [!DNL Workfront] 프로젝트를 만드는 트리거를 정의할 수 있습니다.
author: Becky
...
# [!DNL Salesforce] 개체에서 [!DNL Adobe Workfront] 프로젝트 만들기

Salesforce용 [!DNL Adobe Workfront]을(를) 설치한 후 [!DNL Salesforce] [!UICONTROL 기회] 및 [!UICONTROL 계정]에서 특정 기준이 충족되면 [!DNL Workfront] 프로젝트를 만드는 트리거를 정의할 수 있습니다.
...
[!DNL Salesforce] [!UICONTROL 기회] 또는 계정에서 [!DNL Workfront] 요청을 제출하려면
...
* [!DNL Workfront] 관리자가 [!UICONTROL 영업 기회] 및 계정에 [!DNL Workfront] 섹션을 추가했습니다.
페이지 레이아웃입니다.\
...
* [!DNL Workfront] 계정이 있으며 [!UICONTROL 기회] 또는 계정 내의 [!DNL Workfront] 섹션에서 로그인할 수 있습니다.
.

## [!DNL Salesforce]에서 [!DNL Workfront] 프로젝트 만들기 구성
...
[!DNL Salesforce] 시스템 관리자는 [!DNL Salesforce]에서 다음 상황이 발생할 때 [!DNL Workfront]에서 프로젝트를 자동으로 만들 수 있는 트리거를 정의할 수 있습니다.
...
[!DNL Salesforce]개 항목을 만들거나 업데이트할 때 [!DNL Workfront]개 프로젝트를 자동으로 만들도록 트리거를 구성할 때는 다음 사항을 고려하십시오.
...
[!DNL Workfront] 프로젝트 만들기를 트리거할 수 있습니다. 여기에는 [!DNL Workfront] 계정이 없는 [!DNL Salesforce]명의 사용자가 포함됩니다.
...
트리거를 구성하고 나면 [!UICONTROL Salesforce Classic] 또는 [!DNL Lightning Experience] 프레임워크 모두에서 [!DNL Workfront] 프로젝트를 만드는 프로세스를 사용할 수 있습니다.
...
1. **[!DNL Workfront]** 옆에 있는 **[!UICONTROL 구성]**&#x200B;을 클릭합니다.
...
1. (조건부) 다음을 지정합니다.
   ...
   1. **[!UICONTROL Portfolio 또는 프로그램]** 필드에서 프로젝트를 [!DNL Workfront]에 배치할 Portfolio 또는 프로그램의 이름을 입력한 다음 목록에 표시될 때 선택합니다.\
      ...
      Portfolio 또는 프로그램을 지정하지 않으면 새 프로젝트가 만들어지고 트리거를 구성할 때 [!DNL Workfront]에 로그인한 사용자의 [!UICONTROL 내가 소유한 프로젝트] 목록에 추가됩니다. 이 사용자는 새 프로젝트의 프로젝트 소유자이기도 합니다.
...
**2&rbrace;에 지정된 &#x200B;** [!UICONTROL Type]&#x200B;**(으)로 지정되었으며 [!DNL Workfront]에 &#x200B;** [!UICONTROL Project]**&#x200B;이(가) 만들어집니다.[!DNL Salesforce]
   ...
   1. (선택 사항) 프로젝트를 **[!UICONTROL Portfolio 또는 프로그램]** 필드의 [!DNL Workfront]에 배치할 **[!UICONTROL Portfolio]** 또는 **[!UICONTROL 프로그램]**&#x200B;의 이름을 입력한 다음 목록에 표시될 때 선택합니다.

      Portfolio 또는 프로그램을 지정하지 않으면 새 프로젝트가 만들어지고 [!DNL Salesforce]에서 [!DNL Workfront]에 로그인한 사용자의 **[!UICONTROL 내가 소유한 프로젝트]** 목록에 추가됩니다. 사용자는 새 프로젝트의 프로젝트 소유자이기도 합니다.

   1. 새 [!DNL Workfront] 프로젝트와 연결할 **[!UICONTROL 템플릿]**&#x200B;의 이름을 입력한 다음 목록에 표시될 때 선택하십시오.
...
[!DNL Workfront] 관리자가 [!UICONTROL 기회] 또는 계정에 [!DNL Workfront] 섹션을 추가한 경우
페이지 레이아웃에서는 이 섹션의 [!UICONTROL 프로젝트] 탭에서 자동으로 만들어진 프로젝트를 볼 수 있습니다.\
[!UICONTROL Opportunity] 또는 계정의 페이지 레이아웃에 [!DNL Workfront] 섹션을 추가하는 방법에 대한 자세한 정보
, [사용자 [!DNL Salesforce] 를 위한  [!DNL Adobe Workfront] 섹션 구성](../../workfront-integrations-and-apps/using-workfront-with-salesforce/configure-wf-section-for-salesforce-users.md)을 참조하십시오.

[!UICONTROL 프로젝트] 탭을 보려면 [!DNL Workfront] 계정이 있어야 하며 [!DNL Workfront]에 로그인해야 합니다.
...
1. (선택 사항) [!UICONTROL 프로젝트 세부 정보] 영역 또는 프로젝트 헤더에서 [!UICONTROL **[!UICONTROL Salesforce로 이동]**]을 클릭하여 [!UICONTROL 기회] 또는 계정에 액세스하십시오
프로젝트가 시작된 위치입니다. 시스템 또는 그룹 관리자가 레이아웃 템플릿에 [!UICONTROL 통합] 필드를 추가하여 프로젝트 헤더에서 찾아야 합니다.

   >[!NOTE]
   >
   >[!UICONTROL Salesforce로 이동] 링크가 프로젝트를 볼 수 있는 모든 [!DNL Workfront] 사용자에게 표시됩니다. 프로젝트가 생성된 위치에서 [!DNL Salesforce] 영업 기회 또는 계정으로 이동할 수 있으려면 [!DNL Salesforce] 계정이 있어야 합니다.
