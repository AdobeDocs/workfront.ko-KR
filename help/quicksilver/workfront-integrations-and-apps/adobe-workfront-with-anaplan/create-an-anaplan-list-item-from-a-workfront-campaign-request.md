...
title: 만들기 [!DNL Anaplan] 목록 항목 [!DNL Adobe Workfront] 캠페인 요청
description: 이 통합 시나리오는 [!DNL Adobe Workfront] 프로젝트를 [!DNL Anaplan] 예산 목록 항목.
author: Becky
...
# 만들기 [!DNL Anaplan] 목록 항목 [!DNL Adobe Workfront] 캠페인 요청

이 통합 시나리오는 [!DNL Adobe Workfront] 프로젝트를 [!DNL Anaplan] 예산 목록 항목.

이 시나리오는 요청 큐에 추가된 새 캠페인 요청을 감시합니다. 캠페인 요청이 기록되는 즉시 예산 라인 항목이 [!DNL Anaplan] 자금 조달 프로세스를 시작합니다.
...
* A **[!UICONTROL 캠페인 개요]** 에 첨부된 사용자 지정 양식 [!UICONTROL 요청] 개체.

   Anaplan에 대한 데이터 매핑에 도움이 되도록 사용자 지정 양식에 다음 필수 필드를 포함해야 합니다.
   ...
   | [!UICONTROL 요청된 인건비] |  |
   | [!UICONTROL 요청된 비용 자금] |  |
   | [!UICONTROL [!DNL Anaplan]](으)로 전송됨 | 확인란 |

   양식에 다음과 같은 선택적 필드가 있을 수 있습니다. 이 시나리오는 위의 필드만 매핑하지만 캠페인 개요에 대한 추가 필드는 매핑될 수 있습니다.
...
* 새 캠페인 요청을 캡처하도록 요청 큐로 설정된 프로젝트. 다음 [!UICONTROL 캠페인 개요] 이러한 요청에 양식을 첨부해야 합니다.
...
1. 로 이동합니다 [!UICONTROL 템플릿] 메뉴 [!DNL Workfront Fusion] 을 클릭하고 **[!UICONTROL 만들기 [!DNL Anaplan] Workfront 캠페인 요청의 목록 항목]** 시나리오 템플릿.
