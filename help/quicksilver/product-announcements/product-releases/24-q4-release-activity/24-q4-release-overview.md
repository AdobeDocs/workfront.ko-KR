...
>[!IMPORTANT]
>
>23.3 릴리스에는 조직을 월별 릴리스로 이동하는 옵션이 포함되었습니다. 따라서 Workfront은 월별 및 분기별 릴리스 트랙을 모두 고려하여 릴리스의 번호 지정 체계를 변경했습니다. 첫 번째 숫자는 연도를 지정하고 두 번째 숫자는 출시된 달을 나타냅니다. 예: 2024년 4월 릴리스는 24.4로 표시됩니다.
>
>월간 및 분기별 릴리스는 별도로 명시되지 않는 한 해당 월의 둘째 주 목요일에 사용할 수 있습니다.
>
>| 월간 릴리스 | 분기별 릴리스 |
>|----|----|
>| <ul><li>24.8 (2024년 8월 15일)</li><li>24.9 (2024년 9월 12일)</li><li>24.10 (2024년 10월 17일)</li></ul> | <ul><li>24.10 (2024년 10월 17일)</li></ul> |
>
>분기별 최종 릴리스(이번 분기 24.10)의 경우 빠른 릴리스 일정에 있는 사용자는 하루 일찍 릴리스를 받게 됩니다.
>
>빠른 릴리스 프로세스에 대한 자세한 내용은 [빠른 릴리스 프로세스 사용 또는 사용 안 함](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-fast-release-process.md)을 참조하세요.
        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    [!BADGE In production &#x200B;]{type=Informative}
                    <p>사용자 정의 양식은 500개의 필드로 제한됩니다. 긴 형식에서는 형식에 몇 개의 필드가 있으며 한도에 도달하는지 여부를 알기 어려울 수 있습니다. 왼쪽 하단의 사용자 지정 양식에 카운터가 추가되었습니다. 카운터는 폼에서 사용되는 필드 수를 표시하며 폼 디자이너 내에서 스크롤할 때 항상 표시됩니다.</p>
                </td>
                <td><p><b>다음 날짜에 사용 가능:</b></p>
                    <ul>
                        <li>
                            <p>미리 보기 릴리스: 2024년 10월 1일</p>
                        </li>
                        <li>
                            <p>모든 고객을 위한 프로덕션 릴리스: 24.10 릴리스 포함(2024년 10월 17일)</p>
                        </li>
            ...
            <tr>
                <td>
                    ...
                    [!BADGE In Production &#x200B;]{type=Informative}
                    <p>레이아웃 템플릿으로 필드를 보다 쉽게 표시하고 숨길 수 있도록 레이아웃 템플릿에 있는 세부 사항 보기의 개요 및 재무 영역에 "모두 선택" 확인란이 추가되었습니다. 이 옵션은 "사용자에게 표시되는 항목 사용자 지정"에서 프로젝트, 작업, 문제, Portfolio 또는 프로그램을 선택한 경우에 사용할 수 있습니다.</p>
                </td>
                <td><p><b>다음 날짜에 사용 가능:</b></p>
                    <ul>
                        <li>
                            <p>미리 보기 릴리스: 2024년 8월 29일</p>
                        </li>
                        <li>
...
>[!IMPORTANT]
>
>**문서 관리 개선 사항**&#x200B;에 나열된 기능은 단계별 릴리스의 일부이며 특정 고객만 사용할 수 있습니다.
...
<table>
    ...
    <col style="width: 50%;" />
        <tbody>
            ...
            <tr>
                <td>
                    <a href="/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-document-mgmt-enhancements.md">새 문서 버전에 이전 검토자와 승인자를 빠르게 추가</a></p>
                    [!BADGE In Production &#x200B;]{type=Informative}
...
<table>
    ...
    <col style="width: 50%;" />
        <tbody>
            ...
            <tr>
                <td>
                    <a href="/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-integration-enhancements.md" class="MCXref xref" xrefformat="{para}">Outlook 통합 로그인 환경 개선</a></p>
                    [!BADGE In Production &#x200B;]{type=Informative}
                    <p>Outlook 통합을 위한 로그인 환경이 간소화되어 모든 고객에게 IMS 사용 여부와 상관없이 Workfront에 로그인할 수 있는 동일한 버튼이 표시됩니다. 이후의 로그인 단계는 IMS 및 비 IMS 인스턴스에 대해 다르게 유지되지만 초기 페이지는 모든 사용자에 대해 동일합니다.</p>
                </td>
                <td><p><b>다음 날짜에 사용 가능:</b></p>
                    <ul>
                        <li>
...
<table>
    ...
    <col style="width: 50%;" />
        <tbody>
            ...
            <tr>
                <td>
                    <a href="/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-project-enhancements.md" class="MCXref xref" xrefformat="{para}">새 작업 워크플로우에 추가 관련 할당</a></p>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    [!BADGE In production &#x200B;]{type=Informative}
                    <p>Desktop Proofing Viewer의 업데이트 섹션에서 콘텐츠가 잘못 붙여넣는 문제를 수정했습니다.</p>
                    <p>신규 버전: 2.1.39</p>
                </td>
                <td><p><b>다음 날짜에 사용 가능:</b></p>
                    <ul>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    [!BADGE In Production &#x200B;]{type=Informative}
                    <p>프로젝트 또는 업데이트 스트림의 하이라이트를 더 쉽게 볼 수 있도록 Workfront의 해당 영역에 요약 단추를 추가했습니다. 이제 버튼을 클릭하여 AI Assistant에서 요약을 생성할 수 있습니다.</p><p>이전에 사용자는 AI Assistant를 열고 프롬프트에 을 입력하여 프로젝트 또는 업데이트 스트림의 요약을 만들 수 있었습니다.</p>
                </td>
                <td><p><b>다음 날짜에 사용 가능:</b></p>
                    <ul>
                        <li>
                            <p>미리 보기 릴리스: 2024년 10월 3일</p>
                        </li>
                        <li>
                            <p>모든 고객을 위한 프로덕션 릴리스: 24.10 릴리스 포함(2024년 10월 17일)</p>
                        </li>
            ...
            <tr>
                <td>
                    ...
                    <p>각 분기에 대한 최신 Workfront Planning 릴리스 정보는 아래의 <a href="#workfront-planning-enhancements">Workfront Planning 개선 사항</a> 섹션을 참조하십시오.</p>
                </td>
                <td><p><b>다음 날짜에 사용 가능:</b></p>
                    <ul>
                        <li>
            ...
            <tr>
                <td>
                    <a href="/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Workfront에서 사용 가능한 Adobe AI 길잡이</a></p>
                    [!BADGE In production &#x200B;]{type=Informative}
            ...
            <tr>
                <td>
                    <a href="/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-look-and-feel-updates.md" class="MCXref xref" xrefformat="{para}">2024년 4분기 기간 동안 룩앤필 업데이트</a></p>
...
### Workfront에서 기능이 곧 제거될 예정입니다.

다음 기능은 Workfront에서 곧 제거될 예정입니다.

#### 24.10으로 기존 홈 경험의 사용 중단

24.10 릴리스의 레거시 홈 경험에 대한 공식적인 사용을 중단할 예정입니다. 사용자는 사용 중단 전에 추가 기능을 사용하여 계속 향상될 새 홈을 사용하는 것이 좋습니다.

## 공지

### Workfront Fusion 개선 사항

Workfront Fusion의 새로운 기능은 2024년 4분기 릴리스 일정 이외의 케이던스에서 프로덕션에서 사용할 수 있습니다. 최신 기능에 대한 자세한 내용은 [Adobe Workfront Fusion 릴리스 활동](https://experienceleague.adobe.com/ko/docs/workfront-fusion/using/fusion-release-activity/fusion-release-activity)을 참조하십시오.

### Workfront Planning 개선 사항

Workfront Planning의 새로운 기능은 프로덕션에서 사용할 수 있습니다. 최신 기능에 대한 자세한 내용은 [Adobe Workfront 계획 2024년 4분기 릴리스 활동](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-24-q4.md)을 참조하십시오.
...
현재 릴리스에는 Workfront 목표 업데이트가 없습니다. 이 영역은 업데이트를 사용할 수 있을 때 업데이트됩니다.

### API 버전 19

API 버전 19의 경우 일부 리소스 및 엔드포인트를 수정했습니다. 일부 변경 사항은 새로운 기능을 지원하고, 다른 변경 사항은 API를 통해 사용할 수 있는 정보를 더 쉽게 사용할 수 있도록 합니다.
...
2024년 4분기 릴리스 중 유지 관리 업데이트에 대한 자세한 내용은 [Workfront 유지 관리 업데이트](https://experienceleague.adobe.com/ko/docs/workfront-known-issues/releases/current-updates)를 참조하십시오.
