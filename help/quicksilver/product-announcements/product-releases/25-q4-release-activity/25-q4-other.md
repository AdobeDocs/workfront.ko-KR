...
* 각 행에 접두사가 있는 그룹화 필드 이름이 첫 번째 열 헤더로 이동되었습니다.

* 이제 여러 그룹화 수준이 보고서에 적용되면 이름 열이 슬래시로 구분(슬래시로 구분)됩니다.

* 집계 유형 접두사(&quot;Sum: &quot;, &quot;Max: &quot;, &quot;Min: &quot;, &quot;Avg: &quot;)가 각 집계에서 제거되었습니다.

* 이제 각 열의 합계 유형이 열 헤더 값의 부록으로 표시됩니다.

* 하위 그룹화(2 또는 3 그룹화)는 첫 번째 열에 들여쓴 수준으로 표시됩니다. 최상위 그룹화가 여전히 굵게 표시됩니다.

* 이제 열 너비를 조정할 수 있습니다. 페이지를 새로 고치면 열이 기본 너비 분포로 되돌아갑니다.

>[!NOTE]
>
>해당되는 경우 처음 네 가지 변경 사항은 요약 탭 내보내기에도 적용됩니다. 수준 들여쓰기 및 굵은 글꼴은 내보낸 탭으로 구분된 텍스트 파일로 전송되지 않습니다.
