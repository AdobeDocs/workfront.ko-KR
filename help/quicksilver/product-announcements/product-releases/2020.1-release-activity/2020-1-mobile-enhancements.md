...
왼쪽 패널 사용자 지정에 대한 자세한 내용은 [새 Workfront 경험에서 레이아웃 템플릿을 사용하여 왼쪽 패널 맞춤화](https://one.workfront.com/s/article/Customize-the-left-panel-using-a-Layout-Template-in-the-new-Workfront-experience-354734188).
