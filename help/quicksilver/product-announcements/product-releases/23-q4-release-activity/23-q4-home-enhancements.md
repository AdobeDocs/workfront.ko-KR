...
새 홈에서 사용할 수 있는 위젯에 대한 자세한 내용은 [새 홈 시작하기](/help/quicksilver/workfront-basics/using-home/new-home/get-started-with-new-home.md)를 참조하십시오.
...
새 홈 사용에 대한 자세한 내용은 [새 홈 시작](/help/quicksilver/workfront-basics/using-home/new-home/get-started-with-new-home.md)을 참조하세요.
...
새 홈에서 작업 추적에 대한 자세한 내용은 [새 홈 시작](/help/quicksilver/workfront-basics/using-home/new-home/get-started-with-new-home.md)을 참조하세요.
...
새 홈의 위젯 기능에 대한 자세한 내용은 [새 홈 시작](/help/quicksilver/workfront-basics/using-home/new-home/get-started-with-new-home.md)을 참조하세요.

## 새 홈에 대한 새 필터 옵션

이제 새 홈의 내 작업 위젯에 새 필터 옵션을 사용할 수 있습니다. 옵션에는 오브젝트 유형(작업, 문제 및 요청)과 상태(준비되지 않음, 시작 준비, 작업 중 및 완료)에 대한 필터가 포함됩니다.

새 홈에서 콘텐츠를 필터링하는 방법에 대한 자세한 내용은 [새 홈 시작](/help/quicksilver/workfront-basics/using-home/new-home/get-started-with-new-home.md)을 참조하세요.
...
새 홈에서 사용할 수 있는 콘텐츠에 대한 자세한 내용은 [새 홈 시작](/help/quicksilver/workfront-basics/using-home/new-home/get-started-with-new-home.md)을 참조하세요.
...
새 홈을 사용하거나 사용하지 않도록 설정하는 방법에 대한 자세한 내용은 [새 홈 시작](/help/quicksilver/workfront-basics/using-home/new-home/get-started-with-new-home.md)을 참조하세요.
