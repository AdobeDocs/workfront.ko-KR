...
2023년 9월 28일에 이 페이지에 나열된 많은 개선 사항이 빠른 릴리스(월별) 트랙을 위해 프로덕션에 릴리스되었습니다. 빠른 릴리스 프로세스에 대한 자세한 내용은 [빠른 릴리스 프로세스 활성화 또는 비활성화](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-fast-release-process.md).
