...
description: 2025년 1분기 우선 순위 개선
author: Courtney
...
이 페이지에서는 미리보기 환경에 대한 2025년 1분기 릴리스의 모든 우선순위 개선 사항에 대해 설명합니다. 이러한 개선 사항은 언급된 대로 프로덕션 환경에서 사용할 수 있습니다.
...
이 개요에 포함된 기능에 대한 전체 데모는 아래의 [우선 순위 개선 사항 데모 비디오](#priorities-enhancements-demo-video)를 참조하십시오.

## 스마트 필터를 사용하여 우선 순위에서 작업 찾기

>[!NOTE]
>
>미리보기 릴리스: 2025년 1월 9일, 모든 고객을 위한 프로덕션 릴리스: 25.1 릴리스 포함(2025년 1월 16일)

자연어를 사용하여 우선 순위 작업 목록에서 작업을 빠르게 필터링합니다. 다음과 같은 항목을 입력할 수 있습니다.

* 지연된 작업 표시
* 이번 주 기한의 작업 표시
* 상위 우선 순위 표시

IMS 지원 인스턴스에만 사용할 수 있습니다.
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 12월 20일, 모든 고객을 위한 프로덕션 릴리스: 25.1 릴리스 포함(2025년 1월 16일)
>
...
이제 명확하고 시각적인 달력으로 작업을 추적할 수 있습니다. 우선순위 달력을 사용하여 다음을 수행할 수 있습니다.
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 12월 12일, 모든 고객을 위한 프로덕션 릴리스: 25.1 릴리스 포함(2025년 1월 16일)
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 12월 5일, 모든 고객을 위한 프로덕션 릴리스: 25.1 릴리스 포함(2025년 1월 16일)
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 11월 6일, 빠른 릴리스를 위한 프로덕션: 24.11 릴리스(2024년 11월 14일), 분기별 릴리스의 프로덕션: 25.1 릴리스(2025년 1월 16일)

이제 우선 순위의 작업 목록에서 프로젝트 세부 사항과 주석을 볼 수 있습니다.

자세한 내용은 [우선 순위 작업 목록에서 프로젝트 및 작업 세부 정보 보기](/help/quicksilver/workfront-basics/priorities/view-task-project-details.md)를 참조하십시오.

## 우선 순위 개선 데모 비디오

이번 분기에 Priorities에 추가된 새로운 기능에 대한 자세한 데모는 아래 비디오를 보십시오.
