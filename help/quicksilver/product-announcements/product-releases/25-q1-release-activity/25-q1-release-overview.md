...
<tbody>
    ...
    <tr>
        <td>
            ...
            [!BADGE In production &#x200B;]{type=Informative}
            <p>When you add a native field reference to a custom form and it references a typeahead field (such as Portfolio, Company, or Owner), a filter option is now available. 필터를 사용하면 사용자가 필드를 사용할 때 선택할 수 있는 개체를 제한할 수 있습니다. 이 사용자 지정 필터는 사용자 지정 자동 완성 필드의 필터와 동일하게 작동하며 텍스트 모드를 사용하여 필터를 정의합니다.</p>
        </td>
        <td>
            <p><b>다음 날짜에 사용 가능:</b></p>
            <ul>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>미리보기 릴리스: 2024년 12월 19일</li>
                <li>홈의 모든 고객을 위한 프로덕션 릴리스: 발표 예정</li>
                <li>내 업데이트의 모든 고객을 위한 프로덕션 릴리스: 2025년 6월 19일</li>
            </ul>
        </td>
    </tr>
</tbody>
...
<tbody>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">
            이제 AI 어시스턴트에서 프로젝트, 작업, 문제를 처리할 수 있습니다.</a></p>
            [!BADGE In Production &#x200B;]{type=Informative}
