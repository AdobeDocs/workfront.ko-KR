...
애자일 스크럼 팀의 백로그에서 사용할 수 있는 문제에 대한 자세한 내용은 [스크럼 구성](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md)에서 [반복에 작업 항목을 추가할 때 날짜가 적용되는 방법 구성](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md#configur5)을 참조하십시오.
