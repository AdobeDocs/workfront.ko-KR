...
업데이트된 팀 작업 일정 사용에 대한 자세한 내용은 &quot;리소스 예약&quot;을 참조하십시오.

## 리소스 예약 개선 사항

예약 타임라인에는 다음과 같은 개선 사항이 포함됩니다.

* &quot;필터를 사용하여 예약 타임라인에 표시되는 사용자를 제어합니다.&quot;
* &quot;사용자가 작업을 할당받은 후 타임라인에 남음&quot;
...
필터를 사용하여 예약 타임라인에 표시되는 내용을 제어하는 방법에 대한 자세한 내용은 &quot;예약 영역에서 정보 필터링&quot; 및 &quot;예약 영역에서 지정되지 않은 작업 및 문제 수동으로 지정&quot;을 참조하십시오.
