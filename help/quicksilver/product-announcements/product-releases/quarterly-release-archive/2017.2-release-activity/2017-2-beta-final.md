...
자세한 내용은 [Workfront Proof에서 보고서 실행](../../../../workfront-proof/wp-work-proofsfiles/manage-your-work/run-reports.md)에서 [보고서 필터링](../../../../workfront-proof/wp-work-proofsfiles/manage-your-work/run-reports.md#filtering-reports)을 참조하십시오.

## 보고서에 최소값 및 최대값 표시(ProofHQ) {#display-minimum-and-maximum-values-in-reports-proofhq}

이제 보고서를 볼 때 그래프에 최소값과 최대값을 표시할지 여부를 구성할 수 있습니다.

자세한 내용은 [Workfront Proof에서 보고서 실행](../../../../workfront-proof/wp-work-proofsfiles/manage-your-work/run-reports.md)에서 [보고서 보기](../../../../workfront-proof/wp-work-proofsfiles/manage-your-work/run-reports.md#viewing-reports)를 참조하십시오.
...
예정된 모바일 베타 프로그램에 대한 자세한 내용은 [&quot;베타&quot;](https://support.workfront.com/hc/en-us/sections/115000743248) 페이지를 참조하십시오.
