...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-admin-enhancements.md" class="MCXref xref" xrefformat="{para}">새 양식 디자이너 Beta로 사용자 정의 양식 만들기</a>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">오브젝트 세부 정보에서 Workfront 보드 또는 워크스트림에 작업 및 문제 추가</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">목록 및 보고서의 작업 및 문제를 작업 스트림 카드 목록에 추가</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">보드의 카드에 사용자 정의 필드 추가</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">목록 및 보고서의 작업 및 문제를 Workfront 보드에 추가</a></p>
                 ...
                 <tr>
                    ...
                    <td><p><b>다음 날짜에 사용 가능:</b></p>
                        <ul>
                            ...
                            <li>
                                 <p>초기 옵트인을 위한 프로덕션 릴리스: 2023년 3월 2일 <span style="color: #ff0000;"> 이 기능은 Workfront 보드에 대한 초기 기능 옵트인을 통해서만 이 날짜의 프로덕션에서 사용할 수 있습니다.</span></p>
              ...
              <tr>
                    ...
                    <td><p><b>다음 날짜에 사용 가능:</b></p>
                        <ul>
                            ...
                            <li>
                                 <p>조기 옵트인을 위한 프로덕션 릴리스: 2023년 2월 23일 <span style="color: #ff0000;"> 이 기능은 Workfront 보드에 대한 초기 기능 옵트인을 통해서만 이 날짜의 프로덕션에서 사용할 수 있습니다.</span></p>
                                <p>모든 고객을 위한 프로덕션 릴리스: 23.2 릴리스 포함</p>
                            </li>
                        </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td><p><b>다음 날짜에 사용 가능:</b></p>
                        <ul>
                            ...
                            <li>
                                 <p>초기 옵트인을 위한 프로덕션 릴리스: 이 기능은 지연되었으며 2월 9일에 릴리스됩니다. <span style="color: #ff0000;">이 기능은 Workfront 보드에 대한 초기 기능 옵트인을 통해서만 이 날짜의 프로덕션에서 사용할 수 있습니다.</span></p>
                                <p>모든 고객을 위한 프로덕션 릴리스: 23.2 릴리스 포함</p>
                            </li>
                        </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td><p><b>다음 날짜에 사용 가능:</b></p>
                        <ul>
                            ...
                            <li>
                                 <p>조기 옵트인을 위한 프로덕션 릴리스: 2023년 2월 2일 <span style="color: #ff0000;"> 이 기능은 Workfront 보드에 대한 초기 기능 옵트인을 통해서만 이 날짜의 프로덕션에서 사용할 수 있습니다.</span></p>
                                <p>모든 고객을 위한 프로덕션 릴리스: 23.2 릴리스 포함</p>
                            </li>
                        </ul>
                    </td>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-project-enhancements.md" class="MCXref xref" xrefformat="{para}">프로젝트를 일괄적으로 편집할 때의 새로운 경험</a>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-other-enhancements.md" class="MCXref xref" xrefformat="{para}">문제에 대한 새로운 댓글 달기 경험 Beta</a>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-other-enhancements.md" class="MCXref xref" xrefformat="{para}">완전히 새로운 고객은 통합 경험 Adobe에 온보딩됩니다</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-other-enhancements.md" class="MCXref xref" xrefformat="{para}">통합 경험의 사용자를 위해 새 탭에서 증명 뷰어가 열립니다</a></p>
...
Workfront Fusion의 새로운 기능은 23.2 릴리스 일정이 아닌 다른 케이던스로 프로덕션에서 사용할 수 있습니다. 최신 기능에 대한 자세한 내용은 [Adobe Workfront Fusion 릴리스 활동](/help/quicksilver/product-announcements/product-releases/fusion-release-activity/fusion-release-activity.md).
...
23.2 릴리스와 함께 Workfront Goals 릴리스의 새로운 기능. 이제 미리보기에서 사용할 수 있는 이러한 새로운 기능에 대한 자세한 내용은 [23.2 릴리스의 Adobe Workfront 목표](/help/quicksilver/product-announcements/product-releases/goals-release-activity/goals-23-2-release/goals-23-2-release.md).
...
23.2 릴리스 동안 수행된 유지 관리 업데이트에 대한 자세한 내용은 다음을 참조하십시오. [Workfront 유지 보수 업데이트](https://experienceleague.adobe.com/docs/workfront-known-issues/releases/current-updates.html).
