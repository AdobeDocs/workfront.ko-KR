...
## 버전 업그레이드 종단점을 사용하여 새 이벤트 구독 버전으로 업그레이드
...
두 버전의 차이점에 대한 자세한 내용은 문서 [이벤트 구독 버전 관리](/help/quicksilver/wf-api/general/event-subs-versioning.md)를 참조하십시오.

버전 간에 이벤트 구독을 업그레이드하거나 다운그레이드하는 데 사용되는 끝점에 대한 자세한 내용은 이벤트 구독 API 문서의 [이벤트 구독 버전 관리](/help/quicksilver/wf-api/general/event-subs-api.md#event-subscription-versioning) 섹션을 참조하십시오.
