...
Experience Manager Assets as a Cloud Service 통합의 경험에 맞게 Experience Manager Assets Essentials 통합을 업데이트했습니다. 이제 여러 한 줄 텍스트 필드를 Experience Manager Assets의 단일 필드에 매핑할 때 두 서비스 모두 `xcm:keywords` 필드를 사용합니다.
...
Experience Manager Assets Essentials에 메타데이터를 매핑하는 방법에 대한 자세한 내용은 [AEM 키워드](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/setup-asset-essentials.md#aem-keyword)를 참조하십시오.
