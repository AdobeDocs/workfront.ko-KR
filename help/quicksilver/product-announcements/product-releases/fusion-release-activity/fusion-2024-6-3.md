...
새 경험이 기존 경험과 어떻게 다른지에 대한 자세한 내용은 [Workfront Fusion에서 새 경험으로 이동](/help/quicksilver/workfront-fusion/get-started/new-fusion-ui.md)을 참조하십시오.
...
Fusion 개발 도구에 대한 자세한 내용은 [Debug scenarios with the [!DNL Adobe Workfront Fusion] Devtool](/help/quicksilver/workfront-fusion/scenarios/debug-scenarios-with-dev-tool.md)을(를) 참조하십시오.
