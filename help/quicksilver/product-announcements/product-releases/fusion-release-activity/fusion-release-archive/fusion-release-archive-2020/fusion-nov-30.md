...
title: 'Workfront Fusion 릴리스 활동: 2020년 11월 30일의 주'
description: 이 페이지에서는 2020년 11월 30일이 있는 주의 Adobe Workfront Fusion에서 향상된 기능을 모두 설명합니다.
author: Luke
...
# Workfront Fusion 릴리스 활동: 2020년 11월 30일의 주

이 페이지에서는 2020년 11월 30일이 있는 주의 Adobe Workfront Fusion에서 향상된 기능을 모두 설명합니다.
...
## Workfront Fusion 2.0 웹 후크의 비율 제한.

Workfront Fusion 2.0에 새로운 성능 보호 기능이 도입되었습니다. 이제 webhooks는 초당 100개의 요청 전송률 제한을 갖습니다. 이 한도에 도달하면 Workfront Fusion 2.0에서 429(요청이 너무 많음) 상태를 보냅니다.

이전에는 웹 후크 요청이 제한되지 않았습니다.

자세한 내용은 [Adobe Workfront Fusion 성능 보호 기능](../../../../../workfront-fusion/get-started/fusion-performance-guardrails.md).

## Workfront Fusion 2.0에서 Workfront 개체에 사용자 지정 양식 추가

개체에 사용자 지정 양식을 추가할 수 있도록 하기 위해 Workfront Fusion 2.0에서 Workfront > 기타 페이지에 AssignCategories 작업을 추가했습니다. 작업 모듈입니다.

이전에는 Workfront Fusion 2.0 모듈을 사용하여 Workfront의 개체에 사용자 지정 양식을 추가할 수 없었습니다.

Workfront > 기타 항목에 대한 자세한 정보. 작업 모듈입니다. 자세한 내용은 [Adobe Workfront 모듈](../../../../../workfront-fusion/apps-and-their-modules/workfront-modules.md).
