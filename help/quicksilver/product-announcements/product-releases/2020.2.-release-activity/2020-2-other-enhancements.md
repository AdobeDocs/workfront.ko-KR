...
자세한 내용은 [레이아웃 템플릿](../../../administration-and-setup/customize-workfront/use-layout-templates/use-layout-templates-customize-ui.md)을 참조하세요.
...
자세한 내용은 [Adobe Workfront 검색](../../../workfront-basics/navigate-workfront/search/search-workfront.md)을 참조하세요.
...
자세한 내용은 [FAQ - 이벤트 구독](../../../wf-api/general/event-subs-faq.md) 및 [이벤트 구독 모범 사례](../../../wf-api/general/event-sub-best-practice.md)를 참조하세요.
