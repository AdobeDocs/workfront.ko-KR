...
이제 AEM Planning의 레코드 유형 요청 양식에 Workfront Assets가 있는 연결 필드를 추가할 수 있습니다.
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 12월 5일, 모든 고객을 위한 프로덕션 릴리스: 2024년 12월 5일

Workfront Planning에서 필드 유형을 찾을 때 지능형 검색 기능을 추가했습니다. 이제 키워드를 입력할 때 필드 유형을 찾을 수 있습니다. 예를 들어 &quot;가격&quot;을 입력하면 숫자 및 통화 필드 유형을 찾습니다. 이 개선 이전에는 실제 필드 유형 이름만 검색할 수 있었습니다.

자세한 내용은 [필드 만들기](/help/quicksilver/planning/fields/create-fields.md)를 참조하십시오.

## 단일 또는 다중 선택 필드의 색상으로 구분된 옵션에 대한 사용자 정의 색상 피커

>[!NOTE]
>
>미리보기 릴리스: 2024년 12월 5일, 빠른 릴리스를 위한 프로덕션: 24.12 릴리스(2024년 12월 12일), 분기별 릴리스의 프로덕션: 25.1 릴리스(2025년 1월)

이제 단일 또는 다중 선택 필드를 만들거나 편집할 때 사용자 정의 색상을 선택할 수 있습니다. 색상으로 구분된 옵션이 있는 필드를 만들거나 편집할 때 색상 아이콘을 클릭하면 색상 피커 상자가 열립니다. 미리 정의된 색상 중에서 선택하거나 16진수 코드 또는 색상 스펙트럼을 사용하여 사용자 지정 색상을 만들 수 있습니다.
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 11월 27일, 빠른 릴리스를 위한 프로덕션: 24.12 릴리스(2024년 12월 12일), 분기별 릴리스의 프로덕션: 25.1 릴리스(2025년 1월)
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 11월 26일, 빠른 릴리스를 위한 프로덕션: 24.12 릴리스(2024년 12월 12일), 분기별 릴리스의 프로덕션: 25.1 릴리스(2025년 1월)
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 11월 22일, 빠른 릴리스를 위한 프로덕션: 24.12 릴리스(2024년 12월 12일), 분기별 릴리스의 프로덕션: 25.1 릴리스(2025년 1월)
...
작업을 더 쉽게 수행할 수 있도록 레코드의 세부 사항 미리 보기 또는 레코드 페이지에 Adobe AI 도우미를 추가했습니다. 레코드 페이지 내의 AI Assistant를 사용하여 레코드에 대한 정보를 업데이트할 수 있습니다.
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 11월 20일, 빠른 릴리스를 위한 프로덕션: 24.12 릴리스(2024년 12월 12일), 분기별 릴리스의 프로덕션: 25.1 릴리스(2025년 1월)
...
>[!NOTE]
>
>미리보기 릴리스: 2024년 11월 7일, 빠른 릴리스를 위한 프로덕션: 24.12 릴리스(2024년 12월 12일), 분기별 릴리스의 프로덕션: 25.1 릴리스(2025년 1월)
...
모든 객체 유형의 양식에 새 필드를 추가할 수 있습니다. 그러나 Portfolio, 프로그램, 프로젝트, 회사, 그룹 등의 Workfront Planning 레코드 유형에서 연결할 수 있는 Workfront 개체 중 하나에 첨부된 양식에서만 필드의 정보를 편집할 수 있습니다.
...
[이 기능에 대한 비디오 데모 보기](https://video.tv.adobe.com/v/3435633/){target=_blank}
