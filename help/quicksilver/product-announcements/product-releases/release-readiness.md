...
title: ' [!DNL Adobe Workfront] 릴리스 준비'
...
# [!DNL Adobe Workfront] 예약된 릴리스 준비

>[!NOTE]
>
>Workfront은 새로운 기능 및 업데이트를 릴리스하기 위한 두 가지 모델을 제공합니다. 조직은 분기별로 새로운 기능을 받을지 아니면 더 빠른 릴리스 일정으로 받을지 선택할 수 있습니다. 릴리스 준비 프로세스는 조직에서 사용하는 모델에 관계없이 유사합니다.
>
>두 릴리스 모델에 대한 자세한 설명은 [조직의 빠른 릴리스 사용 또는 사용 안 함](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-fast-release-process.md)을 참조하세요.

[!DNL Adobe Workfront]은(는) 프로덕션 환경에 대한 주요 업데이트를 정기적으로 릴리스합니다. [!DNL Workfront] 관리자는 조직에서 [!DNL Workfront] 제품의 각 새 버전으로 원활하게 전환할 수 있도록 할 수 있습니다.
...
[!DNL Adobe Workfront] 릴리스를 준비하는 방법에 대해 알아보려면 아래 비디오를 시청하십시오.

>[!VIDEO](https://video.tv.adobe.com/v/3413544/?quality=12)

## [!DNL Workfront] 릴리스 프로세스 이해

[!DNL Workfront] 릴리스 프로세스에 대한 자세한 설명은 [[!DNL Adobe Workfront] 릴리스 일정 및 프로세스](workfront-release-schedule.md)를 참조하십시오.

## [!DNL Workfront] 릴리스 준비

>[!TIP]
>
>프로젝트 템플릿을 만들어 예약된 [!DNL Workfront] 릴리스와 관련된 작업을 추적할 수 있습니다.
>
>자세한 내용은 이 문서에서 [프로젝트를 사용하여 릴리스 작업을 추적 [!DNL Workfront] 합니다](#use-a-workfront-project-to-track-release-work).
...
해당 기능이 [!UICONTROL 샌드박스 미리 보기] 환경으로 이동하면 해당 기능의 릴리스 정보가 게시됩니다. 이렇게 하면 기능이 프로덕션 환경에 포함되기 전에 해당 기능에 대해 알고 탐색할 수 있습니다.

각 릴리스에는 각 기능에 대한 간략한 설명과 데모 비디오와 추가 정보를 포함하는 보다 심층적인 참고에 대한 링크가 포함된 릴리스 개요 페이지가 있습니다. 이러한 심층적인 참고는 미리보기 릴리스가 발생할 때마다 주별로 구성된 다음 실제 프로덕션 분기별 릴리스 날짜에 더 가까운 영역별로 다시 구성됩니다.

릴리스 정보에서 제공하는 데모 비디오를 시청하는 것이 좋습니다. 이러한 기능은 특히 작동 중인 기능을 확인하거나 시간이 부족한 경우 기능의 컨텍스트를 빠르게 살펴보는 데 유용합니다.

릴리스 개요에 대한 링크는 [제품 릴리스](product-releases.md)를 참조하십시오.

### [!DNL Workfront] 알림 센터 보기

>[!IMPORTANT]
>
>[!DNL Workfront]의 공지 센터 메시지는 [!DNL Workfront] 관리자만 사용할 수 있습니다.

[!DNL Workfront] 관리자는 [!DNL Workfront]에서 릴리스의 다양한 측면에 대한 알림 센터 메시지를 받게 됩니다. 다음 중 하나가 발생하면 공지 센터 메시지가 표시됩니다.
...
>[!TIP]
>
>[!UICONTROL 알림 센터] 설정에서 &quot;[!UICONTROL 새 릴리스]&quot;을(를) 선택 취소하여 새 릴리스에 대한 정보를 받으십시오.
>
>자세한 내용은 [알림 센터 메시지 구독 취소](../announcements/unsubscribe-from-ac-messages.md)를 참조하십시오.
...
기능이 미리보기 샌드박스 환경으로 릴리스되면 [!DNL Workfront] 설명서가 새 기능을 포함하도록 업데이트됩니다. 해당 문서를 검색하거나 릴리스 정보에서 설명서 링크를 따라갈 수 있습니다.

[!UICONTROL 샌드박스 미리 보기] 환경에 대한 자세한 내용은 [샌드박스 미리 보기 [!DNL Adobe Workfront] [!UICONTROL 샌드박스 미리 보기] 환경](../../administration-and-setup/set-up-workfront/workfront-testing-environments/wf-preview-sandbox-environment.md)을 참조하십시오.

### 릴리스 웨비나 참석

[!DNL Workfront]이(가) 일부 릴리스 바로 전에 릴리스 웨비나를 호스팅합니다. [!DNL Workfront] 제품 팀은 새로운 기능을 설명하고 시연하며 참석자의 질문에 답변할 수 있습니다.

릴리스 웨비나는 [!DNL Workfront] 알림 센터를 통해 발표됩니다. 등록 링크는 릴리스 개요 페이지에서 찾을 수 있습니다.
...
또한 버그를 발견하거나 새 기능에 문제가 있는 경우 Workfront 지원 센터에 문의하십시오. 자세한 내용은 [고객 지원 센터에 문의](../../workfront-basics/tips-tricks-and-troubleshooting/contact-customer-support.md)를 참조하세요.
...
## [!DNL Workfront] 프로젝트를 사용하여 릴리스 작업 추적

조직에서 새 릴리스를 준비하도록 하기 위해 고려할 프로젝트를 만드는 것이 좋습니다. 여기서 미리 보기 환경에서 테스트할 각 워크플로 또는 [!DNL Workfront]의 측면에 대한 작업을 만들 수 있습니다. 워크플로우에 집중하면 기존 워크플로우를 변경할 수 있는 새로운 기능을 설명하고 영향을 받지 않는 워크플로우를 파악할 수 있습니다. 다음과 같은 작업이 있을 수 있습니다.

* 프로젝트 만들기 테스트
* 증명 승인 테스트
* [!UICONTROL 작업자] 및 [!UICONTROL 플래너]에 대한 액세스 수준 테스트
* 모바일 앱 테스트
