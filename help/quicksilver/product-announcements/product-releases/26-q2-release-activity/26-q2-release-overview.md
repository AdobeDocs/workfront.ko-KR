...
>| 월별 릴리스 | 분기별 릴리스 |
>|----|----|
>| <ul><li>26.2 (2026년 2월 12일)</li><li>26.3 (2026년 3월 12일)</li><li>26.4 (2026년 4월 15일)</li></ul> | <ul><li>26.1 (2026년 4월 16일)</li></ul> |
>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">기본적으로 사용자 정의 양식 섹션 축소</a><p>기본적으로 사용자 지정 양식의 모든 섹션은 양식 자체가 확장될 때 확장됩니다. 사용자 지정 양식 디자이너의 새 옵션을 사용하면 사용자가 양식을 열 때 기본적으로 축소될 섹션을 표시할 수 있습니다. 이 옵션은 필드가 아닌 섹션 수준에서 적용됩니다.</p>
        </td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">이제 사용자 지정 양식에서 서식 있는 텍스트 필드 유형을 사용할 수 있습니다.</a><p>사용자 정의 양식의 새 <b>서식 있는 텍스트</b> 필드 형식은 굵게, 기울임꼴, 밑줄, 글머리 기호, 번호 매기기, 하이퍼링크 및 블록 인용과 같은 기존 옵션 외에도 위 첨자 및 아래 첨자, 제목 및 표와 같은 서식 지정 옵션이 있는 강력한 텍스트 편집기입니다. 문자 길이는 15,000자로 제한됩니다.</p>
        </td>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">단일 또는 일괄 할당 작업 </a>을(를) 수행할 때 경험이 업데이트됨<p>[!BADGE 해제 일정]{type=Neutral}</p><p> 단일 작업을 편집하거나 대량으로 편집할 때 [작업 편집] 상자의 [할당] 섹션을 업데이트했습니다. </p>
        </td>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md" class="MCXref xref" xrefformat="{para}">이제 더 많은 Workfront 조직에서 통합 환경 Adobe을 사용할 수 있습니다</a><p></p>
            <p>조직이 Adobe 통합 환경의 혜택에 액세스할 수 있도록 기존 Workfront 고객이 사용할 수 있도록 계속 노력하고 있습니다.</p>
        </td>
...
Workfront Planning 무료 체험판에서는 다음과 같은 기능을 제공합니다.

* 선별된 다중 작업 영역 계획 환경
* 시작할 위치를 알려 주는 샘플 데이터
* 제품 내 교육 및 안내
* 설정 과정에서 특정 역할에 맞게 조정된 중요 시점을 명확하게 표시합니다.
* Planning Designer - 원하는 환경을 구축하는 데 도움이 되는 AI 기반 도우미
