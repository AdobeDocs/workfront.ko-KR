...
이제 미리보기 환경에서 사용할 수 있는 새로운 캔버스 대시보드 페이지를 통해 23.2 릴리스부터 점진적으로 이러한 새로운 경험을 제공할 예정입니다. Canvas Dashboards를 사용하면 기존 보고서를 EMC가 구축하고 있는 새로운 보고 기능과 함께 표시할 수 있으며, Reporting Canvas의 새로운 기능을 배포하고 테스트하기 위한 기본 환경으로 사용됩니다. Canvas 대시보드 사용 및 사용에 대한 자세한 내용은 [Canvas 대시보드 개요](/help/quicksilver/reports-and-dashboards/dashboards/creating-and-managing-dashboards/canvas-dashboards-overview.md)를 참조하십시오.

## 베타 참여하기

>[!IMPORTANT]
>
>아래의 베타 정보는 보고 캔버스 베타에 이미 포함되어 있고 더 이상 새 참가자를 수락하지 않는 관리자를 위한 것입니다. Reporting Canvas의 새로운 기능이 추가되었을 때 이를 테스트하려면 위의 **개발 계획**&#x200B;에서 Canvas 대시보드 사용에 대한 정보를 참조하십시오.
...
1. Workfront의 Reporting Canvas에서 **피드백 보내기** 단추를 클릭합니다.
1. 양식을 작성한 다음 **제출**&#x200B;을 클릭합니다.

## 베타 FAQ

+++기존 보고서를 보고 캔버스로 마이그레이션할 수 있습니까?
...
1. 보고 캔버스에서 선택한 모든 보고서 및 대시보드가 마이그레이션되었는지 확인합니다.
+++

+++내가 일반적으로 하는 모든 개체를 볼 수 없는 이유는 무엇입니까?

고객에게 베타를 최대한 빨리 제공하기 위해 현재 Workfront에서 사용 가능한 여러 오브젝트 유형의 하위 세트만 포함된 베타를 출시했습니다. 다음은 현재 베타에서 지원되는 개체 유형입니다.
...
1. 보고 캔버스로 이동합니다.
1. 보고 캔버스 **권한**&#x200B;을 클릭합니다.
1. 옵트아웃한 목록에서 베타를 옵트아웃할 사용자를 제거합니다.
1. **저장**&#x200B;을 클릭합니다.
+++
