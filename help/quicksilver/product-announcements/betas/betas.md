...
* Workfront 콘텐츠 검토자
  ...
  * 이미지 지침은 현재 베타 버전입니다. 콘텐츠 검토자는 Workfront에서 설정한 브랜드 지침을 사용하여 콘텐츠를 검토하고 검토 및 승인 프로세스 동안 콘텐츠 작성자에게 피드백을 제공합니다.
  * 브랜드 음성 지침은 일반 공급 시 사용할 수 있습니다.
...
* Adobe Workfront Planning Designer은 모든 고객이 Beta로 사용할 수 있습니다.
