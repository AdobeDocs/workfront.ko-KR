...
목록에서 엔티티(사용자, 작업 역할, 팀, 그룹, 회사)를 일괄 선택할 때 한 번에 여러 개체에서 제거할 수 있습니다.

>[!NOTE]
>
>개체를 일괄적으로 선택할 때 선택한 모든 개체에 대해 엔티티가 갖는 액세스 내용은 볼 수 없습니다. 권한을 제거하기 전에 선택한 개체의 공유에서 제거할 개체를 알아야 합니다.
