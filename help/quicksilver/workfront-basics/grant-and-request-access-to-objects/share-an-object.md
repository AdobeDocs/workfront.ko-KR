...
1. 다음을 클릭합니다. **공유** 객체 이름 옆에 있는 단추입니다.

   ![](assets/new-share-button.png)

1. 다음에서 **&lt; 객체 이름 > 액세스 권한 부여** 상자에서 객체를 공유할 사용자, 팀, 역할, 그룹 또는 회사의 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.
...
1. (선택 사항) 이 객체를 시스템의 모든 사용자가 사용할 수 있도록 하려면 아래의 드롭다운 메뉴를 누릅니다 **액세스 권한이 있는 사람**&#x200B;을 클릭한 다음 드롭다운 메뉴에서 을(를) 클릭합니다 **시스템의 모든 사용자가 볼 수 있음**.

   ![](assets/new-share-everyone-access.png)

   모든 사용자는 사용자가 설정한 권한에 따라 개체를 볼 수 있습니다.

1. (선택 사항 및 조건부) 프로젝트를 공유할 때 **톱니바퀴** 아이콘 ![](assets/gear-icon-settings.png)을 클릭한 다음 옆에 있는 상자를 선택합니다 **내 프로젝트 액세스 템플릿으로 설정** 사용 권한을 템플릿으로 설정합니다.
...
1. (조건부) 객체를 외부 사용자와 공유하려면 **링크 복사**&#x200B;를 클릭한 다음 링크를 외부 사용자에게 배포합니다.
...
1. 포트폴리오 및 프로그램의 경우:
   ...
   다음을 클릭합니다. **자세히** 아이콘 ![](assets/more-icon.png) 객체 이름 옆에 있는 을(를) 클릭한 다음 을(를) 클릭합니다 **공유**.
...
1. (선택 사항) **고급 설정** 을 클릭하여 개체에 대한 특정 권한을 구성합니다.
...
1. 공유할 개체 옆의 확인란을 클릭한 다음 **공유 아이콘** ![](assets/share-icon.png) 을 클릭합니다.

   ![](assets/list-share-object-select.png) {width=&quot;350&quot; }

1. 다음에서 **&lt; 오브젝트 > 액세스** 창이 나타나면 **편집 &lt; 객체 이름 > 액세스 대상** 객체를 공유하려는 사용자, 팀, 역할, 그룹 또는 회사의 이름을 상자에 넣은 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.
