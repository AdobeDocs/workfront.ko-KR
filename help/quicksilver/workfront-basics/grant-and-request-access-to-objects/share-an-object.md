...
1. **&lt; 개체 이름 > 액세스 권한 부여** 상자에서 개체를 공유할 사용자, 팀, 역할, 그룹 또는 회사의 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.
...
1. 이름 오른쪽에 있는 드롭다운 메뉴를 클릭한 다음 부여할 권한 수준을 선택하여 3단계에서 추가한 각 사용자, 팀, 역할, 그룹 또는 회사에 대한 권한을 지정합니다.
   ...
   * **Contribute**: 사용자는 업데이트, 로그 정보, 약간의 편집, 공유 및 모든 보기 권한을 수행할 수 있습니다.
   * **관리:** 사용자는 액세스 수준에서 부여된 관리 권한 없이 개체에 대한 전체 액세스 권한을 갖습니다. 또한 모든 보기 및 Contribute 권한이 있습니다.
...
1. (조건부) 개체를 외부 사용자와 공유하려면 **링크 복사**&#x200B;를 클릭한 다음 링크를 외부 사용자에게 배포합니다.
