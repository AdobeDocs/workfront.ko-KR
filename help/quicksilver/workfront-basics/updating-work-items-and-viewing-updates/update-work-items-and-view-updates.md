...
description: Adobe Workfront에서 업데이트를 사용하여 작업하는 방법을 배우려면 이 문서를 검토하십시오.
...
* [업데이트 탭 개요](../../workfront-basics/updating-work-items-and-viewing-updates/updates-tab-overview.md)
