...
Adobe Workfront은 모든 DX(디지털 경험) 제품을 Experience Cloud 알림이라는 일관된 단일 알림 시스템에 통합합니다. 2026년 2월 또는 그 즈음부터 기존 Workfront Notification 서비스는 Adobe의 중앙 알림 시스템으로 자동으로 마이그레이션되기 시작합니다.
