...
<table style="table-layout:auto"> 
 ...
 <tbody>
  ...
  <tr data-mc-conditions=""> 
   <td> <p><strong>내 팀에 할당된 작업의 모든 전임 작업이 완료되었습니다</strong> </p> <p>할당된 팀은 작업 중 하나의 전임 작업이 완료된 것으로 표시되면 이메일 알림을 받습니다.</p> <p>외부 라이선스가 있는 사용자는 알림을 받지 않습니다.</p> <p>인스턴트 알림 전자 메일의 제목은 <em>작업 완료: &lt;이름&gt;</em>입니다.</p> <p> 일별 요약 알림의 제목은 <em> 사용자에게 할당된 작업 요약입니다. &lt;일별 요약 날짜&gt; </em></p> </td> 
  ...
  <tr> 
   <td> <p><strong>나에게 할당된 작업의 기한 변경</strong> </p> <p>계획된 완료 일자를 변경한 사용자가 작업 할당자도 아닌 경우 작업 할당자는 작업의 [!UICONTROL 계획된 완료 일자]가 변경될 때 이메일 알림을 받습니다.</p> <p>프로젝트 상태가 [!UICONTROL Planning] 이외의 다른 상태인 경우에만 알림이 전송됩니다.</p> <p>개인 작업과 관련하여 알림이 전송되지 않습니다.</p> <p> 외부 라이선스가 있는 사용자는 알림을 받지 않습니다. </p> <p> 인스턴트 알림 전자 메일의 제목은 다음과 같습니다. <em>[!UICONTROL 기한이 변경되었습니다.]</em></p> <p> 일별 요약 알림의 주제는 <em> [!UICONTROL Digest of Work Assigned or You] &lt;일별 요약 날짜&gt; </em>입니다.</p> </td> 
