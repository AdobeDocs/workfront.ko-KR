...
>* 승인 알림은 기존 문서 승인에만 적용됩니다. 통합 문서 승인에 대한 알림 컨트롤을 현재 사용할 수 없습니다.
...
1. 이름 옆에 있는 **[!UICONTROL 자세히]** 아이콘 ![자세히 아이콘](assets/more-icon.png)을 클릭한 다음 **[!UICONTROL 사용자 편집]**&#x200B;을 클릭합니다.
...
1. 일별 요약으로 보낼 알림을 선택한 경우 **[!UICONTROL 일별 요약 전자 메일 보내기]** 메뉴에서 **[!UICONTROL 알림]** 섹션의 맨 위에서 알림을 받을 시간을 선택하십시오.
