...
>[!IMPORTANT]
>
>현재 AI Assistant는 제한된 수의 Workfront 및 Workfront Planning 고객이 사용할 수 있습니다.
>
>* Workfront: AI Assistant 베타
>* Workfront 계획: 조기 액세스
>
>귀하가 이러한 그룹에 속해 있는 경우 계정 담당자가 귀하에게 알릴 수 있습니다.
...
지정된 액세스 수준에 대해 AI Assistant를 비활성화하려면 다음을 수행합니다.
...
1. 선택 **액세스 수준** 왼쪽 탐색.
1. AI Assistant를 비활성화할 액세스 수준을 선택합니다.
1. 액세스 수준 편집 창에서 창 아래쪽으로 스크롤하여 을 클릭합니다. **추가 제한 설정...**.
1. 추가 제한 설정 영역에서 옵션을 활성화합니다 **Workfront AI Assistant 비활성화**.
1. **저장**&#x200B;을 클릭합니다.
