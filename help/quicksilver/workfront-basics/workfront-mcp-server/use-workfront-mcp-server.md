...
특히 삭제의 경우 작업을 실행하기 전에 확인 메시지를 표시합니다.
요청을 승인하기 전에 플랫폼에서 수행하려고 하는 작업을 읽어 보십시오.
...
Workfront은 프롬프트 또는 AI 에이전트 플랫폼의 응답을 저장하지 않습니다.
AI 아젠틱 플랫폼을 제공하는 사람이 대화 방식을 제어합니다.
