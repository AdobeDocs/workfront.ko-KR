...
| 일괄 승인을 위해 참가자 추가 및 제거 | `approvals_bulk_update_approval_participants`<br>`approvals__submit_bulk_update_approval_participants` | 여러 승인에서 동시에 참여자를 추가하거나 제거합니다. 현재 일괄 업데이트는 단일 프로젝트에 대해서만 적용할 수 있습니다. 조만간 여러 프로젝트에 대한 벌크 업데이트를 사용할 수 있습니다. | 쓰기 |
