...
| <span class="preview">작업에 대한 새 고급 할당</span> | <span class="preview">작업 > 할당 > 고급 </span> |
...
1. 공유 대화 상자에서 보기를 공유할 사용자, 팀, 그룹, 회사 또는 작업 역할의 이름을 입력한 다음 표시될 때 목록에서 선택합니다.
   ...
   * **보기**: 사용자는 목록에 보기를 적용할 수 있지만 공유할 수는 없습니다.
     ...
     <span class="preview">보기 액세스 사용자가 보기를 업데이트하면 변경 내용이 사용자의 개인 환경 설정에 저장됩니다. 사용자의 **공유 보기**&#x200B;에서 보기 이름에 파란색 점이 있으면 개인 업데이트가 보기에 적용되었음을 나타냅니다.</span>

   * **관리**: 사용자는 보기의 이름을 바꾸거나, 공유하거나, 삭제하고, 보기의 요소를 편집할 수 있습니다.

     <span class="preview">액세스 관리 사용자가 보기를 변경할 때 보기를 공유한 모든 사용자는 보기가 목록에 적용되면 해당 업데이트를 보게 됩니다.</span>

1. **저장**&#x200B;을 클릭합니다.

   <span class="preview">사용자와 보기를 공유하고 해당 액세스 권한을 제거하면 사용자의 **공유 보기**&#x200B;에서 보기가 제거됩니다. 액세스 권한이 제거될 때 목록에 공유 보기가 적용된 경우 시스템 기본 보기가 적용됩니다.</span>
...
1. 필드 값 또는 값을 선택합니다. 필터링 기준으로 사용하는 필드 유형에 따라 목록에서 항목을 선택하거나 검색하거나 달력을 사용하여 날짜 범위를 선택하라는 메시지가 표시될 수 있습니다.
   ...
   >[!TIP]
   >
   ><span class="preview">개인화된 필터를 적용하려면 필드 값에 대해 다음 옵션 중 하나를 선택하십시오.</span>
   >
   ><div class="preview">
   >
