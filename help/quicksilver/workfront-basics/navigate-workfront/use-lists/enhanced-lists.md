...
작업 표시줄의 버튼을 클릭하여 목록 항목 보기, 항목 삭제 또는 항목 편집과 같은 작업을 수행합니다.

선택한 항목에 사용할 수 있는 작업이 없으면 작업 표시줄에 &quot;사용할 수 있는 작업이 없습니다.&quot;라고 표시됩니다.

![작업 표시줄 예](assets/glist-action-bar-statuses.png)

**자세히** 메뉴는 목록 항목 위로 마우스를 가져가면 기본 필드 옆에 표시되는 세 점 메뉴입니다. (기본 필드는 테이블에서 가장 왼쪽에 있는 열입니다.)

메뉴를 클릭하여 항목에 대한 추가 작업을 확인합니다. 일부 작업은 해당 목록에만 해당되며 다른 목록에는 나타나지 않을 수 있습니다.
