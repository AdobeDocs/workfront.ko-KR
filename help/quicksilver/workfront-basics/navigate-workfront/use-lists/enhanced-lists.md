...
편집 권한이 없는 보기를 공유하는 경우 보기를 복사하여 새 이름으로 저장할 수 있습니다. 보기를 복사하려면 먼저 보기를 변경해야 합니다.

1. 보기 드롭다운에서 복사할 **공유 보기**&#x200B;의 보기 위로 마우스를 가져간 후 **자세히** 메뉴 ![추가 메뉴](assets/more-icon.png)를 클릭하고 **기본 설정으로 복사**&#x200B;를 클릭합니다.

   새 보기가 자동으로 만들어집니다. 끝에 (복사)가 있는 원래 보기 이름이 사용되며 보기의 **내 보기** 섹션에 표시됩니다.

   이 보기의 소유자이며 이름을 바꾸고, 편집하고, 공유하거나 삭제할 수 있습니다. 원래 보기의 소유자가 해당 보기에 대한 공유 액세스를 제거하면 사용자가 만든 이 보기에 대한 액세스 권한이 계속 유지됩니다.
