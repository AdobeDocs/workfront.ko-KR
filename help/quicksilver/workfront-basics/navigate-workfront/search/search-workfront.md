...
탐색 막대의 ![검색 아이콘](assets/search-unified-shell-2026.png)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>오브젝트/td 유형에 대한 [!UICONTROL 보기] 액세스 
  </tr> 
  <tr> 
   <td role="rowheader">개체 권한</td> 
   <td>검색에서 개체를 찾으려면 먼저 개체를 볼 수 있는 권한이 있어야 합니다.</td> 
  </tr> 
 </tbody> 
</table>
...
1. **검색** 메뉴 아래쪽에서 **[!UICONTROL 고급 검색]**&#x200B;을 클릭합니다. 기본적으로 **고급 검색** 탭이 선택된 상태로 **검색** 페이지가 열립니다.
   ...
   ![고급 검색](assets/advanced-search-2026.png)
