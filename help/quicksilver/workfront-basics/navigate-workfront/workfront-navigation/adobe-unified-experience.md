...
* **라이선스 유형**: 다른 라이선스 유형에 대한 기본 구성을 알아보려면 [Light[!UICONTROL &#x200B; 라이선스 사용자의 탐색 이해] 또는 &#x200B;](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/reviewer-global-navigation-bar.md) [작업[!UICONTROL &#x200B; 라이선스 사용자의 탐색 이해]를 참조하십시오.](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/worker-global-navigation-bar.md)
