...
Adobe 통합 환경의 Workfront에 로그인하는 방법에 대한 자세한 내용은 이 문서의 [Adobe CX Enterprise에 로그인](#log-in-to-adobe-cx-enterprise)을 참조하십시오.
...
## [!DNL Adobe CX Enterprise]에 로그인합니다.
...
[!DNL Adobe CX Enterprise]에 로그인하면 상단 탐색 영역에서 조직 전환기를 클릭하여 액세스할 수 있는 [!DNL Workfront] 조직 및 환경을 모두 볼 수 있습니다. 작업할 [!DNL Workfront] 조직 또는 환경을 선택하십시오. 조직에서 사용하는 환경에는 [!UICONTROL 미리 보기] 및 [!UICONTROL 샌드박스]가 포함될 수 있습니다.

![조직 및 환경 [!DNL Workfront]개 보기](assets/wf-org-instance-switcher-2026.png)

>[!NOTE]
>
>[!DNL Adobe CX Enterprise]에 처음 로그인하면 조직의 기본값이 알파벳 목록의 첫 번째로 설정됩니다. 다음에 로그인할 때 조직은 기본적으로 사용자가 마지막으로 방문한 조직으로 설정됩니다.

액세스 권한이 있는 [!DNL Adobe CX Enterprise] 제품 목록에 [!DNL Workfront]이(가) 나타납니다. [!DNL CX Enterprise] 홈 페이지의 빠른 액세스 메뉴에서 [!DNL Workfront]을(를) 선택하거나 제품 전환기 ![제품 전환기](assets/main-menu-icon.png)를 사용하여 언제든지 응용 프로그램을 변경할 수 있습니다.
...
![프로필 메뉴](assets/unified-shell-profile-menu-2026.png)

이 메뉴를 사용하여 다음을 수행할 수 있습니다.

* [!DNL Adobe CX Enterprise]에 대해 **[!UICONTROL 어두운 테마]** 서식을 선택하세요.
* 기본 및 보조 언어 기본 설정을 포함하여 [!DNL Adobe CX Enterprise]에 대해 **[!UICONTROL 기본 설정]**&#x200B;을 설정합니다.
...
* **[!UICONTROL 로그아웃]**/[!DNL Adobe CX Enterprise].

## 암호 관리

>[!NOTE]
>
>암호를 변경하면 모든 [!DNL Adobe CX Enterprise] 응용 프로그램에 대해 암호가 변경됩니다.
