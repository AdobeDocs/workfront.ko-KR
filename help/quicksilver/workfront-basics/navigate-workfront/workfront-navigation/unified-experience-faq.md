...
### [!DNL Adobe Assets]에 대한 AEM 관리 패널이 이미 있지만 SSO가 [!DNL Workfront?]과(와) 다르게 구성된 고객에게 어떤 영향을 줍니까
...
### [!DNL Experience Cloud](으)로 전역적으로 마이그레이션됩니까? 아니면 특정 사용자를 선택할 수 있습니까? (모든 사용자가 다른 Adobe 제품을 사용하지는 않음)
