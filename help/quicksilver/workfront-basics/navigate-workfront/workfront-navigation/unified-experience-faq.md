...
이 표에서는 두 경험 간에 다른 몇 가지 기능을 설명합니다.

| [!DNL Adobe Unified Experience] | [!DNL Workfront] 전용 경험 |
| ---- | ----|
...
| 모든 [!DNL Adobe Experience Cloud] 응용 프로그램에 단일 로그인 URL을 사용할 수 있습니다. | 사용자 지정 [!DNL Workfront] URL을 사용하여 [!DNL Workfront]에 로그인합니다. |
...
| 도움말은 [!UICONTROL 주 메뉴] 및 위쪽 탐색 영역을 통해 액세스할 수 있습니다. | [!UICONTROL 기본 메뉴] 및 [!DNL Workfront] 탐색 모음을 통해 도움말에 액세스할 수 있습니다. |
...
예, 모든 사용자가 [!DNL Experience Cloud]을(를) 통해 로그인합니다. Adobe IMS(Identity Management System) 로그인이 SSO를 대체합니다. 매우 유사한 경험이며 다른 로그인 화면입니다.

### 이미 둘 다 있는 경우 사용자가 [!DNL Adobe] 계정을 [!DNL Workfront] 계정에 연결해야 합니까?

예, 이에 대한 프로세스가 있으며, 조직이 IMS로 이동할 때가 되면 자세한 정보가 제공됩니다.

### [!DNL Workfront] 계정이 없는 [!DNL Adobe] 사용자는 어떻게 됩니까?

[!DNL Adobe Admin Console]에 액세스하기 위해 [!DNL Workfront]에서 액세스 권한이 부여되지 않은 사용자는 로그인할 수 있도록 &quot;[!UICONTROL 개인 계정]&quot; 또는 [!DNL Adobe] ID 계정을 만들어야 합니다. 이렇게 하면 관리자에게 이메일을 보내 요청을 승인하거나 거부하며, 관리자가 사용자가 보유한 액세스 유형을 구성할 수 있습니다. 로그인하면 experience.adobe.com으로 이동하여 이메일 주소를 입력하고 [!UICONTROL 개인 계정]을 선택합니다. 여기에서 [!DNL Workfront]에 액세스할 수 있습니다.
...
### [!DNL Workfront] 인스턴스에 외부 사용자가 포함되어 있습니다. [!DNL Adobe]에 포함된 다른 제품에 액세스하지 못하도록 할 수 있습니다. 콘솔 내에서는 액세스를 어떻게 제한합니까?
