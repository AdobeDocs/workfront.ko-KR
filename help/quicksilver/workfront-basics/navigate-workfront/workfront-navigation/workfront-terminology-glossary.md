...
<tr> 
   ...
   <td> <p>[!UICONTROL 원가 성과 지수(CPI)]는 계획된 원가와 실제 원가 간의 프로젝트 또는 태스크 레벨에서의 관계를 설명합니다. 프로젝트 관리자는 이 지표를 검토하여 특정 시점에 비용 이하로 또는 비용 이상으로 현재 추적 중인 작업 또는 프로젝트를 식별합니다. 비용은 [!UICONTROL Performance Index Method(PIM)]에 따라 시간 또는 달러로 측정할 수 있습니다.</p> 
