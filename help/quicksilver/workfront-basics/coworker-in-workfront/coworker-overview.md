...
동료는 조직의 기존 제품 수준 액세스 제어를 따릅니다. 사용자는 Workfront에서 이미 허가된 작업만 수행할 수 있습니다. 동료는 기본적으로 읽기 전용 액세스 권한을 가지며 시스템 관리자는 사용자가 쓰기 액세스 권한을 가질 때 제어합니다.
