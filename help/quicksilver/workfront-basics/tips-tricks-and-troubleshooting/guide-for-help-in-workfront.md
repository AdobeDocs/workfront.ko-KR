...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><a href="https://experienceleague.adobe.com/ko">Experience League</a>은(는) 플래너, 작업자, 공동 작업자 및 시스템 관리자가 [!DNL Workfront]의 주요 기능을 사용하도록 역할 기반 학습 경로를 제공합니다.<br>관심 항목에 대한 학습 경로, 비디오 튜토리얼 및 다운로드 가능한 안내서를 탐색하여 [!DNL Workfront] 지식을 확장</a>하십시오.<br></td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p>[!DNL Workfront] 미리 보기 샌드박스 환경에서 최신 업데이트를 테스트합니다. 미리 보기 샌드박스 환경에 대한 자세한 내용은 <a href="https://experience.workfront.com/s/article/The-Workfront-Preview-Sandbox-Environment-519456234">미리 보기 샌드박스 환경</a>을 참조하십시오.[!DNL Adobe Workfront]</p> </li> 
