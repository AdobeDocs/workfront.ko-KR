...
* <span class="preview">**승인 보류 중**</span>\
    <span class="preview">자신이 소유한 프로젝트의 문서에 할당된 승인을 표시합니다. 여기에서 승인 상태를 보고 사용자에게 미완료 검토 및 승인을 알릴 수 있습니다. <span style="color: #ff0000;">이 기능은 단계별 릴리스의 일부이며 현재 특정 고객에게만 제공됩니다.</span></span>
