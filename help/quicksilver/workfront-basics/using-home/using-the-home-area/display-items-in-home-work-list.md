     ...
     <tr> 
      ...
      <td> 
       <div> 
        ...
        <p>작업 위임에 대한 자세한 내용은 <a href="/help/quicksilver/manage-work/delegate-work/how-to-delegate-work.md#delegate-tasks-and-issues-to-another-user" class="MCXref xref">작업 및 문제 위임</a>을 참조하세요.
       </div> </td> 
     </tr> 
     <tr> 
