...
title: 간판 보드의 스토리에 사용자 지정
description: 간판 보드의 스토리에 사용자를 지정하는 방법을 알아보려면 이 문서를 검토하십시오.
author: Lisa
feature: Agile
...
1. 민첩하게 이동 [!UICONTROL 간판] 사용자를 할당할 보드.
1. 의 스토리 타일로 이동합니다. [!UICONTROL 간판] 사용자를 추가할 보드입니다.
1. 스토리 타일에서 팀 아바타를 클릭하고(또는 이미 할당된 사용자 아바타가 있는 경우 사용자 아바타를 클릭한 다음 스토리에 할당할 사용자의 이름을 입력하고 나타나면 이름을 클릭합니다. 추천 사용자를 선택할 수도 있습니다.

   >[!TIP]
   >
   >스토리에 작업 역할을 할당할 수도 있습니다. 활성 사용자 및 활성 역할만 할당할 수 있습니다.
