...
>[!NOTE]
>
>동적 보드에서 연결된 카드의 연결을 끊으면 보드를 새로 고칠 때 다시 나타납니다. 이 보드 유형은 특정 프로젝트에서 모든 작업 및 문제를 가져오기 때문입니다.
>
>접수 열이 있는 다른 보드 유형에서 연결된 카드의 연결을 끊으면 연결된 작업 또는 문제가 아직 완료로 표시되지 않은 경우 보드를 새로 고칠 때 카드가 접수 열에 다시 나타납니다.
>
