...
title: 게시판 삭제 또는 보관
description: Workfront에서 게시판을 삭제하거나 보관할 수 있습니다. 보드를 삭제하면 Workfront에서 영구적으로 제거되고 보드를 보관하면 모든 카드가 보존되며 나중에 복원할 수 있습니다.
author: Courtney
feature: Agile
...
1. 게시판 이름 옆의 **[!UICONTROL 기타]** 메뉴 ![[!UICONTROL 기타 메뉴]](assets/more-icon-spectrum.png)를 클릭하고 **[!UICONTROL 삭제]**&#x200B;를 선택합니다. 그런 다음 확인 메시지에서 **[!UICONTROL 게시판 삭제]**&#x200B;를 클릭합니다.

   >[!NOTE]
   >
   >자신이 만들었거나 소유자로 이름이 지정된 게시판만 삭제할 수 있으며 구성원으로 추가된 게시판은 삭제할 수 없습니다.

   ![게시판 추가 메뉴](assets/boards-board-more-menu.png)

## 보드 보관

보관된 보드는 모든 카드 및 지정을 유지합니다. 모든 사용자는 언제든지 보드를 보관하거나 복원할 수 있습니다.
...
1. 복원하려는 보드를 찾은 다음 보드 이름 옆의 **[!UICONTROL 기타]** 메뉴 ![기타 메뉴](assets/more-icon-spectrum.png)를 클릭하고 **[!UICONTROL 복원]**&#x200B;을 선택합니다.
