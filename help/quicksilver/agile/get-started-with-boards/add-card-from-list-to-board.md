...
description: 목록 또는 보고서 보기에서 Adobe Workfront의 게시판에 작업이나 문제를 추가할 수 있습니다.
author: Courtney
feature: Agile
...
1. 보드나 워크스트림에 추가할 작업이나 문제가 포함된 프로젝트, 보고서 또는 대시보드로 이동합니다.
1. 하나 이상의 작업이나 문제를 선택하십시오.

   하위 작업을 선택하면 게시판에 카드로도 추가됩니다.

1. [!UICONTROL **추가**] > [!UICONTROL **보드에 추가**] 또는 [!UICONTROL **워크스트림에 추가**]&#x200B;를 클릭합니다.
1. [!UICONTROL 다음에 추가] 대화 상자에서 항목을 추가할 보드 또는 워크스트림을 선택합니다.

   보드의 경우 워크스트림의 일부인 보드가 아닌 독립형 보드만 사용할 수 있습니다.
...
## 개체 세부 정보에서 기존 작업 또는 문제를 보드 또는 워크스트림에 추가

{{step1-click-main-menu}}

1. [!UICONTROL **프로젝트**]&#x200B;를 클릭한 다음 프로젝트 이름을 클릭하여 엽니다.
1. 왼쪽 패널에서 [!UICONTROL **작업**] 또는 [!UICONTROL **문제**]&#x200B;를 클릭합니다.
1. 보드나 워크스트림에 추가할 작업, 하위 작업 또는 문제를 클릭합니다.
1. 개체 이름 옆의 **[!UICONTROL 자세히]** 메뉴를 클릭하고 [!UICONTROL **보드에 추가**] 또는 [!UICONTROL **워크스트림에 추가**]&#x200B;를 선택합니다.
1. [!UICONTROL 다음에 추가] 대화 상자에서 항목을 추가할 보드 또는 워크스트림을 선택합니다.
...
1. [!UICONTROL **추가를 클릭합니다**].
   ...
   열 정책에 대한 자세한 내용은 [보드 열 관리](/help/quicksilver/agile/get-started-with-boards/manage-board-columns.md)를 참조하세요.

   워크스트림의 경우: 작업 또는 문제가 워크스트림의 카드 목록에 계획되지 않은 카드로 추가됩니다.

## 목록에서 작업 또는 문제와 관련된 게시판 표시

1. 게시판 정보를 보려는 작업이나 문제가 포함된 프로젝트, 보고서 또는 대시보드로 이동합니다.
1. 보드 열이 포함된 뷰를 선택하거나 보드 열로 새 뷰를 만듭니다.
...
1. 열에서 [!UICONTROL **표시**]&#x200B;를 클릭하여 작업 또는 문제가 있는 게시판 목록을 표시합니다.
