   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>스토리의 예상 가격을 지정합니다. Agile 팀이 스토리를 포인트 단위로 추정하도록 구성된 경우 기본적으로 1포인트는 8시간에 해당합니다. 견적이 스토리에 [!UICONTROL 계획 시간]으로 추가됩니다.<br>예를 들어 스토리를 3포인트로 추정하는 경우 기본 동작은 스토리에 24 [!UICONTROL 계획 시간]을 추가하는 것입니다.<br>스토리에 하위 작업이 포함된 경우 모든 하위 작업에 대한 예상 값을 조합하면 상위 스토리의 예상 값이 결정됩니다. 자세한 내용은 <a href="../../agile/use-scrum-in-an-agile-team/iterations/add-stories-to-existing-iteration.md" class="MCXref xref">기존 반복에 스토리 추가</a>를 참조하세요.</td>
     </tr>
     <tr>
