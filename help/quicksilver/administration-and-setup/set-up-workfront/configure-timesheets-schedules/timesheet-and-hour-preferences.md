...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>다음이어야 합니다: [!DNL Workfront] 관리자.</p> <p><b>메모</b>
...
1. 을 표시하는 페이지에서 **[!UICONTROL 일반 환경 설정]** 섹션에서 다음 옵션 중 하나를 구성합니다.
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>사용자가 시스템 전체에서 미래 날짜에 대한 시간을 기록할 수 있도록 해줍니다.</p> 
       ...
       </ul> <p>이 기능은 사용자가 사무실을 비울 예정이고 해당 시간을 미리 기록하려는 경우 유용합니다.</p> <p><b>메모</b>:</p> 
...
1. 다음에서 **[!UICONTROL 사용자가 시간을 기록할 수 있는 위치]** 섹션에서 다음 옵션 중 하나를 구성합니다.
   ...
   <table style="table-layout:auto">
    <tr>
        <td>[!UICONTROL 프로젝트에서 직접 로그 시간]</td>
...
1. 다음에서 **[!UICONTROL 프로젝트, 작업 및 문제 삭제됨]** 섹션에서 다음을 지정합니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      <td role="rowheader">프로젝트를 삭제할 때 [!UICONTROL]</td> 
      <td> 
       <ul> 
     ...
     <tr> 
      <td role="rowheader">작업 또는 문제를 삭제할 때 [!UICONTROL]</td> 
      <td> 
       <ul> 
        <li><strong>[!UICONTROL 작업 또는 문제가 있는 프로젝트로 기록된 시간을 이동합니다.]</strong>: 이 작업 또는 문제가 나중에 복원되면 프로젝트에 시간이 유지됩니다.<br></li> 
...
조직의 그룹은 고유한 워크플로우에 대해 다르게 구성된 타임시트 또는 시간 환경 설정이 필요할 수 있습니다. 조직 전체에서 모든 그룹에 대한 환경 설정을 잠금 해제하여 그룹 스스로 구성할 수 있습니다.
