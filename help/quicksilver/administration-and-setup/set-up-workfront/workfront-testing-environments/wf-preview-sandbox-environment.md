...
* 미리보기 환경에서는 Frame.io 뷰어를 사용할 수 없습니다. Adobe 클라우드 스토리지는 사용할 수 있으므로 샌드박스에서 테스트할 수 있지만, 전체 통합 검토 및 승인 경험은 프로덕션에서 검증해야 합니다. 자세한 내용은 [Adobe 클라우드 저장소 개요](/help/quicksilver/review-and-approve-work/esm-overview.md)를 참조하십시오.
