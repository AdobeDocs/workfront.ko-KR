...
사용자 정의 현지화를 사용하면 다른 언어로 사용자 정의 용어 및 구를 정의할 수 있습니다. 그런 다음 Workfront에서는 이러한 용어를 사용자의 Adobe IMS(Identity Management) 설정에 있는 언어 세트로 표시합니다. 사용자가 Adobe IMS를 사용하고 있지 않으면 용어가 사용자의 브라우저 설정에 설정된 언어로 표시됩니다.
