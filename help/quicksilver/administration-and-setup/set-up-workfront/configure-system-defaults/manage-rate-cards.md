...
1. 클릭 [!UICONTROL **새 요금 카드**]&#x200B;를 클릭한 다음 목록에 비율 카드 이름과 설명을 입력합니다.
1. 청구 요금을 추가하려면 목록에서 요금 카드 이름을 클릭합니다.
1. 카드 화면에서 다음을 클릭합니다. [!UICONTROL **새 청구 요금**].
1. 새 청구 요금 대화 상자에서 [!UICONTROL **작업 역할**] 에 대한 청구 요율을 정의합니다.

   기본 청구 요금 은 이 작업 역할에 대한 시스템 수준 요금을 표시합니다.
...
1. (선택 사항) 다른 위치의 동일한 작업 역할이나 별도의 작업 역할에 대해 다른 청구 요금을 추가하려면 [!UICONTROL **새 청구 요금**].
...
1. 왼쪽 패널에서 [!UICONTROL **카드 평가**].
1. 목록에서 등급 카드 옆에 있는 확인란을 선택하고 **복사** 아이콘 ![복사 아이콘](assets/copy-icon.png).
...
1. 왼쪽 패널에서 [!UICONTROL **카드 평가**].
1. 목록에서 등급 카드 옆에 있는 확인란을 선택하고 **삭제** 아이콘 ![삭제 아이콘](assets/delete.png).
