...
* 검토자: 브랜드 또는 브랜드 두뇌를 사용하여 공동 작업자를 만든 다음, 공동 작업자를 에셋에 대한 검토자로 할당합니다.
...
1. 공동 작업자가 평가에 브랜드를 사용할지 또는 브랜드 뇌를 사용할지 선택합니다.
1. (조건부) AI 공동 작업자가 Brand Brain을 사용하는 경우 사용할 테넌트를 선택합니다.
