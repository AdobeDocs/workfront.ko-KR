...
1. 다음을 구성합니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr data-mc-conditions=""> 
      <td role="rowheader"><span>[!UICONTROL 통화 비용 대체 비율]</span> </td> 
      <td>
       ...
       <p>팁: 비용 비율이 이미 연결되어 있는 기존 작업 역할을 업데이트할 때에는 [!DNL Workfront] 시스템의 전환율을 기준으로 [!UICONTROL 통화 재정의] 환율을 계산합니다. [!UICONTROL 통화 대체 비용 비율]을 업데이트하면 작업 역할의 비용 비율도 자동으로 업데이트됩니다.</p> </td> 
     </tr> 
     <tr data-mc-conditions=""> 
      <td role="rowheader"><span>[!UICONTROL 통화 대체 청구 요금]</span> </td> 
      <td>
        ...
        <p>팁: 청구 요금이 이미 연결되어 있는 기존 작업 역할을 업데이트할 때 [!DNL Workfront] 는 시스템의 전환율을 기반으로 통화 대체 환율을 계산합니다. 통화 대체 청구 단가를 갱신하면 작업 역할의 청구 단가도 자동으로 갱신됩니다. </p>
       </td>
     </tr> 
    </tbody> 
   </table>
