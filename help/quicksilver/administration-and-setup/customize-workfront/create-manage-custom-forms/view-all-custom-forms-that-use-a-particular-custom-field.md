...
모든 사용자 정의 필드 목록에서 필드 사용을 보려면 다음을 수행하십시오.
...
사용자 정의 양식 내에서 필드 사용을 보려면 다음을 수행하십시오.

{{step-1-to-setup}}

1. 왼쪽 패널에서 **사용자 지정 Forms**&#x200B;을 클릭합니다.
1. 사용자 정의 양식을 열고 라이브러리에서 필드를 추가하거나 양식에서 기존 필드를 선택합니다.

   양식 디자이너 오른쪽의 사용 표시기는 이 필드를 사용하는 다른 사용자 정의 양식의 수를 보여 줍니다.

1. **관련 Forms 보기**&#x200B;를 클릭합니다.

   양식 목록에서 양식 이름을 클릭하여 양식을 열고 필드가 사용되는 방법을 확인할 수 있습니다. 각 양식의 활성 또는 비활성 여부를 보여 주는 표시기입니다.
