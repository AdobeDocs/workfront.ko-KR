...
![개체 유형 선택](assets/new-custom-form-select-objects.png)
...
1. <span class="preview">(선택 사항) 더 많은 개체에 연결할 수 있도록 양식에 더 많은 개체 형식을 추가하려면 양식 디자이너 헤더에서 **개체 형식**&#x200B;을 클릭합니다. 추가할 개체 형식을 선택하고 폼에서 삭제할 개체 형식을 선택 취소하십시오.</span>
...
1. 화면 오른쪽에서 추가하려는 사용자 정의 필드 유형에 사용할 수 있는 옵션을 구성합니다.
   ...
   <table>
    ...
    <tr>
      ...
      <td><p><span class="preview">이 사용자 정의 필드를 보거나 편집하려면 먼저 사용자가 보유해야 하는 재무 권한 유형을 선택하십시오. 계산된 필드에는 모든 형식이 허용됩니다.</span></p>
