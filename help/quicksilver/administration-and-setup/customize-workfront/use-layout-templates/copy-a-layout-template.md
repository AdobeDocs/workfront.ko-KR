...
1. 표시되는 화면에서 새 **레이아웃 템플릿 이름**&#x200B;을(를) 입력하고 **설명**&#x200B;을(를) 입력하십시오.

1. [레이아웃 템플릿에 사용자 할당](../../../administration-and-setup/customize-workfront/use-layout-templates/assign-users-to-layout-template.md)에 설명된 대로 템플릿을 필요한 사용자에게 할당합니다.
