...
>레이아웃 템플릿에서 이동 또는 크기 조정 위젯만 사용자의 새 홈 페이지가 레이아웃을 업데이트하도록 트리거하지 않습니다. 하지만 위젯을 추가하거나 제거하면 사용자의 페이지에 대한 업데이트가 트리거됩니다.
     ...
     <tr> 
      ...
      <ul>
      <li><p><b>사용자가 사용할 수 있는 필터, 열 또는 그룹 선택:</b></p>
      <p>목록에서 사용자가 사용할 수 있게 하려는 모든 옵션 옆에 있는 상자를 선택합니다. 선택하지 않은 옵션은 사용자에게 표시되지 않습니다.</li></p>     
    <p>

>[!IMPORTANT]
>
>열 구성을 위젯에 제대로 적용하려면 사용자에게 보기에 대한 만들기 액세스 권한이 있어야 합니다.
