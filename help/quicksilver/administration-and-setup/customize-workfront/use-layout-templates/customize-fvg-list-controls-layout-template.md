...
>[!NOTE]
>
>레이아웃 템플릿에 보기, 필터 또는 그룹화를 추가하면 레이아웃만 제어되며 액세스 권한은 부여되지 않습니다. 각 항목에 대한 보기 액세스 권한이 계속 필요합니다.
>
>기여자, 요청자 및 외부 라이선스 사용자는 시스템 전체에서 공유한 항목을 볼 수 없으므로 해당 항목을 위한 보기를 명시적으로 공유해야 합니다. 자세한 내용은 [필터, 보기 또는 그룹화 공유](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/share-filter-view-grouping.md)를 참조하세요.
