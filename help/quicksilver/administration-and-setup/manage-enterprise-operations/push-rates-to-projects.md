...
1. [!UICONTROL **모든 프로젝트에 적용**] 대화 상자에서 이 요금 카드를 사용하는 모든 프로젝트가 기본적으로 선택됩니다. 프로젝트에서 비율 변경 사항을 적용하지 않으려면 선택을 취소해야 합니다.
   ...
   >[!NOTE]
   >
   >오래된 요금 카드 비율이 있는 프로젝트만 대화 상자에 표시됩니다. 프로젝트에서 이 비율 카드를 사용하고 비율이 프로젝트의 현재 속도인 경우 표시되지 않습니다.
