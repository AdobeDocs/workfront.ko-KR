   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <tr> 
      <td role="rowheader">Adobe 엔터프라이즈 스토리지 사용 </td> 
      <td>전체 조직 또는 특정 그룹에 대해 Adobe Enterprise Storage를 활성화 또는 비활성화하도록 선택할 수 있습니다. Adobe 엔터프라이즈 스토리지에 대한 자세한 내용은 <a href="/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md">조직에 Adobe 엔터프라이즈 스토리지 사용</a>을 참조하십시오.</td> 
     </tr>
     <tr> 
      <td role="rowheader">AI 활성화 </td> 
      <td>AI Assistant를 포함하여 AI를 활성화하도록 선택할 수 있습니다. <p><b>참고</b>: 조직에서 AI를 사용하려면 특정 요구 사항을 충족해야 합니다. For more information about AI, including the requirements, see <a href="/help/quicksilver/workfront-basics/ai-assistant/ai-assistant-overview.md">AI Assistant overview</a>.</p></td> 
     </tr>
     <tr> 
     ...
     <tr> 
      ...
      <td>Lets you access your Workfront test environments. 자세한 내용은 <a href="/help/quicksilver/workfront-basics/priorities/get-started-with-priorities.md">Adobe Workfront 미리 보기 샌드박스 환경</a>을 참조하십시오.</p></td> 
    </tbody> 
   </table>
