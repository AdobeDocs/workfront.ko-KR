...
1. 다음 필드 중 하나를 선택하여 조직에 대한 설정을 설정합니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader">사람들이 Workfront의 모바일 애플리케이션을 사용할 수 있도록 허용</td> 
      <td> <p>사용자가 모바일 앱(iPad 및 휴대폰 앱용 Workfront 보기)에 액세스할 수 있도록 허용합니다.</p> <p>이 옵션은 기본적으로 활성화되어 있습니다. </p> <p>Workfront 보기에 대한 자세한 내용은 <a href="../../../workfront-basics/mobile-apps/using-workfront-view/use-workfront-view.md" class="MCXref xref">Adobe Workfront 보기 사용</a>을 참조하세요. 모바일 앱에 대한 자세한 내용은 <a href="../../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/use-the-mobile-app.md" class="MCXref xref">Adobe Workfront 모바일 앱 사용: 문서 색인</a>을 참조하십시오.</p> </td> 
     </tr> 
     <tr> 
    ...
    <tr> 
      <td role="rowheader">액세스 수준 내 자동 업그레이드 비활성화</td> 
      <td>기여자 액세스 수준에 대한 자동 업그레이드 프로세스를 비활성화할 수 있습니다. 이 설정을 선택하면 승인 결정 한도를 초과한 기여자 라이선스 사용자는 관리자가 수동으로 새 라이선스로 업그레이드해야 합니다.</p></td> 
     </tr>
     <tr> 
     ...
     <tr>
      <td><span class="preview">벌크 편집에서 항상 필수 필드 적용</span></td>
      <td><span class="preview"><p>오브젝트를 벌크 편집할 때 사용자가 필수 필드에 정보를 입력하도록 할지 여부를 선택할 수 있습니다.</p> <p>이 옵션을 선택한 경우 벌크 편집 모드로 저장하기 전에 필수 필드에 값이 있어야 합니다. 필수 필드에 벌크로 선택된 하나 이상의 객체에 대한 값이 없으면 저장할 수 없습니다.</p> <p>이 옵션을 선택하지 않으면 사용자가 필드를 수정할 때만 필수 필드가 적용됩니다. 필드가 수정되지 않으면 선택 사항으로 처리되고 확인되지 않습니다.</p></span></td>
     </tr>
     <tr> 
      <td role="rowheader">스토리지 환경 설정 </td> 
      <td>이 섹션에서는 Adobe 클라우드 환경 설정을 활성화할 수 있습니다. 전체 조직 또는 특정 그룹에 대해 Adobe 클라우드 스토리지를 활성화 또는 비활성화하도록 선택할 수 있습니다. 
      <p>다음 정보를 업데이트합니다.</p>
      <ul><li><b>기본값</b>: 기존 Workfront 저장소 또는 Adobe 클라우드 저장소 선택</li>
      <li><b>사용자가 저장소 공급자를 선택할 수 있도록 허용</b>: 사용자가 Workfront 개체를 만들 때 두 저장소 형식 중에서 선택할 수 있도록 허용합니다.</li>
      <li><b>적용 대상</b>: 기본 설정이 전체 조직에 적용되는지 또는 특정 그룹에 적용되는지 여부를 선택합니다.</li>
      <li><b>Adobe 클라우드 스토리지로 변환할 포트폴리오를 선택하십시오</b>: Workfront 레거시 스토리지에서 Adobe 클라우드 스토리지로 자동으로 변환할 포트폴리오를 선택하십시오. 포트폴리오는 시스템 기본 설정을 저장할 때 변환됩니다.</li></ul>     
    Adobe 클라우드 저장소에 대한 자세한 내용은 <a href="/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md">조직에 Adobe 클라우드 저장소 사용</a>을 참조하세요.</td></tr>
    <tr> 
      <td role="rowheader">Adobe 클라우드 스토리지로 변환할 포트폴리오 선택 </td> 
      <td>기존 Workfront 스토리지 포트폴리오를 Adobe 클라우드 스토리지로 변환할 수 있습니다. 자세한 내용은 <a href="/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/convert-portfolios-to-acs.md">레거시 포트폴리오를 Adobe 클라우드 스토리지로 변환</a>을 참조하십시오.</td> 
     </tr>
     <tr> 
      <td role="rowheader">AI 활성화 </td> 
      <td>AI 환경 설정 영역에서 설정을 켜면 AI Assistant를 비롯한 AI를 활성화할 수 있습니다. <p><b>참고</b>: 조직에서 AI를 사용하려면 특정 요구 사항을 충족해야 합니다. 요구 사항을 포함하여 AI에 대한 자세한 내용은 <a href="/help/quicksilver/workfront-basics/ai-assistant/ai-assistant-overview.md">AI Assistant 개요</a>를 참조하십시오.</p></td> 
     </tr>
    <tr> 
      <td role="rowheader">AI 양식 채우기 </td> 
      <td>사람들이 AI로 양식 채우기를 사용하여 요청 양식을 자동으로 채울 수 있도록 허용합니다. 자세한 내용은 <a href="/help/quicksilver/manage-work/requests/create-requests/autofill-from-prompt-document.md">AI에서 제공하는 양식 채우기를 사용하여 프롬프트 또는 문서를 사용하여 요청을 채우는 방법</a>을 참조하십시오.</p></td> 
     </tr>
     <tr> 
