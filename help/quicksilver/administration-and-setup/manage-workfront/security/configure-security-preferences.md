...
1. 다음 필드 중 하나를 선택하여 조직에 대한 설정을 설정합니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader">Adobe 클라우드 스토리지 활성화 </td> 
      <td>전체 조직 또는 특정 그룹에 대해 Adobe 클라우드 스토리지를 활성화 또는 비활성화하도록 선택할 수 있습니다. Adobe 클라우드 저장소에 대한 자세한 내용은 <a href="/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md">조직에 Adobe 클라우드 저장소 사용</a>을 참조하세요.</td> 
     </tr>
     <tr> 
