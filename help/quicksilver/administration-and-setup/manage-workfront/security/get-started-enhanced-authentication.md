...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>✓ 덧신</p> <p>2019.3 릴리스에서 사용 가능</p> </td> 
   <td> <p>✓ 덧신</p> <p>2019.3 릴리스에서 사용 가능</p> </td> 
   <td> <p>✓ 덧신</p> <p>2019.3 릴리스에서 사용 가능</p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>✓ 덧신</p> <p>2019.3 릴리스에서 사용 가능</p> </td> 
   <td> <p>✓ 덧신</p> <p>주소가 대/소문자만 다른 경우 여러 사용자가 동일한 이메일 주소를 가질 수 없습니다. </p> </td> 
   <td> <p>✓ 덧신</p> <p>주소가 대/소문자만 다른 경우 여러 사용자가 동일한 이메일 주소를 가질 수 없습니다. </p> <p>Workfront 관리자는 2019년 말에 중복 이메일 주소 수정을 시작하라는 알림을 받게 됩니다.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>✓ 덧신 </p> <p>잘못된 암호 입력을 5회 시도하면 계정을 잠급니다. Workfront 관리자가 잠금 구성 후 필요한 대기 시간</p> </td> 
   <td> <p>✓ 덧신</p> <p>업계 모범 사례를 기반으로 하는 각각의 연속적인 잘못된 암호 후에는 대기 시간이 기하급수적으로 증가합니다. 필요한 시간은 Workfront 관리자가 구성할 수 없습니다</p> </td> 
   <td> <p>✓ 덧신</p> <p>다양한 의심스러운 행동을 사전에 차단하는 잠금 알고리즘을 사용합니다.</p> </td> 
  </tr> 
  <tr> 
   <td> <p>소문자, 대문자, 숫자 및 특수 문자를 혼용해야 합니다.</p> </td> 
   <td>✓ 덧신</td> 
   <td> <p>✓ 덧신 </p> <p>특정 요구 사항 선택의 유연성 향상</p> </td> 
   <td> <p>✓ 덧신</p> <p> 
     </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>✓ 덧신</p> <p>Workfront 관리자는 id 공급자 로그인 페이지로 리디렉션하도록 로그인 페이지를 구성하거나 로그인 단추 또는 단추를 구성할 수 있습니다.</p> </td> 
   <td> <p>✓ 덧신</p> <p> Workfront 관리자는 id 공급자 로그인 페이지로 리디렉션하도록 로그인 페이지를 구성하거나 로그인 단추 또는 단추를 구성할 수 있습니다.</p> </td> 
  </tr> 
  <tr> 
