...
Workfront의 모든 라이센스에 대해 증명이 자동으로 포함됩니다. 라이선스에 따라 사용자가 수행할 수 있는 작업이 결정됩니다.
...
기존 2017 Workfront 패키지에는 pro, 비즈니스 또는 엔터프라이즈 Workfront 플랜이 있는 경우 작업 및 플랜 라이선스에 대한 자동 증명이 포함됩니다. 이 계획들은 단계적으로 폐지되고 있다.
