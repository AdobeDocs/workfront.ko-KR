...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>승인 결정</p> </td> 
   <td> <p>문제가 할당된 사용자</p> </td> 
   <td> <p>내가 해결한 문제가 승인 또는 거부되었습니다.</p> <p>문제의 할당자는 승인 결정(승인 또는 거부)이 내려지면 이메일 알림을 받습니다.</p> <p>검토 라이선스가 있는 사용자는 알림을 받지 않습니다.</p> </td> 
   <td> <p>비활성</p> </td> 
  </tr> 
  <tr> 
   <td> <p>작업</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>문제 상태 변경</p> </td> 
   <td> <p>문제가 할당된 사용자</p> </td> 
   <td> <p>내 작업 항목 중 하나의 상태가 변경됩니다.</p> <p>상태를 변경한 사용자가 할당자도 아닌 경우 문제의 할당자는 상태가 변경되면 이메일 알림을 받습니다.</p> <p>알림은 프로젝트 상태가 현재인 경우에만 전송됩니다.</p> <p>검토 라이선스가 있는 사용자는 알림을 받지 않습니다.</p> </td> 
   <td> <p>활성</p> </td> 
  </tr> 
  <tr> 
   <td> <p>문서</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>작업 완료</p> </td> 
   <td> <p>작업이 할당된 사용자</p> </td> 
   <td> <p>나에게 할당된 작업이 완료되었습니다.</p> <p>작업이 완료되면 작업 할당자는 전자 메일 알림을 받습니다. 개인 작업이 완료되면 알림이 전송되지 않습니다.</p> <p>알림은 프로젝트 상태가 현재인 경우에만 전송됩니다.</p> <p>검토 또는 요청자 라이선스가 있는 사용자가 알림을 받지 않습니다.</p> </td> 
   <td> <p>비활성</p> </td> 
  </tr> 
  <tr> 
   <td> <p>작업</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>작업 상태 변경</p> </td> 
   <td> <p>작업이 할당된 사용자</p> </td> 
   <td> <p>나에게 할당된 작업의 상태가 변경됩니다.</p> <p>작업 할당자는 상태를 변경한 사용자가 할당자도 아닌 경우 작업 상태가 변경되면 이메일 알림을 받습니다.</p> <p>알림은 프로젝트 상태가 현재인 경우에만 전송됩니다.</p> <p>검토 라이선스가 있는 사용자는 알림을 받지 않습니다. </p> </td> 
   <td> <p>비활성</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>문서 추가</p> </td> 
   <td> <p>프로젝트 소유자</p> </td> 
   <td> <p>내가 소유한 프로젝트에 문서가 추가됩니다.</p> <p>문서를 추가한 사용자가 프로젝트 소유자도 아닌 경우 프로젝트 소유자는 문서가 프로젝트에 추가될 때 이메일 알림을 받습니다.</p> <p>프로젝트 상태가 현재이고 문서가 비공개가 아닌 경우에만 알림이 전송됩니다.</p> <p>검토 라이선스가 있는 사용자는 알림을 받지 않습니다.</p> </td> 
   <td> <p>비활성</p> </td> 
  </tr> 
  <tr> 
   <td> <p>문제</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>문제 완료</p> </td> 
   <td> <p>프로젝트 소유자</p> </td> 
   <td> <p>내가 소유한 프로젝트에서 문제가 완료되었습니다.</p> <p>프로젝트 소유자는 이메일 알림을 받습니다.</p> <p>프로젝트 상태가 현재 또는 계획인 경우에만 알림이 전송됩니다.</p> <p>검토 라이선스가 있는 사용자는 알림을 받지 않습니다.</p> </td> 
   <td> <p>비활성</p> </td> 
  </tr> 
  <tr> 
   <td> <p>작업</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>프로젝트 사용자 추가</p> </td> 
   <td> <p>리소스 소유자</p> </td> 
   <td> <p>내 직원 중 한 명이 프로젝트에 추가되었습니다.</p> <p>관리자는 부하 직원 중 하나가 프로젝트에 추가되면 이메일 알림을 받습니다.</p> <p>검토 라이선스가 있는 사용자는 알림을 받지 않습니다.</p> </td> 
   <td> <p>비활성</p> </td> 
  </tr> 
  <tr> 
   <td> <p>프로젝트</p> </td> 
...
|------------------|------|---------------------------------------------|--------------------------------------------------------------|---------------|
| 작업 및 문제 | 작업 및 문제 위임 | 할당자 | 내 작업 및 문제를 위임함(확인) | 활성 |
| 작업 및 문제 | 작업 및 문제 위임 중지 | 할당자 | 내 작업 및 문제 위임을 중지함(확인) | 활성 |
| 작업 및 문제 | 작업 및 문제 위임 | 피위임자 | 누군가가 자신의 작업과 문제를 나에게 위임함 | 활성 |
| 작업 및 문제 | 작업 및 문제 위임 중지 | 피위임자 | 누군가가 나에게 자신의 작업과 문제를 위임하는 것을 중지함 | 활성 |
