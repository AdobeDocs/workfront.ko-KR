...
1. 클릭 **저장** 또는 다음 위치로 이동 [워크플로우 설정(선택 사항)](#set-up-workflows-optional) 섹션에 자세히 설명되어 있습니다.
...
통합에서 설정한 기본 워크플로우 값은 프로젝트 템플릿 및 프로젝트 수준에서 대체할 수 있습니다.

### Adobe Experience Manager 연결된 폴더를 만들기 위한 워크플로우 설정
