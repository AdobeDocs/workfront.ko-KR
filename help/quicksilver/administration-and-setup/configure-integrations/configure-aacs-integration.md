...
1. (조건부) 이 통합에 폴더 트리(중첩된 폴더)를 추가하려면 다음을 수행합니다.
   ...
   1. 폴더를 Workfront에 연결하려면 폴더를 선택하고 **연결된 폴더 만들기** 아이콘 ![폴더 연결](assets/link-folder.png)을 클릭합니다.
...
>[!NOTE]
>
>* Workfront AEM 기본 통합은 포함된 폴더 트리의 수에 관계없이 **통합당 프로젝트당 100개 이하의 폴더**&#x200B;를 만들 수 있습니다.
>   * 예: 단일 프로젝트에서 4개의 폴더 트리로 통합하면 400개가 아닌 최대 100개의 폴더를 만들 수 있습니다.
>* 각 폴더 트리의 첫 번째 폴더는 자동으로 Workfront에 연결된 것으로 표시됩니다. 이 폴더에 연결하지 않으려면 연결을 해제할 수 있습니다.
