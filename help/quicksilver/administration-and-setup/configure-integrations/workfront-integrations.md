...
* [ [!DNL Adobe Workfront] 에서 사용자를 위한 [!UICONTROL [!DNL Creative Cloud]] for [!DNL Adobe Admin Console]패키지 만들기](/help/quicksilver/administration-and-setup/configure-integrations/create-plugin-only-packages.md)
