...
일정 만들기 및 편집에 대한 일반적인 내용은 다음을 참조하십시오. [일정 만들기](../../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/create-schedules.md).
...
1. 다음 중 하나를 수행합니다.
   ...
   * 클릭 **새 일정** 새 일정을 만들려면
   * 일정을 선택한 다음 도구 모음의 컨트롤을 사용하여 **편집**, **복사**, 또는 **삭제** 그래.
   * **내보내기** 그룹의 일정 목록입니다.
