...
[!BADGE 신규!]{type=Informative}**오프보딩 | 사용자 대시보드 가져오는 중**
...
[!BADGE 신규!]{type=Informative}**리소스 관리 준비**
...
[!BADGE 신규!]{type=Informative}**값 실현 | 핵심 값 대시보드**
...
[!BADGE 신규!]{type=Informative}**값 실현 | 클라이언트측 서비스 제공 대시보드**
...
[!BADGE 신규!]{type=Informative}**값 실현 | 대시보드 검토 및 승인**
