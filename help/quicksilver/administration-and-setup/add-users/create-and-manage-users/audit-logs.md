...
사용자가 다음 중 하나를 수행하면 시스템에서 비즈니스 프로필 감사 로그 항목을 생성합니다.
...
비즈니스 규칙은 Ultimate Workfront 패키지를 구입한 고객에게만 제공됩니다. 자세한 내용은 [비즈니스 규칙 만들기 및 편집](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/business-rules.md)을 참조하세요.
...
* 사용자 정의 필드를 변경합니다.
  ...
  * 필드 크기 변경
    ...
    필드가 한 줄, 단락, 서식 있는 텍스트 유형 중 하나인 경우에만 사용할 수 있습니다
...
>[!NOTE]
>
>모든 조직이 Adobe Admin Console에 온보딩되었으므로 이 기능은 더 이상 사용할 수 없습니다.자세한 내용은 네트워크 또는 IT 관리자에게 문의하십시오.
