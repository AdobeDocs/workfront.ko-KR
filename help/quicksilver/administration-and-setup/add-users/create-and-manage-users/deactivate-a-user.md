...
1. **비활성화 날짜**&#x200B;의 날짜를 선택하십시오.

   >[!NOTE]
   >
   >* 선택한 날짜는 비활성화를 예약하는 사용자의 컴퓨터 시간대와 일치합니다.

1. **저장**&#x200B;을 클릭합니다.

사용자는 선택한 날짜의 오전 12:00에 비활성화됩니다. 여러 사용자를 일괄 비활성화하도록 선택한 경우 선택한 모든 사용자는 선택한 날짜의 오전 12:00에 비활성화됩니다.
