...
* 해당 사용자와 다음 객체의 연관을 삭제합니다.
   ...
   * 대시보드
     ...
     >자세한 내용은 [삭제된 사용자가 소유한 보고서가 포함된 대시보드에 액세스하려면 어떻게 합니까?](../../../reports-and-dashboards/reports/tips-tricks-and-troubleshooting/reports-faq.md#how)보고서 FAQ[ 문서의 ](../../../reports-and-dashboards/reports/tips-tricks-and-troubleshooting/reports-faq.md) 섹션.
