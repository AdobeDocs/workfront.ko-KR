...
>
>  Adobe Admin Console에서 사용자를 삭제하는 방법에 대한 지침은 [개별적으로 사용자 관리](https://helpx.adobe.com/kr/enterprise/using/manage-users-individually.html)의 &quot;사용자 영구 삭제&quot; 섹션을 참조하거나 Adobe Admin Console 관리자에게 문의하십시오.
