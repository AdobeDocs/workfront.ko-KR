...
1. 다음에서 **사용자 편집** 상자가 나타나면 다음 옵션 중 하나를 변경합니다.
   ...
   <li><b>일정 비활성화</b>: 일정 시간이 지나면 사용자를 비활성화하도록 예약하려면 이 확인란을 선택합니다.</li> 
       ...
       <li> <p>(조건부) 하나 또는 여러 개를 선택한 경우 <b>기타 역할</b>, <b>FTE 가용성 백분율</b> 각 역할에 대한 필드가 표시됩니다. 사용자의 일정 중 각 작업 역할에 할당되는 시간의 백분율을 지정합니다. 다른 역할에 대한 FTE 가용성 백분율의 기본값은 0%입니다.</p> <p><b>참고</b>:  
       <ul> 
