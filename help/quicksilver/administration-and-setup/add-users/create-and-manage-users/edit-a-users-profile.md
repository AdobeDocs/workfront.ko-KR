...
* **Only &lt;SSO Configuration> Authentication**: Workfront 관리자가 Workfront과의 SSO 통합을 사용하도록 설정하고 모든 사용자를 SSO로 업데이트한 경우 이 필드가 기본적으로 선택됩니다. Workfront 인스턴스에 대해 활성화된 SSO 구성 유형이 이 필드에 표시됩니다.
