...
1. 에서 **사용자 편집** 표시되는 상자에서 다음 정보를 변경한 다음 **변경 내용 저장**:
   ...
   <li><b>이 테스트 환경에서 전자 메일 받기</b>: 현재 로그인된 환경에서 이메일 알림을 수신하려면 이 옵션을 선택합니다.
      <p><b>메모</b></p>
      이 옵션은 미리 보기 및 샌드박스 환경에서만 사용할 수 있습니다. 전자 메일 알림은 기본적으로 프로덕션 환경에서 활성화되어 있습니다. 
      </li>
   ...
   <li><b>업데이트 상태에 완료 비율 표시</b>: 이 사용자 작업의 업데이트 영역 내에 백분율 전체 막대를 표시하려면 이 옵션을 선택합니다.</li> 
     ...
     <tr> 
      ...
      <td> 
       <ul>
       <li>
       <b>작업 시간</b>: 오버헤드를 포함하지 않고 실제 작업에 사용할 수 있는 FTE(Full Time Equivalent) 시간의 백분율을 나타냅니다. 작업 시간은 1까지의 십진수여야 하며 0일 수 없습니다. 예를 들어 실제 작업의 20% 가용성은 0.2입니다.
   ...
   예약 예외 및 해제 시간은 사용자 용량에 영향을 줄 수 있습니다.
   ...
   사용자가 프로젝트 관련 작업에 사용할 수 있음을 나타내려면 작업 시간 값을 1로 설정합니다.
   </li> 
   ...
   예약 예외, 시간 초과 및 작업 시간 값은 사용자의 가용성에 영향을 줄 수 있습니다.
