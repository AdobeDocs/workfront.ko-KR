...
1. 복사하고 사용자 지정할 액세스 수준을 선택한 다음 **복사** 아이콘 ![복사 아이콘](assets/copy-icon.png)을 클릭합니다.

   또는

   기존 액세스 수준을 편집하는 경우 해당 액세스 수준의 왼쪽에 있는 상자를 클릭하여 액세스 수준을 선택한 다음 **편집** 아이콘 ![편집 아이콘](assets/edit-icon.png)을 클릭합니다.
...
1. 표시되는 상자에서 다음 중 하나를 수행하여 사용자 정의 액세스 수준 구성을 시작합니다.
   ...
   <tr> 
      <td role="rowheader">계획 수립 라이선스 유형</td> 
      <td><p>이 필드는 워크플로우 패키지 외에 Workfront Planning 패키지도 구입한 고객에게만 표시됩니다.</p>
      <p>선택한 라이선스는 이 액세스 수준을 가진 사용자가 사용할 수 있는 설정을 결정합니다. </p>
      <p>다음 선택 사항 중 하나를 선택합니다.</p>
      <ul><li>표준</li>
      <li>기여자</li>
      <li>없음</li>
     </ul> 
      자세한 내용은 <a href="/help/quicksilver/planning/access/access-overview.md">Adobe Workfront Planning 액세스 개요</a>를 참조하십시오. 
      <p><b>중요</b></p>
      <p>계획 라이선스 및 워크플로 라이선스는 함께 작동하여 사용자에게 Workfront에 대한 액세스 권한을 부여합니다. </p>
      <p>사용자에게 Workflow 라이선스 유형과 Planning 라이선스 유형 간에 서로 다른 수준의 라이선스 유형을 제공할 수 있지만, Workflow 라이선스는 Planning 라이선스보다 낮을 수 없습니다. </p>
      <p>예를 들어 사용자에게 Workflow Standard 라이선스 및 Planning Contributor 라이선스를 제공할 수 있지만 Workflow Contributor 라이선스 및 Planning Standard 라이선스는 제공할 수 없습니다.</p>

   </td> 
     </tr>

   <tr> 
      <td role="rowheader">워크플로 라이선스 유형</td> 
      <td>여기서 선택한 라이센스가 만들거나 편집하는 액세스 수준 유형과 가장 밀접하게 연관된 라이센스인지 확인합니다. 선택한 라이센스에 따라 액세스 수준에 사용할 수 있는 설정이 결정됩니다.
   ...
   자세한 내용은 <a href="/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/licenses-overview.md" class="MCXref xref">새 라이선스 개요</a> 또는 <a href="/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/wf-licenses.md">라이선스 개요</a>를 참조하십시오.
...
1. **추가 제한 설정**&#x200B;을 클릭한 다음 액세스 수준에 대해 다음 제한 중 하나를 설정합니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr>
      <td role="rowheader">사용자가 브랜드에 액세스할 수 있도록 허용</td> 
      <td>사용자가 Workfront에서 GenStudio 브랜드에 액세스하고 관리할 수 있습니다. 자세한 내용은 <a href="/help/quicksilver/administration-and-setup/add-users/configure-and-grant-access/grant-access-brands.md" class="MCXref xref">브랜드 사용 권한에 대한 액세스 권한 부여</a>를 참조하십시오.</td> 
     </tr>
    </tbody> 
   </table>


1. (선택 사항) 이 액세스 수준을 가진 사용자가 특정 필드를 보지 못하도록 제한하려면 제한된 필드 추가 섹션에 필드를 추가하십시오.</span>

   이 섹션에서 기본 필드와 사용자 정의 필드를 모두 검색할 수 있습니다. 제한된 필드는 20개로 제한됩니다.

   액세스 수준이 사용자에게 기본 액세스 수준으로 할당되거나 비즈니스 프로필을 통해 할당되는 경우 필드가 제한됩니다. 비즈니스 프로필에 대한 자세한 내용은 [비즈니스 프로필 개요](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/business-profiles.md)를 참조하십시오.

   제한된 필드는 시스템의 사용자에게 계속 표시되지만 공백으로 표시되거나 실제 데이터 대신 해당 없음이 표시됩니다.
