...
description: Adobe Workfront 관리자는 액세스 수준을 사용하여 Workfront에서 템플릿에 대한 사용자의 액세스를 정의할 수 있습니다.
author: Caroline
...
Adobe Workfront 관리자는 다음과 같이 액세스 수준을 사용하여 템플릿에 대한 사용자의 액세스를 정의할 수 있습니다. [액세스 수준 개요](../../../administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md).

계획 라이센스가 있는 사용자만 템플릿에 대한 전체 액세스 권한을 가질 수 있습니다.
...
## 사용자 지정 액세스 수준을 사용하여 템플릿에 대한 사용자 액세스 구성
...
1. 톱니바퀴 아이콘을 클릭합니다 ![](assets/gear-icon-settings.png) on **보기** 또는 **편집** 템플릿 오른쪽의 버튼을 선택한 다음 아래에서 부여할 기능을 선택합니다 **설정 세부 조정**.
...
각 액세스 수준의 사용자가 템플릿으로 수행할 수 있는 작업에 대한 자세한 내용은 섹션을 참조하십시오 [템플릿](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md#template) 기사 [각 객체 유형에 사용할 수 있는 기능](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md).

## 공유 템플릿에 대한 액세스

문제의 소유자 또는 작성자는 다음에 설명된 대로 다른 사용자에게 권한을 부여하여 다른 사용자와 공유할 수 있습니다 [템플릿 공유](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md).
