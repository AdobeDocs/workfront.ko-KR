   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p><span class="preview"><b>참고</b>: 미리 보기 환경에서는 작업 역할에 대한 액세스가 액세스 수준의 개체 유형으로 제어됩니다. <a href="/help/quicksilver/administration-and-setup/add-users/configure-and-grant-access/grant-access-job-roles.md">작업 역할에 대한 액세스 권한 부여</a>를 참조하십시오.</span></p>
      <p>이 액세스 권한을 통해 사용자는 다음 작업을 수행할 수 있습니다.</p> 
       <ul> 
        <li>기존 작업 역할 보기 및 편집</li> 
        <li>새 작업 역할 추가</li> 
        <li>역할 청구 및 비용 요금 편집</li> 
       </ul> <p><b>중요</b>: 작업 역할에 표준 또는 플랜 사용자 관리 액세스 권한을 부여하면 사용자에 대해 [역할 청구 및 비용 요금 편집] 재무 데이터 액세스 설정이 자동으로 활성화됩니다. 나중에 표준 또는 계획 사용자에 대한 작업 역할에 대한 관리 액세스를 비활성화하면 역할 청구 및 비용 요금 편집 설정이 계속 활성화되어 있으므로 작업 역할이 사용자에게 계속 표시됩니다. 이 경우 작업 역할을 보려면 사용자의 액세스 권한을 제거해야 합니다. 사용자의 역할 청구 및 비용 요금 편집 권한 설정을 비활성화해야 합니다. 지침은 <a href="../../../administration-and-setup/add-users/configure-and-grant-access/grant-access-financial.md" class="MCXref xref">재무 데이터에 대한 액세스 권한 부여</a>를 참조하십시오.</p> </td> 
     </tr> 
     <tr> 
