...
title: ' [!DNL Workfront Proof]의 코덱'
description: ' [!DNL Workfront Proof]의 코덱'
author: Courtney
...
* [!DNL Autodesk Animator Flic] 비디오
* [!DNL Autodesk RLE]
* [!DNL Avid Meridien Uncompressed]
* [!DNL AVImszh]
* [!DNL AVIzlib]
* AVS([!DNL Audio Video Standard]) 비디오
* [!DNL Beam Software VB]
* [!DNL Bethesda VID] 비디오
* [!UICONTROL Bink] 비디오
* [!DNL Blackmagic 10-bit]
* [!DNL Broadway MPEG Capture Codec]
* [!DNL Brooktree 411] 코덱
...
* [!DNL CD Graphics] 비디오
* [!DNL Chinese AVS] 비디오([!DNL AVS1-P2], [!DNL JiZhun] 프로필)
* [!DNL Cinepak]
...
* [!DNL IBM Ultimotion]
* [!DNL IBM UltiMotion]
* [!DNL id Quake II CIN] 비디오
* [!DNL id RoQ] 비디오
* [!DNL IFF ByteRun1]
* [!DNL IFF ILBM]
* [!DNL Independent JPEG Group's] 코덱
...
* [!DNL Intel Indeo 5]
* [!DNL Interplay C93]
* [!DNL Interplay MVE] 비디오
* [!DNL Karl Morton]의 비디오 코덱
* [!DNL Kega Game Video]
...
* [!DNL ProRes 422]
* [!DNL Psygnosis YOP] 비디오
* [!DNL Q-team QPEG]
* [!DNL QPEG]
* [!DNL QuickTime 8BPS] 비디오
* [!DNL QuickTime Animation (RLE)] 비디오
* [!DNL QuickTime Graphics (SMC)]
* [!DNL QuickTime] 비디오([!DNL RPZA])
* [!DNL RealVideo 1.0]
* [!DNL RealVideo 2.0]
* [!DNL RealVideo 3.0]
* [!DNL RealVideo 4.0]
...
* [!DNL VP8]
* [!DNL VQA (Vector Quantized Animation)] 비디오
* [!DNL VSS Codec Light]
* [!DNL VSS Wavelet Video Codec]
* [!DNL WebTrain Communication] 무손실 화면 레코더
* [!DNL wincam screen capture] 코덱
...
* [!DNL Winnov Videum winx] 코덱
* [!DNL Winnov Videum wnv1] 코덱
* [!DNL Winnov WNV1]
