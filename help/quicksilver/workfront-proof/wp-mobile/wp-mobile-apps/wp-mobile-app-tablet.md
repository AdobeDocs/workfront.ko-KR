...
description: 다음 [!DNL Workfront Proof] 태블릿 앱을 사용하면 이동 중에 편리하게 증명을 검토하고 승인할 수 있습니다. 앱을 모든 사용자가 다운로드할 수 있으며, 다음이 아니어도 됩니다. [!DNL Workfront Proof] 태블릿이나 휴대폰에서 증명을 검토할 수 있는 사용자입니다.
hide: true
hidefromtoc: true
...
다음 [!DNL Workfront Proof] 태블릿 앱을 사용하면 이동 중에 편리하게 증명을 검토하고 승인할 수 있습니다. 앱을 모든 사용자가 다운로드할 수 있으며, 다음이 아니어도 됩니다. [!DNL Workfront Proof] 태블릿이나 휴대폰에서 증명을 검토할 수 있는 사용자입니다.

다음을 클릭하면 됩니다. [!UICONTROL 증명으로 이동] 받은 이메일 알림의 버튼을 클릭하여 앱에서 증명을 엽니다.

[!DNL Workfront Proof] 사용자는 앱에 로그인하여 대시보드를 이용하여 편리하게 작업을 관리할 수 있다.
...
태블릿용으로 특별히 제작된 앱입니다. 을(를) 사용하려면 [!DNL Workfront Proof] iPhone에서 iTunes Store에서 iOS 앱을 다운로드합니다.
...
다음 [!DNL Workfront Proof] 태블릿 앱을 사용하면 주의가 필요한 증명이 포함된 대시보드에 액세스할 수 있습니다. 대시보드에 액세스하려면:

1. 다음 중 하나를 수행하십시오.

   * 다음을 사용하여 로그인 [!DNL Workfront Proof] 자격 증명.
...
다음에 대한 로그인 상태를 유지하려면 [!DNL Workfront Proof] 계정:

1. 사용 **[!UICONTROL 로그인 유지]** 아래에 있는 사이드바 메뉴에서 **[!UICONTROL 설정]**:

![Keep_me_logged_in.gif](assets/keep-me-logged-in-350x446.gif)

다음 *[!UICONTROL 대시보드]* 링크를 클릭하면 앱의 모든 보기에서 대시보드로 돌아갑니다. 대시보드를 다시 로드하는 데에도 사용할 수 있습니다.
...
웹 애플리케이션의 대시보드 차트와 유사하게, 모바일 앱에는 사용자와 공유된 증명 목록이 표시됩니다. 페이지 맨 위에 있는 시작 메시지에는 총 증명 수와 그 아래에 있는 증명 수가 표시됩니다. *정시*, *위험 상태*, 및 *지연 증명*.

* **정시 증명** 기한이 설정되지 않았거나 기한이 24시간 이상 지난 증명입니다.
* **위험 상태의 증명** 기한이 다음 24시간 이내인 곳입니까? 이 증명에 대한 진행률 표시줄은 주황색입니다.
* **지연 증명** 은 이미 기한을 넘긴 증명입니다. 이 증명에 대한 진행률 표시줄이 빨간색입니다. 기한 도달 시 [!DNL Workfront Proof] 은(는) 지연 의사 결정자 및 증명 소유자에게 자동 미리 알림 이메일을 보냅니다.
...
1. 증명 이름을 클릭하여 [!DNL Workfront Proof] 뷰어.
   ...
   이메일 알림에서 증명을 열려면 검토자가 **[!UICONTROL 증명으로 이동]** 알림의 링크.
다음 항목이 있는 경우: [!DNL Workfront Proof] 계정에서 로그인하고 대시보드에서 증명에 액세스할 수 있습니다.

   >[!NOTE]
   >
   >증명을 검토하려면 장치에 앱이 설치되어 있어야 합니다. [!DNL Workfront Proof], 없는 경우에도 [!DNL Workfront Proof] 계정입니다.
...
1. 증명에서 탐색:
   ...
   * 증명의 특정 페이지로 이동하려면 옆으로 스와이프하거나 [!UICONTROL 축소판] 목록을 표시합니다.
   ...
   * 패닝하려면 이미지를 누른 상태에서 올바른 위치를 찾을 때까지 움직입니다.
     ...
     모바일 앱에서 증명을 검토하는 것은 를 사용하여 증명을 검토하는 것만큼 간단합니다 [!DNL Workfront Proof] 뷰어. 아래에서는 댓글 및 마크업 추가, 피드백 관리 및 의사 결정에 대해 자세히 살펴봅니다. 또한 앱의 사이드바에서 사용할 수 있는 다양한 옵션에 대해 설명합니다.

## 앱의 댓글

아래 비디오에서는 모바일 앱에 댓글을 다는 기본 사항을 보여 줍니다. 댓글을 작성하는 방법, 댓글에 대한 답글을 게시하는 방법, 다양한 마크업을 사용하고 삭제하는 방법, 댓글을 편집하고 삭제하는 방법을 보여줍니다.

회신이 게시되지 않은 경우 댓글만 편집하고 삭제할 수 있습니다. 표시되지 않으면 [!UICONTROL 휴지통] 아이콘, 사용자가 이 옵션을 비활성화했을 수 있습니다. [!DNL Workfront Proof] 관리자.

앱에는 세 가지 주석 보기 옵션이 있습니다. 주석 버튼을 클릭하면 둘 사이를 전환할 수 있습니다.

* **[!UICONTROL 목록 보기]** 모든 주석 목록을 표시합니다. 각 주석을 탭하거나 위쪽 및 아래쪽 화살표를 탭하여 탐색할 수 있습니다.
* **[!UICONTROL 단일 댓글 보기]** 한 번에 한 개의 주석을 표시합니다. 다음 주석으로 이동하려면 페이지 상단의 화살표를 누릅니다.
* **[!UICONTROL 댓글 보기 숨기기]** 모든 주석을 숨깁니다.

증명에 남아 있는 모든 마크업이 이미지에 핀을 놓습니다. 핀과 연관된 주석 및 마크업을 보려면 핀을 탭하면 됩니다. 주석 편집 상자를 닫은 경우에만 이 작업을 수행할 수 있습니다. 주석 상자를 닫으려면 [!UICONTROL x] 을 클릭합니다.

## 텍스트 주석 도구

이동 중 증명 텍스트는 [!DNL Workfront Proof] 태블릿 앱입니다. 텍스트 주석 도구는 주황색을 클릭하면 마크업 도구 모음에서 사용할 수 있습니다 **[!UICONTROL 주석 추가]** 단추를 클릭합니다.
...
1. 강조 표시를 사용할 수 있을 때까지 해당 단어를 누른 채로 슬라이더를 사용하여 마크업할 전체 단어나 구를 강조 표시합니다.
   ...
   |---|---|
   | **[!UICONTROL 바꾸기]** | [ 추가[!UICONTROL 바꾸기]] 및 [[!UICONTROL 포함]- 대체 텍스트를 쉽게 추천할 수 있도록 텍스트와 함께 주석 상자에 입력합니다. |
   | **[!UICONTROL 삭제]** | 텍스트를 표시하고 를 추가합니다. [DELETE] 주석 상자로 이동합니다. |
   | **[!UICONTROL 다음 항목 뒤에 삽입]** | 추가 [다음 항목 뒤에 삽입] 주석 상자에 넣습니다. |
...
모든 사람이 증명에 대한 의견과 마크업을 남긴 후에는 증명 관리자가 피드백을 검토하여 다음 증명 버전에 적용할 변경 사항을 결정해야 하는 경우가 많습니다. 위치 [!DNL Workfront Proof] 주석에 대한 작업 을 사용하여 각 개별 댓글에 플래그를 지정하고 작업을 수행할 댓글을 표시할 수 있습니다.

주석에 대한 작업은 다음을 통해 계정에 설정해야 합니다. [!DNL Workfront Proof] 관리자 및 은 편집 권한이 있는 사람만 증명에 사용할 수 있습니다.
...
이동 중에 비디오를 검토하는 것은 [!DNL Workfront Proof] 태블릿 앱입니다. 아래 비디오에서는 앱에서 댓글, 마크업 및 의사 결정을 수행하는 방법을 보여 줍니다.
...
1. 페이지 상단의 녹색 결정 버튼을 탭합니다.
   ...
   그린이 안 보이면 **[!UICONTROL 검토 완료]** 버튼을 누르면 증명에 대해 결정을 내려야 한다고 생각하게 됩니다. [!DNL Workfront Proof] 관리자는에 설명된 대로 증명 역할을 업데이트할 수 있습니다. [에서 증명 역할 관리 [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md).
...
| **[!UICONTROL 설정]** | 증명에 고정 항목 및/또는 마크업을 표시하도록 결정할 수 있으며, [!UICONTROL 로그인 유지] 앱에서 로그아웃되지 않도록 합니다. |
