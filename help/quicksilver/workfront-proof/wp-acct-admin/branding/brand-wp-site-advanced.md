...
* JPG, GIF 또는 PNG를 사용할 수 있습니다. 이 경우 흰색 배경색이 투명도를 갖는 파일에 사용할 수 있습니다.
...
브랜딩 구성의 이 필드(10)에서 모든 계정 페이지의 맨 아래에 표시되는 바닥글을 작성할 수 있습니다. 기본 제공 WYSIWYG 편집기를 사용하거나 직접 만든 디자인을 붙여넣을 수 있습니다.
![Footer.png](assets/footer-350x157.png)

>[!NOTE]
>
>바닥글 텍스트 편집기에서 HTML을 편집할 수는 없지만 복사한 디자인(모든 링크 및 이미지 포함)을 붙여넣을 수는 있습니다.
