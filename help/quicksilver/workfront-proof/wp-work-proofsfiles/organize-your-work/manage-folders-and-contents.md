...
title: ' [!DNL Workfront Proof]에서 폴더 및 해당 컨텐츠 관리'
description: 프로젝트 및 증명을 폴더로 구성할 때 얻을 수 있는 이점 중 하나는 [!UICONTROL 폴더 세부 정보] 페이지에서 프로젝트 및 증명을 관리할 수 있다는 것입니다. 이 페이지는 프로젝트의 제어 센터입니다. 여기에서 개별 증명 및 파일을 편리하게 관리하고 대량 작업을 수행할 수 있습니다.
author: Courtney
