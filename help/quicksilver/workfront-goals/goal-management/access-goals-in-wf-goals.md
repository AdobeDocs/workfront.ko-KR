...
title: Adobe Workfront 목표의 액세스 및 공개 목표
description: 이 문서에서는 Adobe Workfront에서 목표를 찾아 관리하는 방법을 설명합니다.
author: Alina
...
# Adobe Workfront 목표의 액세스 및 공개 목표

이 문서에서는 Adobe Workfront에서 전략적 목표를 찾아 관리하는 방법을 설명합니다.
...
1. 을(를) 클릭합니다. **기본 메뉴** 아이콘 ![](assets/main-menu-icon.png) 오른쪽 위 모서리에서 을(를) 클릭하고 **목표**.
   ...
   >[!IMPORTANT]
   >
   >   Workfront 목표에 대한 올바른 액세스 권한이 있으면 기본적으로 사용자 또는 목표 목록에서 만들어진 다른 사용자가 목표를 볼 수 있습니다.
...
1. (선택 사항) 목표 이름을 클릭하여 열거나 편집합니다.

   또는

   클릭 **새 목표** 를 눌러 새 목표를 추가합니다.

   목표 만들기에 대한 내용은 [Adobe Workfront 목표에서 목표 만들기](../../workfront-goals/goal-management/create-goals.md).

## 개별 목표 열기 및 관리

목표를 관리할 때 다음 작업을 수행하려면 개별 목표에 액세스해야 합니다.
...
1. 을(를) 클릭합니다. **기본 메뉴** Workfront의 오른쪽 위 모서리에 있는 아이콘을 클릭한 다음 **목표** .
목표 목록이 기본적으로 표시됩니다.
   ![](assets/goal-list-unshimmed.png)
1. 목록에서 목표 이름을 클릭합니다.
목표의 페이지가 표시됩니다.
   ![](assets/goal-page-unshimmed.png)
1. 을(를) 클릭합니다. **자세히** 메뉴 ![](assets/more-icon.png) 목표를 더 편집하거나 공유할 목표 이름의 오른쪽에 있습니다.
1. 클릭 **목표 세부 사항** 왼쪽 패널에서 목표에 대한 정보를 편집합니다. 자세한 내용은 [Adobe Workfront 목표의 목표 세부 사항 섹션에서 목표 업데이트](../goal-management/update-goals-in-goal-details-panel.md).
