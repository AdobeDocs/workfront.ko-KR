...
1. 양식에 첫 번째 필드를 추가하려면:
   ...
   1. **라디오 단추** 필드 유형을 선택한 다음 *필요한 마케팅 콘텐츠 유형을 입력하십시오.* 을(를) 필드의 **레이블**(으)로 설정합니다.
...
1. 만든 드롭다운 필드 *어떤 유형의 웹 사이트가 필요합니까?*&#x200B;를 선택하고, 필드에 다음 선택 사항을 추가한 다음 **적용**&#x200B;을 클릭합니다.
...
1. **필드 추가** 탭을 열고 *웹 사이트의 목표는 무엇입니까?*(이)라는 **서식 있는 텍스트 필드를 만들고** **적용**&#x200B;을 클릭합니다.
