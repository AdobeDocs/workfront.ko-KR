...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>플랜에 대한 [!UICONTROL 관리] 권한</p> <p>플랜에 대한 추가 액세스 요청에 대한 자세한 내용은 <a href="../scenario-planner/request-access-to-plan.md" class="MCXref xref">시나리오 플래너의 플랜에 대한 액세스 요청</a>을 참조하십시오.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. [!DNL Workfront]의 오른쪽 위 모서리에 있는 **[!UICONTROL 기본 메뉴]** ![](assets/main-menu-icon.png)을(를) 클릭한 다음 [!DNL Scenarios]을(를) 클릭하여 [!DNL Scenario Planner]에 액세스합니다.
