...
* 제품 공지 {#product-announcements}
   ...
   * 제품 릴리스 {#product-releases}
      ...
      * 23.3 릴리스 {#release-23-3}
         ...
         * [23.3 릴리스 일정 동안의 업데이트 확인](product-announcements/product-releases/23.3-release-activity/23-3-look-and-feel-updates.md)
...
* 작업 검토 및 승인 {#review-and-approve-work}
   ...
   * 문서 검토 및 승인 {#document-reviews-and-approvals}
      ...
      * 문서 승인 관리 {#manage-document-approvals}
         ...
         * [문서 승인 개요](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/document-approvals-overview.md)
