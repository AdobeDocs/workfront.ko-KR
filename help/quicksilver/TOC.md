...
* Adobe Workfront 계획 {#adobe-workfront-planning}
   ...
   * Adobe Workfront Planning 아키텍처 {#adobe-workfront-planning-architecture}
      ...
      * [교차 작업 영역 레코드 유형 추가](planning/architecture/add-cross-workspace-record-types.md)
...
* Adobe Workfront 통합 {#adobe-workfront-integrations}
   ...
   * 검토 및 승인 통합 {#review-approval-integrations}
      * [검토 및 승인 통합: 문서 색인](/help/quicksilver/workfront-integrations-and-apps/review-and-approval-integrations/review-approval-integrations-toc.md)
