...
* Adobe Workfront 계획 수립 {#adobe-workfront-planning}
   * [Adobe Workfront Planning에 대한 일반 정보](planning/planning-information.md)
   ...
   * Adobe Workfront 계획 모범 사례 {#adobe-workfront-planning-best-practices}
      ...
      * [30일 런치패드: 전략적 홈 구축](planning/best-practices.md/30-day-launchpad.md)
      * [성공 아키텍처: 캠페인 계층 구조 모델링](planning/best-practices.md/model-campaign-hierarchy.md)
      * [누락된 마케팅 캘린더: 데크 없음, 명확성](planning/best-practices.md/marketing-calendar.md)
      * [플레이북: 첫 번째 승리 후 관리되는 크기 조정](planning/best-practices.md/playbook-how-to-scale.md)
      * [브리지: 프로젝트에 전략적 의도 연결](planning/best-practices.md/the-bridge-connect-strategy-with-projects.md)
