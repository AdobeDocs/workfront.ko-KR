...
* 제품 공지 {#product-announcements}
  ...
  * 제품 릴리스 {#product-releases}
    ...
    * 2026년 3분기 릴리스 {#release-26-q3}
      ...
      * [2026년 3분기 AI 개선 사항](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-ai.md)
      ...
      * [2026년 3분기 프로젝트 개선 사항](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-projects.md)
      ...
      * [2026년 3분기 리소스 관리 개선 사항](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-resource-mgmt.md)
    ...
    * 2025년 3분기 릴리스 {#release-25-q3}
      ...
      * {hide-from-toc}[프로젝트 개선 사항](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-project-enhancements.md)
    ...
    * 2024년 3분기 릴리스 {#release-24-q3}
      ...
      * [2024년 3분기 리소스 관리 개선 사항](/help/quicksilver/product-announcements/product-releases/24-q3-release-activity/24-q3-resource-mgmt-enhancements.md)
    ...
    * Adobe Workfront 제한된 가용성 릴리스 활동{#limited-availability-release-activity}
      ...
      * Adobe Workfront의 제한된 가용성 기능에 대한 {hide-from-toc}[2026년 4분기 릴리스 활동](/help/quicksilver/product-announcements/product-releases/limited-availability-release-activity/limited-availability-release-activity-26-q4.md)
  ...
  * Beta 프로그램 {#beta}
    ...
    * 캔버스 대시보드 베타 {#canvas-dashboards-beta}
      ...
      * {hide-from-toc}[보고 캔버스 베타 개요](product-announcements/betas/canvas-dashboards-beta/reporting-canvas-beta-overview.md)
      * {hide-from-toc}[캔버스 대시보드 베타: 릴리스 활동](product-announcements/betas/canvas-dashboards-beta/canvas-dashboards-release-activity.md)
    * 새 댓글 달기 경험 Beta {#new-commenting-experience-beta}
      * {hide-from-toc}[새 댓글 달기 Beta 경험 정보](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-information.md)
      * {hide-from-toc}[새 댓글 달기 경험](product-announcements/betas/new-commenting-experience-beta/unified-commenting-experience.md)
      * {hide-from-toc}[새 댓글 달기 경험 릴리스 활동](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-release-activity.md)
      * {hide-from-toc}[새 댓글 달기 경험 FAQ](product-announcements/betas/new-commenting-experience-beta/new-commenting-faq.md)
* 관리 및 설정 {#administration-and-setup}
  ...
  * 관리 시작 {#get-started-administration}
    ...
    * [e-메일 구성](administration-and-setup/get-started-wf-administration/configure-your-email-allowlist.md)
  ...
  * Workfront 설정 {#set-up-wf}
    ...
    * 시스템 기본값 구성 {#configure-system-defaults}
      ...
      * [AI 공동 작업자](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/ai-collaborators-overview.md)
  ...
  * 사용자 관리 {#add-users}
    ...
    * 액세스 수준 작동 방식 {#access-levels}
      ...
      * [라이센스에 의한 오브젝트 및 영역 액세스](administration-and-setup/add-users/how-access-levels-work/access-to-objects-areas-license-types.md)
      * [각 객체 유형에 사용할 수 있는 기능](administration-and-setup/add-users/how-access-levels-work/functionality-available-for-objects.md)
      * [비유료 사용자에 대한 자동 업그레이드 옵션 비활성화](administration-and-setup/add-users/how-access-levels-work/disable-auto-upgrade.md)
  ...
  * Adobe Workfront 관리 {#manage-wf}
    ...
    * 보안 {#security}
      ...
      * {hide-from-toc}[향상된 인증 개요](administration-and-setup/manage-workfront/security/get-started-enhanced-authentication.md)
      * {hide-from-toc}[향상된 인증을 사용할 때 IDP에서 SAML 2.0 메타데이터 업데이트](administration-and-setup/add-users/single-sign-on/update-saml-2-metadata-ip-eauth.md)
    * 환율 {#exchange-rates}
  ...
  * 관리 및 설정을 위한 팁, 요령 및 문제 해결 {#admin-setup-tips}
    ...
    * {hide-from-toc}[액세스 수준의 자동 업그레이드 옵션 업데이트](administration-and-setup/tips-tricks-and-troubleshooting/update-auto-upgrade-in-access-levels.md)
* Adobe Workfront 기본 사항 {#basics}
  ...
  * Adobe Workfront 탐색 {#navigate}
    ...
    * [라이트 라이선스 사용자의 탐색 이해](workfront-basics/navigate-workfront/workfront-navigation/reviewer-global-navigation-bar.md)
  ...
  * 홈 {#home}
    ...
    * {hide-from-toc}[기존 홈에서 새 홈으로 이동](/help/quicksilver/workfront-basics/using-home/new-home/move-to-new-home.md)
  ...
  * 알림 사용 {#use-notifications}
    ...
    * {hide-from-toc}[Experience Cloud 알림 개요](/help/quicksilver/workfront-basics/using-notifications/exp-cloud-notifications-overview.md)
...
* 문서 {#documents}
  ...
  * 문서 관리 {#manage-documents}
    ...
    * {hide-from-toc}[Workfront 문서 세부 정보 내의 AddBuilder](/help/quicksilver/documents/managing-documents/app-builder-doc-details.md)
  ...
  * Workfront 및 Experience Manager Assets 통합 {#wf-aem-integrations}
    ...
    * Experience Manager Assets 및 Assets Essentials용 Adobe Workfront {#wf-aem-essentials}
      ...
      * [Experience Manager Assets의 콘텐츠 관리자를 사용하여 에셋 및 폴더 연결](documents/adobe-workfront-for-experience-manager-assets-essentials/link-to-aem.md)
      * [Experience Manager Assets Essentials에서 에셋 및 폴더 연결](documents/adobe-workfront-for-experience-manager-assets-essentials/link-to-aem-essentials.md)
...
* 보고 {#reporting}
  ...
  * 캔버스 대시보드 {#canvas-dashboards}
    * {hide-from-toc}[캔버스 대시보드 개요](reports-and-dashboards/canvas-dashboards/canvas-dashboards-overview.md)
  ...
  * 대시보드 {#dashboards}
    ...
    * 대시보드 만들기 및 관리 {#create-dashboards}
      ...
      * {hide-from-toc}[캔버스 대시보드 개요](reports-and-dashboards/dashboards/creating-and-managing-dashboards/canvas-dashboards-overview.md)
...
* 작업 검토 및 승인 {#review-and-approve-work}
  ...
  * 통합 승인 {#document-reviews-and-approvals}
    ...
    * 자산 및 문서 승인 설정 및 관리 {#manage-asset-review-and-approval}
      ...
      * [승인 템플릿 관리](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/manage-approval-templates.md)
...
* Adobe Workfront 계획 수립 {#adobe-workfront-planning}
  ...
  * Adobe Workfront Planning 일반 정보 {#adobe-workfront-planning-general-information}
    ...
    * [Workfront Planning 용어 개요](planning/general/planning-terminology.md)
  ...
  * Adobe Workfront 계획 모범 사례 {#adobe-workfront-planning-best-practices}
    ...
    * [마케팅 캘린더 만들기: 데크 없음, 명확함](planning/best-practices.md/marketing-calendar.md)
    * [첫 승을 지속 가능한 모멘텀으로 전환: 관리형 스케일링을 위한 플레이북](planning/best-practices.md/playbook-how-to-scale.md)
    * [브리지 구축: 프로젝트에 전략적 의도 연결](planning/best-practices.md/the-bridge-connect-strategy-with-projects.md)
...
* Workfront Proof {#workfront-proof}
  ...
  * Workfront Proof mobile {#wf-proof-mobile}
    ...
    * Workfront Proof 모바일 앱 {#wf-proof-mobile-apps}
      * {hide-from-toc}[Workfront Proof 모바일 앱](workfront-proof/wp-mobile/wp-mobile-apps/wp-mobile-apps.md)
...
* ADOBE WORKFRONT API {#adobe-workfront-api}
  ...
  * API 참고 사항 {#api-notes}
    ...
    * [API 버전 22의 새로운 기능](/help/quicksilver/wf-api/api/new-api-version-22.md)
...
* ProofHQ API {#proofhqpapi}
  ...
  * 일반 {#general}
    ...
    * {hide-from-toc}[코드 샘플](proofhq-api/general/code-samples.md)
