...
* 관리 및 설정 {#administration-and-setup}
   ...
   * 사용자 추가 {#add-users}
      ...
      * 액세스 수준 작동 방식 {#access-levels}
         ...
         * [라이선스 유형별 오브젝트 액세스](administration-and-setup/add-users/access-levels-and-object-permissions/access-to-objects-and-areas-by-license-type.md)
...
* Adobe Workfront 기본 사항 {#basics}
   ...
   * 작업 항목 업데이트 및 업데이트 보기 {#update-work-items-view-updates}
      ...
      * [통합 댓글 달기 환경](workfront-basics/updating-work-items-and-viewing-updates/unified-commenting-experience.md)
...
* 애자일 {#agile}
   ...
   * 프로젝트의 애자일 {#agile-in-projects}
      * [프로젝트의 애자일](agile/agile-in-projects/agile-in-projects.md)
...
* 리소스 관리 {#manage-resources}
   ...
   * 리소스 관리 {#resource-management}
      ...
      * [리소스 예약에서 업무 균형자로 마이그레이션](resource-mgmt/resource-mgmt-overview/migrate-resource-scheduling-to-workload-balancer.md)
