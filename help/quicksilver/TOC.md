...
* 제품 공지 {#product-announcements}
   ...
   * 제품 릴리스 {#product-releases}
      ...
      * 23.2 릴리스 {#release-23-2}
         ...
         * [23.2 Agile 개선](product-announcements/product-releases/23.2-release-activity/23-2-agile-enhancements.md)
         * [23.2 프로젝트 관리 개선 사항](product-announcements/product-releases/23.2-release-activity/23-2-project-enhancements.md)
         * [23.2 리소스 관리 개선 사항](product-announcements/product-releases/23.2-release-activity/23-2-resource-management-enhancements.md)
      ...
      * 23.1 릴리스 {#release-23-1}
         ...
         * [23.1 Agile 개선 사항](product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md)
         ...
         * [23.1 릴리스 기간 동안 모양 및 느낌 업데이트](product-announcements/product-releases/23.1-release-activity/23-1-look-and-feel-updates.md)
      * 22.4 릴리스 {#release-22-4}
         ...
         * [22.4 Agile 개선](product-announcements/product-releases/22.4-release-activity/22-4-agile-enhancements.md)
         * [22.4 리소스 관리 개선 사항](product-announcements/product-releases/22.4-release-activity/22-4-resource-management-enhancements.md)
         * [22.4 기타 개선 사항](product-announcements/product-releases/22.4-release-activity/22-4-other-enhancements.md)
         * [22.4 디자인 업데이트](product-announcements/product-releases/22.4-release-activity/22-4-look-and-feel-updates.md)
      * 22.3 릴리스 {#release-22-3}
         ...
         * [22.3 릴리스 일정 동안 업데이트 확인 및 감지](product-announcements/product-releases/22.3-release-activity/22-3-look-and-feel-updates.md)
      * 22.2 릴리스 {#release-22-2}
         ...
         * [22.2 리소스 관리 개선 사항](product-announcements/product-releases/22.2-release-activity/22-2-resource-management-enhancements.md)
         ...
         * [22.2 릴리스 일정 동안 찾기 및 감지 업데이트](product-announcements/product-releases/22.2-release-activity/22-2-look-and-feel-updates.md)
      * 22.1 릴리스 {#release-22-1}
         ...
         * [22.1 리소스 관리 개선 사항](product-announcements/product-releases/22.1-release-activity/22-1-resource-mgt-enhancements.md)
         * [22.1 요청 개선 사항](product-announcements/product-releases/22.1-release-activity/22-1-requests-enhancements.md)
         * [22.1 향상된 언어 교정](product-announcements/product-releases/22.1-release-activity/22-1-proofing-enhancements.md)
      ...
      * 21.4 릴리스 {#release-21-4}
         ...
         * [21.4 Agile 개선](product-announcements/product-releases/21.4-release-activity/21-4-agile-enhancements.md)
         * [21.4 프로젝트 개선 사항](product-announcements/product-releases/21.4-release-activity/21-4-project-enhancements.md)
         * [21.4 리소스 관리 개선 사항](product-announcements/product-releases/21.4-release-activity/21-4-resource-management-enhancements.md)
         ...
         * [21.4 향상된 언어 교정](product-announcements/product-releases/21.4-release-activity/21-4-proofing-enhancements.md)
      ...
      * 21.3 릴리스 {#release-21-3}
         ...
         * [21.3 리소스 관리 개선 사항](product-announcements/product-releases/21.3-release-activity/21-3-resource-management-enhancements.md)
         * [21.3 요청 개선 사항](product-announcements/product-releases/21.3-release-activity/21-3-requests-enhancements.md)
         * [21.3 향상된 언어 교정](product-announcements/product-releases/21.3-release-activity/21-3-proofing-enhancements.md)
      ...
      * 21.2 릴리스 {#release-21-2}
         ...
         * [21.2 리소스 관리 개선 사항](product-announcements/product-releases/21.2-release-activity/21-2-resource-management-enhancements.md)
         * [21. 2가지 보고 개선 사항](product-announcements/product-releases/21.2-release-activity/21-2-reporting-management-enhancements.md)
         * [21.2 향상된 언어 교정](product-announcements/product-releases/21.2-release-activity/21-2-proofing-enhancements.md)
      ...
      * 21.1 릴리스 {#release-21-1}
         ...
         * [21.1 리소스 관리 개선 사항](product-announcements/product-releases/21.1-release-activity/21-1-resource-mgt-enhancements.md)
         * [21.1 프로젝트 관리 개선 사항](product-announcements/product-releases/21.1-release-activity/21-1-project-mgt-enhancements.md)
         * [21.1 향상된 분석 개선 사항](product-announcements/product-releases/21.1-release-activity/21-1-enhanced-analytics-improvements.md)
      ...
      * Adobe Workfront 시나리오 플래너 릴리스 활동 {#scenario-planner-release}
         * [Adobe Workfront 시나리오 플래너 릴리스 활동](product-announcements/product-releases/scenario-planner-release-activity/sp-release-activity.md)
      ...
      * Adobe Workfront 목표 릴리스 활동 {#goals-release}
         ...
         * 23.1 릴리스의 목표 {#goals-23-1}
            ...
            * [Adobe Workfront 목표 23.1 릴리스 활동: 2023년 12월 5일 주](product-announcements/product-releases/goals-release-activity/goals-23-1-release/goals-jan.md)
         * 21.2 릴리스의 목표 {#goals-21-2}
            ...
            * [Adobe Workfront 목표 21.2 릴리스 활동: 2021년 4월 19일 주](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-19.md)
            * [Adobe Workfront 목표 21.2 릴리스 활동: 2021년 4월 5일 주](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-apr-5.md)
            * [Adobe Workfront 목표 21.2 릴리스 활동: 2021년 2월 15일 주](product-announcements/product-releases/goals-release-activity/goals-21.2-release/goals-feb-15.md)
         * 21.1 릴리스의 목표 {#goals-21-1}
            ...
            * [Adobe Workfront 목표 21.1 릴리스 활동: 2021년 1월 11일 주](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-jan-11.md)
            * [Adobe Workfront 목표 21.1 릴리스 활동: 2020년 12월 14일의 주](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-dec-14.md)
            * [Adobe Workfront 목표 21.1 릴리스 활동: 2020년 11월 30일의 주](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-nov-30.md)
            * [Adobe Workfront 목표 21.1 릴리스 활동: 2020년 11월 16일의 주](product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-nov-16.md)
      ...
      * 분기별 릴리스 아카이브 {#quarterly-release}
         ...
         * 20.4 릴리스 {#release-20-4}
            ...
            * [20.4 프로젝트 관리 개선 사항](product-announcements/product-releases/20.4-release-activity/20-4-project-mgt-enhancements.md)
            * [20. 4가지 Analytics 개선 사항](product-announcements/product-releases/20.4-release-activity/20-4-analytics-enhancements.md)
            * [20.4 리소스 관리 개선 사항](product-announcements/product-releases/20.4-release-activity/20-4-resource-mgt-enhancements.md)
         ...
         * 20.3 릴리스 {#release-20-3}
            ...
            * [20.3 리소스 관리 개선 사항](product-announcements/product-releases/20.3-release-activity/20-3-resource-management-enhancements.md)
            * [20.3 Analytics 개선 사항](product-announcements/product-releases/20.3-release-activity/20-3-analytics-enhancements.md)
            ...
            * [20.3 Agile 개선](product-announcements/product-releases/20.3-release-activity/20-3-agile-enhancements.md)
         ...
         * 20.2 릴리스 {#release-20-2}
            ...
            * [2020.2의 기타 개선 사항](product-announcements/product-releases/2020.2.-release-activity/2020.2-other-enhancements.md)
            * [2020.2 프로젝트 개선 사항](product-announcements/product-releases/2020.2.-release-activity/2020.2-project-enhancements.md)
            * [2020.2 향상된 언어 교정](product-announcements/product-releases/2020.2.-release-activity/2020.2-proofing-enhancements.md)
            * [2020.2 리소스 관리 개선 사항: 작업 로드 밸런서](product-announcements/product-releases/2020.2.-release-activity/2020.2-resource-management.md)
         * 20.1 릴리스 {#release-20-1}
            ...
            * [2020.1 향상된 목록](product-announcements/product-releases/2020.1-release-activity/2020.1-list-enhancements.md)
            ...
            * [2020.1 향상된 언어 교정](product-announcements/product-releases/2020.1-release-activity/2020.1-proofing-enhancements.md)
            ...
            * [2020.1 릴리스 전에 프로덕션에 릴리스된 다른 Workfront Classic 기능](product-announcements/product-releases/2020.1-release-activity/prior-to-2020.1.md)
         * 2019.4 릴리스 {#release-19-4}
            ...
            * [2019.4의 기타 개선 사항](product-announcements/product-releases/quarterly-release-archive/2019.4-release-activity/2019.4-other-enhancements.md)
            * [2019.4 리소스 관리 개선 사항](product-announcements/product-releases/quarterly-release-archive/2019.4-release-activity/2019.4-resource-management-enhancements.md)
            * [2019.4 릴리스 전에 프로덕션에 릴리스된 다른 Workfront Classic 기능](product-announcements/product-releases/quarterly-release-archive/2019.4-release-activity/other-workfront-classic-features-prior-to-19.4.md)
         * 2019.3 릴리스 {#release-19-3}
            ...
            * [2019.3 향상된 홈](product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-home-enhancements.md)
         ...
         * 2019.2 릴리스 {#release-19-2}
            ...
            * [2019.2 Agile 개선 사항](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019.2-agile-enhancements.md)
            ...
            * [2019.2 향상된 언어 교정](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019.2-proofing-enhancements.md)
         ...
         * Workfront R1 릴리스 {#r1-release}
            ...
            * [2016년 미리 보기에서 사용할 수 있는 기능](product-announcements/product-releases/quarterly-release-archive/r1-release-activity/available-in-preview-in-2016.md)
            * [R1 최종](product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md)
            * [R1 미리 보기 1 및 2](product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-peview-1-and-2.md)
   ...
   * 공지 {#announcements}
      ...
      * [기능 예약은 더 이상 지원되지 않습니다](product-announcements/announcements/feature-removal-timeline.md)
      * [유지 관리 기간 FAQ](product-announcements/announcements/maintenance-window-faq.md)
      * [증명을에 추가하는 데 필요한 허용 목록에 추가하다 변경 사항](product-announcements/announcements/proofhq-domain-change-workfront.md)
      * [새로운 Adobe Workfront 경험에서 공지 센터 메시지 구독 취소](product-announcements/announcements/unsubscribe-from-ac-messages.md)
      * 발표 아카이브 {#announcement-archive}
         * [발표 아카이브](product-announcements/announcements/announcement-archive/announcement-archive.md)
         ...
         * [요청 큐의 POP 이메일을 21.1로 대체하기 위한 새로운 Adobe Workfront 관리 시스템](product-announcements/announcements/announcement-archive/pop-removal-request-queue.md)
         * [21.1 릴리스를 통해 Adobe Workfront 이메일의 새 IP 주소](product-announcements/announcements/announcement-archive/new-email-ip-21.1.md)
         * [이메일 스푸핑 및 POP 회신 제거](product-announcements/announcements/announcement-archive/email-spoofing-pop-reply-message.md)
         * [클러스터 1, 2 및 3의 고객은 Adobe Workfront 서비스허용 목록에 추가하다가 차단되지 않도록 모든 IP 블록을 업데이트해야 합니다](product-announcements/announcements/announcement-archive/clusters-1-3-update-whitelist.md)
         * [사용자 지정 SMTP를 발신 전자 메일 옵션으로 제거](product-announcements/announcements/announcement-archive/remove-custom-smtp.md)
   * 베타 프로그램 {#beta}
...
* 관리 및 설정 {#administration-and-setup}
   ...
   * 관리 시작 {#get-started-administration}
      ...
      * [방화벽 허용 목록에 추가하다 구성](administration-and-setup/get-started-wf-administration/configure-your-firewall.md)
      * [이메일 허용 목록에 추가하다 구성](administration-and-setup/get-started-wf-administration/configure-your-email-allowlist.md)
      ...
      * [플랫폼 기반의 차이점](administration-and-setup/get-started-wf-administration/actions-in-admin-console.md)
   * Workfront 설정 {#set-up-wf}
      ...
      * 시스템 기본값 구성 {#configure-system-defaults}
         ...
         * [비용 유형 만들기](administration-and-setup/set-up-workfront/configure-system-defaults/create-custom-expense-types.md)
         * [스코어카드 만들기](administration-and-setup/set-up-workfront/configure-system-defaults/create-scorecard.md)
         * [프로젝트 타임라인 다시 계산](administration-and-setup/set-up-workfront/configure-system-defaults/configure-timeline-recalculations-projects.md)
         * [프로젝트에 대한 사용자 지정 분기](administration-and-setup/set-up-workfront/configure-system-defaults/enable-custom-quarters-projects.md)
      * 일정 및 작업표 환경 설정 구성 {#configure-timesheets-schedules}
         * [일정 및 작업표 환경 설정 구성](administration-and-setup/set-up-workfront/configure-timesheets-schedules/configure-timesheets-and-schedules.md)
         * [예약 개요](administration-and-setup/set-up-workfront/configure-timesheets-schedules/schedules-overview.md)
         ...
         * [작업표 및 시간 기본 설정](administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md)
      ...
      * 조직 설정 {#organization-setup}
         ...
         * [직무 역할 청구 비율 대체](administration-and-setup/set-up-workfront/organizational-setup/override-job-role-billing-rates-company-level.md)
      ...
      * Adobe Workfront 테스트 환경 {#testing-environments}
         ...
         * [샌드박스 환경 미리 보기](administration-and-setup/set-up-workfront/workfront-testing-environments/wf-preview-sandbox-environment.md)
         * [사용자 지정 새로 고침 샌드박스 환경](administration-and-setup/set-up-workfront/workfront-testing-environments/wf-custom-refresh-sandbox-environment.md)
   * 사용자 추가 {#add-users}
      ...
      * 사용자 만들기 및 관리 {#create-manage-users}
         ...
         * [직접 보고서 만들기](administration-and-setup/add-users/create-and-manage-users/create-direct-reports.md)
         * [다른 사용자로 로그인](administration-and-setup/add-users/create-and-manage-users/log-in-as-another-user.md)
         * [사용자의 환경 설정 재설정](administration-and-setup/add-users/create-and-manage-users/reset-a-users-preferences.md)
         ...
         * [사용자 특성 매핑](administration-and-setup/add-users/create-and-manage-users/map-user-attributes.md)
      ...
      * 액세스 수준 작동 방식 {#access-levels}
         ...
         * [라이선스 유형별 개체 액세스](administration-and-setup/add-users/access-levels-and-object-permissions/access-to-objects-and-areas-by-license-type.md)
      ...
      * Workfront에 대한 액세스 구성 {#configure-access}
         ...
         * [관리자 액세스 권한 부여](administration-and-setup/add-users/configure-and-grant-access/grant-a-user-full-administrative-access.md)
         ...
         * [보고서, 대시보드, 달력에 대한 액세스 권한 부여](administration-and-setup/add-users/configure-and-grant-access/grant-access-reports-dashboards-calendars.md)
      ...
      * Adobe Workfront에서 단일 사인온 {#sso}
         * [단일 사인온](administration-and-setup/add-users/single-sign-on/single-sign-on.md)
         * [단일 사인온 개요](administration-and-setup/add-users/single-sign-on/sso-in-workfront.md)
         ...
         * [Workfront 및 SAML 2.0용 Outlook 활성화](administration-and-setup/add-users/single-sign-on/enable-outlook-for-use-w-wf-and-saml-2.md)
   ...
   * Adobe Workfront 사용자 지정 {#customize}
      ...
      * 레이아웃 템플릿 {#layout-templates}
         ...
         * [기본 메뉴 사용자 정의](administration-and-setup/customize-workfront/use-layout-templates/customize-main-menu.md)
         ...
         * [홈 및 요약 사용자 지정](administration-and-setup/customize-workfront/use-layout-templates/customize-home-summary-layout-template.md)
         * [고정된 페이지 사용자 지정](administration-and-setup/customize-workfront/use-layout-templates/customize-pinned-pages.md)
         * [필터, 보기, 그룹화 사용자 지정](administration-and-setup/customize-workfront/use-layout-templates/customize-fvg-list-controls-layout-template.md)
         * [사용자 인터페이스 용어 사용자 지정](administration-and-setup/customize-workfront/use-layout-templates/customize-terminology.md)
      ...
      * 사용자 정의 양식 {#custom-forms}
         ...
         * 기존 사용자 지정 양식 빌더 {#custom-form-builder}
            * 사용자 지정 양식 빌더 사용 {#use-the-custom-form-builder}
               * [기존 사용자 지정 양식 빌더 사용](administration-and-setup/customize-workfront/create-manage-custom-forms/use-the-custom-form-builder.md)
               * [기존 빌더로 사용자 지정 양식 만들기 또는 편집](administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md)
               * [사용자 지정 양식을 복사하여 기존 빌더로 새 양식 만들기](administration-and-setup/customize-workfront/create-manage-custom-forms/copy-custom-form-to-create-a-new-one.md)
               * [사용자 지정 필드 추가](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-custom-field-to-a-custom-form.md)
               * [이전 빌더를 사용하여 이미지 또는 기타 자산 위젯을 사용자 지정 양식에 추가합니다](administration-and-setup/customize-workfront/create-manage-custom-forms/add-widget-or-edit-its-properties-in-a-custom-form.md)
               * [기존 빌더로 섹션 브레이크 추가](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-section-break-to-a-custom-form.md)
               ...
               * [기존 계산된 사용자 지정 필드를 기존 빌더로 재사용](administration-and-setup/customize-workfront/create-manage-custom-forms/use-existing-calc-field-new-custom-form.md)
               * [기존 빌더를 사용하여 사용자 지정 필드 및 위젯을 배치합니다](administration-and-setup/customize-workfront/create-manage-custom-forms/position-fields-in-a-custom-form.md)
               * [기존 빌더와 사용자 지정 필드 및 위젯에 대한 공유](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
               * [기존 빌더로 사용자 지정 필드 또는 위젯 재사용](administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
               * [기존 빌더를 사용하여 표시 로직을 추가하고 논리를 건너뜁니다](administration-and-setup/customize-workfront/create-manage-custom-forms/display-or-skip-logic-custom-form.md)
               * [기존 빌더로 사용자 지정 양식 미리 보기 및 완료](administration-and-setup/customize-workfront/create-manage-custom-forms/preview-and-complete-a-custom-form.md)
               * [기존 빌더를 사용하여 사용자 지정 양식에서 개체 유형 삭제](administration-and-setup/customize-workfront/create-manage-custom-forms/delete-object-type-on-a-custom-form.md)
         * 양식 디자이너 {#form-designer}
            ...
            * 사용자 지정 양식 디자인 {#design-a-form}
               ...
               * [양식 디자이너를 사용하여 복사본에서 양식 디자인](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-from-copy.md)
            ...
            * 양식 관리 {#manage-a-form}
               ...
               * [양식 디자이너를 사용하여 기존 사용자 지정 양식에서 개체 유형을 추가하거나 삭제합니다](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/manage-a-form/add-or-remove-objects-from-a-form.md)
               * [양식 디자이너를 사용하여 사용자 지정 양식 이름 바꾸기](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/manage-a-form/rename-a-custom-form.md)
         * 사용자 지정 양식 관리 {#manage-custom-forms}
            * [사용자 지정 양식 및 필드 관리](administration-and-setup/customize-workfront/create-manage-custom-forms/manage-custom-forms-toc.md)
            * [사용자 지정 양식 공유](administration-and-setup/customize-workfront/create-manage-custom-forms/share-access-to-a-custom-form.md)
            * [사용자 지정 필드에 대한 액세스](administration-and-setup/customize-workfront/create-manage-custom-forms/access-for-a-shared-custom-form-you-want-to-use.md)
            * [사용자 지정 양식 비활성화 또는 다시 활성화](administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/manage-a-form/activate-deactivate-form.md)
            * [보고서에서 사용자 지정 양식 참조](administration-and-setup/customize-workfront/create-manage-custom-forms/reference-custom-forms-in-report.md)
            * [사용자 지정 필드 또는 위젯을 사용하는 보고서 보기](administration-and-setup/customize-workfront/create-manage-custom-forms/view-all-reports-that-use-a-particular-custom-field.md)
            * [사용자 지정 필드 또는 위젯을 사용하는 사용자 지정 양식 보기](administration-and-setup/customize-workfront/create-manage-custom-forms/view-all-custom-forms-that-use-a-particular-custom-field.md)
            * [개체를 변환할 때 사용자 지정 양식 데이터 전송](administration-and-setup/customize-workfront/create-manage-custom-forms/transfer-custom-form-data-larger-item.md)
            * [사용자 지정 필드, 섹션 브레이크 또는 위젯의 속성 편집](administration-and-setup/customize-workfront/create-manage-custom-forms/edit-a-custom-field.md)
            ...
            * [사용자 지정 양식 삭제](administration-and-setup/customize-workfront/create-manage-custom-forms/delete-or-deactivate-a-custom-form.md)
            * [API의 리치 텍스트 필드 저장소](administration-and-setup/customize-workfront/create-manage-custom-forms/rich-text-field-storage-in-the-api.md)
      * 상태 및 우선순위 레이블 {#statuses-priority-labels}
         ...
         * [사용자 지정 상태 기본 상태 만들기](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/use-custom-statuses-as-default-statuses.md)
      ...
      * 승인 프로세스 및 이정표 페이지 {#approvals-milestones}
         * [승인 프로세스 및 이정표 경로](administration-and-setup/customize-workfront/configure-approval-milestone-processes/config-approval-milestone-paths.md)
         ...
         * [변경 사항이 지정된 승인 프로세스에 미치는 영향](administration-and-setup/customize-workfront/configure-approval-milestone-processes/how-changes-affect-group-approvals.md)
      ...
      * 사용자 지정 조건 만들기 및 관리 {#custom-conditions}
         ...
         * [조건을 프로젝트의 기본값으로 설정](administration-and-setup/customize-workfront/create-manage-custom-conditions/set-custom-condition-default-projects.md)
         * [조건을 작업 및 문제에 대한 기본값으로 설정](administration-and-setup/customize-workfront/create-manage-custom-conditions/set-custom-condition-default-tasks-issues.md)
   ...
   * Adobe Workfront 관리 {#manage-wf}
      ...
      * 언어 교정 기능 구성 {#configure-proofing}
         * [언어 교정 구성](administration-and-setup/manage-workfront/configure-proofing/configuring-proofing-functionality.md)
         * [증명 설정](administration-and-setup/manage-workfront/configure-proofing/configure-proofing-organization.md)
         * [Workfront과 Workfront 증명 간 사용자 동기화](administration-and-setup/manage-workfront/configure-proofing/user-sync-proofing.md)
         * [언어 교정 액세스](administration-and-setup/manage-workfront/configure-proofing/access-to-proofing-functionality.md)
         * [데스크탑 언어 교정 뷰어](administration-and-setup/manage-workfront/configure-proofing/install-desktop-proofing-viewer-org.md)
         * [언어 교정 역할](administration-and-setup/manage-workfront/configure-proofing/configure-default-proofing-roles.md)
         * [기본 증명 설정 구성](administration-and-setup/manage-workfront/configure-proofing/configure-default-proof-settings.md)
         * [증명 전자 메일 알림 설정](administration-and-setup/manage-workfront/configure-proofing/configure-default-proof-email-notification-settings.md)
         * [사용자의 언어 교정 액세스 구성](administration-and-setup/manage-workfront/configure-proofing/configure-a-users-proofing-access.md)
         * [증명 공유](administration-and-setup/manage-workfront/configure-proofing/configure-sharing-settings-users.md)
         * [자동화된 워크플로우 템플릿](administration-and-setup/manage-workfront/configure-proofing/create-manage-automated-workflow-templates.md)
      ...
      * 이메일 {#emails}
         ...
         * [이벤트 통지 제목 줄](administration-and-setup/manage-workfront/emails/custom-email-subjects-event-notification.md)
         * [사용자의 전자 메일 알림 설정 수정](administration-and-setup/manage-workfront/emails/modify-email-notification-settings-user-profiles.md)
         ...
         * [Workfront에서 보낸 이메일](administration-and-setup/manage-workfront/emails/allow-emails-from-wf-app.md)
         * [새 사용자에게 보내는 이메일 초대](administration-and-setup/manage-workfront/emails/manage-email-invitations.md)
      * 보안 {#security}
         ...
         * [단일 사인온 옵션 제거](administration-and-setup/manage-workfront/security/removal-various-sso-options.md)
         ...
         * [IP 주소별 Workfront 액세스 제한](administration-and-setup/manage-workfront/security/restrict-access-workfront-ip-address.md)
         ...
         * [고급 인증을 사용할 때 IDP에서 SAML 2.0 메타데이터 업데이트](administration-and-setup/add-users/single-sign-on/update-saml-2-metadata-ip-eauth-.md)
      * 환율 {#exchange-rates}
      ...
      * 삭제된 항목 관리 {#manage-deleted-items}
         ...
         * [삭제된 개체가 개체에 미치는 영향](administration-and-setup/manage-workfront/manage-deleted-items/configure-how-hours-affected-when-obj-deleted-restored.md)
      ...
      * 진단 {#diagnostics}
         ...
         * [진단을 사용하여 자동화를 트리거합니다.](administration-and-setup/manage-workfront/run-diagnostics/use-diagnostics-to-trigger-automated-processes.md)
      * 킥스타트 {#kick-starts}
         * [킥스타트](administration-and-setup/manage-workfront/using-kick-starts/kick-starts.md)
         * [Kick-Starts를 통해 Workfront 데이터 내보내기](administration-and-setup/manage-workfront/using-kick-starts/export-data-from-wf-via-kick-starts.md)
         * [킥시작 템플릿을 사용하여 데이터 가져오기](administration-and-setup/manage-workfront/using-kick-starts/import-data-via-kickstarts.md)
         * [데이터 가져오기 시작](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-data-importer.md)
         * [킥시작 시나리오: 회사 및 그룹](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-company-group-role-user-prep.md)
         * [킥시작 시나리오: Workfront에 여러 옵션 사용자 지정 필드 가져오기](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-multiple-option-custom-field-import.md)
         * [킥시작 시나리오: 개체 가져오기](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-simple-project-task-import-prep.md)
         * [킥시작 FAQ](administration-and-setup/manage-workfront/using-kick-starts/frequently-asked-questions-about-kick-starts.md)
   * 그룹 관리 {#manage-groups}
      ...
      * 그룹 만들기 및 관리 {#create-manage-groups}
         ...
         * [하위 그룹 환경 설정의 구성 잠금 해제](administration-and-setup/manage-groups/create-and-manage-groups/lock-or-unlock-a-group-preference.md)
         * [작업표 및 시간 환경 설정 그룹화](administration-and-setup/manage-groups/create-and-manage-groups/configure-timesheet-hour-preferences-group.md)
         * [작업표 잠금 해제 및 시간 기본 설정](administration-and-setup/manage-groups/create-and-manage-groups/lock-or-unlock-a-group-timesheet-hour-preference.md)
         * [그룹 이동](administration-and-setup/manage-groups/create-and-manage-groups/move-a-group.md)
         * [그룹 비활성화 또는 다시 활성화](administration-and-setup/manage-groups/create-and-manage-groups/deactivate-or-reactivate-a-group.md)
      ...
      * 그룹 상태 관리 {#group-statuses}
         ...
         * [상태 그룹 구성 잠금 해제](administration-and-setup/manage-groups/manage-group-statuses/lock-or-unlock-a-custom-group-status.md)
      ...
      * 그룹의 개체 작업 {#group-objects}
         ...
         * [그룹 예약 관리](administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-schedules.md)
         * [그룹 작업표 프로필 관리](administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-timesheet-profiles.md)
   ...
   * 통합 구성 {#configure-integrations}
      ...
      * [사용자 지정 OAuth2 애플리케이션 보기 및 관리](administration-and-setup/configure-integrations/manage-custom-oauth2-apps.md)
   ...
   * 관리 및 설정에 대한 팁, 요령 및 문제 해결 {#admin-setup-tips}
      * [팁, 요령 및 문제 해결](administration-and-setup/tips-tricks-and-troubleshooting/ttt-admin-setup.md)
      * [그룹 관리자는 관리하는 관리자보다 액세스 권한이 더 높아야 합니다](administration-and-setup/tips-tricks-and-troubleshooting/group-admin-access-level.md)
      ...
      * [자동 제공된 사용자가 로그인할 수 없음](administration-and-setup/tips-tricks-and-troubleshooting/error-auto-provisioned-user-cant-log-in.md)
      * [XML 디지털 서명의 유효성을 검사할 수 없습니다.](administration-and-setup/tips-tricks-and-troubleshooting/error-message-couldnt-validate-xml-digital-signature.md)
      * [잘못된 매개 변수: 전환 값](administration-and-setup/tips-tricks-and-troubleshooting/error-message-invalid-parameter-conversion-value.md)
      ...
      * [SAML 2.0: 기본 상태 코드](administration-and-setup/tips-tricks-and-troubleshooting/error-message-saml-2-error-primary-statuscode.md)
      ...
      * [액세스 수준에서 외부 라이선스가 누락됨](administration-and-setup/tips-tricks-and-troubleshooting/external-user-license-type-missing-from-access-levels.md)
      * [이전 데이터 검색](administration-and-setup/tips-tricks-and-troubleshooting/how-to-get-data-out-of-wf.md)
      * [필드가 잘못되었습니다. emailAddr](administration-and-setup/tips-tricks-and-troubleshooting/login-error-following-field-invalid-emailaddr-cant-be-null.md)
      ...
      * [인증되지 않은 전자 메일이 수락되지 않음](administration-and-setup/tips-tricks-and-troubleshooting/unauthenticated-email-not-accepted-domains-dmarc-policy.md)
...
* Adobe Workfront 기본 사항 {#basics}
   ...
   * Adobe Workfront 탐색 {#navigate}
      ...
      * Adobe Workfront의 최근 및 즐겨찾기 {#recents-and-favorites}
         * [Adobe Workfront의 최근 및 즐겨찾기](workfront-basics/navigate-workfront/recent-and-favorites/recent-and-favorites.md)
      ...
      * Adobe Workfront의 목록 {#lists-in-adobe-workfront}
         ...
         * [Adobe Workfront의 목록에서 인라인 편집 항목](workfront-basics/navigate-workfront/use-lists/inline-edit-objects.md)
      ...
      * [위쪽 탐색 모음 개요](workfront-basics/the-new-workfront-experience/global-navigation-overview.md)
      * [Adobe Workfront의 왼쪽 탐색](workfront-basics/the-new-workfront-experience/simplified-left-navigation.md)
      ...
      * [페이지를 고정하여 작업 공간 사용자 지정](workfront-basics/the-new-workfront-experience/pin-pages.md)
      ...
      * [리뷰 라이선스 사용자의 탐색 이해](workfront-basics/navigate-workfront/workfront-navigation/reviewer-global-navigation-bar.md)
   ...
   * 홈 {#home}
      ...
      * 홈 영역 사용 {#use-home-area}
         ...
         * [홈 영역의 작업 목록에 항목을 표시합니다.](workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md)
         ...
         * [홈 영역에서 작업 항목에 대한 로그 시간](workfront-basics/using-home/using-the-home-area/log-time-on-work-item-in-home.md)
         * [홈 영역에서 완료 로 항목 표시](workfront-basics/using-home/using-the-home-area/mark-item-done-in-home.md)
         * [홈 달력 보기](workfront-basics/using-home/using-the-home-area/home-calendar-view.md)
         * [홈 달력 보기 설정 구성](workfront-basics/using-home/using-the-home-area/configure-home-calendar-view.md)
         * [검토자용 홈 영역](workfront-basics/using-home/using-the-home-area/home-for-reviewers.md)
         * [홈 달력 보기 사용](workfront-basics/using-home/using-the-home-area/use-home-calendar-view.md)
         * [홈 달력 보기](workfront-basics/using-home/using-the-home-area/view-home-calendar.md)
   ...
   * 개체에 권한 부여 및 요청 {#grant-request-object-permissions}
   ...
   * 계정 및 프로필 관리 {#manage-account-profile}
      ...
      * 사용자 프로필 구성 {#configure-user-profile}
         ...
         * [Adobe Workfront에서 개인 시간 설정](workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/personal-time-overview.md)
      * Adobe Workfront 계정 관리 {#manage-workfront-account}
         ...
         * [Adobe Workfront에서 로그아웃됨](workfront-basics/manage-your-account-and-profile/managing-your-workfront-account/log-out-of-workfront.md)
         * [이메일 초대 받기 및 Adobe Workfront용 암호 만들기](workfront-basics/manage-your-account-and-profile/managing-your-workfront-account/receive-email-invitations.md)
   ...
   * 모바일 앱 {#mobile-apps}
      ...
      * Adobe Workfront 모바일 앱 사용 {#use-workfront-mobile-app}
         ...
         * [Android에서 증명에 주석 달기](workfront-basics/mobile-apps/using-the-workfront-mobile-app/comment-on-proofs-android.md)
         * [iOS에서 증명에 댓글 달기](workfront-basics/mobile-apps/using-the-workfront-mobile-app/comment-on-proofs-ios.md)
         * [모바일 장치 관리를 위한 Adobe Workfront(MDM)](workfront-basics/mobile-apps/using-the-workfront-mobile-app/wf-mdm.md)
      ...
      * Adobe Workfront 보기 사용 {#use-workfront-view}
         ...
         * [프로젝트 세부 사항 보기에서 위젯 업데이트](workfront-basics/mobile-apps/using-workfront-view/update-widgets-in-workfront-view.md)
      ...
      * Adobe Workfront 모바일 앱에 대한 팁, 요령 및 문제 해결 {#tips-tricks-for-mobile-apps}
         ...
         * [Adobe Workfront 모바일 앱의 오류 메시지: &quot;계정이 API가 활성화되지 않았습니다.&quot;](workfront-basics/mobile-apps/tips-tricks-and-troubleshooting/error-message-on-mobile-app.md)
   * Adobe Workfront 기본 사항에 대한 팁, 요령 및 문제 해결 {#tips-tricks-for-basics}
      ...
      * [Adobe Workfront에서 도움말 찾기 빠른 안내](workfront-basics/tips-tricks-and-troubleshooting/guide-for-help-in-workfront.md)
...
* 애자일 {#agile}
   ...
   * 애자일 팀의 간판 {#kanban}
      ...
      * [간판 보드의 기존 스토리에 하위 태스크를 추가합니다](agile/use-kanban-in-an-agile-team/add-a-subtask-to-an-existing-story.md)
      * [간판 보드에 기존 작업 또는 문제 추가](agile/use-kanban-in-an-agile-team/add-existing-tasks-or-issues-to-the-kanban-board.md)
      ...
      * [간판 보드에서 이야기와 문제 추가](agile/use-kanban-in-an-agile-team/add-story-from-kanban-board.md)
      * [간판 보드의 진행 중인 작업(WIP) 한도 관리](agile/use-kanban-in-an-agile-team/work-in-progress-limit-on-the-kanban-board.md)
      * [간판 보드에서 스토리 재정렬](agile/use-kanban-in-an-agile-team/reorder-stories-on-the-kanban-board.md)
      * [간판 보드의 스토리 상태 업데이트](agile/use-kanban-in-an-agile-team/update-the-status-of-stories.md)
      * [간판 보드의 스토리에 플래그 사용](agile/use-kanban-in-an-agile-team/use-flags-on-stories.md)
      * [간판 보드에 백로그를 추가합니다](agile/use-kanban-in-an-agile-team/view-the-backlog-on-the-kanban-board.md)
      * [간판 보드에서 스토리 삭제](agile/use-kanban-in-an-agile-team/delete-story-from-kanban-board.md)
   * 애자일 팀의 스크럼 {#scrum}
      ...
      * 번다운 {#burndown}
         ...
         * [Agile Burndown 차트 개요](agile/use-scrum-in-an-agile-team/burndown/burndown-chart-overview.md)
         ...
         * [번다운 차트에 대체 팀 스케줄 사용](agile/use-scrum-in-an-agile-team/burndown/use-alt--team-schedule-burndown-charts.md)
      * 반복 {#iterations}
      ...
      * 스크럼 보드 {#scrum-board}
         ...
         * [스크럼 보드의 색상별로 이야기를 분류합니다](agile/use-scrum-in-an-agile-team/scrum-board/categorize-stories-by-color.md)
         * [스크럼 보드의 이야기 순서 변경](agile/use-scrum-in-an-agile-team/scrum-board/change-order-of-stories.md)
         * [스크럼 보드의 사용자별로 필터링](agile/use-scrum-in-an-agile-team/scrum-board/filter-by-user-scrum-board.md)
         * [스크럼 보드에서 이야기와 문제 추가](agile/use-scrum-in-an-agile-team/scrum-board/add-story-from-scrum-board.md)
         * [Screm 보드에서 스토리 및 문제 관리](agile/use-scrum-in-an-agile-team/scrum-board/manage-scrum-board.md)
         * [스크럼 보드의 스토리 및 하위 작업 상태 업데이트](agile/use-scrum-in-an-agile-team/scrum-board/update-status-of-stories-and-subtasks.md)
         * [스크럼 보드에서 스토리 정보 보기 및 편집](agile/use-scrum-in-an-agile-team/scrum-board/view-and-edit-story-info.md)
   * 민첩한 환경에서 작업 {#work-in-agile-environment}
   ...
   * 민첩한 팁, 요령 및 문제 해결 {#tips-tricks-agile}
...
* 문서 {#documents}
   ...
   * 문서 관리 {#manage-documents}
      ...
      * [문서 폴더에 대한 링크 복사 및 공유](documents/managing-documents/copy-a-doc-folder-url.md)
   ...
   * Adobe Workfront 내 Workfront DAM {#wf-dam-within-workfront}
      * [Adobe Workfront 내 Workfront DAM](documents/workfront-dam-within-workfront/workfront-dam-in-workfrontt.md)
   ...
   * Workfront 및 Experience Manager Assets 통합 {#wf-aem-integrations}
      ...
      * Workfront for Experience Manager 고급 커넥터 {#wf-aem-enhanced-connector}
         ...
         * [Workfront for Experience Manager 고급 커넥터 개요](documents/workfront-and-experience-manager-integrations/workfront-for-experience-manager-enhanced-connector/workfront-aem-enhanced-connector-overview.md)
         * [Workfront for Experience Manager 향상된 커넥터 메타데이터 개요](documents/workfront-and-experience-manager-integrations/workfront-for-experience-manager-enhanced-connector/enhanced-connector-metadata-overview.md)
         * [향상된 커넥터와 자산 및 폴더를 연결합니다](documents/workfront-and-experience-manager-integrations/workfront-for-experience-manager-enhanced-connector/enhanced-connector-link-assets.md)
         * [향상된 커넥터를 사용하여 문서 보내기](documents/workfront-and-experience-manager-integrations/workfront-for-experience-manager-enhanced-connector/enhanced-connector-send-document.md)
         * [향상된 커넥터를 사용하여 연결된 자산 확인](documents/workfront-and-experience-manager-integrations/workfront-for-experience-manager-enhanced-connector/enhanced-connector-proof-asset.md)
         * [향상된 커넥터를 사용하여 연결된 자산 보기 또는 다운로드](documents/workfront-and-experience-manager-integrations/workfront-for-experience-manager-enhanced-connector/enhanced-connector-view-download-asset.md)
      * Experience Manager Assets 및 Assets Essentials용 Adobe Workfront {#wf-aem-essentials}
         ...
         * [Adobe Experience Manager 자산 통합 개요](documents/adobe-workfront-for-experience-manager-assets-essentials/aem-asset-integrations.md)
         * [Experience Manager Assets Essentials에서 자산 및 폴더를 연결합니다](documents/adobe-workfront-for-experience-manager-assets-essentials/link-to-aem.md)
         ...
         * [Experience Manager Assets 또는 Asset Essentials에 연결된 자산 증명](documents/adobe-workfront-for-experience-manager-assets-essentials/proof-linked-asset-aem.md)
   ...
   * 레거시 또는 향상된 커넥터에서 마이그레이션 {#migrate-from-legacy-enhanced-connectors}
      ...
      * [기존 또는 향상된 커넥터에서 Adobe Experience Manager as a Cloud Service 통합을 위한 Workfront으로 마이그레이션합니다](documents/workfront-and-experience-manager-integrations/legacy-enhanced-connector-migration/migrate-to-workfont-integration.md)
      * [레거시 커넥터에서 고급 커넥터로 마이그레이션](documents/workfront-and-experience-manager-integrations/legacy-enhanced-connector-migration/migrate-from-legacy-to-enhanced.md)
      ...
      * [Adobe Experience Manager Enhanced Connector로 Workfront 제거](documents/workfront-and-experience-manager-integrations/legacy-enhanced-connector-migration/uninstall-enhanced-connector.md)
...
* 작업 관리 {#manage-work}
   ...
   * 프로젝트 {#projects}
      ...
      * 프로젝트 계획 {#plan-a-project}
         ...
         * [프로젝트 또는 템플릿에 대한 자원 관리자 지정](manage-work/projects/planning-a-project/designate-resource-managers-for-projects-and-templates.md)
         * [프로젝트 실제 완료 일자 개요](manage-work/projects/planning-a-project/project-actual-completion-date.md)
         * [프로젝트 개요 실제 시작 날짜](manage-work/projects/planning-a-project/project-actual-start-date.md)
         ...
         * [프로젝트, 작업 및 문제에 대한 예상 완료 일자 개요](manage-work/projects/planning-a-project/project-projected-completion-date.md)
         * [프로젝트 진행 상태 개요](manage-work/projects/planning-a-project/project-progress-status.md)
         * [프로젝트 개요 예상 시작 일자](manage-work/projects/planning-a-project/project-projected-start-date.md)
      * 프로젝트 만들기 {#create-projects}
         ...
         * [프로젝트 기준 요소 만들기](manage-work/projects/create-projects/create-baselines.md)
      * 프로젝트에서 작업 업데이트 {#update-work-on-a-project}
      ...
      * 비즈니스 사례 정의 {#define-business-case}
         ...
         * [프로젝트에 대한 비즈니스 사례 생성](manage-work/projects/define-a-business-case/create-business-case.md)
         ...
         * [비즈니스 사례 목표 생성](manage-work/projects/define-a-business-case/create-business-case-goals.md)
         * [비즈니스 사례의 예산 자원](manage-work/projects/define-a-business-case/budget-resources-in-business-case.md)
         * [자원 계획자를 사용하여 업무 사례의 예산 자원](manage-work/projects/define-a-business-case/budget-resources-in-business-case-use-resource-planner.md)
         * [시나리오 계획자를 사용하여 비즈니스 사례의 예산 자원](manage-work/projects/define-a-business-case/budget-resources-in-business-case-use-scenario-planner.md)
         * [프로젝트에 스코어카드를 적용하고 정렬 점수를 생성합니다](manage-work/projects/define-a-business-case/apply-scorecard-to-project-to-generate-alignment-score.md)
         * [비즈니스 사례에 사용자 지정 양식 첨부](manage-work/projects/define-a-business-case/attach-custom-form-to-business-case.md)
         * [프로젝트에서 위험 요소 생성 및 편집](manage-work/projects/define-a-business-case/create-edit-risks-on-projects.md)
      ...
      * 프로젝트 재무 {#project-finances}
         ...
         * [프로젝트 재무 분야](manage-work/projects/project-finances/project-finances-overview-1.md)
      ...
      * 프로젝트에 대한 팁, 요령 및 문제 해결 {#tips-tricks-troubleshooting-for-projects}
         ...
         * [프로젝트 상태는 완료에서 현재 상태로 변경되지 않습니다](manage-work/projects/tips-tricks-and-troubleshooting/project-status-does-not-change-from-complete-to-current.md)
         * [계산 예 - 작업에서 롤업으로서 EAC 계산](manage-work/projects/tips-tricks-and-troubleshooting/calculate-eac-by-rolling-up-from-tasks-example.md)
   ...
   * 작업 {#tasks}
      ...
      * 작업 기간 및 기간 유형 {#task-duration-and-duration-types}
         ...
         * [기간 유형 개요: 작업 기반](manage-work/tasks/taskdurtn/effort-driven.md)
         * [기간 유형 개요: 계산된 작업 시간](manage-work/tasks/taskdurtn/calculated-work.md)
         ...
         * [단순 기간 유형으로 작업의 계획 시간 및 기간 업데이트](manage-work/tasks/taskdurtn/update-planned-hours-duration-for-simple-duration-task.md)
         * [Adobe Workfront 및 Microsoft 프로젝트의 기간 유형](manage-work/tasks/taskdurtn/workfront-ms-project-duration-types.md)
      * 작업 선행 작업 사용 {#use-task-predecessors}
         * [작업 선행 작업 사용](manage-work/tasks/use-prdcssrs/use-task-predecessors.md)
         * [작업 선행 작업 개요](manage-work/tasks/use-prdcssrs/predecessors-overview.md)
         * [작업 목록에서 선행 관계 만들기](manage-work/tasks/use-prdcssrs/create-predecessors-on-task-list.md)
         * [선행 작업 영역을 사용하여 선행 관계 만들기](manage-work/tasks/use-prdcssrs/create-predecessors-in-predecessors-area.md)
         * [작업을 체인화하여 이전 관계 생성](manage-work/tasks/use-prdcssrs/create-predecessors-by-chaining-tasks.md)
         * [프로젝트 간 선행 작업 만들기](manage-work/tasks/use-prdcssrs/cross-project-predecessors.md)
         * [작업 종속성 유형 개요](manage-work/tasks/use-prdcssrs/task-dependency-types.md)
         * [선행 작업 적용](manage-work/tasks/use-prdcssrs/enforced-predecessors.md)
   ...
   * 문제 {#issues}
      ...
      * 변환 문제 {#convert-issues}
         * [변환 문제](manage-work/issues/convert-issues/convert-issues-overview.md)
         * [Adobe Workfront의 변환 문제 개요](manage-work/issues/convert-issues/convert-issues.md)
         ...
         * [해결 가능한 객체 해결 및 해결 방법 개요](manage-work/issues/convert-issues/resolving-and-resolvable-objects.md)
         * [해결 중인 개체에서 연결 해제 문제](manage-work/issues/convert-issues/unlink-issues-from-resolvable-objects.md)
   ...
   * 간트 차트 {#the-gantt-chart}
      ...
      * Gantt 차트 개요 {#gantt-chart-overview}
         * [Gantt 차트 개요](manage-work/gantt-chart/use-the-gantt-chart/gantt-chart-overview.md)
         * [Gantt 차트 시작](manage-work/gantt-chart/use-the-gantt-chart/get-started-with-gantt.md)
         * [Gantt 차트에 정보가 표시되는 방식을 구성합니다](manage-work/gantt-chart/use-the-gantt-chart/configure-info-on-gantt-chart.md)
         * [간트 차트에서 정보 보기](manage-work/gantt-chart/use-the-gantt-chart/view-info-in-gantt.md)
         * [작업 목록 Gantt 차트의 정보 업데이트](manage-work/gantt-chart/use-the-gantt-chart/update-info-task-list-gantt.md)
         * [간트 차트의 레벨 리소스](manage-work/gantt-chart/use-the-gantt-chart/level-resources-in-gantt.md)
   ...
   * 포트폴리오 관리 {#portfolio-management}
      ...
      * 프로그램 만들기 및 관리 {#create-and-manage-programs}
      ...
      * Portfolio 최적기에서 프로젝트 관리 {#manage-projects-in-portfolio-optimizer}
         * [Portfolio 최적기에서 프로젝트 관리](manage-work/portfolios/portfolio-optimizer/manage-projects-in-portfolio-optimizer.md)
         * [Portfolio 최적화 프로그램 개요](manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md)
         * [Portfolio 최적기 찾기](manage-work/portfolios/portfolio-optimizer/locate-portfolio-optimizer.md)
         * [Portfolio 최적기 점수 개요](manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-score.md)
         * [Portfolio 최적기에서 프로젝트 우선 순위 지정](manage-work/portfolios/portfolio-optimizer/prioritize-projects-in-portfolio-optimizer.md)
         * [Portfolio 최적기에서 프로젝트 최적화](manage-work/portfolios/portfolio-optimizer/optimize-projects-in-portfolio-optimizer.md)
         * [포트폴리오의 순 가치 평가](manage-work/portfolios/portfolio-optimizer/calculate-risk-to-net-value-in-portfolio.md)
   * 요청 {#requests}
      * [요청](manage-work/requests/requests-overview.md)
      * 요청 큐 만들기 및 관리 {#create-and-manage-request-queues}
      ...
      * 요청 만들기 {#create-requests}
         ...
         * [사용자가 요청 큐 프로젝트에 문제를 이메일로 보낼 수 있도록 설정](manage-work/requests/create-requests/enable-email-issues-into-projects.md)
         * [제출된 요청 찾기](manage-work/requests/create-requests/locate-submitted-requests.md)
         * [요청 큐에 대한 링크 공유](manage-work/requests/create-requests/share-link-to-request-queue.md)
...
* 팀 및 그룹 {#teams-groups}
   ...
   * 팀 만들기 및 관리 {#create-manage-teams}
      ...
      * [Work On It 단추를 시작 단추로 바꿉니다.](people-teams-and-groups/create-and-manage-teams/work-on-it-button-to-start-button.md)
   * 다른 사용자와 직접 작업 {#work-with-others}
      ...
      * [다른 사용자에게 직접 메시지 보내기](people-teams-and-groups/work-directly-with-others/send-direct-messages-to-other-users.md)
   ...
   * 그룹 및 팀과 작업 {#work-with-groups-teams}
      ...
      * [Adobe Workfront의 그룹과 팀](people-teams-and-groups/work-with-groups-and-teams/understanding-differences-and-similarities-between-groups-and-teams.md)
...
* 보고 {#reporting}
   ...
   * 보고 캔버스 {#reporting-canvas}
      ...
      * 테이블 블록 {#table-blocks}
         ...
         * [보고 캔버스에서 테이블 행 그룹화](reports-and-dashboards/reporting-canvas/table-blocks/group-rows-in-table.md)
   ...
   * 보고서 {#reports}
      ...
      * 보고서에서 계산된 사용자 지정 데이터 {#calculated-custom-data}
         ...
         * [계산된 사용자 지정 표현식의 조건 연산자](reports-and-dashboards/reports/calc-cstm-data-reports/condition-operators-calculated-custom-expressions.md)
         * [&quot;IF&quot; 문 개요](reports-and-dashboards/reports/calc-cstm-data-reports/if-statements-overview.md)
         * [계산된 사용자 지정 필드 예: 문제 사용자 지정 양식에 문제 작성자의 관리자를 표시합니다.](reports-and-dashboards/reports/calc-cstm-data-reports/custom-field-manager-issue-creator-on-issue-form.md)
         * [계산된 사용자 지정 필드 예: 사용자 지정 양식에 상태 타임스탬프 표시](reports-and-dashboards/reports/calc-cstm-data-reports/example-status-timestamp-in-calculated-field.md)
         * [계산된 사용자 지정 필드 예: 필드의 편집 기록 표시](reports-and-dashboards/reports/calc-cstm-data-reports/calculated-field-example-edit-history-of-another-field.md)
      ...
      * 보고서 사용량 개요 {#report-usage-overview}
      ...
      * 캘린더 {#calendars}
         ...
         * [달력 보고서에서 계획 일자 사용](reports-and-dashboards/reports/calendars/use-planned-dates.md)
         * [달력 보고서에서 예상 날짜 사용](reports-and-dashboards/reports/calendars/use-projected-dates.md)
      ...
      * 보고서에 대한 팁, 요령 및 문제 해결 {#troubleshooting-tips-tricks-reports}
         ...
         * [달력에 오류 메시지: &quot;이 달력에 비활성화된 사용자의 보기 권한이 있습니다.&quot;](reports-and-dashboards/reports/tips-tricks-and-troubleshooting/error-message-calendar.md)
         ...
         * [인라인 편집 날짜 이동 달력 표시 형식](reports-and-dashboards/reports/tips-tricks-and-troubleshooting/date-edits-shift-calendar.md)
         * [공유 열의 데이터는 대시보드 보고서에 표시되지 않습니다](reports-and-dashboards/reports/tips-tricks-and-troubleshooting/shared-columns-not-displayed-in-report-dashboard.md)
   * 대시보드 {#dashboards}
      ...
      * 대시보드 만들기 및 관리 {#create-dashboards}
         ...
         * [대시보드에 외부 웹 페이지 포함](reports-and-dashboards/dashboards/creating-and-managing-dashboards/embed-external-web-page-dashboard.md)
...
* 리소스 관리 {#manage-resources}
   ...
   * 리소스 관리 {#resource-management}
      ...
      * [Adobe Workfront의 리소스 예약 도구 사용 중단](resource-mgmt/resource-mgmt-overview/deprecate-resource-scheduling.md)
      * [자원 스케줄링에서 작업 로드 밸런서로 마이그레이션](resource-mgmt/resource-mgmt-overview/migrate-resource-scheduling-to-workload-balancer.md)
...
* 작업 검토 및 승인 {#review-and-approve-work}
   ...
   * [유료 사용자가 아닌 사용자를 위한 제한된 문서 및 증명 결정 개요](review-and-approve-work/proof-doc-decision-limits.md)
   * 작업 승인 {#work-approvals}
      ...
      * [승인자에게 제출된 승인 알림](review-and-approve-work/manage-approvals/remind-approvers-submitted-approvals.md)
      * [문서 승인을 제출할 추가 승인자 추가](review-and-approve-work/manage-approvals/add-approver-submitted-doc-approvals.md)
      ...
      * [신규 또는 기존 승인 프로세스를 작업물과 연결](review-and-approve-work/manage-approvals/associate-approval-with-work.md)
   ...
   * 증명 {#proofing}
      ...
      * 교정 개요 {#proofing-overview}
         * [교정 개요](review-and-approve-work/proofing/proofing-overview/proofing-basics.md)
         ...
         * [교정을 위한 문서 재처리 개요](review-and-approve-work/proofing/proofing-overview/document-reprocessing-for-proofing.md)
         * [지원되는 언어 교정 파일 형식 및 크기 제한 개요](review-and-approve-work/proofing/proofing-overview/supported-proofing-file-types.md)
         * [증명 보안 개요](review-and-approve-work/proofing/proofing-overview/proof-security-overview.md)
         * [증명 진행 및 상태 개요](review-and-approve-work/proofing/proofing-overview/view-progress-status-proof.md)
         * [Web Proofing Viewer와 Desktop Proofing Viewer 개요의 차이점](review-and-approve-work/proofing/proofing-overview/understand-differences-between-web-viewer.md)
      * 증명 만들기 {#create-proofs}
         * [증명 만들기](review-and-approve-work/proofing/creating-proofs-within-workfront/create-proofs--in-wf.md)
         * [개인 교정 기본값 구성](review-and-approve-work/proofing/creating-proofs-within-workfront/set-proof-defaults.md)
         * [여러 페이지로 구성된 증명 만들기](review-and-approve-work/proofing/creating-proofs-within-workfront/create-multi-page-proof.md)
         * [웹 사이트 또는 기타 웹 컨텐츠에 대한 대화형 증명 만들기](review-and-approve-work/proofing/creating-proofs-within-workfront/generate-interactive-proof-for-website-or-other-web-content.md)
         * [ZIP 파일에서 대화형 컨텐츠에 대한 증명 만들기](review-and-approve-work/proofing/creating-proofs-within-workfront/generate-proof-interactive-content-.md)
      ...
      * Adobe Workfront에서 증명 관리 {#manage-proofs-in-workfront}
         ...
         * 증명 마감일 관리 {#manage-proof-deadlines}
            * [증명 마감일 관리](review-and-approve-work/proofing/managing-proofs-within-workfront/manage-proof-deadlines/manage-proof-deadlines.md)
         ...
         * 자동 증명 관리 {#manage-automated-proofs}
            * [자동 증명 관리](review-and-approve-work/proofing/managing-proofs-within-workfront/manage-automated-proofs/manage-automated-proofs.md)
            * [증명의 자동화된 워크플로우 단계 보기](review-and-approve-work/proofing/managing-proofs-within-workfront/view-aw-stages-proof.md)
            * [증명의 활성 단계 보기](review-and-approve-work/proofing/managing-proofs-within-workfront/view-active-stages-proof.md)
            * [기존 증명을 위한 자동화된 워크플로우 만들기 또는 편집](review-and-approve-work/proofing/managing-proofs-within-workfront/create-edit-automated-workflow-existing-proof.md)
            * [증명 단계 및 검토자 편집](review-and-approve-work/proofing/managing-proofs-within-workfront/edit-proof-stages-and-reviewers.md)
            * [기본 워크플로우를 증명의 자동화된 워크플로우로 변환합니다](review-and-approve-work/proofing/managing-proofs-within-workfront/convert-basic-automatic-workflow.md)
            * [증명의 자동화된 워크플로우에 단계 및 사용자 추가](review-and-approve-work/proofing/managing-proofs-within-workfront/add-stages-users-to-automated-workflow-proof.md)
      * 데스크탑 교정 뷰어 사용 {#use-the-desktop-proofing-viewer}
         * [데스크탑 교정 뷰어 사용](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/use-desktop-proofing-viewer.md)
         * [데스크탑 교정 뷰어 설치](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/installing-desktop-proofing-viewer.md)
         * [데스크탑 교정 뷰어 업데이트](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/update-the-desktop-proofing-viewer.md)
         * [데스크탑 교정 뷰어에서 증명 열기](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/open-proofs-in-dpv.md)
         * [데스크탑 언어 교정 뷰어에서 비대화형 콘텐츠 검토](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/review-non-interactive-content-in-desktop-proofing-viewer.md)
         * [FAQ - 데스크탑 언어 교정 뷰어](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/faq-desktop-proofing-viewer.md)
      * Adobe Workfront에서 증명 검토 {#review-proofs-in-workfront}
         ...
         * 증명 검토 {#review-a-proof}
            ...
            * [증명의 컨텐츠 보기](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/view-a-proof.md)
            * [증명 내의 영역 측정](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/measure-an-area-proof.md)
            * [비디오 증명에서 타임라인의 측정 단위를 변경합니다](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/change-unit-of-measurement-video.md)
            * [비디오 증명의 재생 제어](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/control-playback-video.md)
            ...
            * [증명 내에서 컨텐츠 검색](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/search-in-a-proof.md)
            * [증명 비교](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/compare-proofs.md)
            * [교정 뷰어에서 증명 다운로드](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/download-a-proof-in-viewer.md)
            * [교정 뷰어의 키보드 단축키](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/keyboard-shortcuts-proof.md)
            * [Web Proofing Viewer에서 대화형 콘텐츠 교정 설정](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/interactive-content-in-web-viewer.md)
            * [교정 뷰어에서 증명 공유](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md)
            * [교정 뷰어에서 이전 증명 버전 보기](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/view-previous-version.md)
            * [교정 뷰어에서 대화형 증명 해상도 변경](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/view-interactive-content-as-it-appears-in-device.md)
            * [언어 교정 뷰어 설정 구성](review-and-approve-work/proofing/reviewing-proofs-within-workfront/configure-proofing-viewer-settings.md)
         * 증명에 주석 달기 {#comment-on-a-proof}
            ...
            * [증명 설명 검색, 필터링 및 정렬](review-and-approve-work/proofing/reviewing-proofs-within-workfront/comment-on-a-proof/search-filter-sort-comments.md)
            * [증명 주석 편집](review-and-approve-work/proofing/reviewing-proofs-within-workfront/comment-on-a-proof/edit-a-proof-comment.md)
            * [증명 댓글 해결](review-and-approve-work/proofing/reviewing-proofs-within-workfront/comment-on-a-proof/resolve-proof-comments.md)
            ...
            * [사용자에게 태그를 지정하여 증명 공유](review-and-approve-work/proofing/reviewing-proofs-within-workfront/comment-on-a-proof/tag-users-to-share-proof.md)
         * 증거를 결정하다 {#make-decision-on-proof}
            * [증거를 결정하다](review-and-approve-work/proofing/reviewing-proofs-within-workfront/make-a-decision-on-a-proof/make-decision-on-proof.md)
      ...
      * Adobe Workfront에서 교정을 위한 팁, 요령 및 문제 해결 {#ttt-proofing-in-workfront}
         * [Adobe Workfront 내 언어 교정을 위한 팁, 요령 및 문제 해결](review-and-approve-work/proofing/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-proofing.md)
...
* 타임시트 {#timesheets}
   ...
   * Adobe Workfront에서 작업표 만들기 및 관리 {#create-and-manage-timesheets-in-adobe-workfront}
      ...
      * [작업표의 시간 유형 및 가용성을 정의합니다.](timesheets/create-and-manage-timesheets/define-hour-types-and-availability.md)
      * [단일 사용 작업표 만들기](timesheets/create-and-manage-timesheets/create-tmshts.md)
      * [작업표 정보 편집](timesheets/create-and-manage-timesheets/edit-timesheets.md)
      * [로그 시간](timesheets/create-and-manage-timesheets/log-time.md)
      * [승인을 위한 작업표 제출](timesheets/create-and-manage-timesheets/submit-timesheet-for-approval.md)
      * [작업표 승인](timesheets/create-and-manage-timesheets/timesheet-approvals.md)
      * [작업표에서 총 시간 보기](timesheets/create-and-manage-timesheets/view-total-hours-timesheets.md)
      * [작업표에서 주석 보기 및 관리](timesheets/create-and-manage-timesheets/view-and-manage-comments-timesheets.md)
      * [작업표 프로필 삭제](timesheets/create-and-manage-timesheets/delete-timesheet-profiles.md)
      * [Adobe Workfront에서 작업표 삭제](timesheets/create-and-manage-timesheets/delete-timesheets.md)
      * [작업표 수동으로 생성](timesheets/create-and-manage-timesheets/manually-generate-timesheets.md)
      * [작업표 목록 내보내기](timesheets/create-and-manage-timesheets/export-timesheets.md)
   * 로그된 시간 구성 {#configure-timesheet-preferences}
   ...
   * 작업표에 대한 팁, 요령 및 문제 해결 {#tips-tricks-troubleshooting-for-timesheets}
...
* Adobe Workfront 시나리오 플래너 {#scenario-planner}
   ...
   * [시나리오 계획자 개요](scenario-planner/scenario-planner-overview.md)
   ...
   * [시나리오 계획자에서 계획 시나리오를 생성하고 비교합니다.](scenario-planner/create-and-compare-scenarios-for-a-plan.md)
   ...
   * [시나리오 계획자에서 계획 삭제](scenario-planner/delete-plans.md)
   ...
   * [시나리오 계획자의 계획 개요](scenario-planner/plans-overview.md)
   ...
   * [시나리오 플래너의 계획에 대한 액세스 요청](scenario-planner/request-access-to-plan.md)
   * [시나리오 계획자에서 이니셔티브 충돌 해결](scenario-planner/resolve-conflicts-in-sp.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Adobe Workfront Fusion 시작 {#get-started-with-workfront-fusion}
      ...
      * [Adobe Workfront Fusion 액세스를 위한 IP 주소](workfront-fusion/get-started/ip-addresses-for-fusion.md)
      * [Adobe Workfront Fusion 라이센스](workfront-fusion/get-started/license-automation-vs-integration.md)
   ...
   * Adobe Experience Cloud의 Adobe Workfront Fusion {#fusion-in-experience-cloud}
      * [Adobe Experience Cloud에서 Adobe Workfront Fusion](workfront-fusion/fusion-in-admin-console/fusion-in-admin-console.md)
      ...
      * [Adobe Admin Console을 통해 Adobe Workfront Fusion의 사용자 삭제](/help/quicksilver/workfront-fusion/fusion-in-admin-console/delete-fusion-users-admin-console.md)
      * [플랫폼 기반의 관리 차이점(Adobe Workfront Fusion/Adobe Business Platform)](/help/quicksilver/workfront-fusion/fusion-in-admin-console/fusion-adobe-admin-console.md)
   * Adobe Workfront Fusion의 연결 {#connections-in-fusion}
      ...
      * [API 토큰 인증을 사용하는 웹 서비스에 Adobe Workfront Fusion을 연결합니다](workfront-fusion/connections/connect-wf-web-service-uses-api-token-auth.md)
      * [업데이트된 보안 조치로 Adobe Workfront Fusion을 Google Services에 연결](workfront-fusion/connections/connect-to-google-with-new-security-measures.md)
      * [사용자 지정 OAuth 클라이언트를 사용하여 Google 서비스에 Adobe Workfront Fusion을 연결합니다](workfront-fusion/connections/connect-fusion-to-google-using-oauth.md)
      * [Adobe Workfront Fusion HTTP > OAuth 2.0 요청 모듈을 통해 MS Graph REST API를 호출합니다](workfront-fusion/connections/call-the-ms-graph-rest-api-.md)
   ...
   * Adobe Workfront Fusion의 오류 {#errors-in-fusion}
      * [Adobe Workfront Fusion의 오류](workfront-fusion/errors/errors.md)
      * [Adobe Workfront Fusion의 처리 오류](workfront-fusion/errors/error-processing.md)
      * [Adobe Workfront Fusion의 오류 처리](workfront-fusion/errors/error-handling.md)
      * [Adobe Workfront Fusion의 오류 처리를 위한 지시어](workfront-fusion/errors/directives-for-error-handling.md)
   ...
   * Adobe Workfront Fusion의 기능 {#functions-in-fusion}
      ...
      * [Adobe Workfront Fusion에서 함수를 사용하여 항목 매핑](workfront-fusion/functions/map-using-functions.md)
      ...
      * [Adobe Workfront Fusion의 배열 기능](workfront-fusion/functions/array-functions.md)
      * [Adobe Workfront Fusion의 날짜 및 시간 형식에 대한 토큰](workfront-fusion/functions/tokens-for-date-and-time-formatting.md)
   ...
   * Adobe Workfront Fusion의 매핑 {#mapping-in-fusion}
      ...
      * [Adobe Workfront Fusion에서 한 모듈의 정보를 다른 모듈에 매핑](workfront-fusion/mapping/map-information-between-modules.md)
      * [Adobe Workfront Fusion의 파일 매핑 기본 정보](workfront-fusion/mapping/about-mapping-files.md)
      ...
      * [Adobe Workfront Fusion의 유형 강제 적용](workfront-fusion/mapping/type-coercion.md)
   * Adobe Workfront Fusion의 모듈 {#modules-in-fusion}
      ...
      * [Adobe Workfront Fusion에서 트리거 모듈의 시작 위치 선택](workfront-fusion/modules/choose-where-trigger-module-starts.md)
      ...
      * [Adobe Workfront Fusion의 누적 모듈](workfront-fusion/modules/aggregator-module.md)
      * [Adobe Workfront Fusion의 라우터 모듈](workfront-fusion/modules/router-module.md)
      * [Adobe Workfront Fusion의 반복기 모듈](workfront-fusion/modules/iterator-module.md)
   ...
   * Adobe Workfront Fusion의 조직 {#organizations-in-fusion}
      ...
      * [Adobe Workfront Fusion의 사용자 관리](workfront-fusion/organizations/manage-fusion-users.md)
   ...
   * Adobe Workfront Fusion의 시나리오 {#scenarios-in-fusion}
      ...
      * [Adobe Workfront Fusion의 시나리오 세부 사항](workfront-fusion/scenarios/scenario-detail.md)
      ...
      * [Adobe Workfront Fusion DevTool을 사용하여 시나리오 디버그](workfront-fusion/scenarios/debug-scenarios-with-dev-tool.md)
      * Adobe Workfront Fusion 시나리오 템플릿 {#fusion-scenario-templates}
         ...
         * [Adobe Workfront Fusion 템플릿으로 시나리오 만들기](workfront-fusion/scenarios/templates/create-scenarios-with-fusion-templates.md)
      ...
      * [Adobe Workfront Fusion 시나리오 예: 전자 메일, 텍스트 파서 및 Google 시트 연결](workfront-fusion/scenarios/example-connect-email-text-parser-gsheets.md)
      * [Adobe Workfront Fusion에서 시나리오 버전 복원](workfront-fusion/scenarios/restore-a-scenario-version.md)
      * [Adobe Workfront Fusion에서 모듈 또는 시나리오 복사](workfront-fusion/scenarios/copy-modules-or-scenarios.md)
   * Workfront Fusion 앱 및 해당 모듈 {#fusion-apps-and-modules}
      ...
      * [할당자 모듈](workfront-fusion/apps-and-their-modules/allocadia-modules.md)
      * [Anaplan 모듈](workfront-fusion/apps-and-their-modules/anaplan-modules.md)
      * [아카이브 모듈](workfront-fusion/apps-and-their-modules/archive-modules.md)
      ...
      * [기본 모듈](workfront-fusion/apps-and-their-modules/bynder-modules.md)
      * [CloudConvert 모듈](workfront-fusion/apps-and-their-modules/cloud-convert-modules.md)
      * [CSV](workfront-fusion/apps-and-their-modules/csv.md)
      * [이벤트 모듈](workfront-fusion/apps-and-their-modules/cvent-modules.md)
      * [데이터 수집 모듈](workfront-fusion/apps-and-their-modules/datadog-modules.md)
      ...
      * [암호화](workfront-fusion/apps-and-their-modules/encryptor-modules.md)
      ...
      * [Google 시트 모듈](workfront-fusion/apps-and-their-modules/google-sheets-modules.md)
      ...
      * HTTP 모듈 {#fusion-http-modules}
         ...
         * [Adobe Workfront Fusion에서 HTTP 모듈에서 상호 TLS 사용](workfront-fusion/apps-and-their-modules/http-modules/use-mtls-in-http-modules.md)
      ...
      * [인터페이스 모듈](workfront-fusion/apps-and-their-modules/intacct-modules.md)
      ...
      * [Microsoft Office 365 일정](workfront-fusion/apps-and-their-modules/microsoft-365-calendar-modules.md)
      ...
      * [Microsoft SQL Server 모듈](workfront-fusion/apps-and-their-modules/microsoft-sql-server-modules.md)
      ...
      * [텍스트 파서](workfront-fusion/apps-and-their-modules/text-parser.md)
      ...
      * [모듈 확대](workfront-fusion/apps-and-their-modules/widen-modules.md)
   ...
   * Adobe Workfront Fusion의 웹 후크 {#webhooks-in-fusion}
      * [Adobe Workfront Fusion의 웹 후크](workfront-fusion/webhooks/webhooks.md)
      * [Adobe Workfront Fusion의 즉각적인 트리거(웹 후크)](workfront-fusion/webhooks/instant-triggers-webhooks.md)
* Adobe Workfront 통합 {#adobe-workfront-integrations}
   ...
   * Adobe Workfront for Creative Cloud {#workfront-for-creative-cloud}
      ...
      * Creative Cloud 애플리케이션용 Adobe Workfront 플러그인 설치 {#install-wf-cc}
         ...
         * [Adobe Workfront for XD 설치 및 열기](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-xd-install.md)
      ...
      * Creative Cloud 애플리케이션용 Adobe Workfront 플러그인을 사용한 작업 관리 {#manage-wf-cc}
         ...
         * [Adobe Workfront 플러그인을 사용하여 작업 항목 완료 표시](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-complete.md)
         * [Adobe Workfront 플러그인을 사용한 로그 시간](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-log-time.md)
      * Creative Cloud 애플리케이션용 Adobe Workfront 플러그인을 사용하여 문서 및 증명을 업로드합니다 {#upload-docs-proofs-wf-cc}
         * [에서 문서 및 증명을 업로드합니다. [!DNL Adobe Workfront plugin] 변환 후 [!DNL Creative Cloud]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/upload-documents-and-proofs.md)
         * [Creative Cloud 애플리케이션용 Adobe Workfront 플러그인을 사용하여 문서 및 증명을 업로드합니다](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-docs-proofs-toc.md)
         ...
         * [XD 대지를 Workfront에 증명으로 업로드](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-xd-proofs.md)
         * [XD 대지를 문서로 Workfront에 업로드](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-xd-docs.md)
         ...
         * [에서 증명 업로드 [!DNL Illustrator]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-proofs-ai.md)
         * [다음 위치에서 문서 업로드 [!DNL Illustrator]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-ai-docs.md)
   ...
   * 지라용 Adobe Workfront {#workfront-for-jira}
      * [지라용 Adobe Workfront](workfront-integrations-and-apps/use-workfront-with-jira/workfront-for-jira.md)
      ...
      * [Adobe Workfront과 Jira 간 링크 항목](workfront-integrations-and-apps/use-workfront-with-jira/link-items-between-wf-jira.md)
   ...
   * G Suite용 Adobe Workfront {#workfront-for-g-suite}
      ...
      * [G Suite에서 문서 보기 및 관리](workfront-integrations-and-apps/workfront-for-g-suite/view-and-manage-documents-in-gsuite.md)
      * [G Suite에서 Adobe Workfront 개체 세부 사항 보기 및 관리](workfront-integrations-and-apps/workfront-for-g-suite/view-manage-work-item-details-in-gsuite.md)
      * [G Suite에서 Adobe Workfront 개체 업데이트 보기](workfront-integrations-and-apps/workfront-for-g-suite/view-object-updates-in-gsuite.md)
      * [G Suite에서 Adobe Workfront 알림 세부 사항 관리](workfront-integrations-and-apps/workfront-for-g-suite/manage-wf-email-notification-details-in-gsuite.md)
      * [G Suite에서 Adobe Workfront 업데이트 알림에 회신](workfront-integrations-and-apps/workfront-for-g-suite/reply-to-wf-update-notification-from-gsuite.md)
      * [G Suite 이메일을 Adobe Workfront 개체 및 업데이트로 전환](workfront-integrations-and-apps/workfront-for-g-suite/turn-gsuite-emails-into-wf-objects-and-updates.md)
      ...
      * [이메일 콘텐츠를 사용하여 G Suite에서 Adobe Workfront 문제 만들기](workfront-integrations-and-apps/workfront-for-g-suite/create-wf-issue-in-g-suite-using-email-content.md)
   ...
   * Adobe Workfront for Outlook {#workfront-for-outlook}
      ...
      * [Outlook용 Workfront의 권한 수준](workfront-integrations-and-apps/using-workfront-with-outlook/permissions-in-workfront-for-outlook.md)
      * [Outlook에서 댓글에 회신](workfront-integrations-and-apps/using-workfront-with-outlook/reply-to-a-comment-from-outlook.md)
      * [Outlook 전자 메일에서 기존 개체 업데이트](workfront-integrations-and-apps/using-workfront-with-outlook/update-an-existing-object-from-an-outlook-email.md)
      * [프로젝트에 작업 또는 문제로 Outlook 전자 메일 추가](workfront-integrations-and-apps/using-workfront-with-outlook/add-outlook-email-to-project-as-task-or-issue.md)
      ...
      * [Adobe Workfront 및 SAML 2.0에서 사용할 Outlook for Office 사용](workfront-integrations-and-apps/using-workfront-with-outlook/enable-outlook-for-office-for-use-with-wf-and-saml-2.md)
   * Microsoft Teams용 Adobe Workfront {#workfront-for-microsoft-teams}
      * [Microsoft Teams용 Adobe Workfront](workfront-integrations-and-apps/using-workfront-with-microsoft-teams/use-workfront-with-ms-teams.md)
      * [Microsoft Teams을 위한 Adobe 워크플로우 개요](workfront-integrations-and-apps/using-workfront-with-microsoft-teams/workfront-for-microsoft-teams.md)
   ...
   * Salesforce용 Adobe Workfront {#workfront-for-salesforce}
      ...
      * [Salesforce용 Adobe Workfront 개요](workfront-integrations-and-apps/using-workfront-with-salesforce/workfront-for-salesforce-overview.md)
      ...
      * [Salesforce 사용자에 대한 Adobe Workfront 섹션을 구성합니다](workfront-integrations-and-apps/using-workfront-with-salesforce/configure-wf-section-for-salesforce-users.md)
      * [Salesforce 개체에서 Adobe Workfront 요청 제출](workfront-integrations-and-apps/using-workfront-with-salesforce/submit-workfront-requests-from-salesforce-objects.md)
      * [Salesforce 개체에서 Adobe Workfront 프로젝트 만들기](workfront-integrations-and-apps/using-workfront-with-salesforce/create-wf-projects-from-salesforce-objects.md)
   * Adobe Workfront for Slack {#workfront-for-slack}
      ...
      * [Slack에 대한 Adobe Workfront 구성](workfront-integrations-and-apps/using-workfront-with-slack/configure-workfront-for-slack.md)
      ...
      * [Slack의 공유 링크에서 Adobe Workfront 개체에 액세스합니다](workfront-integrations-and-apps/using-workfront-with-slack/access-wf-objects-from-shared-linked-in-slack.md)
      * [Slack에서 Adobe Workfront 액세스](workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md)
      * [업데이트로 Slack 주석 게시](workfront-integrations-and-apps/using-workfront-with-slack/post-a-slack-comment-as-an-update.md)
      * [Slack에서 Adobe Workfront 알림 받기](workfront-integrations-and-apps/using-workfront-with-slack/receive-workfront-notifications-in-slack.md)
   * Adobe Workfront 및 안팔란 {#workfront-with-anaplan}
      * [Adobe Workfront 및 안팔란](workfront-integrations-and-apps/adobe-workfront-with-anaplan/anaplan-integration.md)
      * [Adobe Workfront과 Anaplan 통합 FAQ](workfront-integrations-and-apps/adobe-workfront-with-anaplan/anaplan-integration-faq.md)
      * [Adobe Workfront 프로젝트 업데이트를 Anaplan 목록 항목으로 보내기](workfront-integrations-and-apps/adobe-workfront-with-anaplan/send-workfront-project-updates-to-anaplan-list-item.md)
      * [Anaplan 목록 항목으로 Adobe Workfront 비용 보내기](workfront-integrations-and-apps/adobe-workfront-with-anaplan/send-workfront-project-expenses-to-anaplan-list-item.md)
      * [Adobe Workfront 실제 시간 업데이트를 Anaplan 목록 항목으로 보냅니다.](workfront-integrations-and-apps/adobe-workfront-with-anaplan/send-workfront-project-actual-hours-updates-to-anaplan-list-item.md)
      * [Adobe Workfront 예산 요청에서 Anaplan 목록 항목 생성](workfront-integrations-and-apps/adobe-workfront-with-anaplan/create-an-anaplan-list-item-from-a-workfront-budget-request.md)
      ...
      * [Adobe Workfront 캠페인 요청 또는 캠페인 프로젝트에 Animal 예산 할당 적용](workfront-integrations-and-apps/adobe-workfront-with-anaplan/apply-anaplan-budget-allocation-to-workfront-campaign-requests-and-projects.md)
* Workfront Proof {#workfront-proof}
   ...
   * Workfront Proof 시작 {#get-started-wf-proof}
      ...
      * 워크플로우 예 {#workflow-examples}
         * [워크플로우 예](workfront-proof/wp-getstarted/workflow-examples/workflow-examples.md)
         * [Workfront의 기본 교정 프로세스](workfront-proof/wp-getstarted/workflow-examples/basic-proof-process.md)
         * [Workfront 증명의 내부 및 외부 검토](workfront-proof/wp-getstarted/workflow-examples/internal-external-review.md)
         * [Workfront 증명의 디자이너 및 프로젝트 관리자와 함께 작업](workfront-proof/wp-getstarted/workflow-examples/work-designers-project-managers.md)
         * [Workfront 증명의 프리랜서와 작업](workfront-proof/wp-getstarted/workflow-examples/work-freelancers.md)
      * Workfront 증명의 개인 설정 {#personal-settings-in-wf-proof}
         * [Workfront 증명의 개인 설정](workfront-proof/wp-getstarted/personal-settings/personal-settings.md)
         * [Workfront 증명의 임시 증명 소유자 지정](workfront-proof/wp-getstarted/personal-settings/designate-temp-proof-owners.md)
         * [통합 - 사용자 설정](workfront-proof/wp-getstarted/personal-settings/integrations-user-setup.md)
      * Workfront 증명의 시스템 정보 {#system-info-wf-proof}
         * [Workfront 증명의 시스템 정보](workfront-proof/wp-getstarted/system-information/system-information.md)
         * [미리 보기 샌드박스 테스트 환경 - Workfront 증명](workfront-proof/wp-getstarted/system-information/preview-sandbox.md)
         * [Workfront 증명의 언어 설정](workfront-proof/wp-getstarted/system-information/language-settings.md)
         * [Workfront 증명 의 코덱스](workfront-proof/wp-getstarted/system-information/codecs.md)
      * Workfront 증명 FAQ {#wf-proof-faq}
         ...
         * [Workfront 증명을 위해 로그인 및 암호 및 이메일 변경](workfront-proof/wp-getstarted/faqs/log-in-change-password.md)
         * [Workfront 증명의 시간대 설정](workfront-proof/wp-getstarted/faqs/set-timezones-in-wp.md)
   * Workfront 증명 및 파일을 사용하여 작업 {#work-with-proofs-in-wf-proof}
      * [Workfront 증명 및 파일을 사용하여 작업](workfront-proof/wp-work-proofsfiles/wp-work-proofs-files.md)
      * Workfront 증명의 자동화된 워크플로우 {#automated-workflow-in-wf-proof}
         * [Workfront 증명의 자동화된 워크플로우](workfront-proof/wp-work-proofsfiles/automated-workflow/automated-workflow.md)
         * [Workfront 증명의 자동화된 워크플로우를 사용하여 증명 설정](workfront-proof/wp-work-proofsfiles/automated-workflow/set-up-proof-auto-workflow.md)
         * [Workfront 증명의 자동화된 워크플로우로 구성된 증명 관리](workfront-proof/wp-work-proofsfiles/automated-workflow/manage-proof-configured-auto-workflow.md)
      * Workfront 증명의 기본 기능 {#basic-features-in-wf-proof}
         * [Workfront 증명의 기본 기능](workfront-proof/wp-work-proofsfiles/basic-features/basic-features.md)
         * [Workfront 증명의 대시보드](workfront-proof/wp-work-proofsfiles/basic-features/dashboard.md)
         * [Workfront 증명의 보기 탭에 있는 페이지 레이아웃](workfront-proof/wp-work-proofsfiles/basic-features/page-layout-view.md)
         * [Workfront 증명 검색](workfront-proof/wp-work-proofsfiles/basic-features/search.md)
         * [Workfront 증명 활동 감사 추적 이해](workfront-proof/wp-work-proofsfiles/basic-features/activity-audit-trail.md)
      * 증명 및 파일 만들기 {#create-proofs-and-files}
         ...
         * [Workfront 증명에 파일 및 웹 컨텐츠 업로드](workfront-proof/wp-work-proofsfiles/create-proofs-and-files/upload-files-web-content.md)
         * [Workfront 증명에서 증명 생성](workfront-proof/wp-work-proofsfiles/create-proofs-and-files/generate-proofs.md)
         * [Workfront 증명의 증명 복사](workfront-proof/wp-work-proofsfiles/create-proofs-and-files/copy-proofs.md)
      ...
      * 작업 관리 {#manage-your-work}
         ...
         * [Workfront 증명의 파일 관리](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-files.md)
         * [Workfront 증명의 보기 페이지에 있는 항목 관리](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md)
         * [Workfront 증명의 증명 버전 관리](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-versions.md)
         * [Workfront 증명의 증명 설정 구성](workfront-proof/wp-work-proofsfiles/manage-your-work/configure-proof-settings.md)
         * [Workfront 증명 증명에서 사용자 지정 보기 만들기 및 관리](workfront-proof/wp-work-proofsfiles/manage-your-work/create-and-manage-custom-views.md)
         * [Workfront 증명에 저장된 파일 다운로드](workfront-proof/wp-work-proofsfiles/manage-your-work/download-files-stored.md)
         * [Workfront 증명의 증명 세부 정보 관리](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-details.md)
         * [Workfront 증명의 진행 상황과 상태 보기](workfront-proof/wp-work-proofsfiles/manage-your-work/view-progress-and-status-of-proof.md)
         * [Workfront 증명의 증명 상태 이해](workfront-proof/wp-work-proofsfiles/manage-your-work/proof-state.md)
         * [Workfront 증명의 증명 삭제](workfront-proof/wp-work-proofsfiles/manage-your-work/delete-proof.md)
         * [Workfront 증명의 휴지통 복원 및 비우기](workfront-proof/wp-work-proofsfiles/manage-your-work/restore-and-empty-trash.md)
         * [Workfront 증명의 보고서 실행](workfront-proof/wp-work-proofsfiles/manage-your-work/run-reports.md)
      * 작업 구성 {#organize-your-work}
         * [작업 구성](workfront-proof/wp-work-proofsfiles/organize-your-work/organize-your-work.md)
         * [Workfront 증명의 폴더](workfront-proof/wp-work-proofsfiles/organize-your-work/folders.md)
         * [Workfront 증명의 폴더 만들기](workfront-proof/wp-work-proofsfiles/organize-your-work/create-folders.md)
         * [Workfront 증명의 폴더 관리](workfront-proof/wp-work-proofsfiles/organize-your-work/manage-folders.md)
         * [Workfront 증명의 폴더 및 해당 컨텐츠 관리](workfront-proof/wp-work-proofsfiles/organize-your-work/manage-folders-and-contents.md)
         * [Workfront 증명의 폴더 공유](workfront-proof/wp-work-proofsfiles/organize-your-work/share-folders.md)
         * [Workfront 증명의 폴더 권한 이해](workfront-proof/wp-work-proofsfiles/organize-your-work/folder-permissions.md)
         * [Workfront 증명의 태그 만들기 및 관리](workfront-proof/wp-work-proofsfiles/organize-your-work/create-and-manage-tags.md)
         * [Workfront 증명의 아카이브](workfront-proof/wp-work-proofsfiles/organize-your-work/archive.md)
         * [Workfront 증명 데이터 백업](workfront-proof/wp-work-proofsfiles/organize-your-work/back-up-data.md)
         * [Workfront 증명의 주석 인쇄 및 내보내기](workfront-proof/wp-work-proofsfiles/organize-your-work/print-and-export-comments.md)
      * 데스크탑 교정 뷰어에서 증명 검토 {#review-proofs-in-viewer}
         * [데스크탑 교정 뷰어에서 증명 검토](workfront-proof/wp-work-proofsfiles/review-proofs-dpv/review-proofs-in-desktop-proofing-viewer.md)
         * [데스크탑 교정 뷰어 이해](workfront-proof/wp-work-proofsfiles/review-proofs-dpv/destop-proofing-viewer.md)
         * [데스크탑 언어 교정 뷰어에서 하이퍼링크를 여는 방법 구성](workfront-proof/wp-work-proofsfiles/review-proofs-dpv/configure-how-hyperlinks-open.md)
      * Web Proofing Viewer에서 증명 검토 {#review-proofs-web-proofing-viewer}
         * [Web Proofing Viewer에서 증명 검토](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/review-proofs-in-wpv.md)
         * [Workfront 증명의 증명 열기](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/open-proof.md)
         ...
         * [Workfront 교정 뷰어의 키보드 단축키](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/keyboard-shortcuts.md)
      ...
      * 증명 및 파일 공유 {#share-proofs-and-files}
         ...
         * [Workfront 증명의 증명 공유](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof.md)
         * [Workfront 증명의 증명 링크 공유](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof-links.md)
         * [Workfront 증명의 공개 URL 공유](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-public-url.md)
         * [Workfront 증명의 파일 공유](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-files.md)
         * [공유된 증명 액세스](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/access-proofs-shared-with-you.md)
         * [Workfront 증명의 증명 구독](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/subscribe-to-proof.md)
         * [Workfront 증명의 미니 증명 만들기](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/create-mini-proof.md)
         * [미니 증명 포함](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/embed-mini-proof.md)
         * [Workfront 증명의 증명 역할 관리](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md)
   * Workfront 증명 계정 관리 {#wf-proof-account-admin}
      * [Workfront 증명 계정 관리](workfront-proof/wp-acct-admin/wp-account-admin.md)
      * Workfront 증명의 계정 설정 {#account-settings-in-wf-proof}
         * [Workfront 증명의 계정 설정](workfront-proof/wp-acct-admin/account-settings/account-settings.md)
         * [Workfront 증명 사용자 관리](workfront-proof/wp-acct-admin/account-settings/manage-wp-users.md)
         * [Workfront 증명의 사용자 증명 권한 프로필 구성](workfront-proof/wp-acct-admin/account-settings/config-user-pref-in-wp.md)
         * [Workfront 증명의 사용자 지정 프로필 구성](workfront-proof/wp-acct-admin/account-settings/configure-custom-profiles.md)
         * [Workfront 증명 사용자에 대한 단일 사인온 구성](workfront-proof/wp-acct-admin/account-settings/configure-sso-for-wp-users.md)
         * [Workfront에서 단일 사인온 증명: AD FS 구성](workfront-proof/wp-acct-admin/account-settings/sso-in-wp-adfs-configuration.md)
         * [Workfront 증명의 증명 권한 프로필](workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md)
         * [Workfront 증명의 승인 결정 옵션 구성](workfront-proof/wp-acct-admin/account-settings/configure-approval-decision-in-wp.md)
         * [Workfront 증명의 사용자 지정 필드 만들기 및 관리](workfront-proof/wp-acct-admin/account-settings/create-and-manage-custom-fields.md)
         * [Workfront 증명의 드롭존 구성](workfront-proof/wp-acct-admin/account-settings/configure-dropzone-in-wp.md)
         * [Workfront 증명의 통합을 위한 계정 설정](workfront-proof/wp-acct-admin/account-settings/integrations-account-setup.md)
         * [Workfront 증명의 인증 로그 보기](workfront-proof/wp-acct-admin/account-settings/view-auth-logs-in-wp.md)
         * [조직의 Workfront 증명 계정 세부 사항을 보고 편집합니다](workfront-proof/wp-acct-admin/account-settings/view-edit-org-wp-acct-details.md)
         * [조직의 Workfront 증명 관리자 계정 내역 보기](workfront-proof/wp-acct-admin/account-settings/view-org-wp-acct-history.md)
         * [Workfront 증명 스토리지 확인](workfront-proof/wp-acct-admin/account-settings/check-workfront-proof-storage.md)
         * [Workfront 증명의 새 데이터 백업 요청](workfront-proof/wp-acct-admin/account-settings/request-new-data-backup-in-wp.md)
      * 브랜딩 Workfront 증명 {#branding-wf-proof}
         ...
         * [Workfront 증명 사이트 브랜드 - 고급](workfront-proof/wp-acct-admin/branding/brand-wp-site-advanced.md)
      * 보안 관리 {#manage-security}
         * [보안 관리](workfront-proof/wp-acct-admin/managing-security/manage-security.md)
         * [Workfront 증명 보안](workfront-proof/wp-acct-admin/managing-security/proof-security-in-workfront-proof.md)
         * [Workfront에서 단일 사인온 증명](workfront-proof/wp-acct-admin/managing-security/single-sign-on-overview.md)
         * [Workfront 증명의 전자 서명 이해](workfront-proof/wp-acct-admin/managing-security/electronic-sigs-in-wp.md)
      * Workfront 증명의 파트너 계정 {#partner-accounts-in-wf-proof}
         * [Workfront 증명의 파트너 계정](workfront-proof/wp-acct-admin/partner-accounts/partner-accounts.md)
         ...
         * [Workfront 증명의 파트너와 항목 공유](workfront-proof/wp-acct-admin/partner-accounts/share-items-partner-in-wp.md)
      * Workfront 증명 의 위성 계정 {#satellite-accounts-in-wf-proof}
         * [Workfront 증명 의 위성 계정](workfront-proof/wp-acct-admin/satellite-accounts/satellite-accounts.md)
         * [Workfront 증명 의 위성 계정](workfront-proof/wp-acct-admin/satellite-accounts/sat-accts-in-wp.md)
         * [Workfront 증명의 위성 계정 구성](workfront-proof/wp-acct-admin/satellite-accounts/configure-sat-acct-in-wp.md)
         * [Workfront 증명의 위성 계정 관리](workfront-proof/wp-acct-admin/satellite-accounts/manage-sat-acct-in-wp.md)
      * Workfront 증명 계정 관리를 위한 팁, 요령 및 문제 해결 {#ttt-wf-proof-account-admin}
         ...
         * [FAQ: Workfront 증명 - EMEA로 마이그레이션](workfront-proof/wp-acct-admin/tips-tricks-and-troubleshooting/faq-wp-us-to-emea-mig.md)
   * Workfront 증명 청구 설정 {#wf-proof-billing-settings}
      * [Workfront 증명 청구 설정](workfront-proof/wp-billingsettings/wp-billing-settings.md)
      * 청구 관리 {#manage-billing}
         * [청구 관리](workfront-proof/wp-billingsettings/manage-your-billing/manage-your-billing.md)
         * [Workfront 증명 청구 페이지](workfront-proof/wp-billingsettings/manage-your-billing/wp-billing-page.md)
         * [Workfront 증명의 결제 방법 선택](workfront-proof/wp-billingsettings/manage-your-billing/choose-payment-method-in-wp.md)
   ...
   * 증명 알림 및 미리 알림 {#proof-notifications-and-reminders}
      ...
      * 스팸 필터 방지 {#avoid-spam-filters}
         ...
         * [스팸 필터를 방지하기 위해 Workfront 증명 이메일을 구성합니다](workfront-proof/wp-emailsntfctns/avoiding-spam-filters/configure-wp-emails-avoid-spam-filters.md)
         * [Workfront 증명 SPF 레코드](workfront-proof/wp-emailsntfctns/avoiding-spam-filters/wp-spf-records.md)
      * 검토자에게 메시지 보내기 {#send-messages-to-reviewers}
         ...
         * [검토자에게 Workfront 증명의 할당에 대해 알림](workfront-proof/wp-emailsntfctns/messaging-reviewers/remind-reviewer-assignments-wp.md)
         * [증명으로 검토자에게 미리 알림 메시지를 보냅니다.](workfront-proof/wp-emailsntfctns/messaging-reviewers/send-reminder-to-proof-reviewers.md)
      * 증명 알림 및 미리 알림 {#proof-notifications-and-reminders}
   ...
   * 이메일 경고 {#email-alerts}
      ...
      * [Workfront 증명의 이메일 알림 설정 구성](workfront-proof/wp-emailsntfctns/email-alerts/config-email-notification-settings-wp.md)
      * [Workfront 증명의 증명에 대한 이메일 경고 설정 변경](workfront-proof/wp-emailsntfctns/email-alerts/change-email-alert-settings-wp.md)
   * Workfront 증명의 사용자 및 연락처 관리 {#managing-users-in-wf-proof}
      * [Workfront 증명의 사용자 및 연락처 관리](workfront-proof/wp-mnguserscontacts/manage-user-contacts.md)
      * 사용자 {#users}
         ...
         * [Workfront 증명을 사용하여 사용자 지정 프로필 만들기 및 관리](workfront-proof/wp-mnguserscontacts/users/create-and-manage-custom-profiles.md)
         * [Workfront 증명을 사용하여 계정 간에 사용자 이동](workfront-proof/wp-mnguserscontacts/users/move-users-between-accounts.md)
      * 그룹 {#groups}
         ...
         * [Workfront 증명을 사용하여 언어 교정 그룹 만들기](workfront-proof/wp-mnguserscontacts/groups/create-proofing-groups.md)
         * [Workfront 증명을 사용하여 비공개 그룹 만들기](workfront-proof/wp-mnguserscontacts/groups/make-groups-private.md)
      ...
      * 연락처 {#contacts}
         ...
         * [Workfront 증명의 연락처 관리](workfront-proof/wp-mnguserscontacts/contacts/manage-contacts.md)
         * [Workfront 증명의 사용자, 구성원 및 게스트 이해](workfront-proof/wp-mnguserscontacts/contacts/use-members-guests.md)
      * Workfront 증명 사용자 및 연락처를 위한 팁, 요령 및 문제 해결 {#ttt-wf-proof-users-and-contacts}
         * [Workfront 증명 사용자 및 연락처를 위한 팁, 요령 및 문제 해결](workfront-proof/wp-mnguserscontacts/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-wfproof.md)
   ...
   * Workfront Proof 모바일 {#wf-proof-mobile}
      ...
      * Workfront Proof 모바일 앱 {#wf-proof-mobile-apps}
         ...
         * [태블릿용 Workfront 증명 모바일 앱](workfront-proof/wp-mobile/wp-mobile-apps/wp-mobile-app-tablet.md)
      * Workfront Proof 모바일 앱에 대한 팁, 요령 및 문제 해결 {#ttt-wf-proof-mobile-apps}
         ...
         * [Workfront 증명 모바일 앱에 로그인할 수 없습니다.](workfront-proof/wp-mobile/tips-tricks-and-troubleshooting/unable-to-log-in.md)
   * Workfront 증명 기술 코너 {#wf-proof-tech-corner}
      * [Workfront 증명 기술 코너](workfront-proof/wp-tech-corner/tech-corner.md)
      * 증명 유형 {#proof-types}
         * [증명 유형](workfront-proof/wp-tech-corner/proof-types/proof-types.md)
         * [Workfront 증명을 사용하여 정적 웹 사이트 증명 만들기](workfront-proof/wp-tech-corner/proof-types/create-status-web-proof.md)
      * Workfront 증명의 문제 해결 {#troubleshooting-wf-proof}
         * [Workfront 증명의 문제 해결](workfront-proof/wp-tech-corner/troubleshooting/troubleshooting.md)
         ...
         * [캐시 및 쿠키가 Workfront 증명에 미치는 영향 이해](workfront-proof/wp-tech-corner/troubleshooting/how-cache-cookies-affect-pv.md)
         * [Workfront 증명의 속도 문제](workfront-proof/wp-tech-corner/troubleshooting/speed-issue.md)
         * [증명 보기 문제 - Flash 공유 개체 설명](workfront-proof/wp-tech-corner/troubleshooting/view-proof-flash-shared-object.md)
         * [문제 해결 - Workfront 방수 뷰어](workfront-proof/wp-tech-corner/troubleshooting/proofing-viewer.md)
   * Workfront 증명 통합 {#wf-proof-integrations}
      * [Workfront 증명 통합](workfront-proof/wp-integrations/wp-integrations.md)
      * Workfront 증명 API {#wf-proof-api}
         * [Workfront 증명 API](workfront-proof/wp-integrations/api/wp-api.md)
         * [Workfront 증명 API](workfront-proof/wp-integrations/api/workfront-proof-api.md)
      * Box {#box}
         * [Box](workfront-proof/wp-integrations/box/box.md)
         * [Workfront 증명 및 Box 통합 소개](workfront-proof/wp-integrations/box/introduction-to-box.md)
         * [Box 계정을 통해 증명 만들기](workfront-proof/wp-integrations/box/create-proof-box-account.md)
         * [Workfront 증명과 동기화 상자 폴더](workfront-proof/wp-integrations/box/sycn-box-folder.md)
         * [상자에서 증명의 원본 파일 보기](workfront-proof/wp-integrations/box/view-proof-original-file-box.md)
      * 베이스캠프 {#basecamp}
         ...
         * [Basecamp와 Workfront 증명 통합](workfront-proof/wp-integrations/basecamp/integrate-workfront-proof-with-basecamp.md)
         * [Basecamp에서 증명 검토](workfront-proof/wp-integrations/basecamp/review-proof-basecamp.md)
         * [Workfront와의 Basecamp 통합 이해](workfront-proof/wp-integrations/basecamp/basecamp-integration-overview.md)
      * Basecamp Classic {#basecamp-classic}
         ...
         * [Basecamp Classic과 Workfront 증명 통합](workfront-proof/wp-integrations/basecamp-classic/integrate-workfront-proof-basecamp-classic.md)
...
* Adobe Workfront API {#adobe-workfront-api}
   ...
   * Document Webhooks API {#document-webhooks-api}
      * [Document Webhooks API 문서](wf-api/doc-wbhks-api/document-webhooks-api.md)
...
* 증명 HQ API {#proofhqpapi}
   * [증명 HQ API](proofhq-api/proofhq-api.md)
   * 일반 {#general}
