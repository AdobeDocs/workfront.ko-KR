...
* **전역 문서 영역:** Workfront에서 액세스할 수 있는 모든 문서를 나열합니다. 이 영역에 액세스하려면 주 메뉴 **주 메뉴 아이콘**&#x200B;에서 ![문서](assets/document-icon.png) ![문서 아이콘](assets/main-menu-icon.png)을 클릭하세요.
...
Frame.io 뷰어를 사용하여 새 문서 영역의 문서를 검토하고 승인할 수 있습니다.
