...
>[!NOTE]
>
>조직이 Adobe 클라우드 스토리지에 있는 경우 증명을 사용할 수 없습니다. 대신 Frame.io 통합에서 Workfront 검토 및 승인을 사용할 수 있습니다. Adobe 클라우드 스토리지 또는 Frame.io 통합에 대한 자세한 내용은
>
>* [Adobe 클라우드 저장소 개요](/help/quicksilver/review-and-approve-work/esm-overview.md)
