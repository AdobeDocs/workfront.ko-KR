...
description: Adobe Workfront - EDIT ME의 다음 영역에서 프로젝트, 작업 또는 문제에 문서를 추가할 수 있습니다.
author: Courtney
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> 
       <ol> 
        ...
        <li value="2"> <p>워크스테이션의 파일 시스템에서 추가할 문서를 찾아보고 선택합니다.<br></p> <p>추가 파일을 선택할 때 Shift 키를 눌러 여러 문서를 선택할 수 있습니다.</p> </li> 
     ...
     <tr> 
      ...
      <td> 
       <ol> 
        <li value="1"> <p>에서 <strong>새로 추가</strong> 드롭다운 메뉴에서 <strong>From &lt;name_of_third-party_application&gt;</strong>.</p> <p>예를 들어 Google 드라이브에서 문서를 업로드하려면 <strong>Google 드라이브에서</strong>.</p> </li> 
        <li value="2"> <p>화면의 지침에 따라 타사 애플리케이션에서 문서를 선택합니다.<br></p> <p>연결된 문서에 대한 자세한 내용은 <a href="../../documents/adding-documents-to-workfront/link-documents-from-external-apps.md" class="MCXref xref">외부 응용 프로그램에서 문서 연결</a>.</p> </li> 
       </ol> </td> 
     </tr> 
     <tr> 
