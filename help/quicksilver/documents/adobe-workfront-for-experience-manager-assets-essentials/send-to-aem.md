...
>[!INFO]
>
>**예** 작업에 연결된 에셋을 처음 보내면 작업 메타데이터가 Experience Manager Assets 또는 Assets Essentials과 프로젝트, 포트폴리오 및 프로그램과 같은 부모 개체의 매핑된 메타데이터에도 매핑됩니다.
...
이전에 Workfront에 업로드한 문서에 새 버전을 추가할 수 있습니다. 자세한 내용은 [새 문서 버전 업로드](../../documents/managing-documents/upload-new-document-version.md)를 참조하십시오. 최신 버전을 업로드한 후 Assets Essentials에게 보낼 수 있습니다. Workfront의 매핑된 필드가 변경된 경우 새 버전은 를 전송할 때 Assets Essentials의 메타데이터를 업데이트합니다.
