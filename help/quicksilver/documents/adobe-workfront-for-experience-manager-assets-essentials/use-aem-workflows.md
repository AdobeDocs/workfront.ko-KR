...
1. 원하는 대로 **[!UICONTROL 연결된 폴더 만들기]**&#x200B;를 켜거나 끕니다. 이 기능을 켜면 연결된 폴더 구성을 편집할 수 있습니다.
   ...
   연결된 폴더 구성에 대한 자세한 내용은 문서 [Adobe Experience Manager 통합 구성](/help/quicksilver/administration-and-setup/configure-integrations/configure-aacs-integration.md)에서 [Experience Manager Assets 연결된 폴더 만들기](/help/quicksilver/administration-and-setup/configure-integrations/configure-aacs-integration.md#create-adobe-experience-manager-linked-folders)를 참조하십시오. [!UICONTROL as a Cloud Service 구성]
