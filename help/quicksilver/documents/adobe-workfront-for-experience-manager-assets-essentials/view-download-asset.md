...
title: Experience Manager Assets 또는 Assets Essentials에서 연결된 자산을 보거나 다운로드합니다
description: Experience Manager Assets 또는 Assets Essentials에서 연결된 Adobe Workfront에서 자산을 보거나 다운로드할 수 있습니다.
author: Courtney
...
# Experience Manager Assets 또는 Assets Essentials에서 연결된 자산을 보거나 다운로드합니다

Experience Manager Assets 또는 Assets Essentials에서 연결된 Adobe Workfront에서 자산을 보거나 다운로드할 수 있습니다.
...
1. 문서 목록에서 문서를 선택합니다.
1. 오른쪽의 문서 요약에서 맨 위의 축소판 위로 마우스를 가져간 후 선택합니다 **미리 보기** 또는 **다운로드**.
