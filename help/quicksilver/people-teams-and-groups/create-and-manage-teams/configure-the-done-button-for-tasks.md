...
[!UICONTROL 완료] 단추를 사용하면 작업 또는 문제의 상태를 자동으로 설정할 수 있습니다. 기본적으로 [!UICONTROL Adobe Workfront]은(는) 피할당자가 작업 항목에서 [완료]를 클릭하면 작업을 [!UICONTROL 완료됨](으)로 표시합니다.

## 개요

특정 권한이 있는 사용자는 시스템의 특정 상태를 반영하도록 [!UICONTROL 완료] 단추를 구성할 수 있습니다. [!UICONTROL Workfront]의 작업에 대해 [!UICONTROL 완료] 단추가 작동하는 방법은 두 가지가 있습니다.
