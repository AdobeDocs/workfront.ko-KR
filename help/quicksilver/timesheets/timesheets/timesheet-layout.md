...
타임시트 및 시간 환경 설정은 타임시트에 표시되는 내용을 제어합니다. 이 문서에서는 사용 가능한 모든 옵션에 대한 개요를 제공합니다. 옵션 선택에 대한 자세한 내용은 [타임시트 및 시간 환경 설정 구성](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md)을 참조하십시오.
...
* **타임시트**: 실제 타임시트를 표시합니다.
* **업데이트**: 타임시트에 대한 댓글 및 시스템 업데이트를 표시합니다. 자세한 내용은 이 문서에서 왼쪽 패널의 [업데이트 영역](#updates-area-in-the-left-panel) 섹션을 참조하십시오.
...
* 프로젝트, 작업 또는 문제를 추가할 수 있는 **항목 추가** 단추입니다.
* 타임시트에서 작업 또는 문제를 검색하는 빠른 필터 아이콘.
* 프로젝트, 작업 또는 문제 시간 항목에 대해 기록된 시간 설명을 보거나 숨길 수 있는 **설명 표시** 설정입니다.
* 타임시트를 전체 화면 모드로 표시하는 전체 화면 아이콘.
* 작업 또는 문제에 대한 추가 정보를 보려면 요약 패널을 열거나 닫는 **요약 열기**(또는 **요약 닫기**) 단추를 클릭하세요. 이 단추는 프로젝트에 사용할 수 없습니다.

자세한 내용은 [로그 시간](../create-and-manage-timesheets/log-time.md)을 참조하세요.

## 타임시트 바닥글

![타임시트 바닥글](assets/timesheet-footer-unshimmed-redesign.png)

이 영역에서 **승인을 위해 제출**, **닫기**, **승인** 및 **거부** 단추를 클릭하여 타임시트 승인을 닫거나 거부할 수 있습니다.
...
시간 항목과 연결할 다른 작업 역할을 선택할 수 있습니다. Workfront 관리자는 **시간 항목에 작업 역할 할당** 설정을 수동으로 활성화해야 합니다. 작업에 할당되거나 문제가 기본적으로 표시되는 경우 지정된 작업 역할입니다. 작업 또는 문제에 대한 작업 역할이 할당되지 않은 경우 기본 역할이 기본값으로 표시됩니다. 자세한 내용은 [타임시트 및 시간 환경 설정 구성](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md)을 참조하십시오.

서로 다른 역할에 대해 동일한 작업 항목에 대해 여러 시간 항목을 기록할 수 있습니다. 자세한 내용은 [로그 시간](../create-and-manage-timesheets/log-time.md)을 참조하세요.

## 시간 유형

![시간 유형](assets/timesheet-hour-type-unshimmed-redesign.png)

각 항목에 대한 시간 항목과 연결할 다양한 시간 유형을 선택할 수 있습니다. 이 필드는 Workfront 관리자가 사용자 환경에 대해 이 필드를 활성화할 때만 표시됩니다. 자세한 내용은 [타임시트 및 시간 환경 설정 구성](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md)을 참조하십시오.

서로 다른 시간 유형에 대해 동일한 작업 항목에 대해 여러 시간 항목을 기록할 수 있습니다. 자세한 내용은 [로그 시간](../create-and-manage-timesheets/log-time.md)을 참조하세요.
...
타임시트에 표시되는 작업 또는 문제에 대한 요약 패널에 액세스할 수 있습니다. 여기에서 작업 및 문제에 대해 댓글을 달거나 정보를 업데이트할 수 있습니다. 자세한 내용은 [요약 개요](../../workfront-basics/the-new-workfront-experience/summary-overview.md)를 참조하세요.

타임시트 요약 패널에서 작업 항목에 대해 입력한 주석이 작업 또는 문제의 업데이트 영역에 표시됩니다. 요약 패널은 프로젝트에 사용할 수 없습니다.

## 시간대 및 시간 입력 영역

![타임시트 시간대](assets/timesheet-time-frame-log-time-area.png)
...
자세한 내용은 [일회용 타임시트 만들기](../create-and-manage-timesheets/create-tmshts.md) 또는 [타임시트 프로필 만들기, 편집 및 할당](../create-and-manage-timesheets/create-timesheet-profiles.md)을 참조하세요.
...
![시간 항목 주석](assets/timesheet-hour-entry-comment-button-unshimmed-redesign.png)

타임시트에 추가하는 모든 시간 항목에 주석을 추가할 수 있습니다.

시간 항목 설명 상자에 입력한 설명은 도구 모음에서 **설명 표시** 설정이 활성화된 경우 시간을 기록한 각 작업 항목 아래의 타임시트에 표시됩니다.

![시간 항목 주석](assets/hour-entry-comment-under-task-in-timesheet-unshimmed-redesign.png)
