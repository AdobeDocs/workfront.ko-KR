...
![총 시간 필드](assets/timesheet-total-hours-in-header-highlighted-redesigned.png)
...
1. 각 타임시트의 총 시간이 **총 시간** 열에 표시됩니다.
   ...
   ![총 시간 열](assets/total-hours-column-highlighted-all-timesheets-list-nwe-350x120.png)
