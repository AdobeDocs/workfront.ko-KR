...
이 문서에 설명된 단계를 수행하려면 다음 액세스 및 권한이 있어야 합니다.
...
1. 헤더의 프로젝트 이름 옆에 있는 **자세히** 메뉴를 클릭한 다음 **편집**&#x200B;을 클릭합니다.
**프로젝트 편집** 상자가 열립니다.
...
1. 모든 프로젝트별 시간 유형을 프로젝트에서 사용할 수 있도록 하려면 **아니요**&#x200B;를 선택하십시오.
   ...
   프로젝트에서 프로젝트별 시간 형식의 하위 집합만 사용할 수 있도록 하려면 **예**&#x200B;를 선택한 다음 사용할 시간 형식을 선택하십시오.

   Shift 키를 누른 상태로 여러 시간 유형을 선택합니다.
...
1. Adobe Workfront의 오른쪽 상단에 있는 **기본 메뉴** 아이콘 ![](assets/main-menu-icon.png)을(를) 클릭한 다음 왼쪽 상단에 있는 사용자 아바타를 클릭합니다

   또는

   오른쪽 상단의 **기본 메뉴** 아이콘 ![](assets/adobe-main-menu.png)을(를) 클릭한 다음(사용 가능한 경우) **Workfront 프로필**&#x200B;을(를) 클릭합니다.
