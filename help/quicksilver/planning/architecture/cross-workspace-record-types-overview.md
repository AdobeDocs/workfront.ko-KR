...
* 원래 글로벌 레코드 유형이 여러 보조 작업 공간에 추가된 경우 다른 작업 공간에 추가된 레코드는 원래 작업 공간이나 볼 수 있는 권한 이상이 있는 작업 공간에서만 볼 수 있습니다.
...
* 원래 작업 영역에서 글로벌 레코드 유형에 대해 생성된 필드는 레코드 유형이 추가된 모든 작업 영역에서 볼 수 있습니다. 원래 작업공간의 필드 설정은 보조 작업공간에서 읽기 전용입니다.
...
* 보조 작업 공간에서 생성된 레코드에 대한 시나리오는 다음과 같습니다.
   ...
   * 보조 작업 영역에 대한 관리 권한이 있는 경우 글로벌 레코드 유형의 원래 작업 영역 또는 해당 레코드가 추가된 작업 영역에서 레코드를 관리할 수 있습니다.
