...
<p>한 번에 여러 작업 영역을 만들 수 있는 Workfront Planning Prime 이상 패키지 <span class="preview"></span></p>
<p>각 Workfront Planning 패키지에 포함된 내용에 대한 자세한 내용은 Workfront 계정 담당자에게 문의하십시오. </p> 
   </td> 
  <tr> 
   <td role="rowheader"><p>Adobe Workfront 라이선스</p></td> 
   <td><p>표준</p>
   <p><span class="preview">시스템 관리자가 모범 사례 템플릿 번들을 사용하여 한 번에 여러 작업 공간을 만들 수 있음</p>
   </td> 
  </tr> 
  <tr> 
