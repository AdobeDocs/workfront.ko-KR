...
현재 Workfront Planning 고객은 Workfront Planning 체험판을 사용할 수 없습니다. 체험판은 Planning 고객이 아닌 Adobe Workfront 고객이 Workfront Planning을 경험하고, 이를 구현하는 일상적인 작업과 어떻게 큰 그림을 그리는 전략을 연결할 수 있는지 확인할 수 있는 기회입니다.

Workfront Planning은 마케팅 라이프사이클에 대한 중앙 집중식 가시성을 제공하여 팀 간의 공동 작업, 캠페인 실시간 추적 및 자동화된 워크플로우를 가능하게 합니다. 사용자 지정 작업 공간을 만들고 대화형 타임라인 및 캘린더로 작업을 시각화할 수 있습니다.

이 평가판을 통해 Planning이 일상적인 작업을 전략적 목표에 맞게 조정하고 실행을 간소화하며 조직에 측정 가능한 결과를 도출하는 방법을 직접 확인할 수 있습니다.
...
Workfront Planning 무료 체험판에 참여하려면 귀사에 다음 사항이 있어야 합니다.

* 모든 새 Adobe Workfront 또는 워크플로우 패키지
기존 Workfront 패키지에는 Workfront Planning 체험판을 사용할 수 없습니다.
자세한 내용은 [Workfront 설명서의 액세스 요구 사항](/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/access-level-requirements-in-documentation.md)을 참조하십시오.
* Adobe Admin Console 액세스
* IMS(Identity Management System)의 일부여야 함
* 조직의 Workfront 인스턴스에서 사용할 수 있는 서명된 법적 재판 계약
...
* **2026년 5월 1일**: Workfront Planning 평가판이 닫히고 Planning에 대한 액세스 권한이 제거됩니다. Workfront은 체험판이 끝난 후 데이터를 보호합니다.
...
법적 계약을 검토하고 수락하려면 다음 중 하나를 수행합니다.

* 2026년 3월 2일 전에 다음 작업을 수행하십시오.
   ...
   1. (조건부) 시스템 관리자가 아닌 경우 **Workfront Planning 평가판**&#x200B;에 대한 정보가 포함된 인앱 배너를 따라 이동한 다음 **자세히 알아보기**&#x200B;를 클릭합니다.
      ...
      Workfront Planning 체험판 및 Workfront Planning에 대해 자세히 읽어볼 수 있습니다.

* 2026년 3월 2일 이후 체험판이 시작되면 다음 작업을 수행하십시오.
   ...
   1. 계약을 검토한 후 **동의**&#x200B;를 클릭합니다.
      ...
      * 계획 영역이 사용자 및 **평가판** 배지가 있는 시스템의 모든 사용자를 위한 기본 메뉴에 추가됩니다.
      * 계획 영역의 **모범 사례 작업 영역** 탭에 대한 관리 액세스 권한을 받습니다.
      * 시스템의 모든 사용자는 계획 영역의 **모범 사례 작업 영역** 탭에 대한 보기 액세스 권한을 받습니다.
   1. (조건부) 시스템 관리자가 아니고 시스템 관리자가 평가판 계약을 아직 수락하지 않은 경우 **Workfront Planning 평가판**&#x200B;에 대한 정보가 포함된 인앱 배너를 따른 다음 **자세히 알아보기**&#x200B;를 클릭합니다.

      Workfront Planning 체험판 및 Workfront Planning에 대해 자세히 읽어볼 수 있습니다.
   1. (조건부) 시스템 관리자가 아니고 시스템 관리자가 평가판을 수락한 경우 **Workfront Planning 평가판**&#x200B;에 대한 정보가 포함된 인앱 배너를 따르고 **계획 열기**&#x200B;를 클릭합니다.

      **모범 사례 작업 영역** 탭 탐색을 시작하고 작업 영역 또는 해당 개체를 다른 사용자와 공유합니다.
...
* 2026년 3월 2일부터 5월 1일 사이:
  ...
  **평가판 계획** 영역의 **모범 사례 작업 공간** 탭에서 사용할 수 있는 데이터에 대해 다음 권한이 부여됩니다.
...
* 2026년 5월 1일 이후:
  ...
  Workfront Planning에 대한 액세스가 제거되고 Workfront에서 데이터를 보호합니다.
