...
* 2026년 3월 2일 이후 체험판이 시작되면 다음 작업을 수행하십시오.
   ...
   1. 계약을 검토한 후 **동의**&#x200B;를 클릭합니다.
      ...
      * 계획 영역이 사용자 및 시스템의 모든 사용자를 위한 메인 메뉴에 추가되고 **평가판** 배지가 표시됩니다.
      * 시스템 관리자는 계획 영역의 **모범 사례 작업 공간** 탭에 대한 관리 액세스 권한을 받습니다.
      * 시스템 관리자가 아닌 시스템의 모든 사용자는 계획 영역의 **모범 사례 작업 영역** 탭에 대한 보기 액세스 권한을 받습니다.
...
* **2026년 3월 2일부터 5월 1일 사이**:
  ...
  **평가판 계획** 영역의 **모범 사례 작업 공간** 탭에서 사용할 수 있는 데이터에 대해 다음 권한이 부여됩니다.
   ...
   * 모든 시스템 관리자는 계획 영역의 모범 사례 작업 공간 탭에 대한 관리 권한을 갖습니다.
   * 다른 모든 사용자에게는 계획 영역의 모범 사례 작업 공간 탭에 대한 보기 권한이 있습니다.
