...
이 문서에서는 2024년 8월 28일에 일반 출시 전에 2023년에 Workfront Planning 초기 단계에서 릴리스된 기능이 나열됩니다.
...
>[!IMPORTANT]
>
>Workfront 기능 레코드를 Adobe Experience Manager Assets에 연결하려면 조직의 Adobe Workfront 인스턴스가 Adobe Business Platform 또는 Adobe Admin Console에 온보딩되어야 합니다.
>
...
이제 Workfront Planning의 다음 영역에서 Workfront 개체 페이지를 열 수 있습니다.
...
* 각 Workspace에 대해 계획 기능 레코드 유형과 Workfront 회사 및 그룹 객체 유형 간의 연결을 만들어야 합니다.
...
* 각 Workspace에 대해 Workfront에 대한 커넥터 레코드 유형이 있어야 합니다.
