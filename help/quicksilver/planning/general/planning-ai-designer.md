...
<p>모든 워크플로우 및 계획 패키지</p>
  ...
  <tr> 
   ...
   <td><p>표준</p> 
   <p><span class="preview">시스템 관리자가 조직에 대해 Planning Designer을 활성화할 수 있습니다.</span></p>
  </td> 
  </tr> 
  <tr> 
...
1. **AI 활성화**&#x200B;를 켜고 Adobe과 Gen AI 계약에 서명했는지 확인하십시오.
...
* Planning Designer을 사용하려면 먼저 조직에 대해 AI를 활성화해야 합니다. AI 기능을 조직의 모든 사용자가 사용할 수 있도록 하려면 다음 조건을 충족해야 합니다.

   * Workfront은 조직에서 AI 기능을 사용할 수 있도록 해야 합니다.
   ...
   * Workfront에서 조직에서 AI 기능을 사용할 수 있도록 만들면 주 Workfront 관리자가 액세스할 수 있습니다.
   ...
   * Workfront 관리자는 Gen AI 계약에 동의한 다음 조직에 대해 AI 및 Planning Designer을 켜야 합니다.

     자세한 내용은 [AI Assistant 사용 또는 사용 안 함](/help/quicksilver/workfront-basics/ai-assistant/enable-or-disable-assistant.md)을 참조하십시오.
* 시스템 관리자가 조직에 대해 AI와 Planning Designer을 켜면 기본적으로 모든 사용자가 Planning Designer을 사용할 수 있습니다.
