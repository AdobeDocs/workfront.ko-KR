...
<p>모든 Planning을 독립 실행형 제품 패키지로</p>
   </td> </tr>
  </tr> 
  <tr> 
   <td role="rowheader"><p>Workfront 라이선스</p></td> 
   <td><p>표준</p> 
   <p>Workfront 관리자는 조직에 대해 Planning Designer을 활성화해야 합니다</p>
  </td> 
  </tr> 
  <tr> 
   <td role="rowheader"><p>Planning 라이선스</p></td> 
   <td><p>표준</p> 
   <p>Workfront 관리자는 조직에 대해 Planning Designer을 활성화해야 합니다</p>
  </td> 
  </tr> 
...
시스템 관리자는 조직에 대해 Planning Designer Beta을 켤 수 있습니다. 이 설정이 켜지면 Workfront 인스턴스의 모든 사용자가 계획 영역에서 계획 Designer의 기능을 볼 수 있습니다.

1. Workfront 관리자로 로그인합니다.
...
* Planning Designer에 액세스하려면 Beta 계약에 서명해야 합니다.
...
* 조직에서 AI 계약에 서명한 경우 계획 영역에서 AI 비서를 사용할 때 계획 Designer에서 수행하는 작업도 AI 비서에서 수행할 수 있습니다.
...
1. Workfront에 로그인한 다음 왼쪽 상단의 **주 메뉴** 아이콘 ![줄 주 메뉴](assets/lines-main-menu.png)를 클릭한 다음 **계획**&#x200B;을 클릭합니다.
   ...
   **계획** 영역이 열립니다. <!--update screen shot when they change the name of the button-->
   ...
   ![작업 영역 페이지에서 AI로 만들기 단추](assets/design-with-ai-button-on-workspaces-page.png)
...
1. (선택 사항) 작업 영역을 편집하려면 다음 중 하나를 수행합니다.
   ...
   * 작업 영역을 열고 **AI로 편집**&#x200B;을 클릭합니다. 그러면 Planning Designer이 열립니다. 위의 단계를 반복하여 AI를 사용하고 작업 영역을 추가로 변경합니다.
