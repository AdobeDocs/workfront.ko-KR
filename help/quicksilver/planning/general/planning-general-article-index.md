...
description: 마케팅 운영 리더로서 Adobe Workfront 계획 수립을 사용하여 모든 팀의 마케팅 라이프사이클 전반에 걸쳐 작업을 구성할 수 있습니다. 이 섹션의 문서에서는 Workfront Planning에 대한 일반 개념, 구현 방법에 대한 모범 사례에 대해 설명하고 현재 사용할 수 있는 기능 중 일부에 대한 개요를 제공합니다.
author: Alina
...
마케팅 운영 리더로서 Adobe Workfront 계획 수립을 사용하여 모든 팀의 마케팅 라이프사이클 전반에 걸쳐 작업을 구성할 수 있습니다. 이 섹션의 문서에서는 Workfront Planning에 대한 일반 개념, 구현 방법에 대한 모범 사례에 대해 설명하고 현재 사용할 수 있는 기능 중 일부에 대한 개요를 제공합니다.
...
* [보고서에서 Workfront Planning 정보 보기](/help/quicksilver/planning/general/planning-information-in-reports.md)
