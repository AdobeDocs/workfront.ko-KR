...
* 버전 1.0 - 2024년 7월에 릴리스됨

  자세한 내용은 이 문서의 [Workfront Planning API 버전 1.0](#workfront-planning-api-version-10) 섹션을 참조하십시오.
  <!--
...
## Workfront Planning API 버전 1.0

Workfront Planning API 버전 1.0은 2024년 7월에 릴리스되었습니다.

다음 섹션에서는 Workfront API 버전 1.0에서 사용할 수 있는 기능에 대해 설명합니다.
