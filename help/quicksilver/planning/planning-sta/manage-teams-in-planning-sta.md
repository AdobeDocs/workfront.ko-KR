---
title: Adobe Workfront Planning에서 팀을 독립 실행형 제품으로 관리
...
1. **기본 메뉴** > **설정** > 팀 > **새 팀**&#x200B;을 클릭합니다.
   ...
   ![독립 실행형 Planning의 새 팀 상자](assets/new-team-planning-sta.png)
...
1. (선택 사항) 기존 팀을 편집하려면 다음 중 하나를 수행합니다.
   ...
   * 목록의 팀 이름을 마우스로 가리킨 다음 **추가** 메뉴 ![추가 메뉴](assets/more-menu.png) > **팀 편집**&#x200B;을 클릭합니다
