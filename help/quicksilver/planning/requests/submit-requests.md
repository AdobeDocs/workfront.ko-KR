...
1. **제출을 클릭합니다**.
   ...
   * <span class="preview">Planning의 레코드 형식에 **원래 요청** 연결 필드를 추가하여 레코드를 만든 원래 요청의 이름을 표시할 수 있습니다. 자세한 내용은 [레코드 종류 연결](/help/quicksilver/planning/architecture/connect-record-types.md)을 참조하십시오. </span>
...
1. (선택 사항) 동일한 공유 링크에 다른 요청을 추가하려면 **다른 요청 제출**&#x200B;을 클릭합니다.
