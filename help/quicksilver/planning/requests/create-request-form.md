...
1. (조건부) 프로덕션 환경에서 다음 옵션 중 선택하여 이 양식에 액세스할 수 있는 사용자 유형을 나타냅니다.
...
1. (조건부) 프로덕션 환경에서 이전 단계에서 **링크가 있는 모든 사용자**&#x200B;를 선택한 경우 사용 가능한 달력에서 **링크 만료 날짜**&#x200B;를 선택합니다.
...
1. (선택 사항 및 조건부) 프로덕션 환경에서 **링크 저장 및 복사**&#x200B;를 클릭하여 양식에 대한 공유 세부 정보를 저장합니다. 양식을 이전에 저장한 경우 **링크 복사**&#x200B;를 클릭합니다.
...
1. <span class="preview">(조건부) 미리 보기 환경에서 사용자와 공유하려면 내부 공유 탭을 선택하고 사용자 이름을 검색한 다음 목록에 표시될 때 선택합니다.</span>
1. <span class="preview">(조건부) 미리 보기 환경에서 공개 링크를 만들려면 공개 공유 탭을 선택한 다음 공개 링크 만들기 옵션을 켜십시오. 그런 다음 여기에서 링크를 복사하거나 링크 만료 날짜를 설정할 수 있습니다.</span>
