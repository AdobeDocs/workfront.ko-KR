...
# Workfront Planning 작업 영역을 GenStudio으로 승격
...
GenStudio for Performance Marketing 작업 영역은 회사가 제품을 모두 구매하고 Workfront 인스턴스가 회사의 GenStudio 인스턴스와 통합되는 경우 Adobe Workfront Planning에서 사용할 수 있습니다. Workfront Planning 작업 영역을 GenStudio으로 승격하고 두 시스템에서 해당 정보를 보고 업데이트할 수 있습니다.
