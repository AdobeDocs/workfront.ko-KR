...
* 다른 사용자에게 작업 영역에 있는 레코드보다 더 높은 권한을 부여할 수 없습니다.

  예를 들어 작업 공간에 대한 보기 권한과 레코드 유형에 대한 관리 권한을 다른 사용자에게 부여할 수 없습니다.
...
1. **저장**&#x200B;을 클릭합니다.
   ...
   사람들은 더 이상 레코드 종류에 액세스할 수 없습니다. 또한 작업 영역 권한에서 제거하지 않는 한 작업 영역에 대한 권한이 있을 수 있습니다.
