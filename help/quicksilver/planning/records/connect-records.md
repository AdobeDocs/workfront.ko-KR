...
1. 레코드 페이지에서 기존 연결된 레코드 페이지 탭을 클릭합니다. 먼저 연결된 레코드 페이지를 만들어야 합니다.

   연결된 레코드 유형 페이지가 테이블 뷰에 표시됩니다.

   한 유형의 연결된 모든 레코드가 테이블에 표시됩니다.
1. 기존 레코드를 추가하거나 제거하려면 프로젝트 목록에서 **연결** 또는 <span class="preview">**레코드 연결**&#x200B;을 클릭합니다</span>.
...
1. 프로젝트를 만들려면 프로젝트 목록에서 <span class="preview">**새 행**&#x200B;을 클릭합니다. 새 프로젝트는 현재 레코드에 자동으로 연결됩니다. </span>
