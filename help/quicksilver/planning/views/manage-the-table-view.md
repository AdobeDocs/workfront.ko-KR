...
1. 클릭 **필드 설정** 확인할 수 있습니다.
   ...
   >       * 공식
   >
   >   * 기본 필드는 항상 고정되어 있으므로 이동하거나 숨길 수 없습니다. 기본 필드가 고정되어 있고 가로 스크롤의 일부가 아닙니다. 기본 필드를 다른 위치로 이동해야 하는 경우 다른 필드를 선택하여 기본 필드를 대체할 수 있습니다.
   >
   ...
   >
   >   * 기본 필드는 레코드의 제목이 되며 레코드 헤더 영역의 레코드 페이지에 표시되며 레코드가 표시되는 모든 위치에 표시됩니다. 예를 들어 레코드 제목은 연결된 필드 및 모든 보기에 표시됩니다.
