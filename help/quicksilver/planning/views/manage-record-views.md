...
Adobe Workfront Planning 영역에서 레코드 유형을 선택한 후 해당 유형의 모든 레코드를 다양한 방법으로 표시할 수 있습니다.

자신에게 가장 적합한 방식으로 정보를 탐색하고 이해할 수 있는 유연성을 제공하는 여러 형식의 보기에서 레코드를 볼 수 있습니다. 구조화된 개요, 연대순 스토리, 날짜 기반 레이아웃 또는 간단한 스크롤 가능한 목록을 원하는 경우 각 보기는 고유한 관점을 제공합니다.

다음 보기에서 레코드를 볼 수 있습니다.
...
* 목록
  ...
  연결된 레코드 페이지의 레코드를 목록 보기로 볼 수 있습니다.

  >[!IMPORTANT]
  >
  >레코드 유형 페이지의 레코드 목록에는 목록 보기를 적용할 수 없습니다. 레코드의 연결된 레코드 페이지의 목록 보기만 연결된 프로젝트 목록에 적용할 수 있습니다. <!--this will change-->

  자세한 내용은 다음 문서를 참조하십시오.

   * [레코드에 연결된 레코드 페이지 추가](/help/quicksilver/planning/records/add-a-connected-records-page-to-a-record.md)
   * [목록 보기 관리](/help/quicksilver/planning/views/manage-the-list-view.md)
...
| 기능 | 테이블 보기 | 타임라인 보기 | 캘린더 보기 | 목록 보기 |
|-----------------------------------------------------------------------|------------|---------------|--------------|---------|
| 표 형식으로 레코드 표시 | ✓ |              | | ✓ |
| 모든 필드를 표나 목록에 열로 표시 | ✓ |              |    | ✓ |
| 필드(또는 열) 숨기기 또는 표시 | ✓ |               |    | ✓ |
...
이 섹션의 정보는 다음 보기 유형에 적용됩니다.

* 테이블
* 타임라인
* 캘린더

목록 보기에 대한 자세한 내용은 [목록 보기 관리](/help/quicksilver/planning/views/manage-the-list-view.md)를 참조하십시오.
...
>[!NOTE]
>
>목록 보기에서 실시간 현재 상태 표시기를 볼 수 없습니다.
