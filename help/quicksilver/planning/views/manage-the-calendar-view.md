---
title: 달력 보기 관리
description: 달력 보기에서 레코드와 해당 필드를 표시할 수 있습니다. 이 문서에서는 일정 보기를 만들고 기존 일정을 편집하거나 삭제하는 방법에 대해 설명합니다.
...
레코드 종류 페이지 에서 달력 보기로 레코드와 해당 필드를 표시할 수 있습니다.

Adobe Systems Workfront Planning 보기 및 관리 방법에 대한 자세한 내용은 레코드 보기[ 관리를 참조하십시오](/help/quicksilver/planning/views/manage-record-views.md).
...
* 다음과 같은 시나리오가 있습니다.
   ...
   * 시작 날짜가 종료 날짜 이후이면 달력에 레코드가 표시되지 않습니다.

달력 보기를 관리하려면:

1. 달력을 보려는 레코드 종류 페이지 로 이동합니다.
1. 레코드 보기[ 관리 문서에 설명된 대로 일정 보기를 만들기 합니다](/help/quicksilver/planning/views/manage-record-views.md).

   ![달력 보기 예](assets/calendar-view-example.png)

   선택한 레코드 종류와 연결된 레코드가 달력에 막대로 표시됩니다. 막대의 색상은 기본적으로 레코드 아이콘의 색상과 일치합니다.
...
달력 보기에서 필터 작업을 수행할 때 다음 사항을 고려합니다.

<!-- this list is almost identical to the one for the table view - update both-->

* 일정 보기에 대해 만든 필터는 동일한 레코드 종류에 적용되는 다른 보기의 필터와 독립적으로 작동합니다.

* 필터는 사용자가 선택하는 보기에 고유합니다. 레코드 종류가 같은 두 개의 달력 보기에는 서로 다른 필터가 적용될 수 있습니다.

* 동일한 일정 보기를 보고 있는 두 명의 사용자에게 현재 적용된 동일한 필터가 표시됩니다.

* 달력 보기용으로 빌드 한 필터의 이름을 지정할 수 없습니다.

* 필터를 제거하면 사용자와 동일한 레코드 종류에 액세스하고 사용자와 동일한 보기를 표시하는 모든 사용자로부터 필터가 제거됩니다.
...
1. 레코드 보기[ 관리 문서에 설명된 대로 레코드 종류에 대한 일정 보기를 만들기 합니다](/help/quicksilver/planning/views/manage-record-views.md).
1. 설정&#x200B;**클릭합니다**.
1. 왼쪽 패널에서 날짜 및 시간을 클릭한 **다음 달력에 표시할 시작 날짜**&#x200B;와 **종료 날짜를** 선택합니다&#x200B;**.** 기본 시작 및 종료 날짜를 선택하거나 사용 가능한 날짜 필드를 선택할 수 있습니다.
...
1. 왼쪽 패널에서 색상&#x200B;**클릭하여**&#x200B;달력의 레코드 색상을 사용자 지정합니다.

   ![달력 보기 설정의 색상 패널](assets/color-panel-on-calendar-view-settings.png)

1. **Set record color to(레코드 색 설정 대상**) 섹션에서 다음 옵션 중에서 선택하여 레코드의 색상을 설정합니다.
