...
1. <span class="preview">(선택 사항 및 조건부) 필드를 추가한 후 테이블 보기 열 헤더의 필드 이름 위로 마우스를 가져간 후 **자세히** 드롭다운 메뉴를 클릭한 다음 **필드 공유**&#x200B;를 클릭하여 필드를 공유합니다. </span>
   ...
   </span>자세한 내용은 [필드 공유](/help/quicksilver/planning/access/share-fields.md)를 참조하십시오. </span>
...
1. **기본 선택 항목** 필드에서 기본적으로 이 필드에 표시할 선택 항목을 선택합니다. 두 개 이상의 선택을 할 수 있습니다. 사용자는 이 필드를 업데이트할 때 기본 선택 사항을 제거할 수 있습니다.
...
1. **기본 선택** 필드에서 기본적으로 이 필드에 표시할 선택을 선택합니다. 한 가지 선택만 할 수 있습니다. 사용자는 이 필드를 업데이트할 때 기본 선택을 제거할 수 있습니다.
...
1. **새 필드** 탭에 다음 정보를 추가하십시오.
   ...
   * 다음 옵션 중에서 선택합니다.
     ...
     * **24시간**: 예: 18:00
     * **12시간**: 예: 오후 6:00
     * **모든 사용자에게 동일한 시간대 표시**, **표준 시간대 선택**: 사용자의 표준 시간대와 상관없이 필드를 보는 모든 사람에게 동일한 타임스탬프를 표시하려면 이 옵션을 선택하십시오. 선택한 시간대가 이 필드의 열 헤더에 추가됩니다.
...
1. **기본 사용자** 또는 **기본 사용자** 필드에서 기본적으로 이 필드에 표시할 사용자를 선택합니다.

   **여러 값 허용** 설정도 선택한 경우 두 명 이상의 사용자를 선택할 수 있습니다.

   사용자는 이 필드를 업데이트할 때 기본 사용자를 제거할 수 있습니다.

   >[!TIP]
   >
   >이 설정에서 기본 사용자로 선택된 사용자를 비활성화하면 사용자의 이름이 기본값으로 유지됩니다. 비활성화된 사용자는 필드 값에서 제거되지 않으며 다른 사용자에게는 비활성화된 사용자가 표시되지 않습니다.
