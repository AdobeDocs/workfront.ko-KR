...
마케팅 운영 리더로서 Adobe Workfront 계획 수립을 사용하여 모든 팀의 마케팅 라이프사이클 전반에 걸쳐 작업을 구성할 수 있습니다. Workfront Planning에서는 생성하는 모든 사용자 정의 레코드 유형에 대한 사용자 정의 필드 추가를 포함하여 워크플로우의 아키텍처를 완전히 사용자 정의할 수 있습니다.
