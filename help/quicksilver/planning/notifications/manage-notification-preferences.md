...
이 문서에서는 일반적으로 Adobe Workfront 알림이 아닌 Adobe Workfront Planning 알림을 관리하는 방법을 설명합니다.
...
<tr> 
   ...
   <td> 
<p>Planning 패키지가 있는 모든 Workfront 또는 워크플로우</p> <p>독립 실행형 제품으로 구입할 경우 모든 Planning 패키지</p>
   </td> 
  <tr> 
...
<tr> 
   ...
   <td><p>계획 기여자 이상</p>
<p><b>메모</b></p>
<p>모든 고객에게 기여자 라이센스가 있는 것은 아닙니다</p>
   </td> 
  </tr> 
<tr> 
...
* 승인 알림에 대한 자세한 내용은 다음 문서를 참조하십시오.

  * [Adobe Workfront Planning에서 요청 승인](/help/quicksilver/planning/requests/approve-request.md)
...
>[!NOTE]
>
>사용자 프로필 페이지의 Workfront 알림 영역이 아닌 Adobe 환경 설정 영역을 사용하여 Workfront Planning 알림을 관리할 수 있습니다.

1. Adobe Experience Cloud 자격 증명으로 Workfront에 로그인합니다.
1. 화면 오른쪽 상단의 **계정 메뉴** 아이콘 ![Experience Cloud의 계정 메뉴 아이콘](assets/account-menu-icon-on-experience-cloud.png)을 클릭한 다음 **환경 설정**&#x200B;을 클릭합니다.
...
1. Workfront에 사용할 수 있는 알림은 다음과 같습니다.
   ...
   * **승인**: 누군가 승인을 위해 Planning 요청을 제출하거나 Planning 개체에 대한 액세스를 요청하려는 경우 알림을 받습니다.
