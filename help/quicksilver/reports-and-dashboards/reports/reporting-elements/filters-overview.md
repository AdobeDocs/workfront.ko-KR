...
description: Adobe Workfront의 필터를 사용하여 목록, 보고서 또는 기타 영역에서 화면에 표시하는 정보의 양을 줄일 수 있습니다.
author: Lisa
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>키워드 검색을 기반으로 한 일회성 빠른 필터로 목록에서 항목을 신속하게 찾을 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
![베타 필터 빌더](assets/filter-sample-with-or.png)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>필터의 Workfront 데이터베이스 개체. Workfront에서 보고할 수 있는 객체에 대한 자세한 내용은 <a href="../../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md" class="MCXref xref">Adobe Workfront의 개체 이해</a>. </p> <p>예를 들어 프로젝트, 작업, 문제, 사용자, 문서가 필터의 개체일 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td><strong>필드</strong></td> 
   <td> <p>필터링하는 객체의 속성입니다. </p> <p>예를 들어 Portfolio 이름 또는 프로젝트 소유자별로 필터링할 수 있습니다. 이 경우 이름 및 소유자는 Portfolio 및 프로젝트 객체의 필드입니다. </p> </td> 
  </tr> 
  <tr> 
...
다음과 같은 방법으로 표준 또는 베타 빌더 인터페이스를 사용하여 필터를 만들 수 있습니다.
