...
1. 다음 필터 목록을 검토하십시오.
   ...
   <td>다른 사용자가 만들어 나와 공유했거나 시스템 전체에서 공유한 필터입니다.
   <p><b>메모</b></p>
   <p>기여자, 요청자 또는 외부 라이선스가 있는 사용자는 시스템 전체에서 공유되는 필터, 보기 또는 그룹화를 볼 수 없습니다. 이러한 사용자가 사용할 수 있도록 하려면 시스템 전반의 가시성에 의존하지 않고 사용자, 작업 역할, 팀, 그룹 또는 회사를 통해 직접 공유하십시오. 이는 필터, 보기 또는 그룹화가 레이아웃 템플릿에 포함된 경우에도 적용됩니다.</p>
...
1. 공유할 사용자에 따라 다음 중 하나를 완료합니다.
   ...
   **개별 사용자, 팀, 역할, 그룹 또는 회사와 공유하려면:** 제공된 필드에 공유할 사용자, 팀, 역할, 그룹, 회사 또는 비즈니스 프로필 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.\
