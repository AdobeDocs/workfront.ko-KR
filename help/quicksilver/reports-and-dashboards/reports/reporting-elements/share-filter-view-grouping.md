...
선택 목록에서 필터를 공유하는 것은 필터를 공유하는 데 사용하는 인터페이스에 따라 다릅니다. 필터 빌드 인터페이스 유형에 대한 자세한 내용은 [Adobe Workfront에서 필터 만들기 또는 편집](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/create-filters.md).

표준 인터페이스에서만 보기 및 그룹화를 공유할 수 있습니다.

* [표준 인터페이스를 사용하여 필터, 보기 및 그룹화 공유](#share-with-standard-interface)
* [Beta 빌더 인터페이스를 사용하여 필터 공유](#share-with-beta-builder-interface)

### 표준 인터페이스를 사용하여 필터, 보기 및 그룹화 공유 {#share-with-standard-interface}

표준 인터페이스에서 필터, 보기 및 그룹화를 공유하는 것은 동일합니다.
...
Workfront의 다른 객체에는 베타 빌더 인터페이스를 사용할 수 없습니다.

보고서를 작성할 때 베타 빌더 인터페이스에서 필터를 작성할 수 없습니다.

베타 빌더 인터페이스를 사용하여 필터 공유:
...
1. 을(를) 클릭합니다. **필터** 아이콘 ![필터 아이콘](assets/filter-nwepng.png)를 활성화한 후 **베타 설정** ![베타 설정](assets/beta-toggle-white-on-existing-filters.png) 베타 빌더에 액세스하려면 기본적으로 비활성화되어 있습니다.
   ...
   다음으로, 필요한 경우 베타 계약에 동의합니다.

   베타 필터 빌더 인터페이스가 열립니다.

   >[!TIP]
   >
   >Beta 빌더를 활성화하면 빌더 인터페이스 헤더가 파란색으로 변경됩니다. Beta Builder 인터페이스를 활성화하면 Workfront이 사용 가능한 모든 영역에 대해 활성화됩니다.
...
1. 시스템 전체 보기 설정을 활성화합니다. 이렇게 하면 Workfront의 모든 사용자가 필터를 볼 수 있는 권한이 제공됩니다.
