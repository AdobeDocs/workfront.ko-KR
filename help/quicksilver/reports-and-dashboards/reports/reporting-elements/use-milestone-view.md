...
* **계획된 일자 또는 예상 일자:** 마일스톤 보기에서 계획된 일자 또는 예상 일자를 표시할지 여부를 지정합니다.\
   ...
   * **프로젝트 완료 날짜:** 프로젝트가 완료 날짜부터 예약된 경우 프로젝트의 완료 날짜를 수동으로 변경할 수 있으며 시작 날짜가 계산됩니다.
   * **작업 완료 날짜:** 마일스톤 보기에서 직접 작업의 완료를 수동으로 업데이트할 수 있습니다.
...
1. **보기** 드롭다운 메뉴를 클릭한 다음 **마일스톤**&#x200B;을 클릭합니다.\
   Portfolio 또는 프로그램 내의 프로젝트 목록을 보려면 **마일스톤** 하위 탭을 선택하십시오.

1. 마일스톤 보기의 오른쪽 상단 모서리에서 **옵션**&#x200B;을 클릭합니다.\
...
1. (조건부) 마일스톤 보기에서 현재 완료율이 표시되지 않는 경우 마일스톤 보기의 오른쪽 상단 모서리에서 **옵션**&#x200B;을 클릭한 다음 **완료율**&#x200B;이 활성화되어 있는지 확인하십시오.
