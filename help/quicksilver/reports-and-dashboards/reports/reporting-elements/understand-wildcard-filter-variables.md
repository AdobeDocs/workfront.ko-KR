...
<table>
    ...
    <tr>
        <td>고급 검색</td>
        <td>고급 검색에 대한 자세한 내용은 문서 <a href="../../../workfront-basics/navigate-workfront/search/search-workfront.md#using-advanced-search">Adobe Workfront 검색</a>에서 <a href="../../../workfront-basics/navigate-workfront/search/search-workfront.md">고급 검색 사용</a> 섹션을 참조하십시오.
    </tr>
    <tr>
        <td>보기의 계산된 열</td>
        <td></td>
    ...
    <tr>
        <td>보기의 조건부 서식</td>
        <td>조건부 서식에 대한 자세한 내용은 문서 <a href="../../../reports-and-dashboards/reports/reporting-elements/use-conditional-formatting-views.md">보기에서 조건부 서식 사용</a>을 참조하십시오.
    </tr>
    <tr>
        <td>계산된 사용자 정의 필드</td>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>$$USER.name 변수는 로그인한 사용자의 전체 이름을 나타냅니다.</p> <p>메모:   <p>이 와일드카드 변수는 텍스트 모드에서 필터를 수정하는 경우에만 작동합니다. 텍스트 모드를 지원하지 않는 필터에서는 이 와일드카드를 사용할 수 없습니다. 예를 들어 다음 영역의 필터에서는 이 와일드카드를 사용할 수 없습니다.</p> 
     <ul> 
      <li> <p>리소스 플래너</p> </li> 
      <li> <p>워크로드 밸런서</p> </li> 
     </ul> </p> </td> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>$$USER.homeGroupID 변수는 로그인한 사용자의 홈 그룹 ID를 참조합니다. 그룹 관리자는 이 변수를 사용하여 홈 그룹의 사용자에 속하는 항목에 대해서만 필터링할 수 있습니다.</p> <p>예를 들어, 재무 그룹의 프로젝트에서 완료되지 않은 모든 작업을 보려면 작업 필터에서 다음 필터 규칙을 사용하십시오.<br><em>프로젝트: 그룹 ID가 $$USER.homeGroupID와 같음 </em><br><em>완료율이 100퍼센트 미만임</em></p> <p>로그인한 사용자의 홈 그룹인 특정 그룹의 개인에게 할당된 모든 미완료 작업을 보려면 작업 필터에서 다음 필터 규칙을 사용합니다.</p> <p><em>할당 대상: 그룹 ID가 $$USER.homeGroupID와 같음<br>완료율이 100보다 작음</em> </p> </td> 
  </tr> 
  <tr valign="top"> 
