...
description: 달력 보고서는 작업의 시각적 표현을 제공하는 동적 보고서입니다. 달력 보고서에서 태스크, 현안 및 프로젝트에 대해 계획 일자 필드를 사용할 수 있습니다.
author: Courtney
...
또는
**[!UICONTROL + 새 일정]**&#x200B;을 클릭하고 일정 이름을 입력합니다.

   >[!NOTE]
   >
   >일정 보고서를 만들려면 액세스 수준에서 보고서, 대시보드 및 일정에 대한 편집 액세스 권한이 있어야 합니다.
   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr data-mc-conditions="">
      ...
      <td><p>달력이 사용 가능한 실제 날짜로 자동 전환됩니다. <br>사용 가능한 경우 실제 날짜로 전환하려면 <strong>[!UICONTROL 예]</strong> 또는 <strong>[!UICONTROL 아니요]</strong>를 선택하세요. 실제 날짜에 대한 자세한 내용은 다음을 참조하십시오</p>
       <ul>
        <li><a href="../../../manage-work/projects/planning-a-project/project-actual-start-date.md" class="MCXref xref">프로젝트 실제 시작 날짜 개요 </a></li>
...
1. **[!UICONTROL 작업/프로젝트/문제 레이블을...]** 필드로 설정 필드에서 이 일정 그룹의 개체 레이블 지정 방법을 선택합니다.

   >[!NOTE]
   >
   >특정 개체에 대해 기본 레이블 옵션을 사용할 수 없는 경우 개체 이름이 대신 표시됩니다. 예를 들어 [!UICONTROL 상위 작업] 레이블이 선택되어 있고 개체와 연결된 상위 작업이 없는 경우 [!DNL Adobe Workfront]은(는) 달력에서 보고 있는 개체 이름을 표시합니다.
