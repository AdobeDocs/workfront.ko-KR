...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>프로젝트의 상태가 On Target(녹색), In Trouble(빨간색) 또는 At Risk(노란색)임을 나타냅니다.<br>프로젝트 상태에 대한 자세한 내용은 <a href="../../../manage-work/projects/manage-projects/project-condition-and-condition-type.md" class="MCXref xref">프로젝트 상태 및 상태 유형 개요</a>를 참조하십시오.</td> 
   <td>프로젝트</td> 
