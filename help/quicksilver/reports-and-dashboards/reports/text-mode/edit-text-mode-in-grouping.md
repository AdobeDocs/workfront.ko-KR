...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>필터, 보기, 그룹화에 대한 액세스 편집</p> <p>보고서, 대시보드, 달력에 대한 액세스 권한을 편집하여 보고서의 그룹화를 편집합니다.</p></td> 
  </tr> 
  <tr> 
...
1. 그룹화를 추가하려면 **그룹화 추가**&#x200B;를 클릭하고, 빌더의 오른쪽 상단에서 **텍스트 모드로 전환**&#x200B;을 클릭한 다음 **텍스트 모드 편집**&#x200B;을 클릭합니다.
