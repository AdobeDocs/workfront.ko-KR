...
Adobe Workfront의 보고서를 사용하여 시스템의 개체에 대한 정보를 검토하거나 편집할 수 있습니다. 사용자 고유의 보고서를 만들고, 만든 보고서를 구성하고, 나와 공유되거나 공개적으로 공유된 보고서를 볼 수 있습니다.
...
1. 보려는 보고서에 따라 다음 옵션 중 하나를 클릭합니다.
   ...
   * **모든 보고서**&#x200B;를 클릭하여 만든 보고서와 함께 공유되거나 공개적으로 공유된 보고서를 모두 봅니다.
...
1. **내 보고서** 폴더에서 새 폴더에 보고서를 추가합니다.\
   새 폴더에 보고서를 추가하는 방법에 대한 자세한 내용은 이 문서의 [폴더에 보고서 추가](#add-reports-to-a-folder) 섹션을 참조하세요.

   >[!NOTE]
   >
   >**내 보고서** 폴더에만 새 폴더를 추가할 수 있습니다. **나와 공유됨** 또는 **모든 보고서** 폴더에는 새 폴더나 보고서를 추가할 수 없습니다.
...
1. 보고서를 추가할 폴더를 선택합니다.
   ...
   >[!NOTE]
   >
   >보고서를 **내 보고서** 폴더에서 **내 보고서** 아래에 중첩된 다른 폴더로만 이동할 수 있습니다. **나와 공유됨** 또는 **모든 보고서** 폴더에서 다른 폴더로 또는 다른 폴더로 보고서를 이동할 수 없습니다.
