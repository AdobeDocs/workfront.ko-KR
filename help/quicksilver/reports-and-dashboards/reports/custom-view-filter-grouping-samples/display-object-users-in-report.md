...
description: 보고서나 목록의 객체와 연관된 사용자, 작업 역할 및 팀을 표시할 수 있으며 필터에서 참조할 수도 있습니다. 개체와 연관된 사용자, 작업 역할 또는 팀별로 그룹화할 수 없습니다.
...
보고서나 목록의 객체와 연관된 사용자, 작업 역할 및 팀을 표시할 수 있으며 필터에서 참조할 수도 있습니다. 개체와 연관된 사용자, 작업 역할 또는 팀별로 그룹화할 수 없습니다.
...
프로젝트에 있는 모든 사용자 및 해당 역할을 표시하도록 프로젝트 보고서를 만드는 방법에 대한 자세한 내용은 [보기: 작업 역할이 있는 프로젝트 사용자 목록](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-project-user-list.md)을 참조하십시오.

프로젝트 필터에서 프로젝트와 연결된 사용자 또는 작업 역할에 대해 필터링할 수 없습니다.
...
문제에 할당된 모든 사용자, 역할 또는 팀을 문제 목록 또는 보고서 보기에 표시하여 [할당] 필드를 보기에 추가할 수 있습니다.

문제 필터에서 다음 필드를 참조하여 문제에 할당된 사용자, 작업 역할 또는 팀별로 필터링할 수 있습니다.
...
프로그램과 관련된 모든 사용자 및 역할을 프로젝트 보고서에 표시한 다음 보고서를 프로그램별로 그룹화하여 표시할 수 있습니다.
