...
title: '그룹화: 작업 퍼센트 분류 1'
description: '''이 사용자 지정 프로젝트 그룹화에서는 완료율 값 범위별로 그룹화된 프로젝트를 표시할 수 있습니다. 분류는 25% 포인트 증가의 완료율을 보여줍니다. 0~25%, 25~50% 등'
...
이 사용자 지정 프로젝트 그룹화에서는 완료율 값 범위별로 그룹화된 프로젝트를 표시할 수 있습니다. 분류는 25% 포인트 증가의 완료율을 보여줍니다. 0~25%, 25~50% 등 

다음 그룹화는 완료율 값을 기준으로 작업을 6개의 다른 그룹으로 구성합니다.
