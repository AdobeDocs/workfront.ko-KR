...
1. 텍스트를 다음 코드로 바꿉니다.
   ...
   <pre>group.0.linkedname=direct<br>group.0.name=Percent Break<br>group.0.notime=false<br>group.0.valueexpression=IF({percentComplete}=0,"0 %",IF({percentComplete}&lt;=26,"0-25 %",IF({percentComplete}&lt;=51,"25-50 %",IF({percentComplete}&lt;=76,"50-75 %",IF({percentComplete}&lt;100,"75-99 %","100 %")))<br>group.0.valueformat=string</pre>
