...
title: '그룹화: 작업 비율 분류 2'
description: 이 사용자 정의 작업 그룹에서는 완료율 값 범위로 그룹화된 작업을 표시할 수 있습니다. 분류는 1~10%, 11~20% 등 10% 포인트 증가의 완료율 값을 보여 줍니다.
author: Nolan
...
이 사용자 정의 작업 그룹에서는 완료율 값 범위로 그룹화된 작업을 표시할 수 있습니다. 분류는 1~10%, 11~20% 등 10% 포인트 증가의 완료율 값을 보여 줍니다.
