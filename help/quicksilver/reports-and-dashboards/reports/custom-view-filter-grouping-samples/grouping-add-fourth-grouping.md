...
매트릭스 보고서에는 4개의 그룹화가 있을 수 있습니다. 매트릭스 보고서에 대한 자세한 내용은 [매트릭스 보고서 만들기](../../../reports-and-dashboards/reports/creating-and-managing-reports/create-matrix-report.md).

표준 인터페이스를 통해 표준 보고서에 3개의 그룹화만 포함할 수 있습니다. 표준 보고서에서 4번째 그룹을 추가하려면 텍스트 모드를 사용해야 합니다.

![Four_groups_in_a_standard_report.png](assets/four-groupings-in-a-standard-report-350x59.png)

예를 들어, 프로젝트 이름, 진행 상태 및 계획 완료 날짜별로 그룹핑된 작업 보고서가 있을 수 있지만, 지정 대상 이름으로 보고서를 그룹화하려는 경우도 있습니다.
