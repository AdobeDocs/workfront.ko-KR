...
description: 이 작업 보기에는 작업의 총 계획된 시간, 각 할당자에게 할당된 계획된 시간 수, 총 실제 시간 및 각 할당자가 기록한 실제 시간 수가 표시됩니다.
...
이 작업 보기에는 작업의 총 계획된 시간, 각 할당자에게 할당된 계획된 시간 수, 총 실제 시간 및 각 할당자가 기록한 실제 시간 수가 표시됩니다.
