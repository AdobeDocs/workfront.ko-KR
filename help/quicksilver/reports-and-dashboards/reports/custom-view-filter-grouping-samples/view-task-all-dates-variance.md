...
description: 이 작업 보기는 Adobe Workfront 계정에 제공된 "모든 날짜" 보기와 유사합니다. 이 특정 뷰에는 다음 날짜 사이의 일자 차이를 계산하는 차이 열이 포함되어 있습니다. EDIT ME.
...
이 작업 보기는 Adobe Workfront 계정에 제공된 &quot;모든 날짜&quot; 보기와 유사합니다. 이 특정 보기는 다음과 같습니다 *분산* 열 - 다음 날짜 사이의 일자 차이를 계산합니다.
...
이 보기는 계산된 열의 예를 나타내며, 두 개의 다른 열의 값을 가져와서 계산으로 연결하여 세 번째 값을 얻을 수 있습니다. 이 경우 날짜 1을 일자 2에서 빼게 됩니다.

보기에서 계산을 사용하는 방법에 대한 자세한 내용은 [텍스트 모드에 대한 일반적인 사용 개요](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md) 섹션  [텍스트 모드에 대한 일반적인 사용 개요](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md).
