...
>[!IMPORTANT]
>
>대시보드 페이지는 더 이상 대시보드에 포함된 외부 페이지로 지원되지 않습니다. 기존 대시보드는 이러한 외부 페이지를 제거하도록 자동으로 수정되지 않지만, 이러한 참조를 포함하는 대시보드에 대한 수정 사항은 참조가 제거되거나 변경될 때까지 저장할 수 없습니다.
>
...
>
>다른 솔루션으로서, 다음 설명에 따라 대시보드에 목록 보고서를 포함하는 것이 좋습니다. [대시보드에 보고서 추가](/help/quicksilver/reports-and-dashboards/dashboards/creating-and-managing-dashboards/add-report-dashboard.md)
