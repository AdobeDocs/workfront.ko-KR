...
열 시각화는 세로 열을 사용하여 중요한 정보를 강조 표시하여 데이터에 대한 스토리를 빠르게 전달하는 데 도움이 될 수 있습니다.
...
1. 시각화 블록을 **열** 시각화 유형을 보고서에 지정합니다. [보고 캔버스에서 시각화 블록 추가 또는 편집](../../../reports-and-dashboards/reporting-canvas/visualization-blocks/add-or-edit-report-visualization.md).
      ...
      <table style="table-layout:auto">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td><p>가로로 나타낼 데이터 또는 열 시각화의 X축을 선택합니다. 시각화는 이 축의 항목을 세로 축의 각 항목에 따라 비교합니다.</p></td>
        </tr>
        <tr>
         <td role="rowheader">세로 축</td>
         <td><p>왼쪽 드롭다운 메뉴에서 가로 또는 Y축을 따라 나타낼 데이터를 선택합니다. 시각화는 값을 기반으로 이 축의 항목을 비교 열로 표시합니다.</p><p>오른쪽 드롭다운 메뉴에서 디스플레이에서 이러한 값을 계산할 방법을 선택합니다.</p>
          <ul>
