...
대시보드를 만들고 대시보드에 보고서를 추가한 후에는 해당 특정 대시보드에 더 이상 적용할 수 없는 이전 보고서를 제거할 수 있습니다.
...
보고서를 제거하려면 먼저 대시보드에 보고서를 추가해야 합니다.
...
1. **캔버스 대시보드** 페이지에서 업데이트할 대시보드의 오른쪽 위 모서리에 있는 **자세히** ![자세히 아이콘](assets/more-icon.png) 아이콘을 선택한 다음 **제거**&#x200B;를 선택합니다.

   ![보고서 제거](assets/delete-a-report.png)

1. 표시되는 **보고서 삭제** 대화 상자에서 **삭제**&#x200B;을 클릭합니다. 보고서가 삭제되고 대시보드에서 제거됩니다.