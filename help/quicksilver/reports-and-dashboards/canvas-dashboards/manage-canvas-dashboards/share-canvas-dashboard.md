...
* 대시보드의 보고서가 사용자로 실행 옵션으로 구성된 경우 모든 뷰어에 자체 권한이 아닌 선택한 사용자의 권한에 따른 데이터가 표시됩니다. 즉, 뷰어는 일반적으로 액세스할 수 없는 데이터를 볼 수 있습니다. 대시보드의 일부 보고서에서 사용자로 실행 을 사용하고 다른 보고서에서는 사용하지 않는 경우 보고서 간에 일관되지 않은 데이터가 표시될 수 있습니다.
