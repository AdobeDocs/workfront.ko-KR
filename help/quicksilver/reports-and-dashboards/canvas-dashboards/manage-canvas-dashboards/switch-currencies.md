...
<li>프로덕션 환경에서 캔버스 차트, KPI 및 테이블 보고서 <span class="preview">의 계획 통화 필드를 사용합니다. 미리 보기 환경에서 사용할 수 있습니다.</span></li>
</ul>

<p><b>메모</b></p>
<span class="preview">Planning 통화 필드에서 정의된 환율 없이 통화를 사용하는 경우 다음과 같은 경우 Canvas Dashboard에 오류 메시지가 표시될 수 있습니다.</span>
...
<p><span class="preview">Planning 통화 필드에서 정의된 환율이 없는 통화를 사용하는 경우 다음과 같은 경우 Canvas Dashboard에 오류 메시지가 표시될 수 있습니다.</span></p>
