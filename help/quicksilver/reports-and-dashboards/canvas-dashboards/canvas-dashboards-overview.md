...
현재 반복적인 접근 방식으로 Canvas Dashboard에서 다음 기능을 사용할 수 있도록 만들고 있습니다.
...
캔버스 대시보드에 추가된 기능에 대한 자세한 내용은 [제품 릴리스](/help/quicksilver/product-announcements/product-releases/product-releases.md)를 참조하세요.
