...
캔버스 대시보드를 사용하면 다양한 보고서 유형을 유연한 캔버스 레이아웃에 추가하여 Adobe Workfront 데이터를 시각화할 수 있습니다. 이 문서에서는 캔버스 대시보드를 효과적으로 사용하는 방법에 대한 개요를 제공합니다.

## 캔버스 대시보드 액세스

캔버스 대시보드에 액세스하려면 Adobe Workfront의 대시보드 섹션으로 이동합니다. 필요한 권한이 있는 경우 여기에서 기존 대시보드를 보거나 새 대시보드를 만들 수 있습니다.
...
대시보드에서 개별 보고서와 상호 작용할 수 있습니다.

### 테이블 보고서 임시 사용자 지정

대시보드에서 표 보고서를 일시적으로 사용자 지정할 수 있습니다. 이러한 변경 사항은 현재 세션에만 적용되며 원래 보고서 구성에는 영향을 주지 않습니다.

1. 왼쪽 패널에서 **캔버스 대시보드**&#x200B;를 클릭합니다.
1. 기존 대시보드 이름을 클릭하여 엽니다.
   ![대시보드 열기](assets/open-dashboard.png)
1. 사용자 지정할 테이블 보고서를 찾습니다.
1. 다음 옵션 중 하나를 선택하여 보고서를 사용자 지정합니다.

   | 옵션 | 설명 |
   |--------|-------------|
   | **열 추가** | 보고서에 열을 추가하려면 **열 추가**&#x200B;를 클릭하십시오. |
   | **열 구성** | 보고서에서 특정 열을 표시하거나 숨기도록 선택합니다. |
   | **행 높이** | 보고서의 행 높이를 조정합니다. |
   | **스냅 스크롤** | 보고서를 더 쉽게 탐색하려면 스냅 스크롤을 활성화하거나 비활성화하십시오. |
