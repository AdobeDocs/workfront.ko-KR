...
<table>
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>CATEGORYID(자체)<br>ENTEREDBYID<br>GROUPID <br>LASTUPDATEDBYID <br>SYSID</td>
        <td>자체<br>사용자_현재 | USERID<br>GROUPS_CURRENT | GROUPID <br>USERS_CURRENT | USERID <br>관계가 아닙니다. 내부 응용 프로그램 용도로 사용됩니다.</td>
    </tr>
    <tr>
        <td>범주 매개변수</td>
        <td>사용자 정의 양식 필드</td>
    ...
    <tr>
        ...
        <td>CATEGORS_CURRENT | CATEGORYID<br>Self<br>USERS_CURRENT | 사용자 ID <br>GROUPS_CURRENT | GROUPID<br>USERS_CURRENT | USERID <br>비인적 리소스 범주 테이블은 현재 지원되지 않습니다. <br>관계가 없습니다. 내부 응용 프로그램 용도로 사용됩니다.    </td>
    </tr>
    <tr>
        <td>비근무일</td>
        <td>일정 예외</td>
    ...
    <tr>
        ...
        <td>APPROVALPROCESSID<br>ASSIGNEUTTOID<br>CATEGORYID<br>CURRENTAPPROVALSTEPID<br>ENTEREDBYID<br>EXCHANGERATEID<br>ITERATIONID<br>KANBANBOARDID<br>LASTCONDITIONNOTEID<br>LASTNOTEID<br>LASTUPDATEDBYID<br>OPTASKID<br>OWNERID<br>PROJECTID<br>QUEUEDEFID<br>QUEUETOPICID<br>RESOLVEOPTASKID<br>RESOLVETID<br>1}RESOLVINGOBJID<br>ROLEID<br>SOURCEOBJID<br>SOURCETASKID<br>SUBMITTEDBYID<br>TEAMID<br></td>
    ...
    <tr>
        ...
        <td>AEMNATIVEFOLDERTREESREFID<br>ALIGNMENTSCORECARDID<br>APPROVALPROCESSID<br>ATTACHEDRATECARDID<br>CATEGORYID<br>COMPANYID<br>CONVERTEDOPTASKID<br>CONVERTEDOPTASKORIDATORID<br>CURRENTAPPROVALSTEPID<br>DELIVERABLESCORECARDID<br>ENTEREDBYID<br>GROUPID<br>LASTCONDITIONNOTEID<br>LASTNOTEID<br>LASTUPTEDBYID<br>MILESTONEPATHID<br>OWNERID<br>POPACCOUNTID 7}PORTFOLIOID<br>PRIVATERATECARDID<br>PROGRAMID<br>PROJECTID<br>QUEUEDEFID<br>REJECTIONISSUID<br>RESOURCEPOOLID<br>SCHEDULEID<br>SPONSORID<br>SUBMITTEDBYID<br>TEAMID<br>TEMPLATEID<br></td>
    ...
    <tr>
        ...
        <td>ACCESSLEVELID<br>CATEGORYID<br>COMPANYID<br>DEFAULTHORTYPEID<br>DELEGATIONTOID<br>EAUTHUSERID<br>ENTEREDBYID<br>HOMEGROUPID<br>HOMETEMAID<br>LATESTUREDNOTEID<br>LASTUPDATEDBYID<br>LATESTUPDATENOTEID<br>LAYOUTTEMPLATEID<br>MANAGERID<br>PORTALPROFILEID<br>PREFUIID<br>PRIVATERATECARDID<br>RESOURCEOLIPOD<br>ROLEID{18 SCHEDULEID<br>TIMESHEETPROFILEID<br>UITEMPLATEID<br>USERID<br>UUSERID<br></td>
