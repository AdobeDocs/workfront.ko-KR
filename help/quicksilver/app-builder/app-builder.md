...
Adobe App Builder 기반의 Workfront UI 확장 기능을 사용하면 고객과 파트너가 맞춤화된 사용자 경험을 만들 수 있습니다. 이러한 도구를 통해 효율성을 높이고 원활하고 연결된 경험을 제공하며 사용자 만족도를 크게 향상시킬 수 있을 뿐만 아니라 기업이 고유한 비전을 실현하는 데 도움이 됩니다.
...
기본 메뉴 및 보조 탐색에 대한 UI 확장 포인트와 마찬가지로 &quot;위젯&quot; 확장 포인트는 일반적으로 `ExtensionRegistration.js` 필드에 있는 `ExtensionRegistration` 구성 요소의 메서드 개체 내에 구성됩니다. 즉, 양식 위젯을 사용하려면 app.js에서 올바른 경로를 사용하여 `extesionregistration`의 &quot;위젯&quot; 항목만 추가해야 합니다.
