...
[!DNL Claude Code] 기술 집합을 사용하면 [!DNL Claude]에서 [!DNL Workfront]에 대한 사용자 지정 [!DNL Adobe App Builder] 앱을 빌드할 수 있습니다. 즉, 개발자가 되지 않거나 설정 단계를 직접 작성하지 않고도 원하는 것을 일반 영어로 설명하여 빌드할 수 있습니다.
...
## Claude를 위한 UI 확장성 기술

[!DNL Adobe App Builder]을(를) 빌드하는 것은 상당히 기술적일 수 있으며, 사용자가 절차 또는 기술에 익숙하지 않은 경우 장벽을 만들 수 있습니다. UI 확장성 기술은 [!DNL Claude]을(를) 사용하여 이 프로세스를 간소화합니다. 원하는 기능을 설명하면 [!DNL Claude]이(가) 도구 설정, [!DNL Adobe App Builder]에서 프로젝트 만들기, 앱 빌드, Adobe 클라우드로 배포, Workfront 내에서 실행 등의 실습 작업을 수행합니다. 사용자의 작업이 필요한 결정 또는 로그인이 있는 경우에만 프로세스에 참여합니다.

## 전제 조건

시작하기 전에 다음을 확인하십시오.

* **[!DNL Claude Code]**&#x200B;이(가) 설치되었습니다.
* **스킬에 액세스**.
