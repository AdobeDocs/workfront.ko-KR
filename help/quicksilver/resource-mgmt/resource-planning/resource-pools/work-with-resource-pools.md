...
사용자를 사용하여 리소스 풀을 채우고 프로젝트에 첨부하지 않으면 효율적인 리소스 관리를 수행할 수 없습니다. 리소스 계획 기능을 사용하기 위한 전제 조건입니다.

Resource Planning을 사용하기 전에 필요한 사전 요구 사항에 대한 자세한 내용은 [리소스 플래너 개요](../../../resource-mgmt/resource-planning/get-started-resource-planner.md).

리소스 풀 생성 및 관리에 대한 자세한 내용은 다음 문서를 참조하십시오.

* [리소스 풀 만들기](../../../resource-mgmt/resource-planning/resource-pools/create-resource-pools.md)
* [프로젝트 및 템플릿에 리소스 풀 연결](../../../resource-mgmt/resource-planning/resource-pools/associate-resource-pools-with-projects-and-templates.md)
...
* 리소스 풀은 프로젝트 완료에 동시에 필요한 사용자 모음입니다.
* 리소스 풀은 프로그램 및 포트폴리오의 모든 프로젝트와 연결되어 있을 때 여러 프로젝트, 프로그램 또는 포트폴리오에서 공유할 수 있습니다.
* 리소스 풀을 생성하고 기존 사용자로 채우거나, 리소스 풀을 만들어 기존 사용자와 연결하거나, 사용자를 만들거나 편집할 때 새 사용자와 리소스 풀을 만들 수 있습니다.
* 사용자로 리소스 풀을 채운 후 프로젝트 및 템플릿에 연결하고 프로젝트에 대한 사용자 할당을 보다 효율적으로 관리할 수 있습니다.
* 필요에 따라 프로젝트, 템플릿 또는 사용자와 리소스 풀을 연결할 수 있습니다.

## 사용자를 리소스 풀과 연관시키는 기준
...
* 동일한 리소스 풀의 모든 사용자가 동일한 팀에 속하도록 할 수 있습니다.
   ...
   예를 들어, 마케팅 팀의 모든 사용자를 프로젝트에 사용할 수 있도록 하려면 해당 팀의 모든 사용자를 추가할 마케팅 리소스 풀을 만들어야 합니다. 그런 다음 마케팅 리소스 풀을 해당 팀 구성원이 할당된 프로젝트와 연결할 수 있습니다.

* 동일한 리소스 풀의 모든 사용자가 유사한 역할을 수행하도록 할 수 있습니다. 특히 역할이 수요가 높으므로 별도로 예산을 책정해야 할 경우 더욱 그렇습니다.

   예를 들어, 수시로 프로젝트에 사용할 수 있도록 하려는 컨설턴트로 작동하는 외부 리소스가 있을 수 있습니다. 프로젝트에 연결할 수 있는 컨설턴트용 리소스 풀을 만들 수 있습니다. 이 경우 내부 또는 외부 컨설턴트인 사용자를 모두 배치할 수 있습니다.

* 부서 또는 비용 센터별로 자원 풀을 생성할 수도 있습니다.
* 사용자가 많거나 한 번에 많은 수의 프로젝트를 위해 리소스를 관리하는 경우에는 시스템의 모든 사용자를 하나의 리소스 풀에 추가하지 않는 것이 좋습니다.
