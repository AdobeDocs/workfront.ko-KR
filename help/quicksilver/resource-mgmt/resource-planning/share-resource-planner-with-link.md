...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>액세스 수준 구성</td> 
   <td> <p>리소스 관리, 프로젝트 및 사용자에 대한 보기 이상의 액세스 권한</p> <p>비용 정보를 조회하기 위해 원가 비율 조회 및 일반 재무 조회에 대한 액세스를 포함하는 재무 데이터에 대한 액세스 조회</p></td> 
  </tr> 
  <tr> 
   <td>개체 권한</td> 
...
* 작업, 기여자 및 사용 허가된 사용자를 포함하여 다른 사용자와 URL을 공유할 수 있습니다.\
