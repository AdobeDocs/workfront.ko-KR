...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>액세스 수준 구성</td> 
   <td> <p>리소스 플래너에서 우선순위 및 예산 시간 편집에 대한 액세스 권한이 포함된 리소스 관리에 대한 액세스 편집</p> <p>원가율 편집 및 일반 재무 편집에 대한 액세스 권한을 포함하는 재무 데이터에 대한 액세스 편집 및 원가별 리소스 예산 책정</p> <p>프로젝트 및 사용자에 대한 액세스 편집</p></td> 
  </tr> 
  <tr> 
   <td>개체 권한</td> 
