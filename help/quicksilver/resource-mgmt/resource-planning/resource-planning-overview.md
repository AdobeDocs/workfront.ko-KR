...
* [프로젝트 및 역할 보기를 사용하여 리소스 플래너의 리소스 예산](../../resource-mgmt/resource-planning/budget-resources-project-role-views-resource-planner.md)
* [리소스 플래너에서 예산 책정 날짜 조정](../../resource-mgmt/resource-planning/adjust-budgeting-dates.md)
