...
>[!CAUTION]
>
>업무 균형자 에는 작업 항목당 최대 1000개의 계획된 시간과 항목 지속 시간의 최대 1000일만 표시됩니다. 업무 균형자의 할당은 1000시간 또는 1000일 제한에 도달하면 0으로 표시됩니다. 계획된 시간이 더 많거나 1000일 이상의 기간을 사용하려면 작업을 더 작은 하위 작업으로 나누는 것이 좋습니다.
...
1. (선택 사항) **설정** 아이콘 ![](assets/gear-icon-settings.png) 다음 옵션 중 하나를 선택합니다.
   ...
   1. **남은 시간 표시** 옵션을 선택합니다. 사용자 라인의 각 사용자에 대한 총 시간 수가 변경됩니다. 이 설정을 활성화하면 업무 균형자 는 할당된 시간 대신 각 사용자가 작업에 사용할 수 있는 시간을 표시합니다.
