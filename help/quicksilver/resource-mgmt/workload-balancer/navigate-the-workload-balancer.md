...
1. (선택 사항) **할당 숨기기 아이콘** ![](assets/show-allocations-icon-small.png)을 클릭하여 작업 항목의 막대에 작업 및 문제의 이름을 표시합니다.
1. 작업 또는 문제 이름 오른쪽에 있는 **기타 메뉴** 아이콘 ![](assets/more-icon.png)을(를) 클릭한 다음 아래 옵션 중 하나를 클릭하십시오.
...
1. 요약 패널에서 자세한 정보를 보려면 다음 중 하나를 수행합니다.
   ...
   * **요약 열기** 아이콘 ![](assets/summary-panel-icon.png)을(를) 클릭한 다음 작업 또는 문제의 막대를 클릭하여 요약 패널을 엽니다.
