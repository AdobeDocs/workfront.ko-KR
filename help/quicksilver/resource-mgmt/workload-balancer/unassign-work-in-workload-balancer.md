...
드래그 앤 드롭으로 사용자 할당을 취소하는 방법에 대한 자세한 내용은 [드래그 앤 드롭으로 업무 균형자에서 작업 할당](../../resource-mgmt/workload-balancer/assign-work-in-workload-balancer-by-drag-and-drop.md)

일괄 사용자 할당 해제에 대한 자세한 내용은 [업무 균형자 를 사용하여 일괄 작업 할당](../../resource-mgmt/workload-balancer/assign-work-in-workload-balancer-in-bulk.md).
...
1. 업무 균형자에서 **할당된 작업** 사용자 영역을 지정하고 확장합니다.
1. 다음 중 하나를 수행하십시오.

   * 사용자 영역에서 할당 해제할 항목을 찾아 클릭한 다음 할당 해제된 영역 또는 다른 사용자 영역으로 끌어서 놓습니다.
   * 다음을 클릭합니다. **자세히** 아이콘 ![](assets/more-icon-task-list.png) 작업 항목 이름 오른쪽에서 **할당 대상:**&#x200B;을 클릭한 다음 작업 항목에 할당된 엔티티의 이름을 제거하거나 다른 이름을 입력한 후 을 클릭합니다 **저장**.
