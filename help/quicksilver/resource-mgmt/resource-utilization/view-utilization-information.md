...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td scope="col"> <p>포함된 프로젝트의 총 예산 시간. 포함된 프로젝트의 전체 수명에 대한 총 예산 시간을 보거나 지정된 날짜 범위에 대한 총 예산 시간만 볼 수 있습니다(개별 주 또는 월을 지정할 수 있음). </p> <p>예산 시간은 비즈니스 사례 또는 리소스 플래너의 리소스 예산 책정에서 사용할 수 있는 정보로 채워집니다.<em>.</em></p> <p>예산 시간은 다음 행 중 하나의 활용성 보고서에 표시됩니다.</p> 
    <ul> 
    ...
    </ul> <p>예산 시간에 대한 자세한 내용은 다음을 참조하십시오. <a href="/help/quicksilver/manage-work/projects/project-finances/budgeted-labor-cost.md#locate-the-budgeted-hours-of-a-project">프로젝트의 예산 시간을 찾습니다.</a> 위치: <a href="/help/quicksilver/manage-work/projects/project-finances/budgeted-labor-cost.md">프로젝트의 예산 인건비 및 예산 시간 이해</a>.</p> </td> 
  </tr> 
  <tr> 
...
<li><strong>미할당 시간</strong>: 계획된 시간이 작업 또는 문제와 연결되어 있고 작업 또는 문제에 할당된 사용자 또는 역할이 없는 경우 미할당 시간 섹션의 활용성 보고서에 계획된 시간이 표시됩니다. 이 섹션은 프로젝트에 이 설명과 일치하는 시간이 있고 단일 프로젝트에 대한 활용성 보고서를 볼 때만 나타납니다. <br>계획된 시간에 대한 자세한 내용은 다음을 참조하십시오. <a href="../../manage-work/tasks/task-information/planned-hours.md">계획된 시간 개요</a>.
  ...
  <tr> 
   ...
   <td> <p> 작업, 문제에 기록된 총 시간 <span>프로젝트에서</span> 포함된 프로젝트용. 포함된 프로젝트의 전체 수명에 대한 총 실제 시간을 보거나 지정된 날짜 범위에 대한 총 실제 시간만 볼 수 있습니다(개별 주 또는 월을 지정할 수 있음). </p> <p><strong>경고:</strong> 활용성 보고서에는 프로젝트에 기록된 시간, 하위 작업, 문제 및 하나 이상의 할당이 있는 상위 작업이 포함됩니다. 할당이 없는 상위 작업에 기록된 시간은 포함되지 않습니다. 상위 작업을 작업 작업으로 사용하지 않고 하위 작업만 리소스에 할당하는 것이 좋습니다. </p> <p>실제 시간은 다음 행 중 하나의 활용성 보고서에 표시됩니다.</p> 
    <ul> 
...
프로젝트, 프로그램 또는 포트폴리오의 비용을 추적할 때 활용성 보고서의 정보는 작업에서 가져옵니다. 작업의 비용 정보는 항상 활용률 보고서에서 사용할 수 있습니다. 작업의 비용은 작업의 비용 유형을 기반으로 계산됩니다. 작업의 비용 유형에 대한 자세한 내용은 [Workfront에서 작업에 대한 비용 유형을 계산하는 방법](/help/quicksilver/manage-work/projects/project-finances/track-costs.md#how-workfront-calculates-cost-types-for-tasks) 위치: [비용 추적](/help/quicksilver/manage-work/projects/project-finances/track-costs.md).
...
활용성 보고서의 통화는 프로젝트에 설정된 통화로 결정됩니다. 프로젝트의 통화를 조정하는 방법에 대한 자세한 내용은 [프로젝트 통화 변경](../../manage-work/projects/project-finances/change-project-currency.md).
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td scope="col"> <p>포함된 프로젝트의 총 계획된 비용. 포함된 프로젝트의 전체 수명에 대한 총 계획된 비용을 보거나 지정된 날짜 범위에 대한 총 계획된 비용만 볼 수 있습니다(개별 주 또는 월을 지정할 수 있음).</p> <p>주, 월 및 분기별 보기의 경우, 계획된 비용은 작업 역할 또는 사용자의 비용 비율이 유효 일자일 때 선택된 기간의 평균으로 계산됩니다.</p><p>프로젝트에 대한 계획된 비용 계산 방법에 대한 자세한 내용은 <a href="/help/quicksilver/manage-work/projects/project-finances/track-costs.md#how-workfront-calculates-planned-budgeted-and-actual-costs">Workfront에서 계획, 예산 및 실제 비용을 계산하는 방법</a> 위치: <a href="/help/quicksilver/manage-work/projects/project-finances/track-costs.md">비용 추적</a>.</p> </td>
  </tr> 
  <tr> 
   <td scope="col"><strong>실제 비용</strong> </td> 
   <td scope="col"> <p>포함된 프로젝트의 총 실제 비용. 포함된 프로젝트의 전체 수명에 대한 총 실제 비용을 보거나 지정된 날짜 범위에 대한 총 실제 비용만 볼 수 있습니다(개별 주 또는 월을 지정할 수 있음).</p> <p>프로젝트의 실제 비용 계산 방법에 대한 자세한 내용은 <a href="/help/quicksilver/manage-work/projects/project-finances/track-costs.md#how-workfront-calculates-planned-budgeted-and-actual-costs">Workfront에서 계획, 예산 및 실제 비용을 계산하는 방법</a> 위치: <a href="/help/quicksilver/manage-work/projects/project-finances/track-costs.md">비용 추적</a>.</p> </td>
  </tr> 
  <tr> 
...
특정 필드 및 Workfront에서 필드를 계산하는 방법에 대한 자세한 내용은 [비용 추적](../../manage-work/projects/project-finances/track-costs.md) 및 [청구 및 수익 개요](../../manage-work/projects/project-finances/billing-and-revenue-overview.md).
...
고정 수익 작업이 있고 작업에 대해 계획된 시간이 없는 경우 수익을 시간에 분배할 방법이 없으므로 수익이 활용성 보고서에 표시되지 않습니다. 고정 수익이 있고 할당이 없는 작업에 계획된 시간이 있는 경우 수익이 미할당 수익으로 표시됩니다. </p> <p><strong>시간별 역할:</strong> 작업의 매출은 특정 역할에 대해 설정된 청구 요금에 해당 역할과 연관된 계획된 시간 수를 곱한 값을 사용하여 계산됩니다. Workfront에서는 다음 공식을 사용합니다.</p> <p><code>역할 시간당 계획된 수익 = SUM(모든 작업에 대한 역할의 계획된 시간) * 역할 청구 요금</code></p><p><b>참고:</b> 공식의 청구 시간당 요금은 요금의 모든 일자 유효 변경 사항을 고려합니다.</p>   <p><strong>시간별 사용자:</strong> 작업의 매출은 특정 사용자에 대해 설정된 청구 요금에 해당 사용자와 연결된 계획된 시간을 곱한 값을 사용하여 계산됩니다. Workfront에서는 다음 공식을 사용합니다.</p> <p><code>사용자 시간별 계획 수익 = SUM(모든 작업에 대한 사용자의 계획 시간) * 사용자 청구 요금</code> </p> <p><b>참고:</b> 공식의 청구 시간당 요금은 요금의 모든 일자 유효 변경 사항을 고려합니다.</p> <p><b>시간별 또는 사용자별 + 고정 역할</b> </p> <p><b>중요 사항</b>
...
<li> <p><strong>시간별 사용자(상한 포함):</strong> 작업은 시간별 사용자에서와 같이 시간별로 청구되지만 지정할 수 있는 최대 한도 금액이 있습니다. Workfront에서는 다음 공식을 사용합니다. </p> <p><code>시간별 사용자(상한 계획 수익 포함) = [SUM(모든 작업에 대해 사용자의 계획된 시간) * 사용자 청구 요금] + 작업의 상한 금액 + SUM(작업의 상한 금액/계획된 시간 동안의 금액)</code> </p> </li>
  ...
  <tr> 
   ...
   <td> <p>실제 수익 은 작업 및 프로젝트의 실제 시간과 관련된 수익입니다. 실제 매출에 대한 자세한 내용은 <a href="/help/quicksilver/manage-work/projects/project-finances/billing-and-revenue-overview.md#track-revenue-amounts">수익 금액 추적</a> 위치: <a href="/help/quicksilver/manage-work/projects/project-finances/billing-and-revenue-overview.md">청구 및 수익 개요</a>.</p>
...
1. 개별 프로젝트, 여러 프로젝트, 프로그램 또는 포트폴리오에 대한 활용성 정보를 보고 있는지 여부에 따라 다음 중 하나를 수행합니다.
   ...
   * 단일 프로젝트에 대한 활용성 정보를 보려면
      ...
      1. 활용성 정보는 개별 프로젝트를 볼 때 자동으로 표시되며 필터 적용은 필요하지 않습니다.\
         ...
         활용성 보고서를 필터링하는 방법에 대한 자세한 내용은 다음을 참조하십시오. [필터 사용률 정보](#filter-utilization-information) 이 문서에서.\
...
활용률 보고서를 실행하기 전에 필터에서 하나 이상의 프로젝트를 지정해야 합니다. 활용성 보고서를 필터링하는 방법에 대한 자세한 내용은 다음을 참조하십시오. [필터 사용률 정보](#filter-utilization-information) 이 문서에서.\
   ...
   * 프로그램에 대한 활용률 정보를 조회하려면
     ...
     {{step1-to-utilization-report}}
      ...
      1. 클릭 **표시**>**프로그램**.
      1. 활용성 보고서에 필터를 적용한 다음 **실행**.\
         활용성 보고서를 실행하기 전에 필터에 프로그램을 하나 이상 지정해야 합니다. 활용성 보고서를 필터링하는 방법에 대한 자세한 내용은 다음을 참조하십시오. [필터 사용률 정보](#filter-utilization-information) 이 문서에서.\
   ...
   * 포트폴리오에 대한 활용률 정보를 조회하려면
     ...
     {{step1-to-utilization-report}}
      ...
      1. 클릭 **표시**>**Portfolio**.
      1. 활용성 보고서에 필터를 적용한 다음 **실행**.\
         활용률 보고서를 실행하기 전에 필터에 하나 이상의 포트폴리오를 지정해야 합니다. 활용성 보고서를 필터링하는 방법에 대한 자세한 내용은 다음을 참조하십시오. [필터 사용률 정보](#filter-utilization-information) 이 문서에서.\
         개별 프로젝트, 프로그램 및 포트폴리오에 대한 활용성 정보가 표시됩니다(프로젝트는 연결된 프로그램 내에 그룹화되고 프로그램은 연결된 포트폴리오 내에 그룹화됨).

1. 활용성 보고서의 오른쪽 상단 모서리에서 을(를) 클릭합니다. **보기**&#x200B;을(를) 클릭한 다음 메뉴에서 다음 중 하나를 선택합니다.
...
1. (선택사항) 활용률 정보가 표시되는 일자 범위를 선택합니다. 지정된 주 또는 월을 왼쪽에 표시할 수 있습니다. **전체** 열. 전체 프로젝트, 프로그램 또는 포트폴리오에 대한 정보는 항상 **전체** 열.\
   자세한 내용은 [정보가 표시되는 날짜 범위 조정](#adjust-the-date-range-for-which-information-is-displayed) 이 문서에서.
...
1. 활용성 보고서를 엽니다.
다음을 참조하십시오 [활용성 보고서를 사용하여 진행 상황, 비용 및 수익 추적](#track-progress-cost-and-revenue-with-the-utilization-report) 이렇게 하려면.

1. 다음을 클릭합니다. **필터** 아이콘을 클릭하여 필터 옵션을 표시합니다.
1. (조건부) 기존 필터를 수정하려면 **필터** 드롭다운 메뉴를 선택한 다음 수정할 필터를 선택합니다.
1. 다음 정보를 지정하여 필터를 만들거나 수정합니다.

   * **Portfolio:** 활용률 보고서에 포함할 정보가 포함된 포트폴리오의 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다\
     활용률 보고서에 여러 포트폴리오의 정보를 포함하려면 이 프로세스를 반복합니다.\
     시스템의 모든 포트폴리오를 필터에 포함하려면 **모두 추가**. (이 옵션은 시스템에 10개 미만의 포트폴리오가 있는 경우에만 사용할 수 있습니다.)

   * **프로그램:** 활용률 보고서에 포함할 정보가 포함된 프로그램의 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.\
   ...
   * **프로젝트:** 활용률 보고서에 포함할 정보가 포함된 프로젝트의 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.\
   ...
   * **작업:** 활용률 보고서에 포함할 정보가 포함된 작업 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.\
     활용률 보고서에 여러 작업의 정보를 포함하려면 이 프로세스를 반복합니다.\
   ...
   * **문제:** 활용성 보고서에 포함할 정보가 포함된 문제의 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다.\
     ...
     문제에 대한 비용 정보가 활용률 보고서에 항상 포함되는 것은 아닙니다. 문제에 대한 비용 정보가 활용률 보고서에 포함되는 시기에 대한 자세한 내용은 다음을 참조하십시오. [활용성 보고서를 사용하여 진행 상황, 비용 및 수익 추적](#track-progress-cost-and-revenue-with-the-utilization-report) 이 문서에서.

   * **역할:** 활용성 보고서에 나타낼 역할의 이름을 입력한 다음 드롭다운 목록에 표시될 때 이름을 클릭합니다. 추가 역할을 포함하려면 이 프로세스를 반복합니다.
활용성 보고서에는 지정한 역할에 대한 정보만 포함됩니다. 예를 들어 작업에 10개의 실제 시간이 포함되어 있습니다. 이 중 6시간은 디자이너 역할에서 나왔고 4시간은 개발자 역할에서 나왔습니다. Designer에 대해 역할별로 활용성 보고서를 필터링하면 개발자 역할에서 오는 4시간이 보고서에서 제외됩니다.
   ...
   * **필터 규칙 추가:** 클릭 **필터 규칙 추가**&#x200B;를 클릭하고 필터링할 필드 이름을 입력하십시오. 필드를 사용할 수 있는 경우 해당 필드는 연결할 수 있는 각 오브젝트에 대해 채워집니다. 필드 이름을 클릭하여 필터에 추가합니다.
...
1. 클릭 **저장된 필터**&#x200B;을(를) 클릭한 다음, 드롭다운 목록에서 적용할 필터를 선택합니다.
...
1. 클릭 **저장된 필터**&#x200B;을 클릭하고 복제할 필터를 마우스로 가리킨 다음 **복제** 아이콘.

   ![중복 아이콘](assets/utilization-filter-duplicate.png)

   [중복 필터] 대화 상자가 표시됩니다.

1. 다음에서 **필터 이름** 필드에 새 필터 이름을 입력하고 **저장**.
...
1. 클릭 **저장된 필터**&#x200B;을 클릭하고 이름을 바꿀 필터를 마우스로 가리킨 다음 **이름 바꾸기** 아이콘.
...
1. 클릭 **저장된 필터**&#x200B;을 클릭하고 삭제할 필터 위로 마우스를 가져간 다음 **삭제** 아이콘.
...
1. (선택 사항) 아래에서 적절한 옵션을 선택하여 프로젝트, 프로그램 또는 Portfolio을 표시하도록 차트를 구성합니다. **표시** 드롭다운 메뉴.
1. (선택 사항) 보고서의 특정 시점을 마우스로 가리키면 해당 시점의 데이터를 볼 수 있습니다.

   ![데이터 포인트 위로 마우스 오버](assets/utilization-chart-hover.png)

1. (선택 사항) 필터를 조정하여 차트에 표시되는 정보를 변경합니다. 필터 조정에 대한 자세한 내용은 [필터 사용률 정보](#filter-utilization-information) 이 문서에서.
1. (선택 사항) 차트의 시간대에 따라 구성합니다 [정보가 표시되는 날짜 범위 조정](#adjust-the-date-range-for-which-information-is-displayed) 이 문서에서.
