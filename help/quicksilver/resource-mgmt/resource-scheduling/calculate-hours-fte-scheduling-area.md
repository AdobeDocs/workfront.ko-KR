...
title: Workfront에서 예약 영역에 대한 리소스 시간 및 FTE 가용성을 계산하는 방법을 구성합니다
description: Adobe Workfront 관리자는 Resource Management 환경 설정을 구성할 때 Workfront이 시스템 수준에서 리소스 가용성 및 사용자 할당을 계산하는 방법(시간 및 FTE 가용성 고려)을 결정합니다.
author: Alina
...
# Workfront에서 예약 영역에 대한 리소스 시간 및 FTE 가용성을 계산하는 방법을 구성합니다
...
Adobe Workfront 관리자는 Resource Management 환경 설정을 구성할 때 Workfront이 시스템 수준에서 리소스 가용성 및 사용자 할당을 계산하는 방법(시간 및 FTE 가용성 고려)을 결정합니다.

다음 중 하나를 사용하도록 선택할 수 있습니다.
...
* 다음 문서에 설명된 대로 Workfront에서 리소스를 자동으로 할당할 수 있도록 허용하는 경우:
...
* 할당 지표를 표시할 때 다음 문서에 설명된 대로

   * 문서의 &quot;할당 지표&quot; 섹션  [예약 영역에서 사용자 할당 관리](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).
