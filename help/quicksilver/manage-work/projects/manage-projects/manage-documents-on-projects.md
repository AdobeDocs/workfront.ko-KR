...
>[!IMPORTANT]
>
>Workfront 인스턴스는 Workfront 스토리지와 Adobe 스토리지 둘 다에 액세스하지 못할 수 있습니다. 일부 Workfront 인스턴스는 Workfront에만 액세스할 수 있고, 다른 인스턴스는 기본적으로 Adobe 엔터프라이즈 스토리지에만 액세스할 수 있습니다. 한 가지 유형의 스토리지만 액세스하는 고객은 구성이 필요하지 않습니다.
