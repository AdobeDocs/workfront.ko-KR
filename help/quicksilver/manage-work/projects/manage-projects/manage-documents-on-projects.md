...
* Adobe 클라우드 스토리지 프로젝트를 레거시 Workfront 스토리지 프로그램에 추가하고 프로그램에 문서가 첨부되어 있지 않으면 프로그램이 Adobe 클라우드 스토리지 프로그램으로 변환됩니다. 프로그램의 포트폴리오도 전환됩니다.
* Adobe 클라우드 스토리지 프로젝트를 레거시 Workfront 스토리지 프로그램에 추가하고 프로그램에 문서가 첨부된 경우 프로그램 문서 스토리지는 Workfront 스토리지에 유지됩니다. 포트폴리오에 문서가 있으면 해당 문서 저장소도 Workfront 저장소에 남아 있습니다. 그렇지 않으면 포트폴리오가 Adobe 클라우드 저장소로 변환됩니다.

  ![레거시 Workfront 저장소 아이콘](assets/legacy-storage-project-icon.png) 프로그램의 레거시 포트폴리오 저장소 아이콘이 프로그램에서 제거되었습니다.
