...
description: 단일 프로젝트에 대한 리소스를 예약하여 각 리소스에 할당된 작업과 해당 작업을 완료하는 데 소비해야 하는 시간을 나타낼 수 있습니다. 프로젝트에 대한 리소스를 예약하고 프로젝트 수준의 업무 균형자 를 사용하여 각 리소스에 시간을 할당할 수 있습니다.
author: Alina, Lisa
...
단일 프로젝트에 대한 리소스를 예약하여 각 리소스에 할당된 작업과 해당 작업을 완료하는 데 소비해야 하는 시간을 나타낼 수 있습니다. 프로젝트에 대한 리소스를 예약하고 프로젝트 수준의 업무 균형자 를 사용하여 각 리소스에 시간을 할당할 수 있습니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>프로젝트, 작업 및 문제에 대한 권한 이상 기여 </p>  </td> 
  </tr> 
 </tbody> 
</table>
...
업무 균형자 를 사용하여 프로젝트에 대한 리소스를 예약할 수 있습니다.
