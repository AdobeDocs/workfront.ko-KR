...
1. 프로젝트에 대한 다음 재무 정보를 갱신합니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr>
      <td><strong><span class="preview">시스템 날짜의 유효 환율 사용</span></strong></td>
      <td><p><span class="preview">이 옵션을 선택하면 시스템 수준의 일자 유효 환율이 항상 사용되며 프로젝트에 환율 대체가 허용되지 않습니다.</span></p> <p><span class="preview">옵션을 선택한 경우 시작할 <strong>환율 날짜</strong>도 선택해야 합니다.</span></p></td> 
     </tr>
     <tr>
      <td><strong><span class="preview">프로젝트 청구 요율 정보 유지</span></strong></td>
      <td><p><span class="preview">이 옵션을 사용으로 설정하면 모든 발령 청구 요금이 청구 계층에서 적용 가능한 가장 높은 요금에 영구적으로 동결됩니다. 이는 일회성 선택이며, 프로젝트에 할당 또는 시간이 있으면 옵션을 비활성화할 수 없습니다. 보존 후에는 프로젝트의 어느 곳에서든 할당 청구 요율을 변경, 편집 또는 대체할 수 없습니다.</span></p></td>
     </tr>
