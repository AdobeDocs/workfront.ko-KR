...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>프로젝트에 대한 시스템 수준 환율을 설정하고 프로젝트 청구 요금을 보존하려면: Workflow Ultimate</p>
      <p>다른 모든 설정을 편집하려면: 모든 Workfront 또는 워크플로 패키지</p> </td> 
  </tr> 
  <tr> 
...
1. 프로젝트에 대한 다음 정보를 업데이트합니다.
   ...
   <table style="table-layout:auto"> 
      ...
      <li>조직에서 문서에 Workfront 및 Adobe 클라우드 스토리지를 모두 사용하는 경우 레거시 Workfront 스토리지 프로젝트를 Adobe 클라우드 스토리지 프로그램과 연결할 수 없습니다. 그 반대도 마찬가지다. Workfront 인스턴스에 두 가지 유형의 문서 저장소가 모두 없을 수 있습니다. 프로그램은 해당 프로그램이 속한 포트폴리오에서 저장소 유형을 상속합니다. </li></ul>
...
* 프로젝트에 대한 재무 데이터 보기 액세스 권한 및 일반 재무 보기 권한이 있는 경우 재무 섹션의 필드만 볼 수 있습니다. 이 섹션의 필드는 편집할 수 없습니다.
* 프로젝트에 대한 재무 데이터 편집 액세스 권한 및 일반 재무 편집 권한이 있는 경우 이 섹션의 필드를 갱신할 수 있습니다.

두 개 이상의 프로젝트를 선택하여 일괄적으로 편집할 때 다음과 같은 시나리오가 있습니다.

* 일반 재무 보기(일반 재무 편집 대신) 권한이 있는 프로젝트를 하나 이상 선택한 경우 이 섹션에서 선택한 모든 프로젝트에 대한 필드만 볼 수 있습니다. 재무 섹션의 필드는 벌크 편집할 수 없습니다.
...
1. 왼쪽 패널에서 **재무**&#x200B;을 클릭합니다.
   ...
   ![프로젝트 편집 상자의 재무 영역](assets/edit-project-finance-section.png)
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr data-mc-conditions=""> 
      ...
      <td> <p>프로젝트의 통화가 시스템의 기본 통화와 다른 경우 통화를 지정합니다. 프로젝트에 대한 재무 정보가 이미 있는 경우 프로젝트의 통화를 변경할 수 없습니다. 시스템에 기본 통화만 있는 경우에는 이 필드가 표시되지 않습니다. </p> <p>통화에 대한 자세한 내용은 <a href="../../../administration-and-setup/manage-workfront/exchange-rates/set-up-exchange-rates.md" class="MCXref xref">환율 설정</a>을 참조하세요. </p> </td> 
     </tr> 
     <tr> 
...
사용자가 프로젝트에 대해 수신하는 권한과 이러한 객체 유형과 상호 작용할 때 프로젝트의 작업 및 문제를 정의할 수 있습니다.

>[!IMPORTANT]
>
>프로젝트 편집 시 프로젝트, 작업 및 문제에 대한 권한을 수정하면 액세스 권한이 변경된 후 사용자가 이러한 객체 유형과 상호 작용할 때 권한이 부여되는 방식이 설정됩니다.
>
>이 구성을 변경해도 사용자가 이미 할당되었거나 포함된 항목에 대한 사용자의 권한이 소급하여 수정되지 않습니다.
...
* 문서 저장소 유형이 다른 여러 프로젝트를 선택하고 선택한 프로젝트에 대해 Portfolio 또는 프로그램을 업데이트하려는 경우 레거시 Workfront 저장소 프로젝트를 Adobe 클라우드 저장소 포트폴리오와 연결할 수 없습니다. 그 반대도 마찬가지다. 이 경우 한 번에 저장소 유형이 유사한 프로젝트만 선택해야 합니다.
