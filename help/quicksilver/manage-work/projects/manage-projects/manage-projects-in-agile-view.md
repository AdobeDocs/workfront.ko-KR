...
title: 보드 보기에서 애자일 프로젝트 관리
description: 일반적으로 애자일 사례(팀 백로그 관리 또는 반복 생성 등)와 관련된 관리 문제 없이 프로젝트에 대해 애자일 기능을 활용할 수 있습니다.
...
일반적으로 애자일 사례(팀 백로그 관리 또는 반복 생성 등)와 관련된 관리 문제 없이 프로젝트에 대해 애자일 기능을 활용할 수 있습니다.

팀 백로그를 사용하고 백로그의 작업에서 반복을 만들 수 있는 애자일 환경에서 작업할 수 있습니다.

자세한 내용은 [애자일 환경에서 작업](../../../agile/work-in-an-agile-environment/work-in-an-agile-environment.md)을 참조하세요.
...
목록 대신 보드 보기에서 프로젝트의 작업 또는 문제를 모두 보고 프로젝트 개발을 위해 애자일 기능을 활용할 수 있습니다.

1. 애자일 방법론에 따라 관리할 프로젝트로 이동한 다음 왼쪽 패널에서 **작업** 또는 **문제**&#x200B;를 클릭합니다.
...
1. (선택 사항) 목록 보기로 돌아가려면 **목록** 아이콘 ![목록 아이콘](assets/list-icon.png)을 클릭합니다.
