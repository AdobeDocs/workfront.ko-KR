...
* 유효 일자가 통화 및 해당 환율에 적용되는 경우 환율은 프로젝트 기간 동안 변경될 수 있습니다. 유효 날짜 환율에 대한 자세한 내용은 [환율 설정](/help/quicksilver/administration-and-setup/manage-workfront/exchange-rates/set-up-exchange-rates.md)을 참조하십시오.
...
1. (조건부) Workfront 시스템에 대해 설정된 기본 통화 이외의 통화를 선택하는 경우, 시스템에서 기본 통화로 설정된 통화와 관련되므로 선택한 통화에 대한 환율을 지정합니다.
   ...
   >[!NOTE]
   >
   >이 프로젝트에 대해 **시스템의 날짜 유효 환율 사용** 설정이 설정되어 있으면 환율 재정의가 허용되지 않습니다. 자세한 내용은 [프로젝트 편집](/help/quicksilver/manage-work/projects/manage-projects/edit-projects.md)을 참조하세요.
