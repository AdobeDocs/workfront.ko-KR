...
![작업 역할 청구 요금 편집](assets/edit-job-role-multiple-billing-rates-040826.png)
...
>[!NOTE]
>
>사용 가능한 사용자 및 역할 시간당 수익 유형을 얻으려면 워크플로우 Ultimate 패키지가 있어야 합니다
...
작업을 만들 때 기본 수익 유형입니다.</p> </td>
  ...
  <tr> 
   ...
   <td> <p>이 유형은 작업에만 사용할 수 있습니다.</p> <p>이 유형은 사용자 및 역할 정보를 모두 검사하여 적절한 비율을 결정합니다.</p></td> 
  </tr>
  <tr> 
  ...
  <tr> 
   <td> <p>시간별 사용자 및 역할(상한 포함)</p> </td> 
   <td> <p>이 유형은 작업에만 사용할 수 있습니다.</p> <p>작업은 시간별 사용자 및 역할과 같이 시간별로 청구되지만 지정할 수 있는 최대 상한이 있습니다.</p></td> 
  </tr>
  <tr> 
  ...
  <tr> 
   <td> <p>시간별 사용자 및 역할 (고정 포함)</p> </td> 
   <td> <p>이 유형은 작업에만 사용할 수 있습니다.</p> <p>작업은 시간별 사용자 및 역할에서와 같이 시간별로 청구되지만 요금에 추가할 수 있는 추가 고정 금액이 있습니다. 작업에 지정된 고정 금액은 프로젝트의 청구 기록에 포함될 수 있습니다. 고정 금액에 작업의 시간을 곱하지 않습니다.</p></td> 
  </tr>
  <tr> 
   <td> <p>고정 시간별</p> </td> 
