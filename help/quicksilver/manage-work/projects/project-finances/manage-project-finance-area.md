...
프로젝트 세부 정보 섹션의 재무 영역에 액세스하여 프로젝트의 재무 정보를 보거나 편집할 수 있습니다. 이 영역에서 보거나 편집할 수 있는 필드의 수는 제한되어 있습니다. 프로젝트의 모든 정보를 편집하는 방법에 대한 자세한 내용은 [프로젝트 편집](../../../manage-work/projects/manage-projects/edit-projects.md)을 참조하십시오.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>일반 재무 보기 권한이 포함된 프로젝트 이상의 권한 보기</p> <p>일반 재무 편집이 포함된 프로젝트에 대한 권한을 관리하여 프로젝트의 재무 정보를 편집합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 프로젝트 상세내역의 재무 영역에서 찾을 수 있는 재무 정보는 태스크에서 프로젝트 레벨로 적상되는 값과 프로젝트에 직접 입력된 정보를 나타냅니다. 일부 재무 정보는 프로젝트 뿐만 아니라 작업 수준에서도 관리할 수 있습니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>지정된 시간에 프로젝트의 수행 방식을 보여 주는 프로젝트 성능 지표입니다. 이 값은 Performance Index 메서드를 기반으로 계산됩니다.<br>자세한 내용은 다음 문서를 참조하십시오. </p> 
       <ul> 
     ...
     <tr> 
      ...
      <td> PIM(성과 지표 메서드)이 시간 기반인 경우 프로젝트의 예상 총 비용은 시간 단위로 표시되고, PIM(성과 지표 메서드)이 비용 기반인 경우 통화 값으로 표시됩니다.<br>완료 시 예상 비용 계산에 대한 자세한 내용은 <a href="../../../manage-work/projects/project-finances/calculate-eac.md" class="MCXref xref">EAC(완료 시 예상 비용 계산)</a>을 참조하십시오</td> 
     </tr> 
     <tr> 
