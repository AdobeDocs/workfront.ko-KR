...
1. (조건부) 조직에서 사용 중인 문서 저장소에 따라 다음 중 하나를 클릭합니다.
   ...
   * **새 템플릿**. Workfront 관리자가 **Adobe 클라우드 저장소** 또는 **레거시 Workfront**&#x200B;을 선택하고 **사용자가 저장소 공급자를 선택할 수 있도록 허용** 설정을 선택하거나 선택하지 않은 경우.
   * **새 템플릿(기존 저장소)**: Workfront 관리자가 **Adobe 클라우드 저장소** 또는 **기존 Workfront**&#x200B;를 선택하고 **사용자가 저장소 공급자를 선택할 수 있도록 허용** 설정도 선택했습니다.
...
1. 인라인으로 작업을 추가하려면 **템플릿 작업 추가 시작**&#x200B;을 클릭하세요.
   ...
   **새 템플릿 작업**&#x200B;을 클릭하면 **템플릿 작업 만들기** 상자가 열립니다.

   ![새 템플릿 작업에 대한 새 경험](assets/new-template-task-box-unshimmed.png)

1. (조건부) **템플릿 작업 만들기** 상자의 다음 영역에서 정보를 업데이트합니다.
   ...
   * 설정
   ...
   템플릿 작업에 대한 정보를 업데이트하는 것은 템플릿 작업을 편집하는 것과 비슷합니다.
...
1. **템플릿 작업 만들기**&#x200B;를 클릭합니다.

1. (선택 사항) 템플릿 작업을 추가한 후 **템플릿 작업** 섹션에서 작업 목록의 오른쪽 상단에 있는 **간트 차트** 아이콘 ![간트 아이콘](assets/gantt-icon.png)을 클릭하여 템플릿의 작업 목록을 시각적으로 표시합니다.

   >[!TIP]
   >
   >템플릿 작업 간트 차트에서 바로 작업을 편집할 수 없습니다.

1. 새 템플릿에 정보를 추가하려면 헤더의 템플릿 이름 오른쪽에 있는 **자세히** 메뉴 ![추가 아이콘](assets/more-icon.png)을 클릭한 다음 **편집**&#x200B;을 클릭합니다.
