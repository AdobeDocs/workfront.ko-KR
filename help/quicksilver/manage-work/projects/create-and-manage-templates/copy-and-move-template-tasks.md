...
* 마일스톤은 복사되거나 이동된 템플릿 작업으로 전송되지 않습니다.

* 하위 작업이 새 템플릿 작업으로 전송됩니다.
* 사용자 정의 양식이 템플릿 작업과 함께 복사됩니다. 사용자 지정 데이터를 복사하도록 선택한 경우에만 사용자 지정 필드의 정보가 새 템플릿 작업으로 전송됩니다.
...
* Adobe Workfront 웹 애플리케이션의 다음 영역에서 템플릿 작업을 복사할 수 있습니다.
   ...
   * 템플릿 작업 수준에서 **기타 아이콘** ![](assets/more-icon.png) 템플릿 작업 이름의 오른쪽에 있습니다.
...
(마지막 행에 대해 묻기: 템플릿 작업에 &quot;공유&quot;가 없는 것 같습니다.)
...
템플릿 작업을 복사하는 것 외에도 템플릿 작업을 동일한 템플릿의 다른 템플릿 작업으로 이동하거나 다른 템플릿으로 이동할 수도 있습니다.
