   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td><p>이후 프로젝트의 진척 가치 지표를 시간을 사용하여 계산할지 또는 비용을 사용하여 계산할지 지정합니다. 성능 인덱스 메서드에 대한 자세한 내용은 <a href="../../../manage-work/projects/project-finances/set-pim.md" class="MCXref xref">PIM(성능 인덱스 메서드) 설정</a>을 참조하십시오. </p></td> 
     </tr>
     <tr> 
