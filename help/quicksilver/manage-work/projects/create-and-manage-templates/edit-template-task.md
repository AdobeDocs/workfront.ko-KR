...
1. (조건부 및 선택 사항) **기간 유형**&#x200B;이(가) **계산된 작업** 또는 **노력 기반**&#x200B;인 경우 각 피할당자에 대해 **할당 %**(할당 백분율)을 지정하십시오. 피할당자의 일정에서 이 작업에 소비할 수 있는 시간입니다. 피할당자에 대한 할당 백분율을 변경하면 작업의 계획된 시간이 변경됩니다.
1. (조건부 및 선택 사항) **기간 유형**&#x200B;이 **단순**&#x200B;인 경우 각 피할당자의 **시간**&#x200B;을(를) 지정하십시오

   또는

   템플릿 작업의 총 **계획된 시간** 수를 지정하십시오. 이렇게 하면 모든 할당자 간에 총 시간이 균등하게 분산됩니다.

1. (조건부 및 선택 사항) **기간 유형**&#x200B;이 간단한 경우 일 단위로 템플릿 작업의 **기간**&#x200B;을 지정하십시오. 이 기간이 이 템플릿에서 만든 작업의 기간이 됩니다.
...
1. **템플릿 작업 편집** 상자에서 왼쪽 패널의 **할당**&#x200B;을 클릭합니다.
   ...
   ![템플릿 작업 할당 편집](assets/template-task-edit-assignments.png)

1. **사람, 역할 또는 팀 검색** 필드에서 피할당자의 이름을 입력한 다음 목록에 표시될 때 선택합니다
