...
*보유 중인 플랜, 라이선스 유형 또는 액세스 수준을 확인하려면 Workfront 관리자에게 문의하십시오. 자세한 내용은 [Workfront 설명서의 액세스 요구 사항](/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/access-level-requirements-in-documentation.md).
...
1. (선택 사항) 여러 템플릿 작업을 일괄적으로 편집하려면 여러 템플릿 작업을 선택한 다음 **편집** 템플릿 목록의 맨 위에 있습니다.
1. (조건부) 템플릿 작업에 대한 제한된 정보를 편집하려면 다음을 클릭하십시오. **템플릿 작업 세부 정보** 왼쪽 패널에서 세부 정보 섹션의 영역으로 이동하여 각 영역에 대한 정보를 편집합니다.
1. (선택 사항) **모두 접기** 아이콘 ![](assets/collapse-all-icon.png) 모든 영역을 축소합니다.
...
1. (조건부) 템플릿 작업에 대한 모든 정보를 편집하려면 **자세히** 메뉴 ![](assets/qs-more-icon-on-an-object.png) 템플릿 작업 이름 옆에 있는 을(를) 클릭합니다. **편집**.
...
1. 다음 중 하나를 업데이트합니다.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>이후 작업의 기간(분, 시간, 일, 주 또는 개월)을 지정합니다. 이 템플릿에서 만드는 향후 작업은 여기에 지정된 기간을 갖습니다.</p> <p>기본적으로 Workfront은 기간(일)을 측정합니다. 작업을 완료하기 전에 작업이 완료되지 않은 상태로 남아 있도록 허용하는 시간입니다. 다음과 같은 경우에는 작업의 기간을 지정할 수 없습니다. <strong>기간 유형</strong> 작업 중: <strong>단순</strong>또는 <strong>작업 제한</strong> 은(는) <strong>고정 날짜</strong>.</p> <p><b>중요 사항</b></p> <p>기간은 일반적으로 템플릿 작업의 계획된 시작 일자와 계획된 완료 일자 사이의 시간이며 이러한 이유로 템플릿의 타임라인에 영향을 줍니다. 이를 통해 템플릿으로 만드는 향후 프로젝트의 타임라인이 결정됩니다. </p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>계획된 시간</strong> </td> 
      <td> <p>이 템플릿으로 만든 프로젝트에 대한 향후 작업의 계획된 시간 수를 지정합니다. 작업의 할당자가 작업을 완료하는 데 걸리는 실제 시간입니다. 다음과 같은 경우에만 작업에 계획된 시간을 지정할 수 있습니다. <strong>기간 유형</strong> 이(가) (으)로 설정됨 <strong>계산된 할당</strong>. </p> </td> 
     </tr>
   ...
   <tr> 
      ...
      <td> <p>이 템플릿으로 만든 프로젝트의 작업에는 이 제한 사항이 있습니다. 작업 제한은 작업이 완료되어야 하는 시기를 식별합니다. </p> <p>다음 옵션 중에서 선택합니다.</p> 
       <ul> 
        <li><strong>고정 날짜</strong>. 지정 <strong>계획된 시작</strong> 및 a <strong>계획된 완료 일자.</strong></li> 
        <li><strong>다음에서 시작해야 합니다.</strong>. 지정 <strong>계획된 시작 일자.</strong></li> 
        <li><strong>다음까지 완료:</strong>. 지정 <strong>계획된 완료 일자</strong>.</li> 
        <li><strong>빠른 시일 내에</strong> </li> 
        <li><strong>가능한 한 늦게</strong> </li> 
        <li style="font-weight: bold;"><strong>가장 빠른 가용 시간</strong> </li> 
        <li style="font-weight: bold;"><strong>사용 가능한 최신 시간</strong> </li> 
        <li>다음 이후에 시작: 지정 <strong>계획된 시작 일자</strong>.</li> 
        <li><strong>다음 이후에 시작</strong>. 지정 <strong>계획된 시작 일자</strong>.</li> 
        <li><strong>다음 이후에 완료:</strong>. 지정 <strong>계획된 완료 일자</strong>.</li> 
        <li><strong>다음 이후에 완료:</strong>. 지정 <strong>계획된 완료 일자</strong>.</li> 
     ...
     <tr> 
      <td role="rowheader"><span style="font-weight: bold;">시작일</span><span style="font-weight: normal;"> (선택 사항 및 조건부)</span> </td> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>이후 태스크에 대한 원가 유형을 지정합니다. 작업의 시간 수에 따라 작업의 비용이 계산되는 방식이 결정됩니다. </p> <p>다음 옵션 중에서 선택합니다.</p> 
       ...
       </ul> <p>비용 추적에 대한 자세한 내용은 <a href="../../../manage-work/projects/project-finances/track-costs.md" class="MCXref xref">비용 추적</a>.</p> </td> 
     </tr> 
     <tr> 
      ...
      <td> <p>이후 작업에 대한 수익 유형을 지정합니다. 작업의 시간 수를 기반으로 작업의 매출 계산 방법을 결정합니다.</p> <p style="font-weight: normal;">다음 옵션 중에서 선택합니다. </p> 
       ...
       </ul> <p>매출 추적에 대한 자세한 내용은 다음을 참조하십시오. <a href="../../../manage-work/projects/project-finances/billing-and-revenue-overview.md" class="MCXref xref">청구 및 수익 개요</a>.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. 다음 중 하나를 업데이트합니다.
   ...
   <p><b>중요 사항</b></p>
   <p>이 필드를 표시하려면 마일스톤 경로를 템플릿과 연결해야 합니다. 자세한 내용은 <a href="../create-and-manage-templates/edit-templates.md">프로젝트 템플릿 편집</a>.</p> 
   </td> 
     </tr>
     <tr> 
     ...
     <tr> 
      ...
      <td> <p>템플릿 작업과 연결할 승인 프로세스를 선택합니다. 템플릿 작업과 연결하려면 먼저 Workfront 관리자가 시스템 수준 작업 승인 프로세스를 정의해야 합니다. <span>승인 프로세스에 대한 관리 액세스 권한이 있는 사용자는 그룹별 승인 프로세스를 만들 수도 있습니다.</span> 승인 프로세스 만들기에 대한 자세한 내용은 <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-approval-processes.md" class="MCXref xref">작업 항목에 대한 승인 프로세스 만들기</a>.</p> <p>승인 프로세스를 추가할 때는 다음 사항을 고려하십시오. </p> 
       <ul> 
       <li>활성 승인 프로세스만 목록에 표시됩니다. </li> 
       <li> <p>시스템 전체 및 그룹별 승인 프로세스가 목록에 표시됩니다. 템플릿 이외의 그룹과 연결된 승인 프로세스는 목록에 표시되지 않습니다.</p> <p>중요: 템플리트와 연관된 그룹이 변경되면 그룹별 승인 프로세스는 단일 사용 승인 프로세스가 됩니다. 프로젝트 그룹 또는 승인 프로세스 변경 사항이 승인 설정에 미치는 영향에 대한 자세한 내용은 <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/how-changes-affect-group-approvals.md" class="MCXref xref">그룹 및 승인 프로세스 변경이 할당된 승인 프로세스에 미치는 영향</a>. </p> </li> 
       <li> <p>일회용 승인 프로세스를 추가한 경우 이 프로세스가 ""로 표시됩니다.&lt;custom&gt;이 필드에 "가 표시됩니다. 자세한 내용은 <a href="../../../review-and-approve-work/manage-approvals/associate-approval-with-work.md" class="MCXref xref">신규 또는 기존 승인 프로세스를 작업과 연결</a>. </p> <!--<p data-mc-conditions="QuicksilverOrClassic.Draft mode">(NOTE: this will be valid only for Classic when they edit the Edit Template box in NWE)</p>--> </li> 
       ...
       <li> <p>템플릿 작업 중 일회용 승인 프로세스가 첨부된 작업이 있으면 시스템 수준으로 대체됩니다 <span>또는 그룹 수준 승인 프로세스</span> 을 선택합니다. </p> </li> 
       </ul> </li> 
       </ul> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>미리 알림</strong> </td> 
      <td> <p>템플릿 작업에 첨부할 미리 알림을 선택합니다. 이 템플릿으로 만든 프로젝트의 향후 작업에 첨부됩니다. 작업에서 미리 알림을 선택하려면 먼저 시스템 관리자가 미리 알림을 구성해야 합니다. 미리 알림 구성에 대한 자세한 내용은 <a href="../../../administration-and-setup/manage-workfront/emails/set-up-reminder-notifications.md" class="MCXref xref">미리 알림 설정</a>.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. 클릭 **피할당자 추가** 템플릿 작업에 새 피할당자를 추가합니다. 작업에 사용자, 역할 또는 팀을 할당할 수 있습니다. 작업에 여러 명의 할당자가 있을 수 있습니다. 이후 작업에는 이 템플릿 작업에서 생성할 때 할당된 동일한 리소스가 있습니다.
1. (선택 사항) 피할당자가 여러 명인 경우 **소유자** 라디오 단추는 작업 소유자 또는 기본 피할당자로 간주되는 사용자 또는 역할을 나타냅니다. Workfront은 템플릿 작업에 할당한 첫 번째 사용자 또는 작업 역할을 소유자 또는 기본 할당자로 표시합니다.
1. (조건부 및 선택 사항) 태스크 제약이 계산된 작업이나 노력 제어 상태인 경우 **할당 %** (할당 백분율) 피할당자의 일정에서 이 작업에 소비할 수 있는 시간입니다. 피할당자에 대한 할당 백분율을 변경하면 작업의 계획된 시간이 변경됩니다.
1. (조건부 및 선택 사항) 작업 제한 사항이 단순인 경우 **시간** 각 피할당자의

   또는

   의 총 수를 지정합니다. **계획된 시간** 템플릿 작업용 이렇게 하면 모든 할당자 간에 총 시간이 균등하게 분산됩니다.

1. (조건부 및 선택 사항) 작업 제한 사항이 단순인 경우 **기간** 템플릿 작업 기간(일). 이 기간이 이 템플릿에서 만든 작업의 기간이 됩니다.
1. (선택 사항) **피할당자의 역할** 드롭다운 메뉴. 이 역할은 할당자가 향후 작업에서 수행할 수 있는 역할입니다. 프로필의 각 피할당자와 연결된 작업 역할만 드롭다운 메뉴에 나타납니다.
1. (선택 사항) 수정할 정보에 따라 다음 섹션을 계속 편집합니다.
...
작업이 프로젝트에 추가될 때 작업에 자동으로 첨부될 기본 사용자 정의 양식을 정의할 수 있습니다. 기본 작업 사용자 정의 양식을 포함하도록 프로젝트를 설정하는 방법에 대한 자세한 내용은 문서의 &quot;작업&quot; 섹션을 참조하십시오 [프로젝트 편집](../../../manage-work/projects/manage-projects/edit-projects.md).
...
1. 템플릿 작업과 연결할 사용자 정의 양식을 선택합니다. 이 필드에서 사용자 정의 양식을 선택하려면 먼저 사용자 정의 양식을 작성해야 합니다. 활성 사용자 정의 양식만 목록에 표시됩니다. 사용자 정의 양식 작성에 대한 자세한 내용은 [사용자 정의 양식 만들기 또는 편집](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md). 템플릿 작업에 최대 10개의 사용자 정의 양식을 추가할 수 있습니다. 양식은 템플릿에서 만든 작업에 자동으로 추가됩니다.
1. (조건부 및 선택 사항) 사용자 정의 양식을 템플릿 작업에 첨부한 경우 양식의 모든 필드를 편집합니다. 템플릿 작업을 저장하려면 모든 필수 필드를 지정해야 합니다.
   ...
   >사용자 정의 양식의 섹션에 대한 권한 설정에 대한 자세한 내용은 [사용자 정의 양식 공유](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/share-access-to-a-custom-form.md).\
