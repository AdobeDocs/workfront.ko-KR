...
포트폴리오 최적화에 대한 자세한 내용은 [Portfolio 최적화 프로그램 개요](../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md).
...
* [Portfolio 최적화 도구에서 포트폴리오의 정렬 점수 찾기](#locate-the-alignment-score-of-the-portfolio-in-the-portfolio-optimizer)
  ...
  ![Portfolio 최적화 도구에서 정렬 점수](assets/alignment-score-in-portfolio-optimizer.png)
...
1. 포트폴리오의 이름을 클릭합니다.
1. 클릭 **Portfolio 최적화** 왼쪽 패널에서
1. Portfolio 최적화 도구 상단에서 **정렬됨** 값 및 **정렬** 게이지 - 포트폴리오의 정렬 점수를 나타냅니다.
