...
위의 사전 요구 사항에 대한 자세한 내용은 [구성 [!DNL Workfront] 및 [!DNL Frame.io] 통합](/help/quicksilver/administration-and-setup/configure-integrations/configure-wf-and-frame.md).
...
1. 클릭 **새 템플릿**.
1. 템플릿의 이름을 입력한 다음 키를 누릅니다 **입력** 을 눌러 이름을 저장합니다.
1. 왼쪽 패널에서 **템플릿 세부 정보**.
1. 다음에서 **템플릿 연결** 섹션에서 그룹을 지정해야 합니다. 그룹을 추가하지 않으면 기본 프로젝트 그룹이 추가되고 Frame.io의 프로젝트가 Frame.io의 해당 기본 팀 아래에 만들어집니다.
...
1. 왼쪽 패널에서 **템플릿 작업**.
1. 클릭 **템플릿 작업 추가 시작** 을 눌러 작업을 템플릿에 신속하게 추가할 수 있습니다. 나중에 추가 설정을 구성할 수 있습니다.

   또는

   클릭 **새 템플릿 작업** 한 번에 하나씩 작업을 추가하고 추가 설정을 구성합니다.
   ![](assets/add-tasks-to-template.png)
1. 작업 이름을 추가합니다.
1. 다음에서 **할당** 영역, 사용자 또는 팀을 할당합니다. 개별적으로 또는 팀에서 Frame.io 사용 사용자를 할당하면 Frame.io 프로젝트에 대한 공동 작업자 액세스 권한이 부여되고 이메일을 통해 Frame.io 프로젝트의 작업에 대한 알림이 전송됩니다. 해당 이메일에서 Frame.io 프로젝트에 참여하고 작업을 시작할 수 있습니다.
...
Workfront은 강력한 프로젝트 관리 기능을 제공합니다. 다음을 사용하는 것이 좋습니다. [프로젝트 템플릿 편집](/help/quicksilver/manage-work/projects/create-and-manage-templates/edit-templates.md) 문서의 다음 템플릿 영역 구성:
...
1. 템플릿 이름을 선택하고 **템플릿 사용**.
   ![](assets/find-your-template.png)
1. 필요에 따라 프로젝트 설정을 조정한 다음 **프로젝트 만들기**.
1. 왼쪽 패널에서 **문서**.
1. 단방향 동기화 폴더를 사용하여 크리에이티브 자료를 Frame.io와 자동으로 공유할 수 있습니다. [!BADGE 곧 출시 예정]{type=Informative}

   >[!NOTE]
   >
   >이 기능은 현재 개발 중입니다. Frame.io에서 사용자와 정보를 공유하려면 파일을 문서 탭에 업로드하십시오. 프로젝트의 상태를 현재로 설정하면 해당 파일이 자동으로 Frame.io로 푸시됩니다.

1. 프로젝트 헤더에서에서 프로젝트를 변경합니다. **계획 수립** 끝 **현재**.

프로젝트를 만들고 크리에이티브가 완성된 에셋을 업로드하면 Workfront에서 에셋에 검토 및 승인 워크플로를 할당할 수 있습니다. 자세한 내용은 [문서 검토 또는 승인 요청 만들기](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-a-document-approval.md). <!-- name may need to change -->
...
1. 클릭 **새 프로젝트**.
1. 프로젝트의 이름을 입력한 다음 키를 누릅니다 **입력** 을 눌러 이름을 저장합니다.
...
1. 왼쪽 패널에서 **작업**.
1. 클릭 **작업 추가 시작** 프로젝트에 작업을 신속하게 추가할 수 있습니다. 나중에 추가 설정을 구성할 수 있습니다.

   또는

   클릭 **새 작업** 한 번에 하나씩 작업을 추가하고 추가 설정을 구성합니다.
...
Workfront은 강력한 프로젝트 관리 기능을 제공합니다. 다음을 사용하는 것이 좋습니다. [프로젝트 편집](/help/quicksilver/manage-work/projects/manage-projects/edit-projects.md) 이 문서에서 프로젝트의 다음 영역을 구성하십시오.
...
자세한 내용은 [문서 검토 또는 승인 요청 만들기](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-a-document-approval.md). <!-- name may need to change -->