...
* Workfront 관리자 또는 그룹 관리자는 Workfront 인스턴스 또는 그룹에 대한 프로젝트 환경 설정을 구성할 때 새 프로젝트에 대한 기본 설정을 구성할 수 있습니다.
* Workfront은 Workfront 관리자가 설정한 설정을 적용하기 전에 그룹의 설정을 적용합니다(있는 경우).
* 새 프로젝트의 기본 상태는 기본 프로젝트 환경 설정 영역에서 Workfront 관리자가 정의한 상태나 그룹의 프로젝트 환경 설정 영역에서 그룹 관리자(또는 Workfront 관리자)가 정의한 상태에 해당합니다.
...
* Workfront이 새 프로젝트의 그룹 및 상태를 정의하는 방법에 대해 다음 시나리오가 있습니다.

   * 프로젝트를 처음부터 만드는 경우 프로젝트 그룹은 홈 그룹입니다.

      프로젝트 상태는 홈 그룹의 프로젝트 환경 설정(있는 경우)에 있는 기본 상태이거나 Workfront 인스턴스 중 하나입니다. 프로젝트를 만들 때 기본 상태를 프로젝트 그룹에 사용 가능한 상태로 변경할 수 있습니다.
   ...
   * 템플릿을 사용하여 프로젝트를 만드는 경우 템플릿의 설정이 Workfront 또는 그룹 관리자가 설정한 설정에 우선합니다.
      ...
      템플릿에서 만든 새 프로젝트의 기본 상태는 기본 프로젝트 환경 설정 영역에서 Workfront 관리자가 정의한 상태나 그룹의 프로젝트 환경 설정 영역에서 그룹 관리자(또는 Workfront 관리자)가 정의한 상태에 해당합니다. 템플릿을 통해 프로젝트를 만들 때 기본 상태를 템플릿의 그룹이나 프로젝트를 만드는 사용자의 홈 그룹인 프로젝트 그룹의 상태 중 하나로 변경할 수 있습니다.

   * 문제를 변환하여 프로젝트를 만드는 경우 새 프로젝트의 그룹은 문제의 기존 프로젝트 그룹입니다. 문제를 변환하는 사용자가 해당 프로젝트의 프로젝트에 액세스할 수 없거나 문제의 프로젝트에 그룹이 없는 경우 새 프로젝트의 그룹은 문제를 변환하는 사용자의 홈 그룹입니다.

      새 프로젝트의 상태는 원래 프로젝트의 그룹이나 문제를 변환하는 사용자의 홈 그룹인 프로젝트와 연결된 그룹의 그룹 상태와 일치합니다.

      문제를 전환하여 프로젝트를 만들 때 템플릿을 사용하는 경우 위의 두 번째 시나리오를 참조하여 어떤 그룹 및 어떤 상태 Workfront이 새 프로젝트에 적용되는지 알아보십시오.
