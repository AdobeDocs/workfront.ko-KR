...
1. **즐겨찾는 템플릿** 목록에서 템플릿 이름을 클릭합니다.
   ...
   1. (조건부 및 선택 사항) 레거시 저장소 템플릿을 선택한 경우 새 프로젝트 상자의 오른쪽 아래 모서리에 있는 **Adobe 클라우드 저장소에서 이 프로젝트 만들기** 설정을 선택합니다. 이렇게 하면 Adobe 클라우드 스토리지 프로젝트가 생성됩니다. 템플릿의 문서 및 문서 폴더는 프로젝트에 추가되지 않습니다.
