...
1. **즐겨찾는 템플릿** 목록에서 템플릿 이름을 클릭합니다.
   ...
   1. 다음 템플릿 유형 중 하나의 이름을 클릭하여 선택합니다.
      ...
      * 레거시 Workfront 스토리지 템플릿

        기존 Workfront 저장소 템플릿은 이름 옆에 기존 저장소 아이콘 ![기존 저장소 아이콘](assets/legacy-storage-project-icon.png)을(를) 표시합니다.

        템플릿 및 향후 프로젝트에 대한 문서는 Workfront 저장소에 저장됩니다.
      * Adobe 클라우드 스토리지 템플릿

        템플릿 및 향후 프로젝트에 대한 문서는 Adobe 클라우드 저장소에 저장됩니다.

      >[!NOTE]
      >
      >* Adobe 클라우드 스토리지 템플릿을 사용하여 Adobe 클라우드 스토리지 프로젝트를 만듭니다.
      >
      >* 기존 Workfront 스토리지 템플릿을 사용하면 기존 Workfront 스토리지 프로젝트가 만들어집니다.
      >
      >* 기존 Adobe 스토리지 포트폴리오 또는 프로그램의 Workfront 클라우드 스토리지 템플릿을 사용하는 경우 프로젝트는 Adobe 클라우드 스토리지 프로젝트이며 포트폴리오 또는 프로그램도 Adobe 클라우드 스토리지 개체로 변환됩니다. 동일한 포트폴리오 또는 프로그램에 속한 다른 모든 레거시 Workfront 스토리지 프로젝트는 변경되지 않습니다.
      >
...
1. **프로젝트 만들기**&#x200B;를 클릭합니다.
   ...
   프로젝트의 문서 섹션에 있는 Adobe 클라우드 스토리지 프로젝트에 대해 프로젝트와 동일한 이름의 문서 폴더가 자동으로 생성됩니다.
...
>[!NOTE]
>
>Workfront 문서 저장소와 관련된 템플릿은 기존 Workfront 저장소 프로젝트를 만듭니다. 문서용 Adobe 클라우드 스토리지와 관련된 템플릿은 Adobe 클라우드 스토리지 프로젝트를 만듭니다. Workfront 인스턴스에 두 가지 유형의 문서 저장소가 모두 없을 수 있습니다.
>
>자세한 내용은 [프로젝트 및 관련 개체에 대한 문서 관리 개요](/help/quicksilver/manage-work/projects/manage-projects/manage-documents-on-projects.md)를 참조하십시오.
