...
프로젝트의 계획 시작 및 계획 완료 일자는 프로젝트 태스크 일자에 따라 결정됩니다. 이 문서에서는 프로젝트의 계획 시작 날짜에 대해 설명합니다. 계획 시작 날짜에 대한 작업에 대한 자세한 내용은 [작업 계획 시작 일자 개요](../../../manage-work/tasks/task-information/task-planned-start-date.md).

프로젝트의 계획 시작 일자는 시작 또는 완료 일자부터 프로젝트를 스케줄링하는지 여부에 따라 수동으로 또는 자동으로 설정할 수 있습니다.

## 프로젝트의 계획 시작 일자를 수동으로 설정합니다.

시작 일자에서 프로젝트를 스케줄링할 때 프로젝트의 계획 시작 일자를 수동으로 설정해야 합니다.

프로젝트의 계획 시작 날짜 설정에 대한 자세한 내용은 [프로젝트 편집](../../../manage-work/projects/manage-projects/edit-projects.md).
...
## 프로젝트의 계획 시작 일자를 자동으로 설정

다음과 같은 방법으로 프로젝트를 생성할 때 프로젝트의 계획 시작 일자가 자동으로 설정됩니다.

* 처음부터 그리고 완료 날짜로부터 프로젝트를 스케줄링할 때.

   계획 시작 일자는 완료 일자에 대해 선택한 일자 및 프로젝트에 있는 모든 작업의 지속 기간을 기준으로 Adobe Workfront에 의해 자동으로 계산됩니다.

   처음부터 프로젝트를 만드는 방법에 대한 자세한 내용은 [프로젝트 만들기](../../../manage-work/projects/create-projects/create-project.md).

* Microsoft 프로젝트에서 가져옵니다.

   계획 시작 일자는 Microsoft Project에서 프로젝트의 시작 일자입니다.
...
* Workfront 관리자인 경우 Workfront Kick-Starts를 사용하여 가져옵니다.

   킥스타트 파일의 프로젝트 시트의 setPlanningStartDate 필드에 별도로 지정하지 않는 한, 계획된 시작 날짜는 항상 컴퓨터의 시간과 날짜와 일치합니다.

   kick-starts를 사용하여 데이터를 가져오는 방법에 대한 자세한 내용은 [킥시작 템플릿을 사용하여 Adobe Workfront으로 데이터 가져오기](../../../administration-and-setup/manage-workfront/using-kick-starts/import-data-via-kickstarts.md).
...
작업의 계획 시작 날짜를 지정하거나 특정 기준에 따라 계산하도록 Workfront에 둘 수 있습니다.

작업의 계획 시작 날짜에 대한 자세한 내용은 [작업 계획 시작 일자 개요](../../../manage-work/tasks/task-information/task-planned-start-date.md).
