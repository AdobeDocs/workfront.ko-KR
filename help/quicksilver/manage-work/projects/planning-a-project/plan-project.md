...
프로젝트의 비즈니스 사례를 정의하는 방법에 대한 자세한 내용은 [프로젝트의 비즈니스 사례 만들기](../../../manage-work/projects/define-a-business-case/create-business-case.md) 문서를 참조하십시오.

프로젝트의 전체 범위를 정의한 후 프로젝트를 수행할 것인지 여부를 결정하고 계획을 시작할 수 있습니다.

## 예비 프로젝트 계획

* [프로젝트의 시작 및 완료 날짜 정의](#define-the-start-and-completion-date-of-the-project)
...
* 프로젝트에 가장 중요한 목표를 고려하며 이를 마일스톤 작업으로 표시합니다.
  ...
  마일스톤 작업 사용에 대한 자세한 내용은 [마일스톤 경로 만들기](../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-milestone-path.md)를 참조하세요.
...
* 마일스톤 경로를 프로젝트와 연결하고 마일스톤을 해당 작업과 연결합니다.
  ...
  마일스톤 작업 사용에 대한 자세한 내용은 문서 [마일스톤 경로 만들기](../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-milestone-path.md)를 참조하세요.

* 각 작업을 완료하는 데 필요한 작업량을 정의합니다. 각 작업의 계획된 시간 필드에 표시됩니다.

  계획된 시간에 대한 자세한 내용은 문서 [계획된 시간 개요](../../../manage-work/tasks/task-information/planned-hours.md)를 참조하십시오.
