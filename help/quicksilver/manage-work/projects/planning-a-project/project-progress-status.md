...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td>정시</td> 
   <td> 다음과 같은 경우 프로젝트의 진행 상태는 <strong>정시</strong>입니다.<ul><li>예상 및 예상 납기 일자가 모두 프로젝트의 계획된 완료 일자와 같거나 이전인 경우 <p> <img src="assets/project-on-time-progress-status-350x69.png" style="width: 350;height: 69;"> </p></li></ul>  </td> 
  </tr> 
  <tr> 
   <td>위험 상태</td> 
   <td> 다음 중 <strong>모두</strong>이(가) true인 경우 프로젝트의 진행 상태는 <strong>위험</strong>입니다.<ul><li>예상 완료 일자와 예상 완료 일자는 모두 미래입니다.</li><li> 예상 납기 일자가 계획된 완료 일자와 예상 완료 일자 모두보다 늦습니다. <p> <img src="assets/project-at-risk-progress-status-350x67.png" style="width: 350;height: 67;"> </p></li></ul> </td> 
  </tr> 
  <tr> 
   <td>지연됨</td> 
   <td> 다음 중 <strong>모두</strong>이(가) true인 경우 프로젝트의 진행 상태는 <strong>늦음</strong>입니다.<ul><li>예상 완료 일자와 예상 완료 일자는 모두 미래입니다.</li><li> 예상 완료 일자와 예상 완료 일자가 모두 프로젝트의 계획된 완료 일자보다 늦습니다</li><li> 예상 납기 일자는 예상 완료 일자 이후입니다.
...
* 프로젝트의 예상 기한은 가장 최근 예상 기한의 중요 경로에 있는 작업에 의해 결정됩니다.
