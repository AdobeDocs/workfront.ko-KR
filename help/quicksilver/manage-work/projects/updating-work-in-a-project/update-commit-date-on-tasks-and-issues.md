...
1. (조건부 및 선택 사항) Workfront 또는 그룹 관리자가 작업 또는 문제 헤더에 커밋 날짜를 추가한 경우 헤더의 **커밋 날짜** 필드를 클릭한 다음 달력에서 날짜를 선택합니다. 커밋 일자 가 헤더에 없으면 다음 단계를 진행하십시오.
   ...
   ![작업 헤더의 커밋 일자](assets/commit-date-task-header.png)

1. 왼쪽 패널에서 **작업 세부 정보** 또는 **문제 세부 정보**&#x200B;을 클릭합니다.
1. 확장하려면 **개요**&#x200B;를 클릭하세요.
1. **커밋 일자** 필드를 업데이트합니다.

   ![세부 정보 페이지에서 강조 표시된 작업 커밋 일자 편집](assets/task-commit-date-edit-highlighted-details-page.png)
...
1. **변경 내용 저장**&#x200B;을 클릭합니다.
   ...
   * 작업 또는 문제의 커밋 일자와 계획된 완료 일자가 더 이상 동일하지 않습니다.
     ...
     ![강조 표시된 세부 정보의 작업 예상 완료 일자](assets/task-projected-completion-date-in-details-highlighted-nwe-350x230.png)
   ...
   * 업데이트 섹션에서 프로젝트 소유자에게 새 커밋 일자를 제안했다는 알림이 표시되며 사용자는 이때 제안한 커밋 일자와 일치하도록 작업 또는 문제의 계획된 완료 일자를 업데이트할 수 있습니다.
     ...
     ![업데이트 스트림의 커밋 날짜가 프로젝트 타임라인에 영향을 주는 프로젝트 소유자 알림](assets/project-owner-notification-update-stream-that-commit-date-affects-project-timeline.png)
