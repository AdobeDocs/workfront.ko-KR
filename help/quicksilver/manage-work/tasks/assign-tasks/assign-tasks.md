...
1. 다음 중 하나를 수행하십시오.
   ...
   * (조건부) 표시될 때 **제안된 할당**, **사용자 및 팀**, **작업 역할** 또는 <span class="preview">**카드 역할 비율**</span> 목록에 있는 이름 중 하나를 클릭합니다. 자세한 내용은 [스마트 할당 개요](../../../manage-work/tasks/assign-tasks/smart-assignments.md)를 참조하십시오.
