...
1. (선택 사항) 수정할 작업을 마우스 오른쪽 버튼으로 클릭합니다.
   ...
   작업 이름 오른쪽에 있는 **자세히** 메뉴 ![작업 목록의 기타 아이콘](assets/more-icon-task-list.png)을 클릭합니다.
...
1. (선택 사항) 수정할 작업을 마우스 오른쪽 버튼으로 클릭합니다.
   ...
   작업 목록에서 **자세히** 메뉴 ![모드 아이콘을 클릭합니다](assets/more-icon-task-list.png).
...
1. 목록에서 작업을 클릭한 다음 타임라인의 다른 위치에 끌어서 놓습니다.

   상위 작업을 클릭하여 위치를 변경하면 모든 하위 작업도 이동됩니다.

   Workfront은 작업 타임라인을 변경할 때 모든 프로젝트 내 및 프로젝트 간 종속성을 업데이트합니다.
...
1. (선택 사항) 수정할 작업을 마우스 오른쪽 버튼으로 클릭합니다.
   ...
   **기타** 메뉴 ![질문하기 목록의 기타 아이콘](assets/more-icon-task-list.png)을 클릭합니다.
...
1. 작업으로 이동하여 작업 수준에서 정보를 편집하려면 다음 아이콘 또는 영역을 클릭하십시오.
   ...
   <table style="table-layout:auto"> 
      ...
      <tr> 
         ...
         <td><p>작업에 문서를 추가합니다.</p>
         <p><b>메모</b></p>
         <p>조직에서 문서에 Adobe 클라우드 스토리지를 사용하는 경우 Adobe 클라우드 스토리지 작업의 요약 패널에서 작업에 문서를 추가할 수 없습니다.</p>
...
1. **편집** 아이콘 ![편집 아이콘](assets/qs-edit-icon.png)을 클릭합니다. **작업 편집** 상자가 열립니다.
