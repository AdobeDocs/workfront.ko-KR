...
반복 작업 상위 항목에 대한 일부 변경 사항이 기존의 모든 반복에서 업데이트되지 않을 수 있습니다. 진행 상황을 표시하거나 개별적으로 업데이트된 하위 작업은 상위 항목을 업데이트할 때 업데이트되지 않습니다. Workfront은 작업이 다음 상황에서 진행률을 표시한다고 간주합니다.
