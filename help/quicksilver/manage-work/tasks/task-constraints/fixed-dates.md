...
* 고정 일자 제한은 하위 작업이 있는 작업에는 영향을 주지 않습니다. 하위 작업이 있는 작업에는 적용된 제한 사항에 관계없이 가장 이른 하위 작업 시작 및 최신 하위 작업 완료 일자에서 롤업된 자체 계획된 시작, 계획된 완료 및 기간이 있습니다. 대신 고정 일자가 필요한 하위 작업에 고정 일자 제약 조건을 직접 연결해야 합니다. 상위 항목은 자동으로 롤업됩니다.
