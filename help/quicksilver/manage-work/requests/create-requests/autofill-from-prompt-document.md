...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Adobe Workfront 또는 워크플로우 패키지</td> 
   <td> <p>Any </p> </td> 
  </tr> 
  <tr> 
...
-->
* 조직에는 Select, Prime 또는 Ultimate Workfront 또는 Workflow 패키지가 있어야 합니다.
...
* 계산된 데이터에 종속된 필드는 지원되지 않습니다. 예를 들어 필드 A가 계산된 필드이고 필드 B의 옵션이 필드 A에서 파생된 경우 양식 채우기에서 필드 B를 자동으로 채울 수 없습니다.
...
## 조직에 대해 AI 기반의 양식 채우기 활성화

>[!NOTE]
>
>AI에서 제공하는 양식 채우기는 조직 수준에서 활성화되며, 특정 사용자 또는 액세스 수준에 대해 활성화 또는 비활성화할 수 없습니다.
...
AI에서 제공하는 양식 채우기는 프롬프트를 사용하여 요청을 채우거나 업로드한 문서를 기반으로 필드 값을 제안할 수 있습니다.
...
<table>
<tr>
<td>AI에서 제공하는 <b>지원되는 </b><br> 양식 채우기가 채울 수 있음</td>
<td><b>지원되지 않음</b> <br>AI에서 제공하는 양식 채우기가 채워지지 않음</td>
</tr>
<tr>
<td>
<ul>
...
* AI 양식 채우기는 외부 조회 필드 값을 채울 수 있습니다. 그러나 외부 조회 필드에 수식 필드에 대한 종속성이 있는 경우 AI가 필드 옵션을 정확하게 검색할 수 없고 해당 필드 값을 채우지 않습니다.
