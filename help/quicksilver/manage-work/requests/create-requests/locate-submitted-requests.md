...
>[!NOTE]
>
>* Workfront Planning이 있는 경우 Workfront 및 Planning 요청이 동일한 목록에 나타납니다.Planning 요청의 **개체 유형** 이름은 `< Name of workspace > > < Name of record type >` 패턴을 따라 지정됩니다. 예를 들어 Planning 요청의 Object 형식 이름이 `Marketing workspace > Campaigns`일 수 있습니다.\
