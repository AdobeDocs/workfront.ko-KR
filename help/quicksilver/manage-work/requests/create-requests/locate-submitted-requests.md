...
요청 영역에서 제출된 요청을 볼 수 있으며 여기에는 프로덕션 환경 <!--, or links to records created by Planning requests or <span objects converted from Workfront issues in the Preview environment-->에서 Adobe Workfront Planning 요청으로 생성된 레코드에 대한 링크가 포함되어 있습니다.
