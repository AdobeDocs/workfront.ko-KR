...
>     Planning 요청의 **개체 유형** 이름은 `< Name of workspace > > < Name of record type >` 패턴을 따라 지정됩니다. 예를 들어 Planning 요청의 Object 형식 이름이 `Marketing workspace > Campaigns`일 수 있습니다.\
...
1. (선택 사항) **상태** 열을 확인하여 요청 상태를 확인합니다.
   ...
   * **새로 만들기**: 요청이 새로 만들어졌으며 아무도 이 요청을 작업하지 않았습니다.
