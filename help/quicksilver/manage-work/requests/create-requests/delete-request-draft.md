...
title: 제출된 요청 또는 요청 초안 삭제
description: Adobe Workfront에서 제출된 요청이나 요청 초안을 삭제할 수 있습니다.
author: Alina
...
생성했거나 관리 권한이 있는 Adobe Workfront 또는 Adobe Workfront Planning 제출 요청 또는 요청 초안을 삭제할 수 있습니다.

Workfront 관리자 및 Workfront Planning 작업 영역 관리자는 요청을 삭제하고 생성하지 않은 초안을 요청할 수도 있습니다.

레거시 요청 환경에서는 Planning 요청을 볼 수 없습니다.

이 문서에서는 새 요청 경험에서 요청 초안을 삭제하는 방법에 대해 설명합니다. Workfront 및 Planning 요청 또는 초안을 삭제하는 것은 동일합니다.
...
<p>Planning 요청을 관리할 모든 Workfront Planning 패키지 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>생성하지 않은 요청을 삭제하려면 Workfront 관리자 또는 Planning 작업 공간 관리자여야 합니다.</p><p>문제에 대한 편집 액세스 권한이 있어야 합니다.</p>  </td> 
  </tr> 
  <tr> 
   <td role="rowheader">개체 권한</td> 
   <td> <p>새 요청 경험에서 삭제할 요청 또는 초안을 만들었거나 제출하지 않은 요청의 초안을 삭제하려면 Workfront 관리자 또는 Planning 작업 영역 관리자여야 합니다.
   </p><p>삭제 중인 문제에 대한 편집 권한이 있어야 합니다.</p>  </td> 
  </tr>
...
다음 영역에서 요청 및 초안을 삭제할 수 있습니다.

* Workfront의 요청 영역에서
* 홈의 내 요청 위젯에서
* 요청 페이지에서

다음 사용자는 요청 초안을 삭제할 수 있습니다.

* Workfront 관리자는 자신 또는 다른 사용자가 제출한 요청 및 초안을 삭제할 수 있습니다.
* Workfront Planning 작업 영역 관리자는 관리하는 Planning 작업 영역에서 요청 및 초안을 삭제할 수 있습니다.
* 사용자는 제출한 요청 및 초안을 삭제할 수 있습니다.

### 홈의 요청 영역 또는 내 요청 위젯에서 요청 또는 초안 삭제
...
1. **Home**&#x200B;의 **요청** 목록 또는 **내 요청** 위젯에서 삭제할 요청 또는 초안을 마우스로 가리킨 다음 **추가** 메뉴 ![추가 메뉴](assets/more-menu.png)를 클릭합니다
...
1. 대화 상자가 열리면 **삭제**&#x200B;를 클릭합니다.
   ...
   삭제된 요청은 휴지통에 저장되며 Workfront 관리자는 이를 최대 30일 동안 복구할 수 있습니다. 초안은 복구할 수 없습니다.
...
기존 요청 경험에서 Planning 요청 또는 해당 초안에 액세스할 수 없습니다.

{{step1-to-requests}}

1. 왼쪽 패널에서 **초안**&#x200B;을 클릭합니다.
