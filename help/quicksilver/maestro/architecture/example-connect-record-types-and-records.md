...
1. 검색 상자에 제품 이름을 입력한 다음 목록에 표시될 때 선택합니다
   ...
   >[!TIP]
   >
   >    Campaign의 세부 정보 페이지를 열고 연결된 레코드 필드를 찾은 다음 **+** 연결된 제품 레코드 유형의 제품을 추가하는 필드의 아이콘
...
1. 검색 상자에 프로젝트 이름을 입력한 다음 목록에 표시될 때 선택합니다
   ...
   >[!TIP]
   >
   >    Campaign의 세부 정보 페이지를 열고 연결된 프로젝트 필드를 찾은 다음 **+** 연결된 제품 레코드 유형에서 프로젝트를 추가할 필드의 아이콘입니다.
