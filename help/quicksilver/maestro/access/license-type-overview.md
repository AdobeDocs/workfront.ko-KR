...
Adobe Workfront 라이선스 유형은 Adobe Workfront 계획 권한과 함께 작동하여 작업 공간 또는 보기를 보고, 기여하고, 관리할 수 있는 액세스 권한을 부여합니다. <!--add more objects here when we can grant other object-specific permissions-->
...
Workfront Planning의 개체에 대한 권한에 대한 자세한 내용은 [Adobe Workfront Planning의 공유 권한 개요](/help/quicksilver/maestro/access/sharing-permissions-overview.md).

## Workfront 라이선스 유형과 Workfront 계획 권한 간의 관계
