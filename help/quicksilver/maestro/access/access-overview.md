---
title: 액세스 개요
description: Adobe Workfront의 계획 기능을 사용하려면 라이선스 및 공유 권한 제한이 있습니다.
hidefromtoc: true
hide: true
...
Adobe Workfront 계획 기능을 사용하려면 라이선스 및 공유 권한 제한이 있습니다.

## 액세스 요구 사항

Adobe Workfront에서 계획 기능을 사용하려면 다음 설정이 있어야 합니다.
...
<td>
 ...
 <td role="rowheader"><p>Adobe Workfront 계약</p></td>
   <td>
<p>Adobe Workfront 계획 기능 비공개 베타 프로그램에 조직을 등록해야 합니다. </p>
   </td>
  </tr>
  <tr>
...
<p>임의</p>
  ...
  <tr>
   ...
   <td> <p>계획 기능 객체에 대한 액세스 수준 제어가 없습니다</p>  
</td>
  </tr>
<tr>
   ...
   <a href="../access/sharing-permissions-overview.md">Adobe Workfront 계획 기능의 공유 권한 개요</a> 
  </td>
  </tr>
<tr>
...
조직이 Workfront 계획 기능 Beta 프로그램에 등록되면 레이아웃 템플릿을 사용하여 모든 사용자의 메인 메뉴에 마에스트로 영역을 추가할 수 있습니다.
...
1. Workfront 계획 기능에 액세스할 수 있는 사용자에게 레이아웃 템플릿을 할당합니다.
...
Workfront에는 계획 기능에 대한 액세스 제어가 없습니다.

모든 유형의 라이선스가 있는 사용자는 Workfront 계획 기능에 액세스할 수 있습니다.
...
자세한 내용은 [Adobe Workfront 계획 기능의 공유 권한 개요](/help/quicksilver/maestro/access/sharing-permissions-overview.md).

Adobe Workfront 라이선스 유형은 계획 기능 권한과 함께 작동하여 계획 기능 개체를 보고, 기여하고, 관리할 수 있는 액세스 권한을 부여합니다.
