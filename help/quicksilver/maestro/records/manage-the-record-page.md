...
* 레코드에 표지 이미지를 추가하는 것은 레코드 상자 또는 페이지의 전체 레이아웃의 일부가 아닙니다. 각 레코드에 고유한 표지 이미지를 추가할 수 있습니다. 자세한 내용은 [레코드에 표지 이미지 추가](/help/quicksilver/maestro/records/add-a-cover-image-to-a-record.md).
