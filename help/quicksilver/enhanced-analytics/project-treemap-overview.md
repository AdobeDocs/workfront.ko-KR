...
* **작고 연한 파란색 상자**: 시간 또는 일이 적은 프로젝트는 연한 파란색의 작은 상자로 표시됩니다.

  ![](assets/project-treemap-smaller-box.png)

* **크고 짙은 파란색 상자**: 시간이 많은 프로젝트(일 단위)는 어두운 파란색의 더 큰 상자로 표시됩니다.

  ![](assets/project-treemap-larger-box-350x205.png)

* **중간 크기, 파란색 상자**: 두 범주 사이에 있는 프로젝트는 짙은 파란색과 연한 파란색 사이에 파란색 음영이 있는 중간 크기의 상자로 표시됩니다. 중간 크기의 상자에는 3가지 가능한 파란색 음영이 있습니다.
...
1. (선택 사항) 프로젝트 정렬 방법을 변경하려면 **정렬 기준:** 프로젝트 트리맵 시각화의 오른쪽 상단 모서리에서 메뉴를 선택한 다음, 새 정렬 옵션을 선택합니다.
...
1. (선택 사항) 다음에서 보기 변경 **계획된 시간** 끝 **지속 시간**.
...
1. 프로젝트 상태를 확인하고 총 계획된 시간, 총 완료된 시간 및 일별 프로젝트에 소요된 평균 시간을 확인하려면 프로젝트 위로 마우스를 가져갑니다.
   ...
   >[!NOTE]
   >
   >다음을 선택한 경우 **지속 시간** 다음 기간 세부 정보가 표시됩니다.
   >
   >* **계획된 일정**: 프로젝트 완료에 계획된 일 수입니다.
   >* **근무일**: 맨 위에서 선택한 날짜 범위 내에 완료된 각 작업의 계획된 기간을 하루의 시간 수로 나눈 값입니다.
   >   
   >![](assets/duration-treemap-350x159.png)
   >
   >기간에 대한 자세한 내용은 의 &quot;기간 보기&quot; 섹션을 참조하십시오. [향상된 분석 개요](../enhanced-analytics/enhanced-analytics-overview.md).
...
번다운 시각화에 대한 자세한 내용은 [향상된 분석에서 번다운 시각화 보기](../enhanced-analytics/burndown-overview.md). 진행 중인 작업 시각화에 대한 자세한 내용은 [향상된 분석에서 진행 중인 작업 시각화 보기](../enhanced-analytics/tasks-in-flight-overview.md).
