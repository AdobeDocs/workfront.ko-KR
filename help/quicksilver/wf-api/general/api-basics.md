...
<pre>POST /attask/api/v15.0/document?updates={<br> name: aFileName,<br> handle: abc...123, (파일 업로드의 핸들)<br> docObjCode: PROJ, (또는 TASK, OPTASK 등)<br> objID: abc...123,<br> currentVersion:{version:v1.0,fileName:aFileName}<br></pre>
