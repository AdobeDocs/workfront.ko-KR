  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li><a href="#note" class="MCXref xref">메모</a> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p style="font-weight: bold;">액션</p> <p>가능한 값 BUDGETING_INFORMATION이 추가되었습니다. 이를 통해 권한이 있는 사용자는 플래너에서 우선 순위 및 예산 시간을 편집할 수 있습니다.  </p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
