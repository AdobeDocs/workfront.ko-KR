...
청구 기록에 대한 자세한 내용은 [청구 기록 만들기](../../manage-work/projects/project-finances/create-billing-records.md).

BillingRecord 개체가 플래그를 추가했습니다. **DATA_EXTENSIBLE**.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>범주 ID</b> </p> <p>추가됨. 범주는 사용자 정의 양식입니다. 이 매개 변수는 BillingRecord 개체에 사용자 지정 Forms을 추가하는 기능을 지원하기 위해 추가되었습니다.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>objectCategors</b> </p> <p>추가됨. BillingRecord 개체와 연결된 범주(사용자 정의 양식) 컬렉션을 나타냅니다.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>getGroupStates</b> </p> <p>추가됨. 이 쿼리는 그룹 및 하위 그룹의 상태를 만들고 관리하는 기능을 지원합니다. </p> <p>자세한 내용은 <a href="../../administration-and-setup/manage-groups/manage-group-statuses/manage-group-statuses.md" class="MCXref xref">그룹 상태 관리</a>.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>lastCallbackDate</b> </p> <p>추가됨. 이 필드는 버전이 증명과 연결된 경우 Workfront 증명에서 마지막으로 콜백한 날짜와 시간을 기록합니다.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
업데이트의 태그 지정에 대한 자세한 내용은 [업데이트에 다른 사용자 태그 지정](../../workfront-basics/updating-work-items-and-viewing-updates/tag-others-on-updates.md).
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>searchByPath</b> </p> <p>추가됨. 이 작업은 요청 대기열과 주제 그룹을 통과하는 경로를 사용하여 요청을 찾는 기능을 지원합니다.</p> <p>경로별 요청 대기열 검색에 대한 자세한 내용은 <a href="../../manage-work/requests/create-requests/create-submit-requests.md#create-requests-in-the-web-app" class="MCXref xref">Workfront 웹 앱에서 요청 만들기 및 초안 생성</a> 위치: <a href="../../manage-work/requests/create-requests/create-submit-requests.md" class="MCXref xref">Adobe Workfront 요청 만들기 및 제출</a>.</p> </li> 
    </ul> <p> </p> </td> 
  </tr> 
 </tbody> 
</table>
