...
description: API 버전 9를 처음 사용하는 리소스 목록입니다. 버전 9의 리소스에 대한 업데이트 목록을 보려면 API 버전 9 업데이트 를 참조하십시오.
author: Becky
...
API 버전 9를 처음 사용하는 리소스 목록입니다. 버전 9의 리소스에 대한 업데이트 목록을 보려면 다음을 방문하십시오. [API 버전 9 업데이트](../../wf-api/api/new-api-version-9-updates.md)
...
이 목록은 두 부분으로 나누어졌습니다. 후반을 보려면 다음을 참조하십시오. [API 버전 9의 새로운 기능(계속)](../../wf-api/api/new-api-version-9-continue.md). 버전 9 업데이트 목록을 보려면 다음을 방문하십시오. [API 버전 9 업데이트](../../wf-api/api/new-api-version-9-updates.md)
